...
class ImagesStorage(Operation):
    ...
    _url: str = "/ams/v1/admin/namespaces/{namespace}/images-storage"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> ImagesStorage:
    ...
    def parse_response(
        ...
        Union[None, ApiImageStorage], Union[None, HttpResponse, ResponseErrorResponse]
    ]:
        ...
        if code == 200:
            return ApiImageStorage.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> ImagesStorage:
        instance = cls()
