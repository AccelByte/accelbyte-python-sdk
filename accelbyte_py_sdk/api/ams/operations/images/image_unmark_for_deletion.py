...
class ImageUnmarkForDeletion(Operation):
    ...
    _url: str = "/ams/v1/admin/namespaces/{namespace}/images/{imageID}/restore"
    _method: str = "POST"
    _consumes: List[str] = []
    ...
    def with_image_id(self, value: str) -> ImageUnmarkForDeletion:
        self.image_id = value
        return self

    def with_namespace(self, value: str) -> ImageUnmarkForDeletion:
    ...
    @classmethod
    def create(cls, image_id: str, namespace: str, **kwargs) -> ImageUnmarkForDeletion:
        instance = cls()
