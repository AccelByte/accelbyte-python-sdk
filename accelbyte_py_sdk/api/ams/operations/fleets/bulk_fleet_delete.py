...
class BulkFleetDelete(Operation):
    ...
    body: ApiFleetBulkDeleteRequest  # REQUIRED in [body]
    ...
    def with_body(self, value: ApiFleetBulkDeleteRequest) -> BulkFleetDelete:
        self.body = value
        return self

    def with_namespace(self, value: str) -> BulkFleetDelete:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApiFleetBulkDeleteRequest()
    ...
    def parse_response(
        ...
        Union[None, ApiFleetBulkDeleteResponse],
        Union[None, ApiFleetBulkDeleteResponse, HttpResponse, ResponseErrorResponse],
    ]:
        ...
        if code == 200:
            return ApiFleetBulkDeleteResponse.create_from_dict(content), None
        if code == 207:
            return ApiFleetBulkDeleteResponse.create_from_dict(content), None
        if code == 400:
        ...
        if code == 403:
            return None, ResponseErrorResponse.create_from_dict(content)
        if code == 422:
            return None, ApiFleetBulkDeleteResponse.create_from_dict(content)
        if code == 500:
            return None, ResponseErrorResponse.create_from_dict(content)
    ...
    @classmethod
    def create(
        cls, body: ApiFleetBulkDeleteRequest, namespace: str, **kwargs
    ) -> BulkFleetDelete:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApiFleetBulkDeleteRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApiFleetBulkDeleteRequest()
