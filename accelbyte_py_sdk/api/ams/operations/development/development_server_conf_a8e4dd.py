...
class DevelopmentServerConfigurationCreate(Operation):
    ...
    def with_body(
        self, value: ApiDevelopmentServerConfigurationCreateRequest
    ) -> DevelopmentServerConfigurationCreate:
        self.body = value
        return self

    def with_namespace(self, value: str) -> DevelopmentServerConfigurationCreate:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApiDevelopmentServerConfigurationCreateRequest()
    ...
    def parse_response(
        ...
        Union[None, ApiDevelopmentServerConfigurationCreateResponse],
        ...
        if code == 201:
            return (
                ApiDevelopmentServerConfigurationCreateResponse.create_from_dict(
                    content
                ),
                None,
            )
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = (
                ApiDevelopmentServerConfigurationCreateRequest.create_from_dict(
                    dict_["body"], include_empty=include_empty
                )
            )
        elif include_empty:
            instance.body = ApiDevelopmentServerConfigurationCreateRequest()
