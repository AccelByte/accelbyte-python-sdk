...
class DevelopmentServerConfigurationGet(Operation):
    ...
    def with_namespace(self, value: str) -> DevelopmentServerConfigurationGet:
    ...
    def parse_response(
        ...
        Union[None, ApiDevelopmentServerConfigurationGetResponse],
        ...
        if code == 200:
            return (
                ApiDevelopmentServerConfigurationGetResponse.create_from_dict(content),
                None,
            )
        if code == 401:
    ...
    @classmethod
    def create(
        cls, development_server_config_id: str, namespace: str, **kwargs
    ) -> DevelopmentServerConfigurationGet:
        instance = cls()
