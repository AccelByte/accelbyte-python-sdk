...
class AccountLinkTokenGet(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ApiAccountLinkTokenResponse], Union[None, HttpResponse, ResponseErrorResponse]]:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AccountLinkTokenGet:
        instance = cls()
