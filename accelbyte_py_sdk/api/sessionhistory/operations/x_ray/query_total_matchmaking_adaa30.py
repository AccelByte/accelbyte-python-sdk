...
class QueryTotalMatchmakingExpired(Operation):
    ...
    _url: str = "/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/total-ticket-expired"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> QueryTotalMatchmakingExpired:
        self.namespace = value
        return self

    def with_match_pool(self, value: List[str]) -> QueryTotalMatchmakingExpired:
        self.match_pool = value
        return self

    def with_end_date(self, value: str) -> QueryTotalMatchmakingExpired:
        self.end_date = value
        return self

    def with_start_date(self, value: str) -> QueryTotalMatchmakingExpired:
    ...
    def parse_response(
        ...
        Union[None, ApimodelsXRayExpiredMatchmakingTicketQueryResponse],
        ...
        if code == 200:
            return (
                ApimodelsXRayExpiredMatchmakingTicketQueryResponse.create_from_dict(
                    content
                ),
                None,
            )
