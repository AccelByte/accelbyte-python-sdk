...
class ModelsDefaultProvider(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsDefaultProvider, List[ModelsDefaultProvider], Dict[Any, ModelsDefaultProvider]]:
        if many:
