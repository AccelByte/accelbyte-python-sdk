...
class ModelsUpdatePortRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdatePortRequest, List[ModelsUpdatePortRequest], Dict[Any, ModelsUpdatePortRequest]]:
        if many:
