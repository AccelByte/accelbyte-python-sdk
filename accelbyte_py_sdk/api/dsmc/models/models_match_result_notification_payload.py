...
class ModelsMatchResultNotificationPayload(Model, MutableMapping):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsMatchResultNotificationPayload, List[ModelsMatchResultNotificationPayload]]:
        if many:
