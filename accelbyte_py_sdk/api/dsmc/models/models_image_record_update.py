...
class ModelsImageRecordUpdate(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsImageRecordUpdate, List[ModelsImageRecordUpdate], Dict[Any, ModelsImageRecordUpdate]]:
        if many:
