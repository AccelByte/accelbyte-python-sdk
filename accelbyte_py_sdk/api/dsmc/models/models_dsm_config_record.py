...
class ModelsDSMConfigRecord(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsDSMConfigRecord, List[ModelsDSMConfigRecord], Dict[Any, ModelsDSMConfigRecord]]:
        if many:
