...
class ModelsServerSessionResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsServerSessionResponse, List[ModelsServerSessionResponse], Dict[Any, ModelsServerSessionResponse]]:
        if many:
