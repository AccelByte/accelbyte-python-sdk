...
class ModelsImportResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsImportResponse, List[ModelsImportResponse], Dict[Any, ModelsImportResponse]]:
        if many:
