# Auto-generated at 2021-10-21T08:52:24.260156+08:00
...
class ModelsDeploymentConfig(Model):
    ...
    def with_buffer_percent(self, value: int) -> ModelsDeploymentConfig:
    ...
    def with_enable_region_overrides(self, value: bool) -> ModelsDeploymentConfig:
    ...
    def with_region_overrides(self, value: Dict[str, ModelsPodCountConfigOverride]) -> ModelsDeploymentConfig:
    ...
    def with_use_buffer_percent(self, value: bool) -> ModelsDeploymentConfig:
