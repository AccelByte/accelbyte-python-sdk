...
class ModelsCreateRegionOverrideRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsCreateRegionOverrideRequest, List[ModelsCreateRegionOverrideRequest]]:
        if many:
