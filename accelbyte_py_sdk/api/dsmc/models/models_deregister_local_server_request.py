...
class ModelsDeregisterLocalServerRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsDeregisterLocalServerRequest, List[ModelsDeregisterLocalServerRequest], Dict[Any, ModelsDeregisterLocalServerRequest]]:
        if many:
