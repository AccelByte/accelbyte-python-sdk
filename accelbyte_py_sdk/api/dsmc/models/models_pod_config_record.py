...
class ModelsPodConfigRecord(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsPodConfigRecord, List[ModelsPodConfigRecord], Dict[Any, ModelsPodConfigRecord]]:
        if many:
