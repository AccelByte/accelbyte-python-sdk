...
class ModelsCountSessionResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsCountSessionResponse, List[ModelsCountSessionResponse], Dict[Any, ModelsCountSessionResponse]]:
        if many:
