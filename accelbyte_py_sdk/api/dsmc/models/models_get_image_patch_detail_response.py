...
class ModelsGetImagePatchDetailResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsGetImagePatchDetailResponse, List[ModelsGetImagePatchDetailResponse], Dict[Any, ModelsGetImagePatchDetailResponse]]:
        if many:
