...
class ModelsCreateImagePatchRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsCreateImagePatchRequest, List[ModelsCreateImagePatchRequest], Dict[Any, ModelsCreateImagePatchRequest]]:
        if many:
