...
# justice-dsm-controller-service (2.15.1)
...
class ModelsCreateDeploymentRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsCreateDeploymentRequest, List[ModelsCreateDeploymentRequest]]:
        if many:
