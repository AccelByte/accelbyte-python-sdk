...
class ModelsClaimSessionRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsClaimSessionRequest, List[ModelsClaimSessionRequest], Dict[Any, ModelsClaimSessionRequest]]:
        if many:
