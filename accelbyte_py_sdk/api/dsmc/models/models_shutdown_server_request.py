...
class ModelsShutdownServerRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsShutdownServerRequest, List[ModelsShutdownServerRequest], Dict[Any, ModelsShutdownServerRequest]]:
        if many:
