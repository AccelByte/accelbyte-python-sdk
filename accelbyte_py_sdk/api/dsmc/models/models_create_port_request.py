...
class ModelsCreatePortRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsCreatePortRequest, List[ModelsCreatePortRequest], Dict[Any, ModelsCreatePortRequest]]:
        if many:
