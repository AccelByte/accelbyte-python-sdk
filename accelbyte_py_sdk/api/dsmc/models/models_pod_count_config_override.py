...
class ModelsPodCountConfigOverride(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsPodCountConfigOverride, List[ModelsPodCountConfigOverride], Dict[Any, ModelsPodCountConfigOverride]]:
        if many:
