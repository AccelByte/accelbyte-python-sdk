# Auto-generated at 2021-10-21T08:52:24.395264+08:00
...
class CountServerDetailed(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsDetailedCountServerResponse], Union[None, ResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> CountServerDetailed:
        instance = cls()
