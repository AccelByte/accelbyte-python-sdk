...
class IamPermission(Model):
    ...
    def with_action(self, value: int) -> IamPermission:
        self.action = value
        return self

    def with_resource(self, value: str) -> IamPermission:
        self.resource = value
        return self
    ...
    @classmethod
    def create(cls, action: int, resource: str, **kwargs) -> IamPermission:
        instance = cls()
    ...
    ) -> Union[IamPermission, List[IamPermission], Dict[Any, IamPermission]]:
        if many:
