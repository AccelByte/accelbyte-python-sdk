...
class AdminMoveGoalToSlot(Operation):
    ...
    _url: str = "/challenge/v1/admin/namespaces/{namespace}/challenges/{challengeCode}/goals/{code}/slots"
    _method: str = "PUT"
    ...
    body: ModelMoveGoalToSlotRequest  # REQUIRED in [body]
    ...
    def with_body(self, value: ModelMoveGoalToSlotRequest) -> AdminMoveGoalToSlot:
        self.body = value
        return self

    def with_challenge_code(self, value: str) -> AdminMoveGoalToSlot:
        self.challenge_code = value
        return self

    def with_code(self, value: str) -> AdminMoveGoalToSlot:
        self.code = value
        return self

    def with_namespace(self, value: str) -> AdminMoveGoalToSlot:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelMoveGoalToSlotRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelMoveGoalToSlotRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelMoveGoalToSlotRequest()
