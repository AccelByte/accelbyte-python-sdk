...
class PublicGetChallenges(Operation):
    ...
    def with_namespace(self, value: str) -> PublicGetChallenges:
        self.namespace = value
        return self

    def with_keyword(self, value: str) -> PublicGetChallenges:
        self.keyword = value
        return self

    def with_limit(self, value: int) -> PublicGetChallenges:
        self.limit = value
        return self

    def with_offset(self, value: int) -> PublicGetChallenges:
        self.offset = value
        return self

    def with_sort_by(self, value: Union[str, SortByEnum]) -> PublicGetChallenges:
        self.sort_by = value
        return self

    def with_status(self, value: Union[str, StatusEnum]) -> PublicGetChallenges:
        self.status = value
        return self

    def with_tags(self, value: List[str]) -> PublicGetChallenges:
        self.tags = value
        return self
