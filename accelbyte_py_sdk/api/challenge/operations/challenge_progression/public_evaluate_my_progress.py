...
class PublicEvaluateMyProgress(Operation):
    ...
    def with_namespace(self, value: str) -> PublicEvaluateMyProgress:
        self.namespace = value
        return self

    def with_challenge_code(self, value: List[str]) -> PublicEvaluateMyProgress:
        self.challenge_code = value
        return self

    def with_include_one_time_event(self, value: str) -> PublicEvaluateMyProgress:
