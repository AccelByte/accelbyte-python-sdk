...
class PublicGetGameSessionPassword(Operation):
    ...
    def with_namespace(self, value: str) -> PublicGetGameSessionPassword:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> PublicGetGameSessionPassword:
