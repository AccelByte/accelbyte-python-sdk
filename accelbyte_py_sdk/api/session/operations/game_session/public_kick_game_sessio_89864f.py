...
class PublicKickGameSessionMember(Operation):
    ...
    _url: str = "/session/v1/public/namespaces/{namespace}/gamesessions/{sessionId}/members/{memberId}/kick"
    _method: str = "DELETE"
    ...
    def with_member_id(self, value: str) -> PublicKickGameSessionMember:
        self.member_id = value
        return self

    def with_namespace(self, value: str) -> PublicKickGameSessionMember:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> PublicKickGameSessionMember:
    ...
    @classmethod
    def create(
        cls, member_id: str, namespace: str, session_id: str, **kwargs
