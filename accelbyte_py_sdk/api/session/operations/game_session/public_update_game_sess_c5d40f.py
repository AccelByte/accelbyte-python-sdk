...
class PublicUpdateGameSessionPassword(Operation):
    ...
    _url: str = (
        "/session/v1/public/namespaces/{namespace}/gamesessions/{sessionId}/password"
    )
    _method: str = "PUT"
    ...
    body: ApimodelsUpdatePasswordRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelsUpdatePasswordRequest
    ) -> PublicUpdateGameSessionPassword:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicUpdateGameSessionPassword:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> PublicUpdateGameSessionPassword:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelsUpdatePasswordRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelsUpdatePasswordRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelsUpdatePasswordRequest()
