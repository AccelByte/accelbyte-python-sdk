...
class AdminSyncNativeSession(Operation):
    ...
    _url: str = "/session/v1/admin/namespaces/{namespace}/users/{userId}/native-sync"
    _method: str = "POST"
    ...
    def with_namespace(self, value: str) -> AdminSyncNativeSession:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminSyncNativeSession:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> AdminSyncNativeSession:
        instance = cls()
