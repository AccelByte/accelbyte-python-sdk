...
class PublicGetPartyPassword(Operation):
    ...
    def with_namespace(self, value: str) -> PublicGetPartyPassword:
        self.namespace = value
        return self

    def with_party_id(self, value: str) -> PublicGetPartyPassword:
        self.party_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ApimodelsGetPasswordResponse],
        ...
        if code == 200:
            return ApimodelsGetPasswordResponse.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, namespace: str, party_id: str, **kwargs) -> PublicGetPartyPassword:
        instance = cls()
