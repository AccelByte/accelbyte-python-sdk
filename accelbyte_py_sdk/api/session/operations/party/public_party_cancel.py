...
class PublicPartyCancel(Operation):
    ...
    _url: str = "/session/v1/public/namespaces/{namespace}/parties/{partyId}/users/{userId}/cancel"
    _method: str = "DELETE"
    ...
    def with_namespace(self, value: str) -> PublicPartyCancel:
        self.namespace = value
        return self

    def with_party_id(self, value: str) -> PublicPartyCancel:
        self.party_id = value
        return self

    def with_user_id(self, value: str) -> PublicPartyCancel:
        self.user_id = value
        return self
