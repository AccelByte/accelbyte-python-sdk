...
class PublicUpdatePartyPassword(Operation):
    ...
    _url: str = "/session/v1/public/namespaces/{namespace}/parties/{partyId}/password"
    _method: str = "PUT"
    ...
    def with_namespace(self, value: str) -> PublicUpdatePartyPassword:
        self.namespace = value
        return self

    def with_party_id(self, value: str) -> PublicUpdatePartyPassword:
        self.party_id = value
        return self
