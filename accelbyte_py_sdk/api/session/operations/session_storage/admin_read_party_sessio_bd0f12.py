...
class AdminReadPartySessionStorage(Operation):
    ...
    _url: str = "/session/v1/admin/namespaces/{namespace}/parties/{partyId}/storage"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> AdminReadPartySessionStorage:
        self.namespace = value
        return self

    def with_party_id(self, value: str) -> AdminReadPartySessionStorage:
        self.party_id = value
        return self
