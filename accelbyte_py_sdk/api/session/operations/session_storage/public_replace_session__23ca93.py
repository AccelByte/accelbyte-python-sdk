...
class PublicReplaceSessionStorageUserV2(Operation):
    ...
    _url: str = "/session/v2/public/namespaces/{namespace}/sessions/{sessionId}/storage/users/{userId}"
    _method: str = "PUT"
    ...
    def with_body(self, value: Dict[str, Any]) -> PublicReplaceSessionStorageUserV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicReplaceSessionStorageUserV2:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> PublicReplaceSessionStorageUserV2:
        self.session_id = value
        return self

    def with_user_id(self, value: str) -> PublicReplaceSessionStorageUserV2:
        self.user_id = value
        return self
