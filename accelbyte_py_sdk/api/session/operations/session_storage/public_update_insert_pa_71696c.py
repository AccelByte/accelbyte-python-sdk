...
class PublicUpdateInsertPartySessionStorage(Operation):
    ...
    _url: str = "/session/v1/public/namespaces/{namespace}/parties/{partyId}/storage/users/{userId}"
    _method: str = "PATCH"
    ...
    def with_body(self, value: Dict[str, Any]) -> PublicUpdateInsertPartySessionStorage:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicUpdateInsertPartySessionStorage:
        self.namespace = value
        return self

    def with_party_id(self, value: str) -> PublicUpdateInsertPartySessionStorage:
        self.party_id = value
        return self

    def with_user_id(self, value: str) -> PublicUpdateInsertPartySessionStorage:
        self.user_id = value
        return self
