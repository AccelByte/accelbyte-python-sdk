...
class PublicUpdateInsertSessionStorageLeaderV2(Operation):
    ...
    def with_namespace(self, value: str) -> PublicUpdateInsertSessionStorageLeaderV2:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> PublicUpdateInsertSessionStorageLeaderV2:
