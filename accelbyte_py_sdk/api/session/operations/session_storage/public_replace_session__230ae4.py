...
class PublicReplaceSessionStorageLeaderV2(Operation):
    ...
    def with_body(self, value: Dict[str, Any]) -> PublicReplaceSessionStorageLeaderV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicReplaceSessionStorageLeaderV2:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> PublicReplaceSessionStorageLeaderV2:
