...
class AdminGetListNativeSession(Operation):
    ...
    _url: str = "/session/v1/admin/namespaces/{namespace}/native-sessions"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> AdminGetListNativeSession:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> AdminGetListNativeSession:
        self.limit = value
        return self

    def with_offset(self, value: int) -> AdminGetListNativeSession:
        self.offset = value
        return self

    def with_order(self, value: str) -> AdminGetListNativeSession:
        self.order = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ApimodelsNativeSessionPagingResponse],
        ...
        if code == 200:
            return ApimodelsNativeSessionPagingResponse.create_from_dict(content), None
        if code == 401:
