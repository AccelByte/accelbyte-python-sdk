...
class AdminUploadPlatformCredentials(Operation):
    ...
    _url: str = "/session/v1/admin/namespaces/{namespace}/platform-credentials/{platformId}/upload"
    _method: str = "PUT"
    ...
    def with_description(self, value: str) -> AdminUploadPlatformCredentials:
        self.description = value
        return self

    def with_file(self, value: Any) -> AdminUploadPlatformCredentials:
        self.file = value
        return self

    def with_password(self, value: str) -> AdminUploadPlatformCredentials:
        self.password = value
        return self

    def with_namespace(self, value: str) -> AdminUploadPlatformCredentials:
    ...
    def create(
        ...
        password: str,
        namespace: str,
        platform_id: Union[str, PlatformIdEnum],
