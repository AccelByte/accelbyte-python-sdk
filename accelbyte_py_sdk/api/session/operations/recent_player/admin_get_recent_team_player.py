...
class AdminGetRecentTeamPlayer(Operation):
    ...
    _url: str = "/session/v1/admin/namespaces/{namespace}/recent-team-player"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> AdminGetRecentTeamPlayer:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> AdminGetRecentTeamPlayer:
        self.limit = value
        return self

    def with_user_id(self, value: str) -> AdminGetRecentTeamPlayer:
        self.user_id = value
        return self
