...
class PublicGetRecentTeamPlayer(Operation):
    ...
    _url: str = "/session/v1/public/namespaces/{namespace}/recent-team-player"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> PublicGetRecentTeamPlayer:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> PublicGetRecentTeamPlayer:
        self.limit = value
        return self
