...
class AdminHideUserContent(Operation):
    ...
    _url: str = "/ugc/v1/admin/namespaces/{namespace}/users/{userId}/contents/{contentId}/hide"
    _method: str = "PUT"
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminHideUserContent:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsHideContentRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
