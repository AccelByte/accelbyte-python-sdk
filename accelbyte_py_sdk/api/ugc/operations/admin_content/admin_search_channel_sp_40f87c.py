...
class AdminSearchChannelSpecificContent(Operation):
    ...
    _url: str = "/ugc/v1/admin/namespaces/{namespace}/channels/{channelId}/contents/search"
    _method: str = "GET"
    ...
    def with_limit(self, value: str) -> AdminSearchChannelSpecificContent:
        self.limit = value
        return self
    ...
    def with_offset(self, value: str) -> AdminSearchChannelSpecificContent:
        self.offset = value
        return self
    ...
    def with_tags(self, value: str) -> AdminSearchChannelSpecificContent:
        self.tags = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminSearchChannelSpecificContent:
        instance = cls()
