...
class AdminGetType(Operation):
    ...
    def with_limit(self, value: str) -> AdminGetType:
        self.limit = value
        return self

    def with_offset(self, value: str) -> AdminGetType:
        self.offset = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsPaginatedGetTypeResponse], Union[None, HttpResponse, ResponseError]]:
