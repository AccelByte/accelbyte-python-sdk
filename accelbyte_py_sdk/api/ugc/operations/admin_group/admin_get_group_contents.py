...
class AdminGetGroupContents(Operation):
    ...
    _url: str = "/ugc/v1/admin/namespaces/{namespace}/users/{userId}/groups/{groupId}/contents"
    _method: str = "GET"
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetGroupContents:
        instance = cls()
