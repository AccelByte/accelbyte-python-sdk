...
class SingleAdminGetAllGroups(Operation):
    ...
    Required permission <b>ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENTGROUP
    [READ]</b>.
    ...
    def with_limit(self, value: str) -> SingleAdminGetAllGroups:
        self.limit = value
        return self

    def with_offset(self, value: str) -> SingleAdminGetAllGroups:
        self.offset = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsPaginatedGroupResponse], Union[None, ResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> SingleAdminGetAllGroups:
        instance = cls()
