...
class AdminGetAllGroups(Operation):
    ...
    def with_limit(self, value: str) -> AdminGetAllGroups:
        self.limit = value
        return self

    def with_offset(self, value: str) -> AdminGetAllGroups:
        self.offset = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetAllGroups:
        instance = cls()
