...
class SingleAdminGetChannel(Operation):
    ...
    def with_limit(self, value: str) -> SingleAdminGetChannel:
        self.limit = value
        return self

    def with_offset(self, value: str) -> SingleAdminGetChannel:
        self.offset = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsPaginatedGetChannelResponse], Union[None, HttpResponse, ResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> SingleAdminGetChannel:
        instance = cls()
