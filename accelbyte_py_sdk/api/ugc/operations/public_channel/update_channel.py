...
class UpdateChannel(Operation):
    ...
    _url: str = "/ugc/v1/public/namespaces/{namespace}/users/{userId}/channels/{channelId}"
    _method: str = "PUT"
    ...
    def with_body(self, value: ModelsChannelRequest) -> UpdateChannel:
        self.body = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsChannelResponse], Union[None, ResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateChannel:
        instance = cls()
