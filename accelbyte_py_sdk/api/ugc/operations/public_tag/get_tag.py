...
class GetTag(Operation):
    ...
    def with_limit(self, value: str) -> GetTag:
        self.limit = value
        return self

    def with_offset(self, value: str) -> GetTag:
        self.offset = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsPaginatedGetTagResponse], Union[None, HttpResponse, ResponseError]]:
