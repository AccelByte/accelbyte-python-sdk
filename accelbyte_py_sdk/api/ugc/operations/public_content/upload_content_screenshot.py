...
class UploadContentScreenshot(Operation):
    ...
    def with_body(self, value: ModelsCreateScreenshotRequest) -> UploadContentScreenshot:
        self.body = value
        return self
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsCreateScreenshotResponse], Union[None, HttpResponse, ResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UploadContentScreenshot:
        instance = cls()
