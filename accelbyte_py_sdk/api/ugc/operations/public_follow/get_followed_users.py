...
class GetFollowedUsers(Operation):
    ...
    def with_limit(self, value: str) -> GetFollowedUsers:
        self.limit = value
        return self

    def with_offset(self, value: str) -> GetFollowedUsers:
        self.offset = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsPaginatedCreatorOverviewResponse], Union[None, ResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetFollowedUsers:
        instance = cls()
