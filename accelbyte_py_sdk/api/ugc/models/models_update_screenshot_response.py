...
class ModelsUpdateScreenshotResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateScreenshotResponse, List[ModelsUpdateScreenshotResponse], Dict[Any, ModelsUpdateScreenshotResponse]]:
        if many:
