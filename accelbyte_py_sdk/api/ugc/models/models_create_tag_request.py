...
class ModelsCreateTagRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsCreateTagRequest, List[ModelsCreateTagRequest], Dict[Any, ModelsCreateTagRequest]]:
        if many:
