...
class ModelsAddDownloadCountResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsAddDownloadCountResponse, List[ModelsAddDownloadCountResponse], Dict[Any, ModelsAddDownloadCountResponse]]:
        if many:
