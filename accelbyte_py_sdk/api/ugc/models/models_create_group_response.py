...
class ModelsCreateGroupResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsCreateGroupResponse, List[ModelsCreateGroupResponse], Dict[Any, ModelsCreateGroupResponse]]:
        if many:
