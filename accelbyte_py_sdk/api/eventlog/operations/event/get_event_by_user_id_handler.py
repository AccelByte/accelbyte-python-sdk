...
class GetEventByUserIDHandler(Operation):
    ...
    def with_offset(self, value: float) -> GetEventByUserIDHandler:
        self.offset = value
        return self
    ...
    def with_page_size(self, value: float) -> GetEventByUserIDHandler:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetEventByUserIDHandler:
        instance = cls()
