...
class GetEventByEventTypeHandler(Operation):
    ...
    def with_offset(self, value: float) -> GetEventByEventTypeHandler:
        self.offset = value
        return self
    ...
    def with_page_size(self, value: float) -> GetEventByEventTypeHandler:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetEventByEventTypeHandler:
        instance = cls()
