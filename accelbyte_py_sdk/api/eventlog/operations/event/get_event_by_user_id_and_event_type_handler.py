...
class GetEventByUserIDAndEventTypeHandler(Operation):
    ...
    Required permission <code>NAMESPACE:{namespace}:EVENT [UPDATE]and scope
    <code>analytics</code>
    ...
    def with_offset(self, value: float) -> GetEventByUserIDAndEventTypeHandler:
        self.offset = value
        return self
    ...
    def with_page_size(self, value: float) -> GetEventByUserIDAndEventTypeHandler:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetEventByUserIDAndEventTypeHandler:
        instance = cls()
        if "eventType" in dict_ and dict_["eventType"] is not None:
            instance.event_type = float(dict_["eventType"])
        elif include_empty:
            instance.event_type = float()
