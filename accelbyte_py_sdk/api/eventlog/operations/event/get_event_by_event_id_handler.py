...
class GetEventByEventIDHandler(Operation):
    ...
    def with_offset(self, value: float) -> GetEventByEventIDHandler:
        self.offset = value
        return self
    ...
    def with_page_size(self, value: float) -> GetEventByEventIDHandler:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetEventByEventIDHandler:
        instance = cls()
