...
class GetEventByUserEventIDAndEventTypeHandler(Operation):
    ...
    def with_offset(self, value: float) -> GetEventByUserEventIDAndEventTypeHandler:
        self.offset = value
        return self
    ...
    def with_page_size(self, value: float) -> GetEventByUserEventIDAndEventTypeHandler:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetEventByUserEventIDAndEventTypeHandler:
        instance = cls()
