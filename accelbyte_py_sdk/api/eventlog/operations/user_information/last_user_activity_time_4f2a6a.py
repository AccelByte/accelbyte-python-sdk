...
class LastUserActivityTimeHandler(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsUserLastActivity], Union[None, HttpResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> LastUserActivityTimeHandler:
        instance = cls()
