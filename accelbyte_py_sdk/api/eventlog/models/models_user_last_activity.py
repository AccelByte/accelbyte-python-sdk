...
class ModelsUserLastActivity(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUserLastActivity, List[ModelsUserLastActivity], Dict[Any, ModelsUserLastActivity]]:
        if many:
