...
class ModelsMultipleEventType(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsMultipleEventType, List[ModelsMultipleEventType], Dict[Any, ModelsMultipleEventType]]:
        if many:
