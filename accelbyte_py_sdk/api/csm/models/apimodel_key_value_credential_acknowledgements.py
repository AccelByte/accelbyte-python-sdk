...
class ApimodelKeyValueCredentialAcknowledgements(Model):
    """Apimodel key value credential acknowledgements (apimodel.KeyValueCredentialAcknowledgements)
    ...
    @classmethod
    def create(
        cls, accept_key_value_secure_credential_handling: bool, **kwargs
    ) -> ApimodelKeyValueCredentialAcknowledgements:
        instance = cls()
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ApimodelKeyValueCredentialAcknowledgements]:
        return (
    ...
    ) -> List[ApimodelKeyValueCredentialAcknowledgements]:
        return (
    ...
    def create_from_any(
        ...
        ApimodelKeyValueCredentialAcknowledgements,
        List[ApimodelKeyValueCredentialAcknowledgements],
        Dict[Any, ApimodelKeyValueCredentialAcknowledgements],
    ]:
        if many:
