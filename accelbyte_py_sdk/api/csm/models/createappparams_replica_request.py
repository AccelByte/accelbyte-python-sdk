...
class CreateappparamsReplicaRequest(Model):
    """Createappparams replica request (createappparams.ReplicaRequest)
    ...
    def with_max_replica(self, value: int) -> CreateappparamsReplicaRequest:
        self.max_replica = value
        return self

    def with_min_replica(self, value: int) -> CreateappparamsReplicaRequest:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, CreateappparamsReplicaRequest]:
        return (
    ...
    ) -> List[CreateappparamsReplicaRequest]:
        return (
    ...
    def create_from_any(
        ...
        CreateappparamsReplicaRequest,
        List[CreateappparamsReplicaRequest],
        Dict[Any, CreateappparamsReplicaRequest],
    ]:
        if many:
