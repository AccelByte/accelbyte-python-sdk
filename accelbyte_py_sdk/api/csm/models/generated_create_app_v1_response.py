...
class GeneratedCreateAppV1Response(Model):
    """Generated create app V1 response (generated.CreateAppV1Response)
    ...
    def with_status_url(self, value: str) -> GeneratedCreateAppV1Response:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, GeneratedCreateAppV1Response]:
        return (
    ...
    ) -> List[GeneratedCreateAppV1Response]:
        return (
    ...
    def create_from_any(
        ...
        GeneratedCreateAppV1Response,
        List[GeneratedCreateAppV1Response],
        Dict[Any, GeneratedCreateAppV1Response],
    ]:
        if many:
