...
class GeneratedStopAppV1Response(Model):
    """Generated stop app V1 response (generated.StopAppV1Response)
    ...
    def with_status_url(self, value: str) -> GeneratedStopAppV1Response:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, GeneratedStopAppV1Response]:
        return (
    ...
    ) -> List[GeneratedStopAppV1Response]:
        return (
    ...
    def create_from_any(
        ...
        GeneratedStopAppV1Response,
        List[GeneratedStopAppV1Response],
        Dict[Any, GeneratedStopAppV1Response],
    ]:
        if many:
