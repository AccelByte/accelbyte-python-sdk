...
class ApimodelAutoscalingRequest(Model):
    """Apimodel autoscaling request (apimodel.AutoscalingRequest)
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ApimodelAutoscalingRequest]:
        return (
    ...
    ) -> List[ApimodelAutoscalingRequest]:
        return (
    ...
    def create_from_any(
        ...
        ApimodelAutoscalingRequest,
        List[ApimodelAutoscalingRequest],
        Dict[Any, ApimodelAutoscalingRequest],
    ]:
        if many:
