...
class ApimodelIntegrationCredentialInfo(Model):
    """Apimodel integration credential info (apimodel.IntegrationCredentialInfo)
    ...
    def with_created_at(self, value: str) -> ApimodelIntegrationCredentialInfo:
        self.created_at = value
        return self

    def with_owner(self, value: str) -> ApimodelIntegrationCredentialInfo:
        self.owner = value
        return self
    ...
    def with_username(self, value: str) -> ApimodelIntegrationCredentialInfo:
        self.username = value
        return self
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ApimodelIntegrationCredentialInfo]:
        return (
    ...
    ) -> List[ApimodelIntegrationCredentialInfo]:
        return (
    ...
    def create_from_any(
        ...
        ApimodelIntegrationCredentialInfo,
        List[ApimodelIntegrationCredentialInfo],
        Dict[Any, ApimodelIntegrationCredentialInfo],
    ]:
        if many:
