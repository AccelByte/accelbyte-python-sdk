...
class GeneratedSaveConfigurationV1Response(Model):
    """Generated save configuration V1 response (generated.SaveConfigurationV1Response)
    ...
    def with_config_id(self, value: str) -> GeneratedSaveConfigurationV1Response:
        self.config_id = value
        return self

    def with_config_name(self, value: str) -> GeneratedSaveConfigurationV1Response:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, GeneratedSaveConfigurationV1Response]:
        return (
    ...
    ) -> List[GeneratedSaveConfigurationV1Response]:
        return (
    ...
    def create_from_any(
        ...
        GeneratedSaveConfigurationV1Response,
        List[GeneratedSaveConfigurationV1Response],
        Dict[Any, GeneratedSaveConfigurationV1Response],
    ]:
        if many:
