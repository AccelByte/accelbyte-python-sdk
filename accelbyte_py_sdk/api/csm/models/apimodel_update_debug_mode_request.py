...
class ApimodelUpdateDebugModeRequest(Model):
    """Apimodel update debug mode request (apimodel.UpdateDebugModeRequest)
    ...
    def with_enable_debug_mode(self, value: bool) -> ApimodelUpdateDebugModeRequest:
    ...
    @classmethod
    def create(
        cls, enable_debug_mode: bool, **kwargs
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ApimodelUpdateDebugModeRequest]:
        return (
    ...
    ) -> List[ApimodelUpdateDebugModeRequest]:
        return (
    ...
    def create_from_any(
        ...
        ApimodelUpdateDebugModeRequest,
        List[ApimodelUpdateDebugModeRequest],
        Dict[Any, ApimodelUpdateDebugModeRequest],
    ]:
        if many:
