...
class ApimodelCreateNoSQLDatabaseCredentialRequest(Model):
    ...
    def with_username(self, value: str) -> ApimodelCreateNoSQLDatabaseCredentialRequest:
        self.username = value
        return self
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ApimodelCreateNoSQLDatabaseCredentialRequest]:
        return (
    ...
    ) -> List[ApimodelCreateNoSQLDatabaseCredentialRequest]:
        return (
    ...
    def create_from_any(
        ...
        ApimodelCreateNoSQLDatabaseCredentialRequest,
        List[ApimodelCreateNoSQLDatabaseCredentialRequest],
        Dict[Any, ApimodelCreateNoSQLDatabaseCredentialRequest],
    ]:
        if many:
