...
class CreateappparamsMemoryRequest(Model):
    """Createappparams memory request (createappparams.MemoryRequest)
    ...
    def with_request_memory(self, value: int) -> CreateappparamsMemoryRequest:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, CreateappparamsMemoryRequest]:
        return (
    ...
    ) -> List[CreateappparamsMemoryRequest]:
        return (
    ...
    def create_from_any(
        ...
        CreateappparamsMemoryRequest,
        List[CreateappparamsMemoryRequest],
        Dict[Any, CreateappparamsMemoryRequest],
    ]:
        if many:
