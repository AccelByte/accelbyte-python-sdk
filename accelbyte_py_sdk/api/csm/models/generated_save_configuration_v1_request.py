...
class GeneratedSaveConfigurationV1Request(Model):
    """Generated save configuration V1 request (generated.SaveConfigurationV1Request)
    ...
    def with_config_name(self, value: str) -> GeneratedSaveConfigurationV1Request:
        self.config_name = value
        return self

    def with_source(self, value: str) -> GeneratedSaveConfigurationV1Request:
        self.source = value
        return self

    def with_value(self, value: str) -> GeneratedSaveConfigurationV1Request:
        self.value = value
        return self

    def with_apply_mask(self, value: bool) -> GeneratedSaveConfigurationV1Request:
        self.apply_mask = value
        return self

    def with_description(self, value: str) -> GeneratedSaveConfigurationV1Request:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, GeneratedSaveConfigurationV1Request]:
        return (
    ...
    ) -> List[GeneratedSaveConfigurationV1Request]:
        return (
    ...
    def create_from_any(
        ...
        GeneratedSaveConfigurationV1Request,
        List[GeneratedSaveConfigurationV1Request],
        Dict[Any, GeneratedSaveConfigurationV1Request],
    ]:
        if many:
