...
class DomainDebugPod(Model):
    """Domain debug pod (domain.DebugPod)
    ...
    def with_pod_name(self, value: str) -> DomainDebugPod:
        self.pod_name = value
        return self

    def with_port(self, value: int) -> DomainDebugPod:
        self.port = value
        return self
    ...
    @classmethod
    def create(cls, pod_name: str, port: int, **kwargs) -> DomainDebugPod:
        instance = cls()
    ...
    ) -> Union[DomainDebugPod, List[DomainDebugPod], Dict[Any, DomainDebugPod]]:
        if many:
