...
class ApimodelDeleteSQLResourceResponse(Model):
    """Apimodel delete SQL resource response (apimodel.DeleteSQLResourceResponse)
    ...
    def with_platform_name(self, value: str) -> ApimodelDeleteSQLResourceResponse:
        self.platform_name = value
        return self

    def with_resource_id(self, value: str) -> ApimodelDeleteSQLResourceResponse:
        self.resource_id = value
        return self

    def with_resource_name(self, value: str) -> ApimodelDeleteSQLResourceResponse:
        self.resource_name = value
        return self

    def with_resource_type(self, value: str) -> ApimodelDeleteSQLResourceResponse:
        self.resource_type = value
        return self

    def with_studio_name(self, value: str) -> ApimodelDeleteSQLResourceResponse:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ApimodelDeleteSQLResourceResponse]:
        return (
    ...
    ) -> List[ApimodelDeleteSQLResourceResponse]:
        return (
    ...
    def create_from_any(
        ...
        ApimodelDeleteSQLResourceResponse,
        List[ApimodelDeleteSQLResourceResponse],
        Dict[Any, ApimodelDeleteSQLResourceResponse],
    ]:
        if many:
