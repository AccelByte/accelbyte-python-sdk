...
class ApimodelSQLAppResponse(Model):
    """Apimodel SQL app response (apimodel.SQLAppResponse)
    ...
    def with_app_id(self, value: str) -> ApimodelSQLAppResponse:
        self.app_id = value
        return self

    def with_app_name(self, value: str) -> ApimodelSQLAppResponse:
        self.app_name = value
        return self

    def with_game_name(self, value: str) -> ApimodelSQLAppResponse:
        self.game_name = value
        return self

    def with_scenario(self, value: str) -> ApimodelSQLAppResponse:
        self.scenario = value
        return self
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ApimodelSQLAppResponse]:
        return (
    ...
    def create_from_any(
        ...
        ApimodelSQLAppResponse,
        List[ApimodelSQLAppResponse],
        Dict[Any, ApimodelSQLAppResponse],
    ]:
        if many:
