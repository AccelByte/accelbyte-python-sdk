...
class ApimodelIntegrateAppKeyValueResponse(Model):
    """Apimodel integrate app key value response (apimodel.IntegrateAppKeyValueResponse)
    ...
    def with_app_id(self, value: str) -> ApimodelIntegrateAppKeyValueResponse:
        self.app_id = value
        return self
    ...
    def with_game_namespace(self, value: str) -> ApimodelIntegrateAppKeyValueResponse:
        self.game_namespace = value
        return self

    def with_hostnames(self, value: str) -> ApimodelIntegrateAppKeyValueResponse:
        self.hostnames = value
        return self

    def with_integration_id(self, value: str) -> ApimodelIntegrateAppKeyValueResponse:
        self.integration_id = value
        return self

    def with_platform_name(self, value: str) -> ApimodelIntegrateAppKeyValueResponse:
        self.platform_name = value
        return self

    def with_resource_id(self, value: str) -> ApimodelIntegrateAppKeyValueResponse:
        self.resource_id = value
        return self

    def with_resource_status(self, value: str) -> ApimodelIntegrateAppKeyValueResponse:
        self.resource_status = value
        return self

    def with_scenario(self, value: str) -> ApimodelIntegrateAppKeyValueResponse:
        self.scenario = value
        return self

    def with_status(self, value: str) -> ApimodelIntegrateAppKeyValueResponse:
        self.status = value
        return self

    def with_status_message(self, value: str) -> ApimodelIntegrateAppKeyValueResponse:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ApimodelIntegrateAppKeyValueResponse]:
        return (
    ...
    ) -> List[ApimodelIntegrateAppKeyValueResponse]:
        return (
    ...
    def create_from_any(
        ...
        ApimodelIntegrateAppKeyValueResponse,
        List[ApimodelIntegrateAppKeyValueResponse],
        Dict[Any, ApimodelIntegrateAppKeyValueResponse],
    ]:
        if many:
