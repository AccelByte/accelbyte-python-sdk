...
class ApimodelPaginationResponse(Model):
    """Apimodel pagination response (apimodel.PaginationResponse)
    ...
    def with_total_data(self, value: int) -> ApimodelPaginationResponse:
        self.total_data = value
        return self

    def with_first(self, value: str) -> ApimodelPaginationResponse:
        self.first = value
        return self

    def with_last(self, value: str) -> ApimodelPaginationResponse:
        self.last = value
        return self

    def with_next(self, value: str) -> ApimodelPaginationResponse:
        self.next_ = value
        return self

    def with_previous(self, value: str) -> ApimodelPaginationResponse:
        self.previous = value
        return self
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ApimodelPaginationResponse]:
        return (
    ...
    ) -> List[ApimodelPaginationResponse]:
        return (
    ...
    def create_from_any(
        ...
        ApimodelPaginationResponse,
        List[ApimodelPaginationResponse],
        Dict[Any, ApimodelPaginationResponse],
    ]:
        if many:
