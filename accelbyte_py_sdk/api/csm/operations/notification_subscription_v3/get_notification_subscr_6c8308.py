...
class GetNotificationSubscriberListV3(Operation):
    ...
    _url: str = "/csm/v3/admin/namespaces/{namespace}/apps/{app}/subscriptions"
    _method: str = "GET"
    ...
    def with_app(self, value: str) -> GetNotificationSubscriberListV3:
        self.app = value
        return self

    def with_namespace(self, value: str) -> GetNotificationSubscriberListV3:
        self.namespace = value
        return self

    def with_notification_type(self, value: str) -> GetNotificationSubscriberListV3:
    ...
    def parse_response(
        ...
        Union[None, ApimodelGetNotificationSubscriberListResponseV2],
        ...
        if code == 200:
            return (
                ApimodelGetNotificationSubscriberListResponseV2.create_from_dict(
                    content
                ),
                None,
            )
