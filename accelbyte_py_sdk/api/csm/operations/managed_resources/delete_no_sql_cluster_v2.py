...
class DeleteNoSQLClusterV2(Operation):
    ...
    def with_namespace(self, value: str) -> DeleteNoSQLClusterV2:
    ...
    def parse_response(
        ...
        Union[None, ApimodelDeleteNoSQLResourceResponse],
        ...
        if code == 200:
            return ApimodelDeleteNoSQLResourceResponse.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> DeleteNoSQLClusterV2:
        instance = cls()
