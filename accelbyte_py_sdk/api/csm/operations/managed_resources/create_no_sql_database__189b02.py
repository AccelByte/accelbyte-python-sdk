...
class CreateNoSQLDatabaseCredentialV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/nosql/crendentials"
    _method: str = "POST"
    ...
    def with_app(self, value: str) -> CreateNoSQLDatabaseCredentialV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> CreateNoSQLDatabaseCredentialV2:
