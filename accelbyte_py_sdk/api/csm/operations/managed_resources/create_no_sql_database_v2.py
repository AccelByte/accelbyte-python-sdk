...
class CreateNoSQLDatabaseV2(Operation):
    ...
    body: ApimodelCreateNoSQLAppDatabaseRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelCreateNoSQLAppDatabaseRequest
    ) -> CreateNoSQLDatabaseV2:
        self.body = value
        return self

    def with_app(self, value: str) -> CreateNoSQLDatabaseV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> CreateNoSQLDatabaseV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelCreateNoSQLAppDatabaseRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelCreateNoSQLAppDatabaseRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelCreateNoSQLAppDatabaseRequest()
