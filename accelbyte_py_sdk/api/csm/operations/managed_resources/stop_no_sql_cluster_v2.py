...
class StopNoSQLClusterV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/nosql/clusters/stop"
    _method: str = "PUT"
    ...
    def with_namespace(self, value: str) -> StopNoSQLClusterV2:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> StopNoSQLClusterV2:
        instance = cls()
