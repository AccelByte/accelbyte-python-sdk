...
class StartNoSQLClusterV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/nosql/clusters/start"
    _method: str = "PUT"
    ...
    def with_namespace(self, value: str) -> StartNoSQLClusterV2:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> StartNoSQLClusterV2:
        instance = cls()
