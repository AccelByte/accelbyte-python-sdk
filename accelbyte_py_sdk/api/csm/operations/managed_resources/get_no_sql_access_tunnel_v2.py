...
class GetNoSQLAccessTunnelV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/nosql/tunnels"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> GetNoSQLAccessTunnelV2:
    ...
    def parse_response(
        ...
        Union[None, ApimodelTunnelInfoResponse],
        ...
        if code == 200:
            return ApimodelTunnelInfoResponse.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> GetNoSQLAccessTunnelV2:
        instance = cls()
