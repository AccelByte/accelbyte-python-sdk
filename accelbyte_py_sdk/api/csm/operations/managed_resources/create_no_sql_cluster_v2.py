...
class CreateNoSQLClusterV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/nosql/clusters"
    _method: str = "POST"
    ...
    body: NosqlresourceNoSQLResourceConfiguration  # REQUIRED in [body]
    ...
    def with_namespace(self, value: str) -> CreateNoSQLClusterV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = NosqlresourceNoSQLResourceConfiguration()
    ...
    def parse_response(
        ...
        Union[None, ApimodelNoSQLResourceResponse],
        ...
        if code == 200:
            return ApimodelNoSQLResourceResponse.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, body: NosqlresourceNoSQLResourceConfiguration, namespace: str, **kwargs
    ) -> CreateNoSQLClusterV2:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = NosqlresourceNoSQLResourceConfiguration.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = NosqlresourceNoSQLResourceConfiguration()
