...
class DeleteNoSQLDatabaseV2(Operation):
    ...
    def with_app(self, value: str) -> DeleteNoSQLDatabaseV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> DeleteNoSQLDatabaseV2:
    ...
    def parse_response(
        ...
        Union[None, ApimodelNoSQLDatabaseDeleteResponse],
        ...
        if code == 200:
            return ApimodelNoSQLDatabaseDeleteResponse.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, app: str, namespace: str, **kwargs) -> DeleteNoSQLDatabaseV2:
        instance = cls()
        instance.app = app
