...
class CreateAppV5(Operation):
    ...
    _url: str = "/csm/v5/admin/namespaces/{namespace}/apps/{app}"
    _method: str = "POST"
    ...
    body: ApimodelCreateAppV5Request  # REQUIRED in [body]
    ...
    def with_body(self, value: ApimodelCreateAppV5Request) -> CreateAppV5:
        self.body = value
        return self

    def with_app(self, value: str) -> CreateAppV5:
        self.app = value
        return self

    def with_namespace(self, value: str) -> CreateAppV5:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelCreateAppV5Request()
    ...
    def parse_response(
        ...
        Union[None, ApimodelAppItemV5], Union[None, HttpResponse, ResponseErrorResponse]
    ]:
        ...
        if code == 200:
            return ApimodelAppItemV5.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, body: ApimodelCreateAppV5Request, app: str, namespace: str, **kwargs
    ) -> CreateAppV5:
        instance = cls()
        instance.body = body
        instance.app = app
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> CreateAppV5:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelCreateAppV5Request.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelCreateAppV5Request()
