...
class DeleteAppImagesV2(Operation):
    ...
    def with_body(self, value: GeneratedDeleteAppImagesV1Request) -> DeleteAppImagesV2:
        self.body = value
        return self

    def with_app(self, value: str) -> DeleteAppImagesV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> DeleteAppImagesV2:
