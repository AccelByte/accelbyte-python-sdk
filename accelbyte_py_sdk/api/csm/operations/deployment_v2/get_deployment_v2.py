...
class GetDeploymentV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/deployments/{deploymentId}"
    _method: str = "GET"
    ...
    deployment_id: str  # REQUIRED in [path]
    ...
    def with_deployment_id(self, value: str) -> GetDeploymentV2:
        self.deployment_id = value
        return self

    def with_namespace(self, value: str) -> GetDeploymentV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        result: dict = {}
        if hasattr(self, "deployment_id") and self.deployment_id:
    ...
    def parse_response(
        ...
        Union[None, ApimodelGetDeploymentListV2DataItem],
        ...
        if code == 200:
            return ApimodelGetDeploymentListV2DataItem.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, deployment_id: str, namespace: str, **kwargs) -> GetDeploymentV2:
        instance = cls()
