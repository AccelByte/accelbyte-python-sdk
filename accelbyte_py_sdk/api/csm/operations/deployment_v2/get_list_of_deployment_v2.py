...
class GetListOfDeploymentV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/deployments"
    _method: str = "POST"
    ...
    body: ApimodelGetDeploymentListV2Request  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelGetDeploymentListV2Request
    ) -> GetListOfDeploymentV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> GetListOfDeploymentV2:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> GetListOfDeploymentV2:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetListOfDeploymentV2:
        self.offset = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelGetDeploymentListV2Request()
    ...
    def parse_response(
        ...
        Union[None, ApimodelGetDeploymentListV2Response],
        ...
        if code == 200:
            return ApimodelGetDeploymentListV2Response.create_from_dict(content), None
        if code == 400:
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelGetDeploymentListV2Request.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelGetDeploymentListV2Request()
