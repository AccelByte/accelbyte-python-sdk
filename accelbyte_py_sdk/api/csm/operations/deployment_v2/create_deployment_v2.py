...
class CreateDeploymentV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/deployments"
    _method: str = "POST"
    ...
    body: ApimodelCreateDeploymentV2Request  # REQUIRED in [body]
    ...
    def with_body(self, value: ApimodelCreateDeploymentV2Request) -> CreateDeploymentV2:
        self.body = value
        return self

    def with_app(self, value: str) -> CreateDeploymentV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> CreateDeploymentV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelCreateDeploymentV2Request()
    ...
    def parse_response(
        ...
        Union[None, ApimodelCreateDeploymentV2Response],
        ...
        if code == 201:
            return ApimodelCreateDeploymentV2Response.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, body: ApimodelCreateDeploymentV2Request, app: str, namespace: str, **kwargs
    ) -> CreateDeploymentV2:
        instance = cls()
        instance.body = body
        instance.app = app
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelCreateDeploymentV2Request.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelCreateDeploymentV2Request()
