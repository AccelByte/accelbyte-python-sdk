...
class DeleteDeploymentV2(Operation):
    ...
    def with_deployment_id(self, value: str) -> DeleteDeploymentV2:
        self.deployment_id = value
        return self

    def with_namespace(self, value: str) -> DeleteDeploymentV2:
    ...
    @classmethod
    def create(cls, deployment_id: str, namespace: str, **kwargs) -> DeleteDeploymentV2:
        instance = cls()
