...
class CreateSQLDatabaseCredentialV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/sql/credentials"
    _method: str = "POST"
    ...
    body: ApimodelCreateSQLDatabaseCredentialRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelCreateSQLDatabaseCredentialRequest
    ) -> CreateSQLDatabaseCredentialV2:
        self.body = value
        return self

    def with_app(self, value: str) -> CreateSQLDatabaseCredentialV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> CreateSQLDatabaseCredentialV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelCreateSQLDatabaseCredentialRequest()
    ...
    def parse_response(
        ...
        Union[None, ApimodelSQLDatabaseCredentialResponse],
        ...
        if code == 200:
            return ApimodelSQLDatabaseCredentialResponse.create_from_dict(content), None
        if code == 400:
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelCreateSQLDatabaseCredentialRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelCreateSQLDatabaseCredentialRequest()
