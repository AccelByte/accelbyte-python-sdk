...
class CreateSQLDatabaseV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/sql/databases"
    _method: str = "POST"
    ...
    body: ApimodelCreateSQLAppDatabaseRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelCreateSQLAppDatabaseRequest
    ) -> CreateSQLDatabaseV2:
        self.body = value
        return self

    def with_app(self, value: str) -> CreateSQLDatabaseV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> CreateSQLDatabaseV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelCreateSQLAppDatabaseRequest()
    ...
    def parse_response(
        ...
        Union[None, ApimodelSQLDatabaseResponse],
        ...
        if code == 200:
            return ApimodelSQLDatabaseResponse.create_from_dict(content), None
        if code == 400:
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelCreateSQLAppDatabaseRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelCreateSQLAppDatabaseRequest()
