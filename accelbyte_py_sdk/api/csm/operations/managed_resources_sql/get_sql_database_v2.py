...
class GetSQLDatabaseV2(Operation):
    ...
    def with_app(self, value: str) -> GetSQLDatabaseV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> GetSQLDatabaseV2:
    ...
    @classmethod
    def create(cls, app: str, namespace: str, **kwargs) -> GetSQLDatabaseV2:
        instance = cls()
        instance.app = app
