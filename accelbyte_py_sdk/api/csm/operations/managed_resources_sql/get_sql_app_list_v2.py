...
class GetSQLAppListV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/sql/{resourceId}/apps"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> GetSQLAppListV2:
        self.namespace = value
        return self

    def with_resource_id(self, value: str) -> GetSQLAppListV2:
        self.resource_id = value
        return self

    def with_app_name(self, value: str) -> GetSQLAppListV2:
        self.app_name = value
        return self

    def with_game_namespace(self, value: str) -> GetSQLAppListV2:
        self.game_namespace = value
        return self

    def with_limit(self, value: int) -> GetSQLAppListV2:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetSQLAppListV2:
        self.offset = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ApimodelSQLAppListResponse],
        ...
        if code == 200:
            return ApimodelSQLAppListResponse.create_from_dict(content), None
        if code == 400:
