...
class StartSQLClusterV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/sql/clusters/start"
    _method: str = "PUT"
    ...
    def with_namespace(self, value: str) -> StartSQLClusterV2:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> StartSQLClusterV2:
        instance = cls()
