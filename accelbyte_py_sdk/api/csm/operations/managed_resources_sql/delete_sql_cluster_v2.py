...
class DeleteSQLClusterV2(Operation):
    ...
    def with_namespace(self, value: str) -> DeleteSQLClusterV2:
    ...
    def parse_response(
        ...
        Union[None, ApimodelDeleteSQLResourceResponse],
        ...
        if code == 200:
            return ApimodelDeleteSQLResourceResponse.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> DeleteSQLClusterV2:
        instance = cls()
