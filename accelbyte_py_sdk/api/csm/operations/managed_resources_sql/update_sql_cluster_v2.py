...
class UpdateSQLClusterV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/sql/clusters"
    _method: str = "PUT"
    ...
    body: SqlresourceSQLResourceConfiguration  # REQUIRED in [body]
    ...
    def with_namespace(self, value: str) -> UpdateSQLClusterV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = SqlresourceSQLResourceConfiguration()
    ...
    def parse_response(
        ...
        Union[None, ApimodelSQLResourceResponse],
        ...
        if code == 200:
            return ApimodelSQLResourceResponse.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, body: SqlresourceSQLResourceConfiguration, namespace: str, **kwargs
    ) -> UpdateSQLClusterV2:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = SqlresourceSQLResourceConfiguration.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = SqlresourceSQLResourceConfiguration()
