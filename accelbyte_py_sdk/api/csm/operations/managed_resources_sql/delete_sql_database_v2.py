...
class DeleteSQLDatabaseV2(Operation):
    ...
    def with_app(self, value: str) -> DeleteSQLDatabaseV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> DeleteSQLDatabaseV2:
    ...
    def parse_response(
        ...
        Union[None, ApimodelSQLDatabaseDeleteResponse],
        ...
        if code == 200:
            return ApimodelSQLDatabaseDeleteResponse.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, app: str, namespace: str, **kwargs) -> DeleteSQLDatabaseV2:
        instance = cls()
        instance.app = app
