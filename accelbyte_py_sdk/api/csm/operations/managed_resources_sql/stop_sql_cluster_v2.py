...
class StopSQLClusterV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/sql/clusters/stop"
    _method: str = "PUT"
    ...
    def with_namespace(self, value: str) -> StopSQLClusterV2:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> StopSQLClusterV2:
        instance = cls()
