...
class StartAppV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/start"
    _method: str = "PUT"
    ...
    def with_app(self, value: str) -> StartAppV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> StartAppV2:
    ...
    @classmethod
    def create(cls, app: str, namespace: str, **kwargs) -> StartAppV2:
        instance = cls()
        instance.app = app
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> StartAppV2:
        instance = cls()
