...
class ApplyAppConfigV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/apply"
    _method: str = "POST"
    ...
    body: ApimodelApplyAppConfigRequest  # REQUIRED in [body]
    ...
    def with_body(self, value: ApimodelApplyAppConfigRequest) -> ApplyAppConfigV2:
        self.body = value
        return self

    def with_app(self, value: str) -> ApplyAppConfigV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> ApplyAppConfigV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelApplyAppConfigRequest()
    ...
    @classmethod
    def create(
        cls, body: ApimodelApplyAppConfigRequest, app: str, namespace: str, **kwargs
    ) -> ApplyAppConfigV2:
        instance = cls()
        instance.body = body
        instance.app = app
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelApplyAppConfigRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelApplyAppConfigRequest()
