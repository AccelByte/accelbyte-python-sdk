...
class UpdateAppResourcesResourceLimitFormV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/resources/form"
    _method: str = "POST"
    ...
    body: ApimodelIncreaseLimitFormRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelIncreaseLimitFormRequest
    ) -> UpdateAppResourcesResourceLimitFormV2:
        self.body = value
        return self

    def with_app(self, value: str) -> UpdateAppResourcesResourceLimitFormV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> UpdateAppResourcesResourceLimitFormV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelIncreaseLimitFormRequest()
    ...
    @classmethod
    def create(
        cls, body: ApimodelIncreaseLimitFormRequest, app: str, namespace: str, **kwargs
    ) -> UpdateAppResourcesResourceLimitFormV2:
        instance = cls()
        instance.body = body
        instance.app = app
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelIncreaseLimitFormRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelIncreaseLimitFormRequest()
