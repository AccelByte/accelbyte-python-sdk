...
class CreateAppV2(Operation):
    ...
    body: ApimodelCreateAppV2Request  # REQUIRED in [body]
    ...
    def with_body(self, value: ApimodelCreateAppV2Request) -> CreateAppV2:
        self.body = value
        return self

    def with_app(self, value: str) -> CreateAppV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> CreateAppV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelCreateAppV2Request()
    ...
    @classmethod
    def create(
        cls, body: ApimodelCreateAppV2Request, app: str, namespace: str, **kwargs
    ) -> CreateAppV2:
        instance = cls()
        instance.body = body
        instance.app = app
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> CreateAppV2:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelCreateAppV2Request.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelCreateAppV2Request()
