...
class StopAppV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/stop"
    _method: str = "PUT"
    ...
    def with_app(self, value: str) -> StopAppV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> StopAppV2:
    ...
    @classmethod
    def create(cls, app: str, namespace: str, **kwargs) -> StopAppV2:
        instance = cls()
        instance.app = app
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> StopAppV2:
        instance = cls()
