...
class UpdateSecretV1(Operation):
    ...
    _url: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/secrets/{configId}"
    _method: str = "PUT"
    ...
    def with_body(self, value: GeneratedUpdateConfigurationV1Request) -> UpdateSecretV1:
        self.body = value
        return self

    def with_app(self, value: str) -> UpdateSecretV1:
        self.app = value
        return self

    def with_config_id(self, value: str) -> UpdateSecretV1:
        self.config_id = value
        return self

    def with_namespace(self, value: str) -> UpdateSecretV1:
