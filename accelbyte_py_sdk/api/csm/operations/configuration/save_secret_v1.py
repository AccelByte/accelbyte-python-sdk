...
class SaveSecretV1(Operation):
    ...
    _url: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/secrets"
    _method: str = "POST"
    ...
    body: GeneratedSaveConfigurationV1Request  # REQUIRED in [body]
    ...
    def with_body(self, value: GeneratedSaveConfigurationV1Request) -> SaveSecretV1:
        self.body = value
        return self

    def with_app(self, value: str) -> SaveSecretV1:
        self.app = value
        return self

    def with_namespace(self, value: str) -> SaveSecretV1:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = GeneratedSaveConfigurationV1Request()
    ...
    def parse_response(
        ...
        Union[None, GeneratedSaveConfigurationV1Response],
        ...
        if code == 200:
            return GeneratedSaveConfigurationV1Response.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> SaveSecretV1:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = GeneratedSaveConfigurationV1Request.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = GeneratedSaveConfigurationV1Request()
