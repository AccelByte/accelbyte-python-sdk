...
class GetListOfSecretsV1(Operation):
    ...
    def with_app(self, value: str) -> GetListOfSecretsV1:
        self.app = value
        return self

    def with_namespace(self, value: str) -> GetListOfSecretsV1:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> GetListOfSecretsV1:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetListOfSecretsV1:
        self.offset = value
        return self
    ...
    def parse_response(
        ...
        Union[None, GeneratedGetListOfConfigurationsV1Response],
        ...
        if code == 200:
            return (
                GeneratedGetListOfConfigurationsV1Response.create_from_dict(content),
                None,
            )
        if code == 400:
