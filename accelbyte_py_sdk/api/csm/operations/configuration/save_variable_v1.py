...
class SaveVariableV1(Operation):
    ...
    _url: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/variables"
    _method: str = "POST"
    ...
    def with_body(self, value: GeneratedSaveConfigurationV1Request) -> SaveVariableV1:
        self.body = value
        return self

    def with_app(self, value: str) -> SaveVariableV1:
        self.app = value
        return self

    def with_namespace(self, value: str) -> SaveVariableV1:
