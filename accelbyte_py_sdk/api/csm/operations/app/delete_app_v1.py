...
class DeleteAppV1(Operation):
    ...
    def with_app(self, value: str) -> DeleteAppV1:
        self.app = value
        return self

    def with_namespace(self, value: str) -> DeleteAppV1:
        self.namespace = value
        return self

    def with_forced(self, value: str) -> DeleteAppV1:
        self.forced = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> DeleteAppV1:
        instance = cls()
