...
class GetAppReleaseV1(Operation):
    ...
    _url: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/release"
    _method: str = "GET"
    ...
    def with_app(self, value: str) -> GetAppReleaseV1:
        self.app = value
        return self

    def with_namespace(self, value: str) -> GetAppReleaseV1:
    ...
    def parse_response(
        ...
        Union[None, GeneratedGetAppReleaseV1Response],
        ...
        if code == 200:
            return GeneratedGetAppReleaseV1Response.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, app: str, namespace: str, **kwargs) -> GetAppReleaseV1:
        instance = cls()
        instance.app = app
