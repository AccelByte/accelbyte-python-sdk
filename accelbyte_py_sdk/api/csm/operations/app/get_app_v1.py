...
class GetAppV1(Operation):
    ...
    def with_app(self, value: str) -> GetAppV1:
        self.app = value
        return self

    def with_namespace(self, value: str) -> GetAppV1:
    ...
    def parse_response(
        ...
        Union[None, GeneratedGetAppV1Response],
        ...
        if code == 200:
            return GeneratedGetAppV1Response.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, app: str, namespace: str, **kwargs) -> GetAppV1:
        instance = cls()
        instance.app = app
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetAppV1:
        instance = cls()
