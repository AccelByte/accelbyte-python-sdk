...
class DeleteVariableV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/variables/{configId}"
    _method: str = "DELETE"
    ...
    def with_app(self, value: str) -> DeleteVariableV2:
        self.app = value
        return self

    def with_config_id(self, value: str) -> DeleteVariableV2:
        self.config_id = value
        return self

    def with_namespace(self, value: str) -> DeleteVariableV2:
    ...
    @classmethod
    def create(
        cls, app: str, config_id: str, namespace: str, **kwargs
    ) -> DeleteVariableV2:
        instance = cls()
        instance.app = app
