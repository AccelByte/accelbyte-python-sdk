...
class GetListOfVariablesV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/variables"
    _method: str = "GET"
    ...
    def with_app(self, value: str) -> GetListOfVariablesV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> GetListOfVariablesV2:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> GetListOfVariablesV2:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetListOfVariablesV2:
        self.offset = value
        return self
