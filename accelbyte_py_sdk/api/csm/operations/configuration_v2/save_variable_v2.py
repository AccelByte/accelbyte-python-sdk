...
class SaveVariableV2(Operation):
    ...
    def with_body(self, value: ApimodelSaveConfigurationV2Request) -> SaveVariableV2:
        self.body = value
        return self

    def with_app(self, value: str) -> SaveVariableV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> SaveVariableV2:
