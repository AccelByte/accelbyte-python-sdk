...
class GetResourcesLimits(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/resources/limits"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> GetResourcesLimits:
    ...
    def parse_response(
        ...
        Union[None, ApimodelCSMAppLimitsResponse],
        ...
        if code == 200:
            return ApimodelCSMAppLimitsResponse.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> GetResourcesLimits:
        instance = cls()
