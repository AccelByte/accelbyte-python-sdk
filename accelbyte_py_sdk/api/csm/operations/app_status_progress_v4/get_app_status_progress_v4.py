...
class GetAppStatusProgressV4(Operation):
    ...
    _url: str = "/csm/v4/admin/namespaces/{namespace}/apps/{app}/status-progress"
    _method: str = "GET"
    ...
    def with_app(self, value: str) -> GetAppStatusProgressV4:
        self.app = value
        return self

    def with_namespace(self, value: str) -> GetAppStatusProgressV4:
    ...
    def parse_response(
        ...
        Union[None, ApimodelGetAppStatusProgressResponse],
        ...
        if code == 200:
            return ApimodelGetAppStatusProgressResponse.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, app: str, namespace: str, **kwargs) -> GetAppStatusProgressV4:
        instance = cls()
        instance.app = app
