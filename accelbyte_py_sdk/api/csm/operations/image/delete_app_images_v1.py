...
class DeleteAppImagesV1(Operation):
    ...
    _url: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/images"
    _method: str = "DELETE"
    ...
    body: GeneratedDeleteAppImagesV1Request  # REQUIRED in [body]
    ...
    def with_body(self, value: GeneratedDeleteAppImagesV1Request) -> DeleteAppImagesV1:
        self.body = value
        return self

    def with_app(self, value: str) -> DeleteAppImagesV1:
        self.app = value
        return self

    def with_namespace(self, value: str) -> DeleteAppImagesV1:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = GeneratedDeleteAppImagesV1Request()
    ...
    @classmethod
    def create(
        cls, body: GeneratedDeleteAppImagesV1Request, app: str, namespace: str, **kwargs
    ) -> DeleteAppImagesV1:
        instance = cls()
        instance.body = body
        instance.app = app
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = GeneratedDeleteAppImagesV1Request.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = GeneratedDeleteAppImagesV1Request()
