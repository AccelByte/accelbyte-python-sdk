...
class GetAppImageListV1(Operation):
    ...
    def with_app(self, value: str) -> GetAppImageListV1:
        self.app = value
        return self

    def with_namespace(self, value: str) -> GetAppImageListV1:
        self.namespace = value
        return self

    def with_cached(self, value: str) -> GetAppImageListV1:
        self.cached = value
        return self

    def with_limit(self, value: int) -> GetAppImageListV1:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetAppImageListV1:
        self.offset = value
        return self
    ...
    def parse_response(
        ...
        Union[None, GeneratedGetAppImageListV1Response],
        ...
        if code == 200:
            return GeneratedGetAppImageListV1Response.create_from_dict(content), None
        if code == 401:
