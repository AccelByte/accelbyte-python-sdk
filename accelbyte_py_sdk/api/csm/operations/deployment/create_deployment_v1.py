...
class CreateDeploymentV1(Operation):
    ...
    _url: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/deployments"
    _method: str = "POST"
    ...
    body: GeneratedCreateDeploymentV1Request  # REQUIRED in [body]
    ...
    def with_body(
        self, value: GeneratedCreateDeploymentV1Request
    ) -> CreateDeploymentV1:
        self.body = value
        return self

    def with_app(self, value: str) -> CreateDeploymentV1:
        self.app = value
        return self

    def with_namespace(self, value: str) -> CreateDeploymentV1:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = GeneratedCreateDeploymentV1Request()
    ...
    def parse_response(
        ...
        Union[None, GeneratedCreateDeploymentV1Response],
        ...
        if code == 201:
            return GeneratedCreateDeploymentV1Response.create_from_dict(content), None
        if code == 400:
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = GeneratedCreateDeploymentV1Request.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = GeneratedCreateDeploymentV1Request()
