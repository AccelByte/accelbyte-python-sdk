...
class GetDeploymentV1(Operation):
    ...
    _url: str = "/csm/v1/admin/namespaces/{namespace}/deployments/{deploymentId}"
    _method: str = "GET"
    ...
    def with_deployment_id(self, value: str) -> GetDeploymentV1:
        self.deployment_id = value
        return self

    def with_namespace(self, value: str) -> GetDeploymentV1:
    ...
    def parse_response(
        ...
        Union[None, GeneratedGetDeploymentV1Response],
        ...
        if code == 200:
            return GeneratedGetDeploymentV1Response.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, deployment_id: str, namespace: str, **kwargs) -> GetDeploymentV1:
        instance = cls()
