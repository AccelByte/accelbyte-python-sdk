...
class DeleteDeploymentV1(Operation):
    ...
    def with_deployment_id(self, value: str) -> DeleteDeploymentV1:
        self.deployment_id = value
        return self

    def with_namespace(self, value: str) -> DeleteDeploymentV1:
    ...
    @classmethod
    def create(cls, deployment_id: str, namespace: str, **kwargs) -> DeleteDeploymentV1:
        instance = cls()
