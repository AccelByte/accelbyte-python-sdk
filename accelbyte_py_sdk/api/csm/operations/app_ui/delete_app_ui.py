...
class DeleteAppUI(Operation):
    ...
    _url: str = "/csm/v1/admin/namespaces/{namespace}/app-ui/{appUiName}"
    _method: str = "DELETE"
    ...
    def with_app_ui_name(self, value: str) -> DeleteAppUI:
        self.app_ui_name = value
        return self

    def with_namespace(self, value: str) -> DeleteAppUI:
    ...
    @classmethod
    def create(cls, app_ui_name: str, namespace: str, **kwargs) -> DeleteAppUI:
        instance = cls()
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> DeleteAppUI:
        instance = cls()
