...
class DeleteSubscriptionAppNotificationByUserIDV2(Operation):
    ...
    def with_app(self, value: str) -> DeleteSubscriptionAppNotificationByUserIDV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> DeleteSubscriptionAppNotificationByUserIDV2:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> DeleteSubscriptionAppNotificationByUserIDV2:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(
        cls, app: str, namespace: str, user_id: str, **kwargs
