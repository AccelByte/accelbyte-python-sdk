...
class GetSubscriptionV2Handler(Operation):
    ...
    def with_app(self, value: str) -> GetSubscriptionV2Handler:
        self.app = value
        return self

    def with_namespace(self, value: str) -> GetSubscriptionV2Handler:
    ...
    def parse_response(
        ...
        Union[None, ApimodelGetNotificationSubscriberStatusResponse],
        ...
        if code == 200:
            return (
                ApimodelGetNotificationSubscriberStatusResponse.create_from_dict(
                    content
                ),
                None,
            )
    ...
    @classmethod
    def create(cls, app: str, namespace: str, **kwargs) -> GetSubscriptionV2Handler:
        instance = cls()
        instance.app = app
