...
class DeleteSubscriptionAppNotificationV2(Operation):
    ...
    def with_app(self, value: str) -> DeleteSubscriptionAppNotificationV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> DeleteSubscriptionAppNotificationV2:
        self.namespace = value
        return self

    def with_subscription_id(self, value: str) -> DeleteSubscriptionAppNotificationV2:
    ...
    @classmethod
    def create(
        cls, app: str, namespace: str, subscription_id: str, **kwargs
