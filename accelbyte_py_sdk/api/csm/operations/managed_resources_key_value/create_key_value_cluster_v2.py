...
class CreateKeyValueClusterV2(Operation):
    ...
    body: DomainKeyValueResourceConfiguration  # REQUIRED in [body]
    ...
    def with_namespace(self, value: str) -> CreateKeyValueClusterV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = DomainKeyValueResourceConfiguration()
    ...
    @classmethod
    def create(
        cls, body: DomainKeyValueResourceConfiguration, namespace: str, **kwargs
    ) -> CreateKeyValueClusterV2:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = DomainKeyValueResourceConfiguration.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = DomainKeyValueResourceConfiguration()
