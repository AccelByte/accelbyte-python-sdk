...
class ListKeyValueClusterV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/keyvalue/clusters"
    _method: str = "GET"
    ...
    refresh: bool  # OPTIONAL in [query]
    ...
    def with_namespace(self, value: str) -> ListKeyValueClusterV2:
        self.namespace = value
        return self

    def with_refresh(self, value: bool) -> ListKeyValueClusterV2:
        self.refresh = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "namespace") and self.namespace:
            ...
            result["namespace"] = ""
        if hasattr(self, "refresh") and self.refresh:
            result["refresh"] = bool(self.refresh)
        elif include_empty:
    ...
    def parse_response(
        ...
        Union[None, ApimodelKeyValueResourceListResponse],
        ...
        if code == 200:
            return ApimodelKeyValueResourceListResponse.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, namespace: str, refresh: Optional[bool] = None, **kwargs
    ...
    def create_from_dict(
        ...
        if "refresh" in dict_ and dict_["refresh"] is not None:
            instance.refresh = bool(dict_["refresh"])
        elif include_empty:
