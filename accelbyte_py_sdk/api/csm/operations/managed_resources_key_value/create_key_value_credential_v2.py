...
class CreateKeyValueCredentialV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/keyvalue/credentials"
    _method: str = "POST"
    ...
    body: ApimodelCreateKeyValueCredentialRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelCreateKeyValueCredentialRequest
    ) -> CreateKeyValueCredentialV2:
        self.body = value
        return self

    def with_app(self, value: str) -> CreateKeyValueCredentialV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> CreateKeyValueCredentialV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelCreateKeyValueCredentialRequest()
    ...
    def parse_response(
        ...
        Union[None, ApimodelCreateKeyValueCredentialResponse],
        ...
        if code == 200:
            return (
                ApimodelCreateKeyValueCredentialResponse.create_from_dict(content),
                None,
            )
        if code == 400:
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelCreateKeyValueCredentialRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelCreateKeyValueCredentialRequest()
