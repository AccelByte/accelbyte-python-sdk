...
class GetListIntegratedAppKeyValueClusterV2(Operation):
    ...
    _url: str = (
        "/csm/v2/admin/namespaces/{namespace}/keyvalue/{resourceId}/integrations"
    )
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> GetListIntegratedAppKeyValueClusterV2:
        self.namespace = value
        return self

    def with_resource_id(self, value: str) -> GetListIntegratedAppKeyValueClusterV2:
    ...
    def parse_response(
        ...
        Union[None, ApimodelListIntegratedAppsKeyValueResponse],
        ...
        if code == 200:
            return (
                ApimodelListIntegratedAppsKeyValueResponse.create_from_dict(content),
                None,
            )
        if code == 401:
    ...
    @classmethod
    def create(
        cls, namespace: str, resource_id: str, **kwargs
