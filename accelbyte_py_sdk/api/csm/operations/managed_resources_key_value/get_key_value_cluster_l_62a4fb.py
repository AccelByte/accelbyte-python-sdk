...
class GetKeyValueClusterLimitConfigV2(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/keyvalue/clusters/limitconfig"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> GetKeyValueClusterLimitConfigV2:
    ...
    def parse_response(
        ...
        Union[None, DomainKeyValueClusterConfig],
        ...
        if code == 200:
            return DomainKeyValueClusterConfig.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> GetKeyValueClusterLimitConfigV2:
        instance = cls()
