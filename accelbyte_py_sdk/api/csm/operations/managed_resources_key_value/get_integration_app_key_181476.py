...
class GetIntegrationAppKeyValueClusterV2(Operation):
    ...
    def with_app(self, value: str) -> GetIntegrationAppKeyValueClusterV2:
        self.app = value
        return self

    def with_namespace(self, value: str) -> GetIntegrationAppKeyValueClusterV2:
    ...
    def parse_response(
        ...
        Union[None, ApimodelGetIntegrationAppKeyValueResponse],
        ...
        if code == 200:
            return (
                ApimodelGetIntegrationAppKeyValueResponse.create_from_dict(content),
                None,
            )
        if code == 400:
    ...
    @classmethod
    def create(
        cls, app: str, namespace: str, **kwargs
