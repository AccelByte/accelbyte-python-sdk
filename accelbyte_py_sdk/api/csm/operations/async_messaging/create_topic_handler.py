...
class CreateTopicHandler(Operation):
    ...
    body: ApimodelCreateTopicRequest  # REQUIRED in [body]
    ...
    def with_body(self, value: ApimodelCreateTopicRequest) -> CreateTopicHandler:
        self.body = value
        return self

    def with_namespace(self, value: str) -> CreateTopicHandler:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelCreateTopicRequest()
    ...
    def parse_response(
        ...
        Union[None, ApimodelTopicResponse],
        ...
        if code == 200:
            return ApimodelTopicResponse.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, body: ApimodelCreateTopicRequest, namespace: str, **kwargs
    ) -> CreateTopicHandler:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelCreateTopicRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelCreateTopicRequest()
