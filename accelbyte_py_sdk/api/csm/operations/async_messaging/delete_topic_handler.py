...
class DeleteTopicHandler(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/asyncmessaging/topics/{topicName}"
    _method: str = "DELETE"
    ...
    def with_namespace(self, value: str) -> DeleteTopicHandler:
        self.namespace = value
        return self

    def with_topic_name(self, value: str) -> DeleteTopicHandler:
    ...
    @classmethod
    def create(cls, namespace: str, topic_name: str, **kwargs) -> DeleteTopicHandler:
        instance = cls()
