...
class UnsubscribeTopicHandler(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/asyncmessaging/topics/{topicName}/subscriptions"
    _method: str = "DELETE"
    ...
    def with_app(self, value: str) -> UnsubscribeTopicHandler:
        self.app = value
        return self

    def with_namespace(self, value: str) -> UnsubscribeTopicHandler:
        self.namespace = value
        return self

    def with_topic_name(self, value: str) -> UnsubscribeTopicHandler:
    ...
    def parse_response(
        ...
        Union[None, ApimodelTopicSubscription],
        ...
        if code == 200:
            return ApimodelTopicSubscription.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(
        cls, app: str, namespace: str, topic_name: str, **kwargs
