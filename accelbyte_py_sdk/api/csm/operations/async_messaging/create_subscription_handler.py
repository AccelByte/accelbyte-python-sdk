...
class CreateSubscriptionHandler(Operation):
    ...
    _url: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/asyncmessaging/topics/subscriptions"
    _method: str = "POST"
    ...
    body: ApimodelCreateSubscriptionRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelCreateSubscriptionRequest
    ) -> CreateSubscriptionHandler:
        self.body = value
        return self

    def with_app(self, value: str) -> CreateSubscriptionHandler:
        self.app = value
        return self

    def with_namespace(self, value: str) -> CreateSubscriptionHandler:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelCreateSubscriptionRequest()
    ...
    def parse_response(
        ...
        Union[None, ApimodelCreateSubscriptionResponse],
        ...
        if code == 200:
            return ApimodelCreateSubscriptionResponse.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, body: ApimodelCreateSubscriptionRequest, app: str, namespace: str, **kwargs
    ) -> CreateSubscriptionHandler:
        instance = cls()
        instance.body = body
        instance.app = app
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelCreateSubscriptionRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelCreateSubscriptionRequest()
