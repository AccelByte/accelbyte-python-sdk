...
class ExpGrantHistoryPagingSlicedResult(Model):
    ...
    def with_data(self, value: List[ExpGrantHistoryInfo]) -> ExpGrantHistoryPagingSlicedResult:
        self.data = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ExpGrantHistoryPagingSlicedResult:
        instance = cls()
        if not dict_:
            return instance
        if "data" in dict_ and dict_["data"] is not None:
            instance.data = [ExpGrantHistoryInfo.create_from_dict(i0, include_empty=include_empty) for i0 in dict_["data"]]
        elif include_empty:
            instance.data = []
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ExpGrantHistoryPagingSlicedResult]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ExpGrantHistoryPagingSlicedResult]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ExpGrantHistoryPagingSlicedResult, List[ExpGrantHistoryPagingSlicedResult], Dict[Any, ExpGrantHistoryPagingSlicedResult]]:
        if many:
