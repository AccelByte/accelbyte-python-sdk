...
class SeasonCloneRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[SeasonCloneRequest, List[SeasonCloneRequest], Dict[Any, SeasonCloneRequest]]:
        if many:
