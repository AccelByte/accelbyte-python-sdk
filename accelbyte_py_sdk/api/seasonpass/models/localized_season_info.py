...
class LocalizedSeasonInfo(Model):
    ...
    def is_valid(self) -> bool:
        ...
        # required checks
        if not hasattr(self, "auto_claim") or self.auto_claim is None:
            return False
        ...
        if not hasattr(self, "namespace") or self.namespace is None:
            return False
        if not hasattr(self, "passes") or self.passes is None:
            return False
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "rewards"):
            result["rewards"] = {str(k0): v0.to_dict(include_empty=include_empty) for k0, v0 in self.rewards.items()}
        elif include_empty:
            result["rewards"] = {}
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> LocalizedSeasonInfo:
        instance = cls()
        if not dict_:
            return instance
        ...
        if "rewards" in dict_ and dict_["rewards"] is not None:
            instance.rewards = {str(k0): RewardInfo.create_from_dict(v0, include_empty=include_empty) for k0, v0 in dict_["rewards"].items()}
        elif include_empty:
            instance.rewards = {}
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, LocalizedSeasonInfo]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[LocalizedSeasonInfo]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[LocalizedSeasonInfo, List[LocalizedSeasonInfo]]:
        if many:
