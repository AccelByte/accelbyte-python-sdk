...
class GetUserParticipatedSeasons(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ListUserSeasonInfoPagingSlicedResult], Union[None, ErrorEntity, HttpResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserParticipatedSeasons:
        instance = cls()
