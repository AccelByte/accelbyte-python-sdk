...
class ResetUserSeason(Operation):
    ...
    _url: str = "/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/current/reset"
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ResetUserSeason:
        instance = cls()
