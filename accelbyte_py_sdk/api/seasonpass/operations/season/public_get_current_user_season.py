...
class PublicGetCurrentUserSeason(Operation):
    ...
    _url: str = "/seasonpass/public/namespaces/{namespace}/users/{userId}/seasons/current/data"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ClaimableUserSeasonInfo], Union[None, ErrorEntity, HttpResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetCurrentUserSeason:
        instance = cls()
