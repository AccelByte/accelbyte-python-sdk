...
class PublicClaimUserReward(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ClaimableRewards], Union[None, ErrorEntity, HttpResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicClaimUserReward:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = UserRewardClaim.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
