...
class UpdatePass(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, PassInfo], Union[None, ErrorEntity, HttpResponse, ValidationErrorEntity]]:
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdatePass:
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = PassUpdate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
