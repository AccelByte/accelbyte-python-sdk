...
class GrantUserExp(Operation):
    ...
    _url: str = "/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/current/exp"
    _method: str = "POST"
    _consumes: List[str] = []
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GrantUserExp:
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = UserExpGrant.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
