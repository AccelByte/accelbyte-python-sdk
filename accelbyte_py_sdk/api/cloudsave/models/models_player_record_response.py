...
class ModelsPlayerRecordResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsPlayerRecordResponse, List[ModelsPlayerRecordResponse], Dict[Any, ModelsPlayerRecordResponse]]:
        if many:
