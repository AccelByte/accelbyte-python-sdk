...
class ModelsPlayerRecordKeyInfo(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsPlayerRecordKeyInfo, List[ModelsPlayerRecordKeyInfo], Dict[Any, ModelsPlayerRecordKeyInfo]]:
        if many:
