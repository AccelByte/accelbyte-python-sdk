...
class PutPlayerRecordConcurrentHandlerV1(Operation):
    ...
    _url: str = "/cloudsave/v1/namespaces/{namespace}/users/{userId}/concurrent/records/{key}"
    _method: str = "PUT"
    ...
    def with_body(self, value: ModelsConcurrentRecordRequest) -> PutPlayerRecordConcurrentHandlerV1:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PutPlayerRecordConcurrentHandlerV1:
        instance = cls()
