# Auto-generated at 2021-10-21T08:52:32.612823+08:00
...
class GetPlayerPublicRecordHandlerV1(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsPlayerRecord], Union[None, ModelsResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetPlayerPublicRecordHandlerV1:
        instance = cls()
