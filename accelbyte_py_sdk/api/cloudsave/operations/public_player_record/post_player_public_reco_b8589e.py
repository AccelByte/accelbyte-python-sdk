...
class PostPlayerPublicRecordHandlerV1(Operation):
    ...
    _url: str = "/cloudsave/v1/namespaces/{namespace}/users/{userId}/records/{key}/public"
    _method: str = "POST"
    ...
    def with_body(self, value: ModelsPlayerRecordRequest) -> PostPlayerPublicRecordHandlerV1:
        self.body = value
        return self
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, Optional[str]], Union[None, HttpResponse, ModelsResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PostPlayerPublicRecordHandlerV1:
        instance = cls()
