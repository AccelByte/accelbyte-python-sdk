...
class AdminPutPlayerRecordConcurrentHandlerV1(Operation):
    ...
    def with_body(self, value: ModelsAdminConcurrentRecordRequest) -> AdminPutPlayerRecordConcurrentHandlerV1:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminPutPlayerRecordConcurrentHandlerV1:
        instance = cls()
