# Auto-generated at 2021-09-21T14:10:40.249260+08:00
...
class PostAdminGameRecordHandlerV1(Operation):
    ...
    Responses:
        200: OK - (Record in namespace-level saved)
    ...
    def with_body(self, value: ModelsGameRecordRequest) -> PostAdminGameRecordHandlerV1:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PostAdminGameRecordHandlerV1:
        self.namespace = value
        return self

    def with_key(self, value: str) -> PostAdminGameRecordHandlerV1:
        self.key = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PostAdminGameRecordHandlerV1:
        instance = cls()
