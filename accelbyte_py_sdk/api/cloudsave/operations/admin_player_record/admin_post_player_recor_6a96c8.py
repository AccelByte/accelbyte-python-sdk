...
class AdminPostPlayerRecordHandlerV1(Operation):
    ...
    def with_body(self, value: ModelsPlayerRecordRequest) -> AdminPostPlayerRecordHandlerV1:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminPostPlayerRecordHandlerV1:
        instance = cls()
