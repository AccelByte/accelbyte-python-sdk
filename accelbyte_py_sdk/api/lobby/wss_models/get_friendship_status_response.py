...
class GetFriendshipStatusResponse(WebSocketMessage):
    ...
    @classmethod
    def create_from_wsm(cls, wsm: str, is_strict: bool = False) -> GetFriendshipStatusResponse:
        instance = cls()
        if not wsm:
            return instance
        ...
        for line in lines[2:]:
            ...
            if (not is_strict and name.casefold() == "code".casefold()) or (name == "code"):
                instance.code = value
                continue
            if (not is_strict and name.casefold() == "friendshipStatus".casefold()) or (name == "friendshipStatus"):
