# Auto-generated at 2021-10-21T08:52:27.823039+08:00
...
class PublicGetPlayerBlockedByPlayersV1(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsGetAllPlayerBlockedByUsersResponse], Union[None, RestapiErrorResponseBody]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetPlayerBlockedByPlayersV1:
        instance = cls()
