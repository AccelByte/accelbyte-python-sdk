# Auto-generated at 2021-10-21T08:52:27.758021+08:00
...
class AdminGetPlayerSessionAttribute(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsGetPlayerSessionAttributeResponse], Union[None, RestapiErrorResponseBody]]:
        ...
        """
        if code == 200:
            return ModelsGetPlayerSessionAttributeResponse.create_from_dict(content), None
        if code == 400:
