...
class CreateNotificationTemplateV1Admin(Operation):
    ...
    template. Include handlebars {{key}} for replaceable contexts. The key inside
    handlebars will be the key to be replaced when sending notification. Already
    existing template with the same slug and language can not be created.
    ...
    def with_body(self, value: ModelCreateTemplateRequest) -> CreateNotificationTemplateV1Admin:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> CreateNotificationTemplateV1Admin:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelCreateTemplateRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
