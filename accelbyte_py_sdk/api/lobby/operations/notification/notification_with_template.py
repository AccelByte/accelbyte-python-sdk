...
class NotificationWithTemplate(Operation):
    ...
    Required permission : <code>NAMESPACE:{namespace}:NOTIFICATION [CREATE]</code>
    with scope <code>social</code> <br>Sends notification to all connected users
    in a namespace with predefined template. <br>In the request body, specify
    which template slug (template identifier) to use and the template language.
    ...
    def with_body(self, value: ModelNotificationWithTemplateRequest) -> NotificationWithTemplate:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> NotificationWithTemplate:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelNotificationWithTemplateRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
