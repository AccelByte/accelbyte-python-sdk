...
class SendUsersTemplatedNotificationV1Admin(Operation):
    ...
    connected users in a namespace with predefined template. <br>In the request
    body, specify which template slug (template identifier) to use and the
    template language. <br>NotificationTemplate context is the key-value pair
    defining the value of each handlebar specified in the template content.
