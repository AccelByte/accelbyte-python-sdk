...
class GetTopicByNamespace(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelTopicByNamespacesResponse], Union[None, HttpResponse, RestapiErrorResponseBody]]:
