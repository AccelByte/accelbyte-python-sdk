...
class GetTopicByTopicName(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelNotificationTopicResponse], Union[None, HttpResponse, RestapiErrorResponseBody]]:
