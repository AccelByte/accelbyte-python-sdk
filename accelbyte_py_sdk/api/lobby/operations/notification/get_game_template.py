...
class GetGameTemplate(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ModelTemplateResponse]], Union[None, HttpResponse, RestapiErrorResponseBody]]:
