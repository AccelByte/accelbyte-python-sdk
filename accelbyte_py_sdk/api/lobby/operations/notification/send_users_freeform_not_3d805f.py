...
class SendUsersFreeformNotificationV1Admin(Operation):
    ...
    def with_body(self, value: ModelFreeFormNotificationRequestV1) -> SendUsersFreeformNotificationV1Admin:
        self.body = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, HttpResponse], Union[None, HttpResponse, RestapiErrorResponseV1]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> SendUsersFreeformNotificationV1Admin:
        instance = cls()
