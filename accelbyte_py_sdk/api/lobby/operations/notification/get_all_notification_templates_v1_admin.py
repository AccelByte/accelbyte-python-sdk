# Auto-generated at 2021-10-14T22:17:13.326862+08:00
...
class GetAllNotificationTemplatesV1Admin(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ModelNotificationTemplateResponse]], Union[None, RestapiErrorResponseV1]]:
        ...
        """
        if code == 200:
            return [ModelNotificationTemplateResponse.create_from_dict(i) for i in content], None
        if code == 400:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetAllNotificationTemplatesV1Admin:
        instance = cls()
