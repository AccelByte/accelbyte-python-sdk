...
class GetNotificationTopicV1Admin(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelNotificationTopicResponseV1], Union[None, HttpResponse, RestapiErrorResponseV1]]:
