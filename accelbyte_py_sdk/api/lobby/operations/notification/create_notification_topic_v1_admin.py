# Auto-generated at 2021-09-27T17:01:26.552497+08:00
...
class CreateNotificationTopicV1Admin(Operation):
    ...
    def with_body(self, value: ModelCreateTopicRequestV1) -> CreateNotificationTopicV1Admin:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> CreateNotificationTopicV1Admin:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelCreateTopicRequestV1.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
