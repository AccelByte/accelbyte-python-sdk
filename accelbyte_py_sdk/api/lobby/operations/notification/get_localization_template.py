# Auto-generated at 2021-10-14T22:17:13.552481+08:00
...
class GetLocalizationTemplate(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelTemplateLocalization], Union[None, RestapiErrorResponseBody]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetLocalizationTemplate:
        instance = cls()
