# Auto-generated at 2021-10-21T08:52:27.702971+08:00
...
class GetSingleTemplateLocalizationV1Admin(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelLocalization], Union[None, RestapiErrorResponseV1]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetSingleTemplateLocalizationV1Admin:
        instance = cls()
