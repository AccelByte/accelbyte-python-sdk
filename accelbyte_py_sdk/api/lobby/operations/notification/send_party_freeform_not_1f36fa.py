...
class SendPartyFreeformNotificationV1Admin(Operation):
    ...
    def with_body(self, value: ModelFreeFormNotificationRequestV1) -> SendPartyFreeformNotificationV1Admin:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> SendPartyFreeformNotificationV1Admin:
        instance = cls()
