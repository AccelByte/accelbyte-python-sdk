...
class AdminAddProfanityFilters(Operation):
    ...
    [CREATE]</code> with scope <code>social</code> <br>add multiple filters into
    the list
    ...
    _url: str = "/lobby/v1/admin/profanity/namespaces/{namespace}/list/{list}/filters/bulk"
    _method: str = "POST"
    ...
    def with_body(self, value: ModelsAdminAddProfanityFiltersRequest) -> AdminAddProfanityFilters:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminAddProfanityFilters:
        instance = cls()
