# Auto-generated at 2021-09-21T14:10:36.361080+08:00
...
class AdminCreateProfanityList(Operation):
    ...
    def with_body(self, value: ModelsAdminCreateProfanityListRequest) -> AdminCreateProfanityList:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminCreateProfanityList:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsAdminCreateProfanityListRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
