...
class AdminAddProfanityFilterIntoList(Operation):
    ...
    [CREATE]</code> with scope <code>social</code> <br>add a single filter into
    the list
    ...
    def with_body(self, value: ModelsAdminAddProfanityFilterIntoListRequest) -> AdminAddProfanityFilterIntoList:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminAddProfanityFilterIntoList:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsAdminAddProfanityFilterIntoListRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
