...
class AdminDebugProfanityFilters(Operation):
    ...
    def with_body(self, value: ModelsDebugProfanityFilterRequest) -> AdminDebugProfanityFilters:
        self.body = value
        return self
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ModelsProfanityFilter]], Union[None, HttpResponse, RestapiErrorResponseBody]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminDebugProfanityFilters:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsDebugProfanityFilterRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
