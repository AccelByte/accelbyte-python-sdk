...
class AdminGetProfanityRule(Operation):
    ...
    [READ]</code> with scope <code>social</code> <br>get current profanity rule
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsProfanityRule], Union[None, RestapiErrorResponseBody]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetProfanityRule:
        instance = cls()
