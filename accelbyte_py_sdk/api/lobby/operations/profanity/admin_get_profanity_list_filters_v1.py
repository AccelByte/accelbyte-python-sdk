# Auto-generated at 2021-10-21T08:52:27.770393+08:00
...
class AdminGetProfanityListFiltersV1(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsAdminGetProfanityListFiltersV1Response], Union[None, RestapiErrorResponseBody]]:
        ...
        """
        if code == 200:
            return ModelsAdminGetProfanityListFiltersV1Response.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetProfanityListFiltersV1:
        instance = cls()
