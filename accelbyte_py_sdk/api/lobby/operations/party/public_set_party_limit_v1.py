...
class PublicSetPartyLimitV1(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicSetPartyLimitV1:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsPartyPUTLimitSizeRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
