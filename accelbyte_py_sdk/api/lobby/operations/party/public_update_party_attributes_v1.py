...
class PublicUpdatePartyAttributesV1(Operation):
    ...
    Required valid user authorization <br/> <br>update party attributes in a
    namespace.
    ...
    _url: str = "/lobby/v1/public/party/namespaces/{namespace}/parties/{partyId}/attributes"
    _method: str = "PUT"
    ...
    def with_body(self, value: ModelsPartyPUTCustomAttributesRequest) -> PublicUpdatePartyAttributesV1:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicUpdatePartyAttributesV1:
        instance = cls()
