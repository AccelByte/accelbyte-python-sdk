# Auto-generated at 2021-09-27T17:01:26.450189+08:00
...
class GetUserIncomingFriends(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ModelGetUserIncomingFriendsResponse]], Union[None, RestapiErrorResponseV1]]:
        ...
        """
        if code == 200:
            return [ModelGetUserIncomingFriendsResponse.create_from_dict(i) for i in content], None
        if code == 400:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserIncomingFriends:
        instance = cls()
