...
class GetUserIncomingFriends(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ModelGetUserIncomingFriendsResponse]], Union[None, HttpResponse, RestapiErrorResponseV1]]:
