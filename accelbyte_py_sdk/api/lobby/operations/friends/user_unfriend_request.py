# Auto-generated at 2021-10-14T22:17:13.300455+08:00
...
class UserUnfriendRequest(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UserUnfriendRequest:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUserUnfriendRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
