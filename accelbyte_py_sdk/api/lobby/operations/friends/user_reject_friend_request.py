# Auto-generated at 2021-10-21T08:52:27.658484+08:00
...
class UserRejectFriendRequest(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UserRejectFriendRequest:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUserRejectFriendRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
