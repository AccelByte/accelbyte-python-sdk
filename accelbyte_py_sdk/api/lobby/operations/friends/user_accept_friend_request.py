# Auto-generated at 2021-09-27T17:01:26.468403+08:00
...
class UserAcceptFriendRequest(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UserAcceptFriendRequest:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUserAcceptFriendRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
