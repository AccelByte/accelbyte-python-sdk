...
class GetListOfFriends(Operation):
    ...
    [READ]</code> with scope <code>social</code> <br>get list of friends in a
    namespace.
    ...
    def with_limit(self, value: str) -> GetListOfFriends:
        self.limit = value
        return self

    def with_offset(self, value: str) -> GetListOfFriends:
        self.offset = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelGetFriendsResponse], Union[None, RestapiErrorResponseBody]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetListOfFriends:
        instance = cls()
