# Auto-generated at 2021-10-21T08:52:27.645583+08:00
...
class GetUserFriends(Operation):
    """get list of friends (getUserFriends)
    ...
    def with_namespace(self, value: str) -> GetUserFriends:
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ModelGetUserFriendsResponse]], Union[None, RestapiErrorResponseV1]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserFriends:
        instance = cls()
