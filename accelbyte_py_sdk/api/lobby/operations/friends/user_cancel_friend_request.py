# Auto-generated at 2021-10-14T22:17:13.291706+08:00
...
class UserCancelFriendRequest(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UserCancelFriendRequest:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUserCancelFriendRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
