# Auto-generated at 2021-10-21T08:52:27.649550+08:00
...
class GetUserOutgoingFriends(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ModelGetUserOutgoingFriendsResponse]], Union[None, RestapiErrorResponseV1]]:
        ...
        """
        if code == 200:
            return [ModelGetUserOutgoingFriendsResponse.create_from_dict(i) for i in content], None
        if code == 400:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserOutgoingFriends:
        instance = cls()
