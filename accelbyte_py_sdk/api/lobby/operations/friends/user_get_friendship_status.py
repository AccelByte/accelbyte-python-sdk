...
class UserGetFriendshipStatus(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelUserGetFriendshipStatusResponse], Union[None, HttpResponse, RestapiErrorResponseV1]]:
