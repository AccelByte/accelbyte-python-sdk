...
class UsersPresenceHandlerV1(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, HandlersGetUsersPresenceResponse], Union[None, HttpResponse, RestapiErrorResponseBody]]:
