...
class AdminUpdateThirdPartyConfig(Operation):
    ...
    [UPDATE]</code> with scope <code>social</code> <br>Update third party config
    in a namespace.
    ...
    def with_body(self, value: ModelsUpdateConfigRequest) -> AdminUpdateThirdPartyConfig:
        self.body = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsUpdateConfigResponse], Union[None, RestapiErrorResponseV1]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminUpdateThirdPartyConfig:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsUpdateConfigRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
