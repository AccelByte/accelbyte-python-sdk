...
class AdminCreateThirdPartyConfig(Operation):
    ...
    [CREATE]</code> with scope <code>social</code> <br>create third party config
    in a namespace.
    ...
    def with_body(self, value: ModelsCreateConfigRequest) -> AdminCreateThirdPartyConfig:
        self.body = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsCreateConfigResponse], Union[None, RestapiErrorResponseV1]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminCreateThirdPartyConfig:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsCreateConfigRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
