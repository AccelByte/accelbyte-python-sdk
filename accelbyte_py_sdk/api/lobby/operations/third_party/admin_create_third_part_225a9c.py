...
class AdminCreateThirdPartyConfig(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsCreateConfigResponse], Union[None, HttpResponse, RestapiErrorResponseV1]]:
