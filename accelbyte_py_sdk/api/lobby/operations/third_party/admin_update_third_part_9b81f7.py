...
class AdminUpdateThirdPartyConfig(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsUpdateConfigResponse], Union[None, HttpResponse, RestapiErrorResponseV1]]:
