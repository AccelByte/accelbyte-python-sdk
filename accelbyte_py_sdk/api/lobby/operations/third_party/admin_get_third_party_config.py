# Auto-generated at 2021-10-21T08:52:27.801443+08:00
...
class AdminGetThirdPartyConfig(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsGetConfigResponse], Union[None, RestapiErrorResponseV1]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetThirdPartyConfig:
        instance = cls()
