...
class AdminExportConfigV1(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsConfigExport], Union[None, HttpResponse, ResponseError]]:
        ...
        if code == 200:
            return ModelsConfigExport.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminExportConfigV1:
        instance = cls()
