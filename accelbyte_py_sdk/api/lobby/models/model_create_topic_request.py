...
class ModelCreateTopicRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelCreateTopicRequest, List[ModelCreateTopicRequest], Dict[Any, ModelCreateTopicRequest]]:
        if many:
