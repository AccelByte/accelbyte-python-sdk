...
class ModelsAdminAddProfanityFilterIntoListRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsAdminAddProfanityFilterIntoListRequest, List[ModelsAdminAddProfanityFilterIntoListRequest], Dict[Any, ModelsAdminAddProfanityFilterIntoListRequest]]:
        if many:
