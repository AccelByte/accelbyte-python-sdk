...
class ModelsAdminAddProfanityFiltersFilterRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsAdminAddProfanityFiltersFilterRequest, List[ModelsAdminAddProfanityFiltersFilterRequest]]:
        if many:
