...
class ModelFreeFormNotificationRequestV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelFreeFormNotificationRequestV1, List[ModelFreeFormNotificationRequestV1]]:
        if many:
