...
class ModelsAdminCreateProfanityListRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsAdminCreateProfanityListRequest, List[ModelsAdminCreateProfanityListRequest], Dict[Any, ModelsAdminCreateProfanityListRequest]]:
        if many:
