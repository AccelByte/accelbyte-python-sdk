...
class ModelCreateTemplateRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelCreateTemplateRequest, List[ModelCreateTemplateRequest], Dict[Any, ModelCreateTemplateRequest]]:
        if many:
