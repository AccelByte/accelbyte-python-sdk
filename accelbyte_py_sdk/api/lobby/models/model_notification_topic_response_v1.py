...
class ModelNotificationTopicResponseV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelNotificationTopicResponseV1, List[ModelNotificationTopicResponseV1]]:
        if many:
