...
class ModelNotificationWithTemplateRequestV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelNotificationWithTemplateRequestV1, List[ModelNotificationWithTemplateRequestV1]]:
        if many:
