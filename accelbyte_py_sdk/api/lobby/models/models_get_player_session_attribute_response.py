...
class ModelsGetPlayerSessionAttributeResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsGetPlayerSessionAttributeResponse, List[ModelsGetPlayerSessionAttributeResponse]]:
        if many:
