...
class ModelFreeFormNotificationRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelFreeFormNotificationRequest, List[ModelFreeFormNotificationRequest], Dict[Any, ModelFreeFormNotificationRequest]]:
        if many:
