...
class ModelsAdminSetProfanityRuleForNamespaceRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsAdminSetProfanityRuleForNamespaceRequest, List[ModelsAdminSetProfanityRuleForNamespaceRequest], Dict[Any, ModelsAdminSetProfanityRuleForNamespaceRequest]]:
        if many:
