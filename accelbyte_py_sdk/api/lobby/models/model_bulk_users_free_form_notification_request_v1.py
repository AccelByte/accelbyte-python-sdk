...
class ModelBulkUsersFreeFormNotificationRequestV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelBulkUsersFreeFormNotificationRequestV1, List[ModelBulkUsersFreeFormNotificationRequestV1], Dict[Any, ModelBulkUsersFreeFormNotificationRequestV1]]:
        if many:
