...
class ModelsProfanityFilter(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsProfanityFilter, List[ModelsProfanityFilter], Dict[Any, ModelsProfanityFilter]]:
        if many:
