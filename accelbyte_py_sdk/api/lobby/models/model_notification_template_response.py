...
class ModelNotificationTemplateResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelNotificationTemplateResponse, List[ModelNotificationTemplateResponse]]:
        if many:
