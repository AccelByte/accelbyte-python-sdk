...
class ModelNotificationWithTemplateRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelNotificationWithTemplateRequest, List[ModelNotificationWithTemplateRequest], Dict[Any, ModelNotificationWithTemplateRequest]]:
        if many:
