...
class AdminListClientTemplates(Operation):
    ...
    _url: str = "/iam/v3/admin/clientConfig/templates"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def parse_response(
        ...
        Union[None, ClientmodelListTemplatesResponse],
        ...
        if code == 200:
            return ClientmodelListTemplatesResponse.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, **kwargs) -> AdminListClientTemplates:
        instance = cls()
