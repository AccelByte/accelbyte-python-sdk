# Auto-generated at 2021-10-21T08:52:26.757660+08:00
...
class TokenRevocationV3(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, HttpResponse], Union[None, OauthmodelErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> TokenRevocationV3:
        instance = cls()
