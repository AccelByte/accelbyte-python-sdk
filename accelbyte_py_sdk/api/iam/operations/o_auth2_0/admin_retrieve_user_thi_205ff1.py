...
class AdminRetrieveUserThirdPartyPlatformTokenV3(Operation):
    ...
    def with_platform_id(self, value: str) -> AdminRetrieveUserThirdPartyPlatformTokenV3:
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, OauthmodelTokenThirdPartyResponse], Union[None, HttpResponse, OauthmodelErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminRetrieveUserThirdPartyPlatformTokenV3:
        instance = cls()
