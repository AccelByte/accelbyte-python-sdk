...
class AdminUpdateRoleOverrideConfigV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/roleoverride"
    _method: str = "PATCH"
    ...
    body: ModelRoleOverrideUpdateRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelRoleOverrideUpdateRequest
    ) -> AdminUpdateRoleOverrideConfigV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminUpdateRoleOverrideConfigV3:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelRoleOverrideUpdateRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelRoleOverrideUpdateRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelRoleOverrideUpdateRequest()
