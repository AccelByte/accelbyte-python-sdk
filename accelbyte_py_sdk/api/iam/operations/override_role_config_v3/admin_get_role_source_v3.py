...
class AdminGetRoleSourceV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/roleoverride/source"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> AdminGetRoleSourceV3:
        self.namespace = value
        return self

    def with_identity(self, value: Union[str, IdentityEnum]) -> AdminGetRoleSourceV3:
        self.identity = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelRoleOverrideSourceResponse],
        ...
        if code == 200:
            return ModelRoleOverrideSourceResponse.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, namespace: str, identity: Union[str, IdentityEnum], **kwargs
