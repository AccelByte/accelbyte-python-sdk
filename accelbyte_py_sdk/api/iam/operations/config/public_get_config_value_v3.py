...
class PublicGetConfigValueV3(Operation):
    ...
    * verificationCodeType
    ...
    def with_config_key(self, value: str) -> PublicGetConfigValueV3:
        self.config_key = value
        return self

    def with_namespace(self, value: str) -> PublicGetConfigValueV3:
    ...
    @classmethod
    def create(
        cls, config_key: str, namespace: str, **kwargs
