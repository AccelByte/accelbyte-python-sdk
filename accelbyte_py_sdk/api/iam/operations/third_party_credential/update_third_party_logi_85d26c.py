...
class UpdateThirdPartyLoginPlatformDomainV3(Operation):
    ...
    Responses:
        ...
        404: Not Found - RestErrorResponse (Platform client not found)
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/platforms/{platformId}/clients/domain"
    _method: str = "PUT"
    ...
    def with_body(self, value: ModelPlatformDomainUpdateRequest) -> UpdateThirdPartyLoginPlatformDomainV3:
        self.body = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelPlatformDomainResponse], Union[None, HttpResponse, RestErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateThirdPartyLoginPlatformDomainV3:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelPlatformDomainUpdateRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
