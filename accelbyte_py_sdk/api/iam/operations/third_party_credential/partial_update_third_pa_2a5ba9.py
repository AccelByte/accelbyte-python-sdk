...
class PartialUpdateThirdPartyLoginPlatformDomainV3(Operation):
    ...
    body: ModelPlatformDomainPatchRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelPlatformDomainPatchRequest
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelPlatformDomainPatchRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelPlatformDomainPatchRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelPlatformDomainPatchRequest()
