...
class AdminCheckThirdPartyLoginPlatformAvailabilityV3(Operation):
    ...
    def parse_response(
        ...
        Union[None, ModelCheckAvailabilityResponse],
        ...
        if code == 200:
            return ModelCheckAvailabilityResponse.create_from_dict(content), None
        if code == 400:
