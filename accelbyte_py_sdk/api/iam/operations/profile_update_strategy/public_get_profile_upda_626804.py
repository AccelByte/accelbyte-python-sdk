...
class PublicGetProfileUpdateStrategyV3(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/profileUpdateStrategies"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicGetProfileUpdateStrategyV3:
