...
class AdminGetLoginAllowlistV3(Operation):
    ...
    def with_namespace(self, value: str) -> AdminGetLoginAllowlistV3:
    ...
    def parse_response(
        ...
        Union[None, ModelLoginAllowlistResponse],
        ...
        if code == 200:
            return ModelLoginAllowlistResponse.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> AdminGetLoginAllowlistV3:
        instance = cls()
