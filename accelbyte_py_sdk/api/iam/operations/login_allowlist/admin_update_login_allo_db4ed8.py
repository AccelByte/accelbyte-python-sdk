...
class AdminUpdateLoginAllowlistV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/loginAllowlist"
    _method: str = "PUT"
    ...
    body: ModelLoginAllowlistRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelLoginAllowlistRequest
    ) -> AdminUpdateLoginAllowlistV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminUpdateLoginAllowlistV3:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelLoginAllowlistRequest()
    ...
    @classmethod
    def create(
        cls, body: ModelLoginAllowlistRequest, namespace: str, **kwargs
    ) -> AdminUpdateLoginAllowlistV3:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelLoginAllowlistRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelLoginAllowlistRequest()
