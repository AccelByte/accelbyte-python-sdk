# Auto-generated at 2021-09-21T14:10:35.570036+08:00
...
class AdminListAssignedUsersV4(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelListAssignedUsersV4Response], Union[None, RestErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminListAssignedUsersV4:
        instance = cls()
