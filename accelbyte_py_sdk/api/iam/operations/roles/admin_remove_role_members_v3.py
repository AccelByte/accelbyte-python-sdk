# Auto-generated at 2021-10-21T08:52:26.712529+08:00
...
class AdminRemoveRoleMembersV3(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminRemoveRoleMembersV3:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelRoleMembersRequestV3.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
