...
class RemoveRoleManagers(Operation):
    ...
    [UPDATE]' instead.</p> <p>Role can only be assigned to other users by the
    role's manager.</p>
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> RemoveRoleManagers:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelRoleManagersRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
