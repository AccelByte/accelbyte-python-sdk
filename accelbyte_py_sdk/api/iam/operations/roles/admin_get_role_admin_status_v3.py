...
class AdminGetRoleAdminStatusV3(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelRoleAdminStatusResponseV3], Union[None, HttpResponse, RestErrorResponse]]:
