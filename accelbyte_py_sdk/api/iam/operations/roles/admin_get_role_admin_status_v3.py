# Auto-generated at 2021-09-21T14:10:35.330087+08:00
...
class AdminGetRoleAdminStatusV3(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelRoleAdminStatusResponseV3], Union[None, RestErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetRoleAdminStatusV3:
        instance = cls()
