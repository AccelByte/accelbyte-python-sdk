# Auto-generated at 2021-10-21T08:52:26.181026+08:00
...
class UpdateClientPermission(Operation):
    ...
    def with_body(self, value: AccountcommonClientPermissions) -> UpdateClientPermission:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateClientPermission:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = AccountcommonClientPermissions.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
