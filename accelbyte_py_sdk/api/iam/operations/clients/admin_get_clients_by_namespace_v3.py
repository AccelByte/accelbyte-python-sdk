# Auto-generated at 2021-10-21T08:52:26.466409+08:00
...
class AdminGetClientsByNamespaceV3(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ClientmodelClientsV3Response], Union[None, RestErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetClientsByNamespaceV3:
        instance = cls()
