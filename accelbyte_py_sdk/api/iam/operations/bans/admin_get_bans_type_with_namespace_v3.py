# Auto-generated at 2021-09-21T14:10:35.129036+08:00
...
class AdminGetBansTypeWithNamespaceV3(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, AccountcommonBansV3], Union[None, RestapiErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetBansTypeWithNamespaceV3:
        instance = cls()
