...
class Verify2faCodeV4(Operation):
    ...
    _url: str = "/iam/v4/oauth/mfa/verify"
    _method: str = "POST"
    ...
    def with_code(self, value: str) -> Verify2faCodeV4:
        self.code = value
        return self

    def with_factor(self, value: str) -> Verify2faCodeV4:
        self.factor = value
        return self

    def with_mfa_token(self, value: str) -> Verify2faCodeV4:
        self.mfa_token = value
        return self

    def with_remember_device(self, value: bool) -> Verify2faCodeV4:
