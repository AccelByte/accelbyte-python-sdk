# Auto-generated at 2021-10-21T08:52:26.423368+08:00
...
class PublicUpdatePasswordV2(Operation):
    ...
    def with_body(self, value: ModelUserPasswordUpdateRequest) -> PublicUpdatePasswordV2:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicUpdatePasswordV2:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUserPasswordUpdateRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
