# Auto-generated at 2021-09-21T14:10:35.405937+08:00
...
class PublicListUserIDByPlatformUserIDsV3(Operation):
    ...
    def with_body(self, value: ModelPlatformUserIDRequest) -> PublicListUserIDByPlatformUserIDsV3:
        self.body = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, AccountcommonUserPlatforms], Union[None, RestErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicListUserIDByPlatformUserIDsV3:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelPlatformUserIDRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
