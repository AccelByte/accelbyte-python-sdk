...
class AdminListAllDistinctPlatformAccountsV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/distinct"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> AdminListAllDistinctPlatformAccountsV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminListAllDistinctPlatformAccountsV3:
        self.user_id = value
        return self

    def with_status(self, value: str) -> AdminListAllDistinctPlatformAccountsV3:
        self.status = value
        return self
    ...
    @classmethod
    def create(
        cls, namespace: str, user_id: str, status: Optional[str] = None, **kwargs
