...
class AdminListUsersV3(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, AccountcommonListUsersWithPlatformAccountsResponse], Union[None, HttpResponse, RestErrorResponse]]:
