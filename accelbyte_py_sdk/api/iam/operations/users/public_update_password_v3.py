# Auto-generated at 2021-10-21T08:52:26.831327+08:00
...
class PublicUpdatePasswordV3(Operation):
    ...
    def with_body(self, value: ModelUserPasswordUpdateV3Request) -> PublicUpdatePasswordV3:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicUpdatePasswordV3:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUserPasswordUpdateV3Request.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
