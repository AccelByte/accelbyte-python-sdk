...
class PublicCreateUserV3(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelUserCreateResponseV3], Union[None, HttpResponse, RestErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicCreateUserV3:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUserCreateRequestV3.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
