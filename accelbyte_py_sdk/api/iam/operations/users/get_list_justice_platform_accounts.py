# Auto-generated at 2021-09-21T14:10:35.094938+08:00
...
class GetListJusticePlatformAccounts(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ModelGetUserMapping]], Union[None, HttpResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetListJusticePlatformAccounts:
        instance = cls()
