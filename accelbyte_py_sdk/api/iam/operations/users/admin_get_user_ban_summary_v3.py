...
class AdminGetUserBanSummaryV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/bans/summary"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> AdminGetUserBanSummaryV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminGetUserBanSummaryV3:
        self.user_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelGetUserBanSummaryV3],
        ...
        if code == 200:
            return ModelGetUserBanSummaryV3.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> AdminGetUserBanSummaryV3:
        instance = cls()
