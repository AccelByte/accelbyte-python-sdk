...
class PublicGetMyProfileAllowUpdateStatusV3(Operation):
    ...
    _url: str = "/iam/v3/public/users/me/profileStatus"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def parse_response(
        ...
        Union[None, ModelUserProfileUpdateAllowStatus],
        ...
        if code == 200:
            return ModelUserProfileUpdateAllowStatus.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, **kwargs) -> PublicGetMyProfileAllowUpdateStatusV3:
        instance = cls()
