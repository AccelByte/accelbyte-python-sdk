# Auto-generated at 2021-09-27T17:01:25.110034+08:00
...
class AdminGetUserBanV3(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelGetUserBanV3Response], Union[None, RestErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetUserBanV3:
        instance = cls()
