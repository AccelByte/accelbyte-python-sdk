# Auto-generated at 2021-09-21T14:10:35.249102+08:00
...
class AdminUpdateUserDeletionStatusV3(Operation):
    ...
    def with_body(self, value: ModelUpdateUserDeletionStatusRequest) -> AdminUpdateUserDeletionStatusV3:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminUpdateUserDeletionStatusV3:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUpdateUserDeletionStatusRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
