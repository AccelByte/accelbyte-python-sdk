...
class AdminListUserAllPlatformAccountsDistinctV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/distinctPlatforms"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> AdminListUserAllPlatformAccountsDistinctV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminListUserAllPlatformAccountsDistinctV3:
        self.user_id = value
        return self
