# Auto-generated at 2021-10-21T08:52:26.779688+08:00
...
class PublicGetAsyncStatus(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/requests/{requestId}/async/status"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelLinkRequest], Union[None, RestErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetAsyncStatus:
        instance = cls()
