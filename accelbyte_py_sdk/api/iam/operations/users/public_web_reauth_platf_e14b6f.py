...
class PublicWebReauthPlatformProcess(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}/web/reauth/process"
    _method: str = "POST"
    ...
    def with_code(self, value: str) -> PublicWebReauthPlatformProcess:
        self.code = value
        return self

    def with_state(self, value: str) -> PublicWebReauthPlatformProcess:
        self.state = value
        return self

    def with_namespace(self, value: str) -> PublicWebReauthPlatformProcess:
        self.namespace = value
        return self

    def with_platform_id(self, value: str) -> PublicWebReauthPlatformProcess:
    ...
    def parse_response(
        ...
        Union[None, ModelWebReauthProcessResponse],
        ...
        if code == 200:
            return ModelWebReauthProcessResponse.create_from_dict(content), None
        if code == 400:
