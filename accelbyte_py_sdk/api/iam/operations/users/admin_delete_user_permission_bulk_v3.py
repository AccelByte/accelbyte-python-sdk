# Auto-generated at 2021-09-21T14:10:35.266120+08:00
...
class AdminDeleteUserPermissionBulkV3(Operation):
    ...
    def with_body(self, value: List[ModelPermissionDeleteRequest]) -> AdminDeleteUserPermissionBulkV3:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminDeleteUserPermissionBulkV3:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = [ModelPermissionDeleteRequest.create_from_dict(i0, include_empty=include_empty) for i0 in dict_["body"]]
        elif include_empty:
            instance.body = []
