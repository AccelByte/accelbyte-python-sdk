...
class AdminGetUserStateByUserIdV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/state"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> AdminGetUserStateByUserIdV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminGetUserStateByUserIdV3:
        self.user_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelUserStateResponseV3],
        ...
        if code == 200:
            return ModelUserStateResponseV3.create_from_dict(content), None
        if code == 400:
