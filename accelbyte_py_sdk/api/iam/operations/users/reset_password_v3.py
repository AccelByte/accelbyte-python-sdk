# Auto-generated at 2021-09-27T17:01:25.534930+08:00
...
class ResetPasswordV3(Operation):
    ...
    Responses:
        ...
        403: Forbidden - RestErrorResponse (errorCode: 10137 | errorMessage: code is expired)
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ResetPasswordV3:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelResetPasswordRequestV3.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
