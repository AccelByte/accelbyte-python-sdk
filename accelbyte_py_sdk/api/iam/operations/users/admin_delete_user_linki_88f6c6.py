...
class AdminDeleteUserLinkingRestrictionByPlatformIDV3(Operation):
    ...
    **Supported Platforms:**
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/{platformId}/link/restrictions"
    _method: str = "DELETE"
    _consumes: List[str] = []
