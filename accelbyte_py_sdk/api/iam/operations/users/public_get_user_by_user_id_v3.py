# Auto-generated at 2021-10-21T08:52:26.858309+08:00
...
class PublicGetUserByUserIdV3(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelPublicUserResponseV3], Union[None, RestErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetUserByUserIdV3:
        instance = cls()
