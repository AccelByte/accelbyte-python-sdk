...
class PublicSendRegistrationCode(Operation):
    ...
    def with_body(self, value: ModelSendRegisterVerificationCodeRequest) -> PublicSendRegistrationCode:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicSendRegistrationCode:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelSendRegisterVerificationCodeRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
