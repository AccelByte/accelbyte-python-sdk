...
class PublicWebReauthPlatform(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}/web/reauth"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    operation: Union[str, OperationEnum]  # REQUIRED in [query]
    ...
    def with_namespace(self, value: str) -> PublicWebReauthPlatform:
        self.namespace = value
        return self

    def with_platform_id(self, value: str) -> PublicWebReauthPlatform:
        self.platform_id = value
        return self

    def with_client_id(self, value: str) -> PublicWebReauthPlatform:
        self.client_id = value
        return self

    def with_redirect_uri(self, value: str) -> PublicWebReauthPlatform:
        self.redirect_uri = value
        return self

    def with_operation(
        self, value: Union[str, OperationEnum]
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "operation") and self.operation:
            ...
            result["operation"] = Union[str, OperationEnum]()
        return result
    ...
    def create(
        ...
        namespace: str,
        platform_id: str,
        operation: Union[str, OperationEnum],
    ...
    def create_from_dict(
        ...
        if "operation" in dict_ and dict_["operation"] is not None:
            ...
            instance.operation = Union[str, OperationEnum]()
        return instance
