...
class AdminBulkUpdateUsersV3(Operation):
    ...
    * skipLoginQueue
    ...
    body: ModelUsersUpdateRequestV3  # REQUIRED in [body]
    ...
    def with_body(self, value: ModelUsersUpdateRequestV3) -> AdminBulkUpdateUsersV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminBulkUpdateUsersV3:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelUsersUpdateRequestV3()
    ...
    @classmethod
    def create(
        cls, body: ModelUsersUpdateRequestV3, namespace: str, **kwargs
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUsersUpdateRequestV3.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelUsersUpdateRequestV3()
