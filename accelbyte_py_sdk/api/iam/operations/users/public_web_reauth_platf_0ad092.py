...
class PublicWebReauthPlatformEstablish(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}/web/reauth/establish"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicWebReauthPlatformEstablish:
        self.namespace = value
        return self

    def with_platform_id(self, value: str) -> PublicWebReauthPlatformEstablish:
        self.platform_id = value
        return self

    def with_code(self, value: str) -> PublicWebReauthPlatformEstablish:
        self.code = value
        return self

    def with_state(self, value: str) -> PublicWebReauthPlatformEstablish:
        self.state = value
        return self
