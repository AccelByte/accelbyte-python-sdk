...
class PublicPlatformUnlinkV3(Operation):
    ...
    Required valid user authorization. <h2>Supported platforms:</h2> <ul>
    ...
    <li><strong>apple</strong></li> <li><strong>device</strong></li>
    <li><strong>discord</strong></li> <li><strong>awscognito</strong></li>
    <li><strong>epicgames</strong></li> <li><strong>nintendo</strong></li>
    <li><strong>stadia</strong></li> </ul> <p>Unlink user's account from a
