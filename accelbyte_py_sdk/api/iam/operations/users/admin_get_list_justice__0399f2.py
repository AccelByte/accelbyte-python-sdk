...
class AdminGetListJusticePlatformAccounts(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ModelGetUserMapping]], Union[None, HttpResponse, RestErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetListJusticePlatformAccounts:
        instance = cls()
