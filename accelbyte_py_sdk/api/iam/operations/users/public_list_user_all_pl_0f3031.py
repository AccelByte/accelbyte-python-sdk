...
class PublicListUserAllPlatformAccountsDistinctV3(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, AccountcommonDistinctPlatformResponseV3], Union[None, HttpResponse, RestErrorResponse]]:
        ...
        if code == 200:
            return AccountcommonDistinctPlatformResponseV3.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicListUserAllPlatformAccountsDistinctV3:
        instance = cls()
