...
class PublicGetNamespaceScopedInputValidations(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/inputValidations"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicGetNamespaceScopedInputValidations:
