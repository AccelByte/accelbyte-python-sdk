...
class PublicGetNamespaceScopedInputValidationByField(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/inputValidations/{field}"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_field(self, value: str) -> PublicGetNamespaceScopedInputValidationByField:
        self.field = value
        return self
