...
class AdminResetNamespaceScopedInputValidations(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/inputValidations/{field}"
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    def with_field(self, value: str) -> AdminResetNamespaceScopedInputValidations:
        self.field = value
        return self

    def with_namespace(self, value: str) -> AdminResetNamespaceScopedInputValidations:
    ...
    @classmethod
    def create(
        cls, field: str, namespace: str, **kwargs
