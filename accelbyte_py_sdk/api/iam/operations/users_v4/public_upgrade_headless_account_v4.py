# Auto-generated at 2021-10-21T08:52:26.986064+08:00
...
class PublicUpgradeHeadlessAccountV4(Operation):
    ...
    def with_body(self, value: AccountUpgradeHeadlessAccountRequestV4) -> PublicUpgradeHeadlessAccountV4:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicUpgradeHeadlessAccountV4:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = AccountUpgradeHeadlessAccountRequestV4.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
