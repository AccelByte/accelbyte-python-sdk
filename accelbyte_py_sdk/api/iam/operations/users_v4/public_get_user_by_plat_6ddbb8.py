...
class PublicGetUserByPlatformUserIDV4(Operation):
    ...
    **Supported Platforms:**
    ...
    _url: str = "/iam/v4/public/namespaces/{namespace}/platforms/{platformId}/users/{platformUserId}"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicGetUserByPlatformUserIDV4:
        self.namespace = value
        return self

    def with_platform_id(self, value: str) -> PublicGetUserByPlatformUserIDV4:
        self.platform_id = value
        return self

    def with_platform_user_id(self, value: str) -> PublicGetUserByPlatformUserIDV4:
