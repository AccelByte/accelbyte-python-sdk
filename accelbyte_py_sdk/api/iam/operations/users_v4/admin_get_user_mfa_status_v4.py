...
class AdminGetUserMFAStatusV4(Operation):
    ...
    **This endpoint is used to get user's 2FA status.**
    ...
    _url: str = "/iam/v4/admin/namespaces/{namespace}/users/{userId}/mfa/status"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> AdminGetUserMFAStatusV4:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminGetUserMFAStatusV4:
        self.user_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelUserMFAStatusResponseV4],
        ...
        if code == 200:
            return ModelUserMFAStatusResponseV4.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> AdminGetUserMFAStatusV4:
        instance = cls()
