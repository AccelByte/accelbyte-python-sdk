...
class PublicEnableBackupCodesV4(Operation):
    ...
    _url: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCodes/enable"
    _method: str = "POST"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicEnableBackupCodesV4:
