...
class PublicGetMyOwnMFAStatusV4(Operation):
    ...
    _url: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/status"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicGetMyOwnMFAStatusV4:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> PublicGetMyOwnMFAStatusV4:
        instance = cls()
