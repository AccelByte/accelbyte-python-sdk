...
class PublicDisableMyAuthenticatorV4(Operation):
    ...
    _url: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/authenticator/disable"
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicDisableMyAuthenticatorV4:
        instance = cls()
