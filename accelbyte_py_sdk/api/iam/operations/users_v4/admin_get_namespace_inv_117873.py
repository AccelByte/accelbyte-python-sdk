...
class AdminGetNamespaceInvitationHistoryV4(Operation):
    ...
    _url: str = "/iam/v4/admin/namespaces/{namespace}/invitationHistories"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> AdminGetNamespaceInvitationHistoryV4:
    ...
    def parse_response(
        ...
        Union[None, ModelInvitationHistoryResponse],
        ...
        if code == 200:
            return ModelInvitationHistoryResponse.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> AdminGetNamespaceInvitationHistoryV4:
        instance = cls()
