...
class PublicGetMyEnabledFactorsV4(Operation):
    ...
    Responses:
        ...
        400: Bad Request - RestErrorResponse (10191: email address not verified | 10193: mfa not enabled)
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelEnabledFactorsResponseV4], Union[None, HttpResponse, RestErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetMyEnabledFactorsV4:
        instance = cls()
