...
class AccountcommonBanReasons(Model):
    ...
    def create(
        cls,
        reasons: List[AccountcommonBanReason],
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonBanReasons, List[AccountcommonBanReasons]]:
        if many:
