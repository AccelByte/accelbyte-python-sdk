...
class AccountUpgradeHeadlessAccountWithVerificationCodeRequestV4(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountUpgradeHeadlessAccountWithVerificationCodeRequestV4, List[AccountUpgradeHeadlessAccountWithVerificationCodeRequestV4]]:
        if many:
