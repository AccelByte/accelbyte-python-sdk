...
class RestapiErrorResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[RestapiErrorResponse, List[RestapiErrorResponse], Dict[Any, RestapiErrorResponse]]:
        if many:
