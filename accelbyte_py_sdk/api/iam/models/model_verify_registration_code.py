...
class ModelVerifyRegistrationCode(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelVerifyRegistrationCode, List[ModelVerifyRegistrationCode], Dict[Any, ModelVerifyRegistrationCode]]:
        if many:
