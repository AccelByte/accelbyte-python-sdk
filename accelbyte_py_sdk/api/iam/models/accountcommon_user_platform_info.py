...
class AccountcommonUserPlatformInfo(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonUserPlatformInfo, List[AccountcommonUserPlatformInfo], Dict[Any, AccountcommonUserPlatformInfo]]:
        if many:
