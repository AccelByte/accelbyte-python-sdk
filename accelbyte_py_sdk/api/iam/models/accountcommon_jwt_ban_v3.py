...
class AccountcommonJWTBanV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonJWTBanV3, List[AccountcommonJWTBanV3], Dict[Any, AccountcommonJWTBanV3]]:
        if many:
