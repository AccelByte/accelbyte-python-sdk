...
class AccountcommonClientPermissionV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonClientPermissionV3, List[AccountcommonClientPermissionV3], Dict[Any, AccountcommonClientPermissionV3]]:
        if many:
