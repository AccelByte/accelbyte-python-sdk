...
class ModelPublicUserInformationV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelPublicUserInformationV3, List[ModelPublicUserInformationV3], Dict[Any, ModelPublicUserInformationV3]]:
        if many:
