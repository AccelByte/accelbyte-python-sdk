...
class ClientmodelPermissionSetUpsertRequest(Model):
    """Clientmodel permission set upsert request (clientmodel.PermissionSetUpsertRequest)
    ...
    def with_doc_link(self, value: str) -> ClientmodelPermissionSetUpsertRequest:
        self.doc_link = value
        return self
    ...
    def with_module(self, value: str) -> ClientmodelPermissionSetUpsertRequest:
        self.module = value
        return self
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ClientmodelPermissionSetUpsertRequest]:
        return (
    ...
    ) -> List[ClientmodelPermissionSetUpsertRequest]:
        return (
    ...
    def create_from_any(
        ...
        ClientmodelPermissionSetUpsertRequest,
        List[ClientmodelPermissionSetUpsertRequest],
        Dict[Any, ClientmodelPermissionSetUpsertRequest],
    ]:
        if many:
