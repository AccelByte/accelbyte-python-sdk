...
class ModelSearchUsersResponseWithPaginationV3(Model):
    ...
    def with_data(self, value: List[ModelUserResponseV3]) -> ModelSearchUsersResponseWithPaginationV3:
        self.data = value
        return self

    def with_paging(self, value: AccountcommonPaginationV3) -> ModelSearchUsersResponseWithPaginationV3:
        self.paging = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ModelSearchUsersResponseWithPaginationV3:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ModelSearchUsersResponseWithPaginationV3]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ModelSearchUsersResponseWithPaginationV3]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelSearchUsersResponseWithPaginationV3, List[ModelSearchUsersResponseWithPaginationV3], Dict[Any, ModelSearchUsersResponseWithPaginationV3]]:
        if many:
