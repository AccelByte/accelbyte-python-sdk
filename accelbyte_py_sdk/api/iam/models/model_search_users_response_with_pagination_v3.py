...
class ModelSearchUsersResponseWithPaginationV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelSearchUsersResponseWithPaginationV3, List[ModelSearchUsersResponseWithPaginationV3]]:
        if many:
