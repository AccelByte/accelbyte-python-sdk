...
class ModelUpdateUserStatusRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelUpdateUserStatusRequest, List[ModelUpdateUserStatusRequest], Dict[Any, ModelUpdateUserStatusRequest]]:
        if many:
