...
class ModelVerificationCodeResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelVerificationCodeResponse, List[ModelVerificationCodeResponse], Dict[Any, ModelVerificationCodeResponse]]:
        if many:
