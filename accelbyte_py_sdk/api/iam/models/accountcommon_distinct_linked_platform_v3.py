...
from ..models.accountcommon_simple_user_platform_info_v3 import AccountcommonSimpleUserPlatformInfoV3
...
class AccountcommonDistinctLinkedPlatformV3(Model):
    ...
    def with_details(self, value: List[AccountcommonSimpleUserPlatformInfoV3]) -> AccountcommonDistinctLinkedPlatformV3:
        self.details = value
        return self
    ...
    def with_platform_user_id(self, value: str) -> AccountcommonDistinctLinkedPlatformV3:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "details"):
            result["details"] = [i0.to_dict(include_empty=include_empty) for i0 in self.details]
        elif include_empty:
            result["details"] = []
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AccountcommonDistinctLinkedPlatformV3:
        instance = cls()
        if not dict_:
            return instance
        if "details" in dict_ and dict_["details"] is not None:
            instance.details = [AccountcommonSimpleUserPlatformInfoV3.create_from_dict(i0, include_empty=include_empty) for i0 in dict_["details"]]
        elif include_empty:
            instance.details = []
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, AccountcommonDistinctLinkedPlatformV3]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[AccountcommonDistinctLinkedPlatformV3]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonDistinctLinkedPlatformV3, List[AccountcommonDistinctLinkedPlatformV3], Dict[Any, AccountcommonDistinctLinkedPlatformV3]]:
        if many:
