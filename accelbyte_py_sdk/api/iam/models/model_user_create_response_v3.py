...
class ModelUserCreateResponseV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelUserCreateResponseV3, List[ModelUserCreateResponseV3], Dict[Any, ModelUserCreateResponseV3]]:
        if many:
