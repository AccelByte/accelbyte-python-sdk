...
class ModelUpgradeHeadlessAccountWithVerificationCodeRequestV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelUpgradeHeadlessAccountWithVerificationCodeRequestV3, List[ModelUpgradeHeadlessAccountWithVerificationCodeRequestV3]]:
        if many:
