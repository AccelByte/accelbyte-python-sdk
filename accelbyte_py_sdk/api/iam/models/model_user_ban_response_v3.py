...
class ModelUserBanResponseV3(Model):
    ...
    def is_valid(self) -> bool:
        ...
        if not hasattr(self, "created_at") or self.created_at is None:
            return False
        if not hasattr(self, "disabled_date") or self.disabled_date is None:
            return False
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelUserBanResponseV3, List[ModelUserBanResponseV3]]:
        if many:
