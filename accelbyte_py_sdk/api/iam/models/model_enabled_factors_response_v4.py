...
class ModelEnabledFactorsResponseV4(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelEnabledFactorsResponseV4, List[ModelEnabledFactorsResponseV4], Dict[Any, ModelEnabledFactorsResponseV4]]:
        if many:
