...
class ModelSearchUsersByPlatformIDResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelSearchUsersByPlatformIDResponse, List[ModelSearchUsersByPlatformIDResponse]]:
        if many:
