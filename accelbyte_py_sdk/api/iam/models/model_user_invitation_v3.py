...
class ModelUserInvitationV3(Model):
    ...
    def is_valid(self) -> bool:
        ...
        if not hasattr(self, "email") or self.email is None:
            return False
        if not hasattr(self, "expired_at") or self.expired_at is None:
            return False
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelUserInvitationV3, List[ModelUserInvitationV3]]:
        if many:
