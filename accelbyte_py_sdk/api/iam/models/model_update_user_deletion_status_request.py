...
class ModelUpdateUserDeletionStatusRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelUpdateUserDeletionStatusRequest, List[ModelUpdateUserDeletionStatusRequest], Dict[Any, ModelUpdateUserDeletionStatusRequest]]:
        if many:
