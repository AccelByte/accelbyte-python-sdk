...
class ModelPlatformDomainDeleteRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelPlatformDomainDeleteRequest, List[ModelPlatformDomainDeleteRequest], Dict[Any, ModelPlatformDomainDeleteRequest]]:
        if many:
