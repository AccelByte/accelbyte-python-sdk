...
class ModelPublicUserUpdateRequestV3(Model):
    """Model public user update request V3 (model.PublicUserUpdateRequestV3)
    ...
    def with_avatar_url(self, value: str) -> ModelPublicUserUpdateRequestV3:
        self.avatar_url = value
        return self

    def with_country(self, value: str) -> ModelPublicUserUpdateRequestV3:
        self.country = value
        return self

    def with_date_of_birth(self, value: str) -> ModelPublicUserUpdateRequestV3:
        self.date_of_birth = value
        return self

    def with_display_name(self, value: str) -> ModelPublicUserUpdateRequestV3:
        self.display_name = value
        return self

    def with_language_tag(self, value: str) -> ModelPublicUserUpdateRequestV3:
        self.language_tag = value
        return self

    def with_unique_display_name(self, value: str) -> ModelPublicUserUpdateRequestV3:
        self.unique_display_name = value
        return self

    def with_user_name(self, value: str) -> ModelPublicUserUpdateRequestV3:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelPublicUserUpdateRequestV3]:
        return (
    ...
    ) -> List[ModelPublicUserUpdateRequestV3]:
        return (
    ...
    def create_from_any(
        ...
        ModelPublicUserUpdateRequestV3,
        List[ModelPublicUserUpdateRequestV3],
        Dict[Any, ModelPublicUserUpdateRequestV3],
    ]:
        if many:
