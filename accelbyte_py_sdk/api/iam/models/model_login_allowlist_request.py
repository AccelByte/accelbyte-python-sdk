...
class ModelLoginAllowlistRequest(Model):
    """Model login allowlist request (model.LoginAllowlistRequest)
    ...
    def with_active(self, value: bool) -> ModelLoginAllowlistRequest:
        self.active = value
        return self

    def with_role_ids(self, value: List[str]) -> ModelLoginAllowlistRequest:
        self.role_ids = value
        return self
    ...
    @classmethod
    def create(
        cls, active: bool, role_ids: List[str], **kwargs
    ) -> ModelLoginAllowlistRequest:
        instance = cls()
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelLoginAllowlistRequest]:
        return (
    ...
    ) -> List[ModelLoginAllowlistRequest]:
        return (
    ...
    def create_from_any(
        ...
        ModelLoginAllowlistRequest,
        List[ModelLoginAllowlistRequest],
        Dict[Any, ModelLoginAllowlistRequest],
    ]:
        if many:
