...
class ClientmodelClientUpdateSecretRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ClientmodelClientUpdateSecretRequest, List[ClientmodelClientUpdateSecretRequest]]:
        if many:
