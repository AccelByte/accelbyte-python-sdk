...
class ModelRoleResponseWithManagersAndPaginationV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelRoleResponseWithManagersAndPaginationV3, List[ModelRoleResponseWithManagersAndPaginationV3]]:
        if many:
