...
class ModelCreateJusticeUserResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelCreateJusticeUserResponse, List[ModelCreateJusticeUserResponse], Dict[Any, ModelCreateJusticeUserResponse]]:
        if many:
