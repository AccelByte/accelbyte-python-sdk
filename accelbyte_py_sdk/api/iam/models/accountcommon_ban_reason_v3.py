...
class AccountcommonBanReasonV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonBanReasonV3, List[AccountcommonBanReasonV3], Dict[Any, AccountcommonBanReasonV3]]:
        if many:
