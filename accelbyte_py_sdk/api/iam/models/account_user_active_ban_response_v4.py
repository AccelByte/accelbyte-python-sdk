...
class AccountUserActiveBanResponseV4(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountUserActiveBanResponseV4, List[AccountUserActiveBanResponseV4], Dict[Any, AccountUserActiveBanResponseV4]]:
        if many:
