...
class AccountcommonSimpleUserPlatformInfoV3(Model):
    ...
    def with_origin_namespace(self, value: str) -> AccountcommonSimpleUserPlatformInfoV3:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AccountcommonSimpleUserPlatformInfoV3:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, AccountcommonSimpleUserPlatformInfoV3]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[AccountcommonSimpleUserPlatformInfoV3]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonSimpleUserPlatformInfoV3, List[AccountcommonSimpleUserPlatformInfoV3], Dict[Any, AccountcommonSimpleUserPlatformInfoV3]]:
        if many:
