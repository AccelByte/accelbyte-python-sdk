...
class ModelUserInfoResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelUserInfoResponse, List[ModelUserInfoResponse], Dict[Any, ModelUserInfoResponse]]:
        if many:
