...
class ClientmodelClientUpdateRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ClientmodelClientUpdateRequest, List[ClientmodelClientUpdateRequest], Dict[Any, ClientmodelClientUpdateRequest]]:
        if many:
