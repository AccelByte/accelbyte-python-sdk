...
class AccountcommonBanReasonsV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonBanReasonsV3, List[AccountcommonBanReasonsV3], Dict[Any, AccountcommonBanReasonsV3]]:
        if many:
