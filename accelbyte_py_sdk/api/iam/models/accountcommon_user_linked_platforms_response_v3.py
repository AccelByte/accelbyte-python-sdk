...
class AccountcommonUserLinkedPlatformsResponseV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonUserLinkedPlatformsResponseV3, List[AccountcommonUserLinkedPlatformsResponseV3]]:
        if many:
