...
class AccountUpgradeHeadlessAccountRequestV4(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountUpgradeHeadlessAccountRequestV4, List[AccountUpgradeHeadlessAccountRequestV4]]:
        if many:
