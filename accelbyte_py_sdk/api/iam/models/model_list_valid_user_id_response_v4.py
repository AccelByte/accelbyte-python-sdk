...
class ModelListValidUserIDResponseV4(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelListValidUserIDResponseV4, List[ModelListValidUserIDResponseV4], Dict[Any, ModelListValidUserIDResponseV4]]:
        if many:
