...
class ModelAuthenticatorKeyResponseV4(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelAuthenticatorKeyResponseV4, List[ModelAuthenticatorKeyResponseV4], Dict[Any, ModelAuthenticatorKeyResponseV4]]:
        if many:
