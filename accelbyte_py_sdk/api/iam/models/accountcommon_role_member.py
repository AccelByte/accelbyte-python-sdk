...
class AccountcommonRoleMember(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonRoleMember, List[AccountcommonRoleMember], Dict[Any, AccountcommonRoleMember]]:
        if many:
