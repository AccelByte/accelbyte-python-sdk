...
class AccountcommonCountryAgeRestriction(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonCountryAgeRestriction, List[AccountcommonCountryAgeRestriction], Dict[Any, AccountcommonCountryAgeRestriction]]:
        if many:
