...
class ModelValidUserIDResponseV4(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelValidUserIDResponseV4, List[ModelValidUserIDResponseV4], Dict[Any, ModelValidUserIDResponseV4]]:
        if many:
