...
class ModelUserPasswordUpdateV3Request(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelUserPasswordUpdateV3Request, List[ModelUserPasswordUpdateV3Request]]:
        if many:
