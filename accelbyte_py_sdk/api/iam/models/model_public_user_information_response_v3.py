...
class ModelPublicUserInformationResponseV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelPublicUserInformationResponseV3, List[ModelPublicUserInformationResponseV3]]:
        if many:
