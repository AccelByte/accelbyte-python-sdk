...
class ModelUserVerificationRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelUserVerificationRequest, List[ModelUserVerificationRequest], Dict[Any, ModelUserVerificationRequest]]:
        if many:
