...
class AccountcommonClientPermissions(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonClientPermissions, List[AccountcommonClientPermissions], Dict[Any, AccountcommonClientPermissions]]:
        if many:
