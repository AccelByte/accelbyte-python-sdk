...
class ModelCheckValidUserIDRequestV4(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelCheckValidUserIDRequestV4, List[ModelCheckValidUserIDRequestV4], Dict[Any, ModelCheckValidUserIDRequestV4]]:
        if many:
