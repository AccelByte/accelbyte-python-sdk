...
class ModelRoleManagersRequestV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelRoleManagersRequestV3, List[ModelRoleManagersRequestV3], Dict[Any, ModelRoleManagersRequestV3]]:
        if many:
