...
class ModelUserCreateRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelUserCreateRequest, List[ModelUserCreateRequest], Dict[Any, ModelUserCreateRequest]]:
        if many:
