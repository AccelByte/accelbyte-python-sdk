...
class ModelListAssignedUsersV4Response(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelListAssignedUsersV4Response, List[ModelListAssignedUsersV4Response]]:
        if many:
