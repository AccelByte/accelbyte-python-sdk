...
class AccountcommonDescription(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonDescription, List[AccountcommonDescription], Dict[Any, AccountcommonDescription]]:
        if many:
