...
class ModelRoleNamesResponseV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelRoleNamesResponseV3, List[ModelRoleNamesResponseV3], Dict[Any, ModelRoleNamesResponseV3]]:
        if many:
