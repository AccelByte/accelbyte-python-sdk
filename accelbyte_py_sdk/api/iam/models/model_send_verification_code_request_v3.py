...
class ModelSendVerificationCodeRequestV3(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelSendVerificationCodeRequestV3, List[ModelSendVerificationCodeRequestV3]]:
        if many:
