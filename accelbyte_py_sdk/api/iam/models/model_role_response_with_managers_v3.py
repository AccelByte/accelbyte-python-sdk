...
class ModelRoleResponseWithManagersV3(Model):
    ...
    def with_managers(self, value: List[AccountcommonRoleManagerV3]) -> ModelRoleResponseWithManagersV3:
        self.managers = value
        return self

    def with_permissions(self, value: List[AccountcommonPermissionV3]) -> ModelRoleResponseWithManagersV3:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ModelRoleResponseWithManagersV3:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ModelRoleResponseWithManagersV3]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ModelRoleResponseWithManagersV3]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelRoleResponseWithManagersV3, List[ModelRoleResponseWithManagersV3], Dict[Any, ModelRoleResponseWithManagersV3]]:
        if many:
