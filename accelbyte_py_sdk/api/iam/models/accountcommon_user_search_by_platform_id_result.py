...
class AccountcommonUserSearchByPlatformIDResult(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AccountcommonUserSearchByPlatformIDResult, List[AccountcommonUserSearchByPlatformIDResult], Dict[Any, AccountcommonUserSearchByPlatformIDResult]]:
        if many:
