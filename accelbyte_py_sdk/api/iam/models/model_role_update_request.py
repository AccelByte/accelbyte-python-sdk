...
class ModelRoleUpdateRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelRoleUpdateRequest, List[ModelRoleUpdateRequest], Dict[Any, ModelRoleUpdateRequest]]:
        if many:
