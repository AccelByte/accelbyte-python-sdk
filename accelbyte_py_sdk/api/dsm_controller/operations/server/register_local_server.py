# Auto-generated at 2021-09-21T14:10:33.186991+08:00
...
class RegisterLocalServer(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsServer], Union[None, ResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> RegisterLocalServer:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsRegisterLocalServerRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
