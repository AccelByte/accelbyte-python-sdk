# Auto-generated at 2021-09-21T14:10:33.184987+08:00
...
class DeregisterLocalServer(Operation):
    ...
    def with_body(self, value: ModelsDeregisterLocalServerRequest) -> DeregisterLocalServer:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> DeregisterLocalServer:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsDeregisterLocalServerRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
