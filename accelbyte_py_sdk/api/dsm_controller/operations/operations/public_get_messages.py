# Auto-generated at 2021-10-14T22:17:09.083058+08:00
...
class PublicGetMessages(Operation):
    ...
    Responses:
        200: OK - List[LogAppMessageDeclaration] (Public Get Message method)

        500: Internal Server Error - ResponseError (Error response)
    """
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[LogAppMessageDeclaration]], Union[None, ResponseError]]:
