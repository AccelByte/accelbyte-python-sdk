# Auto-generated at 2021-10-14T22:17:08.995197+08:00
...
class SaveConfig(Operation):
    ...
    "100", "mem_limit": "64", "artifact_path":"/srv/datads/artifacts/", "params":
    "", "min_count": 0, "max_count": 0, "buffer_count": 0, "configurations": {
    "1player": { "cpu_limit": "100", "mem_limit": "64", "params": "-gamemode 1p",
    ...
    Properties:
        ...
        body: (body) REQUIRED ModelsDSMConfig in body
    ...
    body: ModelsDSMConfig                                                                          # REQUIRED in [body]
    ...
    def with_body(self, value: ModelsDSMConfig) -> SaveConfig:
        self.body = value
        return self
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> SaveConfig:
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsDSMConfig.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
            instance.body = ModelsDSMConfig()
        return instance
