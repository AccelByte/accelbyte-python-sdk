# Auto-generated at 2021-10-14T22:17:09.004934+08:00
...
class GetConfig(Operation):
    ...
    Responses:
        200: OK - ModelsDSMConfig (config retrieved)
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsDSMConfig], Union[None, ResponseError]]:
        ...
        """
        if code == 200:
            return ModelsDSMConfig.create_from_dict(content), None
        if code == 401:
