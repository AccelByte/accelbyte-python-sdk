...
class ModelsSaveInboxMessageResponse(Model):
    ...
    def with_scope(self, value: Union[str, ScopeEnum]) -> ModelsSaveInboxMessageResponse:
        self.scope = value
        return self

    def with_status(self, value: Union[str, StatusEnum]) -> ModelsSaveInboxMessageResponse:
        self.status = value
        return self
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ModelsSaveInboxMessageResponse:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ModelsSaveInboxMessageResponse]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ModelsSaveInboxMessageResponse]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsSaveInboxMessageResponse, List[ModelsSaveInboxMessageResponse], Dict[Any, ModelsSaveInboxMessageResponse]]:
        if many:
