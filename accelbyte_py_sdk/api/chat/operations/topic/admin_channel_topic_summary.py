...
class AdminChannelTopicSummary(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsChannelTopicSummaryResponse], Union[None, HttpResponse, RestapiErrorResponseBody]]:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminChannelTopicSummary:
        instance = cls()
