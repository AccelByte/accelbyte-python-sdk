...
class AdminUpdateInboxMessage(Operation):
    ...
    def with_body(self, value: ModelsUpdateInboxMessageRequest) -> AdminUpdateInboxMessage:
        self.body = value
        return self
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminUpdateInboxMessage:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsUpdateInboxMessageRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
