...
class ExportChannels(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ModelsChannelV1]], Union[None, HttpResponse, ResponseErrorV1]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ExportChannels:
        instance = cls()
