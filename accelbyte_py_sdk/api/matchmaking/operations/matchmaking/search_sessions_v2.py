...
class SearchSessionsV2(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ServiceGetSessionHistorySearchResponseV2], Union[None, HttpResponse, ResponseError, ResponseErrorV1]]:
