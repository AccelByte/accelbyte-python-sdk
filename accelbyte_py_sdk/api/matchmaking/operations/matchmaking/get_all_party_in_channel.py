...
class GetAllPartyInChannel(Operation):
    ...
    _url: str = "/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/parties"
    _method: str = "GET"
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ModelsMatchingParty]], Union[None, HttpResponse, ResponseError, ResponseErrorV1]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetAllPartyInChannel:
        instance = cls()
