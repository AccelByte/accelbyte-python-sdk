...
class GetAllChannelsHandler(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsGetChannelsResponse], Union[None, HttpResponse, ResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetAllChannelsHandler:
        instance = cls()
