...
class ModelsAllianceRuleV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsAllianceRuleV1, List[ModelsAllianceRuleV1], Dict[Any, ModelsAllianceRuleV1]]:
        if many:
