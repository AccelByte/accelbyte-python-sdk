...
class ServiceGetSessionHistorySearchResponseItemV2(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ServiceGetSessionHistorySearchResponseItemV2, List[ServiceGetSessionHistorySearchResponseItemV2]]:
        if many:
