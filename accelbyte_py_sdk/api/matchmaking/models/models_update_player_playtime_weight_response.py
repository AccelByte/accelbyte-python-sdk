...
class ModelsUpdatePlayerPlaytimeWeightResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdatePlayerPlaytimeWeightResponse, List[ModelsUpdatePlayerPlaytimeWeightResponse], Dict[Any, ModelsUpdatePlayerPlaytimeWeightResponse]]:
        if many:
