...
class ModelsActiveMatchmakingGameResponse(Model):
    ...
    def with_pagination(self, value: ModelsPagingCursor) -> ModelsActiveMatchmakingGameResponse:
        self.pagination = value
        return self

    def with_sessions(self, value: List[ModelsGameSession]) -> ModelsActiveMatchmakingGameResponse:
        self.sessions = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ModelsActiveMatchmakingGameResponse:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ModelsActiveMatchmakingGameResponse]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ModelsActiveMatchmakingGameResponse]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsActiveMatchmakingGameResponse, List[ModelsActiveMatchmakingGameResponse], Dict[Any, ModelsActiveMatchmakingGameResponse]]:
        if many:
