...
class ModelsAddPlayerRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsAddPlayerRequest, List[ModelsAddPlayerRequest], Dict[Any, ModelsAddPlayerRequest]]:
        if many:
