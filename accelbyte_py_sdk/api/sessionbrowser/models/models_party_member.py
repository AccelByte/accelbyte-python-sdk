...
class ModelsPartyMember(Model):
    ...
    def is_valid(self) -> bool:
        ...
        # required checks
        if not hasattr(self, "extra_attributes") or self.extra_attributes is None:
            return False
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsPartyMember, List[ModelsPartyMember]]:
        if many:
