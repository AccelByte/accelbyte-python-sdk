...
class ModelsAddPlayerResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsAddPlayerResponse, List[ModelsAddPlayerResponse], Dict[Any, ModelsAddPlayerResponse]]:
        if many:
