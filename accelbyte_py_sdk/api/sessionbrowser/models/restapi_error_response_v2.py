...
class RestapiErrorResponseV2(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[RestapiErrorResponseV2, List[RestapiErrorResponseV2], Dict[Any, RestapiErrorResponseV2]]:
        if many:
