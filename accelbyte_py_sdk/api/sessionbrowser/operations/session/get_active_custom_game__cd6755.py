...
class GetActiveCustomGameSessions(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsActiveCustomGameResponse], Union[None, HttpResponse, RestapiErrorResponseV2]]:
