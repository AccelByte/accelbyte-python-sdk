# Auto-generated at 2021-10-21T08:52:31.847693+08:00
...
class AdminGetSession(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsAdminSessionResponse], Union[None, RestapiErrorResponseV2]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetSession:
        instance = cls()
