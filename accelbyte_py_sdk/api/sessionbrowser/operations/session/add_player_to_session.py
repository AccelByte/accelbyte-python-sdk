...
class AddPlayerToSession(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsAddPlayerResponse], Union[None, HttpResponse, RestapiErrorResponseV2]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AddPlayerToSession:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsAddPlayerRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
