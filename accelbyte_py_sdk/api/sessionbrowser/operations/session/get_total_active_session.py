...
class GetTotalActiveSession(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsCountActiveSessionResponse], Union[None, HttpResponse, RestapiErrorResponseV2]]:
