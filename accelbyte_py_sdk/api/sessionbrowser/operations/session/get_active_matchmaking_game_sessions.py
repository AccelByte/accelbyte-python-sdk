# Auto-generated at 2021-10-21T08:52:31.845501+08:00
...
class GetActiveMatchmakingGameSessions(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsActiveMatchmakingGameResponse], Union[None, RestapiErrorResponseV2]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetActiveMatchmakingGameSessions:
        instance = cls()
