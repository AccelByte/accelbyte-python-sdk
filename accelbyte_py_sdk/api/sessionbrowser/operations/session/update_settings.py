...
class UpdateSettings(Operation):
    ...
    _url: str = "/sessionbrowser/namespaces/{namespace}/gamesession/{sessionID}/settings"
    _method: str = "PUT"
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsSessionResponse], Union[None, HttpResponse, RestapiErrorResponseV2]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateSettings:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsUpdateSettingsRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
