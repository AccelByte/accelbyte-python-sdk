...
class LegalReadinessStatusResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[LegalReadinessStatusResponse, List[LegalReadinessStatusResponse], Dict[Any, LegalReadinessStatusResponse]]:
        if many:
