...
class RetrievePolicyTypeResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[RetrievePolicyTypeResponse, List[RetrievePolicyTypeResponse], Dict[Any, RetrievePolicyTypeResponse]]:
        if many:
