...
class RetrievePolicyVersions(Operation):
    ...
    Properties:
        ...
        base_policy_id: (basePolicyId) OPTIONAL str in query

        locale_id: (localeId) OPTIONAL str in query
    ...
    _url: str = "/agreement/public/policies"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def get_query_params(self) -> dict:
        ...
        if hasattr(self, "locale_id"):
            result["localeId"] = self.locale_id
    ...
    def with_base_policy_id(self, value: str) -> RetrievePolicyVersions:
        self.base_policy_id = value
        return self

    def with_locale_id(self, value: str) -> RetrievePolicyVersions:
        self.locale_id = value
        return self

    def with_namespace(self, value: str) -> RetrievePolicyVersions:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "locale_id") and self.locale_id:
            result["localeId"] = str(self.locale_id)
        elif include_empty:
            result["localeId"] = str()
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> RetrievePolicyVersions:
        ...
        if "localeId" in dict_ and dict_["localeId"] is not None:
            instance.locale_id = str(dict_["localeId"])
        elif include_empty:
            instance.locale_id = str()
