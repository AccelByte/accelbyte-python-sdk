...
class RetrieveAllPoliciesFromBasePolicy(Operation):
    ...
    def with_base_policy_id(self, value: str) -> RetrieveAllPoliciesFromBasePolicy:
        self.base_policy_id = value
        return self

    def with_namespace(self, value: str) -> RetrieveAllPoliciesFromBasePolicy:
    ...
    def parse_response(
        ...
        Union[None, List[RetrievePoliciesFromBasePolicyResponse]],
        ...
        if code == 200:
            return [
                RetrievePoliciesFromBasePolicyResponse.create_from_dict(i)
                for i in content
            ], None
        if code == 404:
