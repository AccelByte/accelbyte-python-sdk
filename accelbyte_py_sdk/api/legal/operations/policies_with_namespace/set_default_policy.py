...
class SetDefaultPolicy(Operation):
    ...
    def with_namespace(self, value: str) -> SetDefaultPolicy:
        self.namespace = value
        return self

    def with_policy_id(self, value: str) -> SetDefaultPolicy:
    ...
    @classmethod
    def create(cls, namespace: str, policy_id: str, **kwargs) -> SetDefaultPolicy:
        instance = cls()
