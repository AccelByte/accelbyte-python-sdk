...
class OldRetrieveAllUsersByPolicyVersion(Operation):
    ...
    def with_keyword(self, value: str) -> OldRetrieveAllUsersByPolicyVersion:
        self.keyword = value
        return self

    def with_limit(self, value: int) -> OldRetrieveAllUsersByPolicyVersion:
        self.limit = value
        return self

    def with_offset(self, value: int) -> OldRetrieveAllUsersByPolicyVersion:
        self.offset = value
        return self

    def with_policy_version_id(self, value: str) -> OldRetrieveAllUsersByPolicyVersion:
