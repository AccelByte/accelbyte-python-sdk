...
class ChangePreferenceConsent(Operation):
    ...
    Change marketing preference consent.<br>Other detail info: <ul><li><i>Required
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ChangePreferenceConsent:
        instance = cls()
