...
class RetrieveSingleLocalizedPolicyVersion1(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, RetrieveLocalizedPolicyVersionPublicResponse], Union[None, ErrorEntity, HttpResponse]]:
