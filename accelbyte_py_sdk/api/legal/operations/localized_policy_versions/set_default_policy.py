...
class SetDefaultPolicy(Operation):
    ...
    Update a localized version policy to be the default.<br>Other detail info:
    ...
    _url: str = "/agreement/admin/localized-policy-versions/{localizedPolicyVersionId}/default"
    _method: str = "PATCH"
    _consumes: List[str] = []
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> SetDefaultPolicy:
        instance = cls()
