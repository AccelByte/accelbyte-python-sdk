...
class RequestPresignedURL(Operation):
    ...
    of base policy.<br>Other detail info: <ul><li><i>Required permission</i>:
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, UploadLocalizedPolicyVersionAttachmentResponse], Union[None, ErrorEntity]]:
