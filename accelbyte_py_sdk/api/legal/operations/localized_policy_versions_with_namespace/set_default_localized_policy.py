...
class SetDefaultLocalizedPolicy(Operation):
    ...
    def with_localized_policy_version_id(self, value: str) -> SetDefaultLocalizedPolicy:
        self.localized_policy_version_id = value
        return self

    def with_namespace(self, value: str) -> SetDefaultLocalizedPolicy:
