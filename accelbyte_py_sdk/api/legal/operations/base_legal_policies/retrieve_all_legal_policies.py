...
class RetrieveAllLegalPolicies(Operation):
    ...
    Retrieve all base policies.<br>Other detail info: <ul><li><i>Required
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[RetrieveBasePolicyResponse]], Union[None, HttpResponse]]:
        """Parse the given response.

        200: OK - List[RetrieveBasePolicyResponse] (successful operation)
        """
        if code == 200:
            return [RetrieveBasePolicyResponse.create_from_dict(i) for i in content], None
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> RetrieveAllLegalPolicies:
        instance = cls()
        return instance
