...
class RetrieveEligibilitiesPublic(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[RetrieveUserEligibilitiesResponse]], Union[None, HttpResponse]]:
        ...
        if code == 200:
            return [RetrieveUserEligibilitiesResponse.create_from_dict(i) for i in content], None
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> RetrieveEligibilitiesPublic:
        instance = cls()
