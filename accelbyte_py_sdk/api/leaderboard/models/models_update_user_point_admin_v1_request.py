...
class ModelsUpdateUserPointAdminV1Request(Model):
    ...
    def is_valid(self) -> bool:
        # pylint: no-self-use
        # required checks
        if not hasattr(self, "inc") or self.inc is None:
            return False
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateUserPointAdminV1Request, List[ModelsUpdateUserPointAdminV1Request]]:
        if many:
