...
class ModelsUserLeaderboardRanking(Model):
    ...
    def with_all_time(self, value: ModelsUserRankingResponseDetail) -> ModelsUserLeaderboardRanking:
        self.all_time = value
        return self

    def with_current(self, value: ModelsUserRankingResponseDetail) -> ModelsUserLeaderboardRanking:
        self.current = value
        return self

    def with_daily(self, value: ModelsUserRankingResponseDetail) -> ModelsUserLeaderboardRanking:
        self.daily = value
        return self
    ...
    def with_monthly(self, value: ModelsUserRankingResponseDetail) -> ModelsUserLeaderboardRanking:
        self.monthly = value
        return self
    ...
    def with_weekly(self, value: ModelsUserRankingResponseDetail) -> ModelsUserLeaderboardRanking:
        self.weekly = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ModelsUserLeaderboardRanking:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ModelsUserLeaderboardRanking]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ModelsUserLeaderboardRanking]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUserLeaderboardRanking, List[ModelsUserLeaderboardRanking], Dict[Any, ModelsUserLeaderboardRanking]]:
        if many:
