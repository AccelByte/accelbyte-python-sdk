...
class ModelsDeleteBulkLeaderboardSuccessResp(Model):
    """Models delete bulk leaderboard success resp (models.DeleteBulkLeaderboardSuccessResp)
    ...
    @classmethod
    def create(
        cls, leaderboard_code: str, **kwargs
    ) -> ModelsDeleteBulkLeaderboardSuccessResp:
        instance = cls()
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelsDeleteBulkLeaderboardSuccessResp]:
        return (
    ...
    ) -> List[ModelsDeleteBulkLeaderboardSuccessResp]:
        return (
    ...
    def create_from_any(
        ...
        ModelsDeleteBulkLeaderboardSuccessResp,
        List[ModelsDeleteBulkLeaderboardSuccessResp],
        Dict[Any, ModelsDeleteBulkLeaderboardSuccessResp],
    ]:
        if many:
