...
class ModelsWeeklyConfig(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsWeeklyConfig, List[ModelsWeeklyConfig], Dict[Any, ModelsWeeklyConfig]]:
        if many:
