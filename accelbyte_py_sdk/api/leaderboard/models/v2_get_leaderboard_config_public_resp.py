...
class V2GetLeaderboardConfigPublicResp(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[V2GetLeaderboardConfigPublicResp, List[V2GetLeaderboardConfigPublicResp]]:
        if many:
