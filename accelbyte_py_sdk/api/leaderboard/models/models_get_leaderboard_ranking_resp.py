...
class ModelsGetLeaderboardRankingResp(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsGetLeaderboardRankingResp, List[ModelsGetLeaderboardRankingResp], Dict[Any, ModelsGetLeaderboardRankingResp]]:
        if many:
