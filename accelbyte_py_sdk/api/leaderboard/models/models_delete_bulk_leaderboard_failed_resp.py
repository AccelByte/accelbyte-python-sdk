...
class ModelsDeleteBulkLeaderboardFailedResp(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsDeleteBulkLeaderboardFailedResp, List[ModelsDeleteBulkLeaderboardFailedResp], Dict[Any, ModelsDeleteBulkLeaderboardFailedResp]]:
        if many:
