...
class ModelsGetLeaderboardConfigResp(Model):
    ...
    def with_monthly(self, value: ModelsMonthlyConfig) -> ModelsGetLeaderboardConfigResp:
        self.monthly = value
        return self
    ...
    def is_valid(self) -> bool:
        ...
        if not hasattr(self, "icon_url") or self.icon_url is None:
            return False
        if not hasattr(self, "is_archived") or self.is_archived is None:
            return False
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ModelsGetLeaderboardConfigResp:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ModelsGetLeaderboardConfigResp]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ModelsGetLeaderboardConfigResp]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsGetLeaderboardConfigResp, List[ModelsGetLeaderboardConfigResp]]:
        if many:
