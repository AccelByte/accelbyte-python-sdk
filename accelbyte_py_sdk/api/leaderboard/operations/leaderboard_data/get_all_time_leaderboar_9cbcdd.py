...
class GetAllTimeLeaderboardRankingPublicV2(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, V2GetPublicLeaderboardRankingResponse], Union[None, HttpResponse, ResponseErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetAllTimeLeaderboardRankingPublicV2:
        instance = cls()
