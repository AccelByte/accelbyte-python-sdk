...
class GetCurrentSeasonLeaderboardRankingAdminV1(Operation):
    ...
    def with_leaderboard_code(self, value: str) -> GetCurrentSeasonLeaderboardRankingAdminV1:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetCurrentSeasonLeaderboardRankingAdminV1:
        instance = cls()
