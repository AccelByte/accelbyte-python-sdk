...
class GetCurrentMonthLeaderboardRankingAdminV1(Operation):
    ...
    def with_leaderboard_code(self, value: str) -> GetCurrentMonthLeaderboardRankingAdminV1:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetCurrentMonthLeaderboardRankingAdminV1:
        instance = cls()
