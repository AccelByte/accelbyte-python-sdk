...
class GetCurrentSeasonLeaderboardRankingPublicV1(Operation):
    ...
    def with_leaderboard_code(self, value: str) -> GetCurrentSeasonLeaderboardRankingPublicV1:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsGetLeaderboardRankingResp], Union[None, HttpResponse, ResponseErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetCurrentSeasonLeaderboardRankingPublicV1:
        instance = cls()
