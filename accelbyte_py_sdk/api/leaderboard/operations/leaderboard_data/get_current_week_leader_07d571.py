...
class GetCurrentWeekLeaderboardRankingPublicV1(Operation):
    ...
    def with_leaderboard_code(self, value: str) -> GetCurrentWeekLeaderboardRankingPublicV1:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetCurrentWeekLeaderboardRankingPublicV1:
        instance = cls()
