...
class GetCurrentMonthLeaderboardRankingPublicV1(Operation):
    ...
    def with_leaderboard_code(self, value: str) -> GetCurrentMonthLeaderboardRankingPublicV1:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetCurrentMonthLeaderboardRankingPublicV1:
        instance = cls()
