...
class GetCurrentWeekLeaderboardRankingAdminV1(Operation):
    ...
    def with_leaderboard_code(self, value: str) -> GetCurrentWeekLeaderboardRankingAdminV1:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetCurrentWeekLeaderboardRankingAdminV1:
        instance = cls()
