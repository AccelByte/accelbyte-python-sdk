...
class DeleteAllUserRankingByCycleIdAdminV3(Operation):
    ...
    _url: str = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/cycles/{cycleId}/reset"
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    def with_cycle_id(self, value: str) -> DeleteAllUserRankingByCycleIdAdminV3:
        self.cycle_id = value
        return self

    def with_leaderboard_code(self, value: str) -> DeleteAllUserRankingByCycleIdAdminV3:
        self.leaderboard_code = value
        return self

    def with_namespace(self, value: str) -> DeleteAllUserRankingByCycleIdAdminV3:
    ...
    @classmethod
    def create(
        cls, cycle_id: str, leaderboard_code: str, namespace: str, **kwargs
