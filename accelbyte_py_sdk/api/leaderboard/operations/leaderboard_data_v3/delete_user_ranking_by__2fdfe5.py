...
class DeleteUserRankingByCycleIdAdminV3(Operation):
    ...
    _url: str = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/cycles/{cycleId}/users/{userId}"
    _method: str = "DELETE"
    ...
    def with_cycle_id(self, value: str) -> DeleteUserRankingByCycleIdAdminV3:
        self.cycle_id = value
        return self

    def with_leaderboard_code(self, value: str) -> DeleteUserRankingByCycleIdAdminV3:
        self.leaderboard_code = value
        return self

    def with_namespace(self, value: str) -> DeleteUserRankingByCycleIdAdminV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> DeleteUserRankingByCycleIdAdminV3:
        self.user_id = value
        return self
