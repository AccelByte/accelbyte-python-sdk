...
class SetUserVisibilityStatusV2(Operation):
    ...
    def with_body(self, value: ModelsSetUserVisibilityRequest) -> SetUserVisibilityStatusV2:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> SetUserVisibilityStatusV2:
        instance = cls()
