...
class DeleteLeaderboardConfigurationAdminV1(Operation):
    ...
    def with_leaderboard_code(self, value: str) -> DeleteLeaderboardConfigurationAdminV1:
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[None, Union[None, HttpResponse, ResponseErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> DeleteLeaderboardConfigurationAdminV1:
        instance = cls()
