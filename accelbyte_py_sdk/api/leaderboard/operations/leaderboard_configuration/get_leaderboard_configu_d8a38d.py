...
class GetLeaderboardConfigurationsPublicV2(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, V2GetAllLeaderboardConfigsPublicResp], Union[None, HttpResponse, ResponseErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetLeaderboardConfigurationsPublicV2:
        instance = cls()
