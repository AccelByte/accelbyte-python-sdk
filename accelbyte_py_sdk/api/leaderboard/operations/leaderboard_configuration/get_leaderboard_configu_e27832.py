...
class GetLeaderboardConfigurationsPublicV1(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsGetAllLeaderboardConfigsPublicResp], Union[None, ResponseErrorResponse]]:
