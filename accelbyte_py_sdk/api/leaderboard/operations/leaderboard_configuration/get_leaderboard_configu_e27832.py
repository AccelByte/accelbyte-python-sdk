...
class GetLeaderboardConfigurationsPublicV1(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsGetAllLeaderboardConfigsPublicResp], Union[None, HttpResponse, ResponseErrorResponse]]:
        ...
        if code == 200:
            return ModelsGetAllLeaderboardConfigsPublicResp.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetLeaderboardConfigurationsPublicV1:
        instance = cls()
