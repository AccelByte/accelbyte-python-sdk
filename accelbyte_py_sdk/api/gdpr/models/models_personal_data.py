...
class ModelsPersonalData(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsPersonalData, List[ModelsPersonalData], Dict[Any, ModelsPersonalData]]:
        if many:
