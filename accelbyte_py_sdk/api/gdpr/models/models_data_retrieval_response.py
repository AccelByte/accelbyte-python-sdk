...
class ModelsDataRetrievalResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsDataRetrievalResponse, List[ModelsDataRetrievalResponse], Dict[Any, ModelsDataRetrievalResponse]]:
        if many:
