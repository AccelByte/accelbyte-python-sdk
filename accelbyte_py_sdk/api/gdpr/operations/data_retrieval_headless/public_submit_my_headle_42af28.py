...
class PublicSubmitMyHeadlessPersonalDataRequest(Operation):
    ...
    **Typically used by web portal** to invoke headless player GDPR using 3rd platform web authentication.
    ...
    _url: str = "/gdpr/public/users/me/headless/requests"
    _method: str = "POST"
    ...
    def with_email(self, value: str) -> PublicSubmitMyHeadlessPersonalDataRequest:
        self.email = value
        return self
    ...
    @classmethod
    def create(
        cls, email: Optional[str] = None, language_tag: Optional[str] = None, **kwargs
    ) -> PublicSubmitMyHeadlessPersonalDataRequest:
        instance = cls()
