...
class PublicGenerateMyHeadlessPersonalDataURL(Operation):
    ...
    **Typically used by web portal** to invoke headless player GDPR using 3rd platform web authentication.
    ...
    _url: str = "/gdpr/public/users/me/headless/requests/{requestDate}/generate"
    _method: str = "POST"
    _consumes: List[str] = ["*/*"]
    ...
    def with_request_date(self, value: str) -> PublicGenerateMyHeadlessPersonalDataURL:
