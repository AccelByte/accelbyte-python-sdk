...
class PublicCancelUserPersonalDataRequest(Operation):
    ...
    _url: str = "/gdpr/public/namespaces/{namespace}/users/{userId}/requests/{requestDate}"
    _method: str = "DELETE"
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicCancelUserPersonalDataRequest:
        instance = cls()
