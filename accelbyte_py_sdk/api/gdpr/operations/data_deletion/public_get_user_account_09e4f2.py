...
class PublicGetUserAccountDeletionStatus(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsDeletionStatus], Union[None, HttpResponse, ResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetUserAccountDeletionStatus:
        instance = cls()
