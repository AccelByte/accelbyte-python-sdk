...
class AdminGetListDeletionDataRequest(Operation):
    ...
    <code>ADMIN:NAMESPACE:{namespace}:INFORMATION:USER[READ]</code> and scope
    <code>account</code></p>
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsListDeletionDataResponse], Union[None, ResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminGetListDeletionDataRequest:
        instance = cls()
