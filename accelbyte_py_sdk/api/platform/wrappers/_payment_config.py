...
def create_payment_provider_config(body: Optional[PaymentProviderConfigEdit] = None):
...
def debug_matched_payment_merchant_config(namespace: Optional[str] = None, region: Optional[str] = None):
...
def debug_matched_payment_provider_config(namespace: Optional[str] = None, region: Optional[str] = None):
...
def delete_payment_provider_config(id_: str):
...
def get_payment_merchant_config(id_: str):
...
def query_payment_provider_config(namespace: Optional[str] = None, region: Optional[str] = None, offset: Optional[int] = None, limit: Optional[int] = None):
...
def test_adyen_config(body: Optional[AdyenConfig] = None, sandbox: Optional[bool] = None):
...
def test_adyen_config_by_id(id_: str, sandbox: Optional[bool] = None):
...
def test_ali_pay_config(body: Optional[AliPayConfig] = None, sandbox: Optional[bool] = None):
...
def test_ali_pay_config_by_id(id_: str, sandbox: Optional[bool] = None):
...
def test_checkout_config(body: Optional[CheckoutConfig] = None, sandbox: Optional[bool] = None):
...
def test_checkout_config_by_id(id_: str, sandbox: Optional[bool] = None):
...
def test_pay_pal_config(body: Optional[PayPalConfig] = None, sandbox: Optional[bool] = None):
...
def test_pay_pal_config_by_id(id_: str, sandbox: Optional[bool] = None):
...
def test_stripe_config(body: Optional[StripeConfig] = None, sandbox: Optional[bool] = None):
...
def test_stripe_config_by_id(id_: str, sandbox: Optional[bool] = None):
...
def test_wx_pay_config(body: Optional[WxPayConfigRequest] = None):
...
def test_wx_pay_config_by_id(id_: str):
...
def test_xsolla_config(body: Optional[XsollaConfig] = None):
...
def test_xsolla_config_by_id(id_: str):
...
def update_adyen_config(id_: str, body: Optional[AdyenConfig] = None, validate: Optional[bool] = None, sandbox: Optional[bool] = None):
...
def update_ali_pay_config(id_: str, body: Optional[AliPayConfig] = None, validate: Optional[bool] = None, sandbox: Optional[bool] = None):
...
def update_checkout_config(id_: str, body: Optional[CheckoutConfig] = None, validate: Optional[bool] = None, sandbox: Optional[bool] = None):
...
def update_pay_pal_config(id_: str, body: Optional[PayPalConfig] = None, validate: Optional[bool] = None, sandbox: Optional[bool] = None):
...
def update_payment_provider_config(id_: str, body: Optional[PaymentProviderConfigEdit] = None):
...
def update_payment_tax_config(body: Optional[PaymentTaxConfigEdit] = None):
...
def update_stripe_config(id_: str, body: Optional[StripeConfig] = None, validate: Optional[bool] = None, sandbox: Optional[bool] = None):
...
def update_wx_pay_config(id_: str, body: Optional[WxPayConfigRequest] = None, validate: Optional[bool] = None):
...
def update_wx_pay_config_cert(id_: str, file: Optional[Any] = None):
...
def update_xsolla_config(id_: str, body: Optional[XsollaConfig] = None, validate: Optional[bool] = None):
...
def update_xsolla_ui_config(id_: str, body: Optional[XsollaPaywallConfigRequest] = None):
