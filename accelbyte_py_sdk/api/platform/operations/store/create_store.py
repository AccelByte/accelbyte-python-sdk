...
class CreateStore(Operation):
    ...
    This API is used to create a non published store in a namespace.<p>Other
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> CreateStore:
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = StoreCreate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
