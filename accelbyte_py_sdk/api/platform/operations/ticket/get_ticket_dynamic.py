# Auto-generated at 2021-10-21T08:52:30.948453+08:00
...
class GetTicketDynamic(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, TicketDynamicInfo], Union[None, ErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetTicketDynamic:
        instance = cls()
