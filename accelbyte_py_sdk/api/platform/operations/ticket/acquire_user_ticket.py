# Auto-generated at 2021-10-21T08:52:30.957563+08:00
...
class AcquireUserTicket(Operation):
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/users/{userId}/tickets/{boothName}"
    _method: str = "POST"
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, TicketAcquireResult], Union[None, ErrorEntity, ValidationErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AcquireUserTicket:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = TicketAcquireRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
