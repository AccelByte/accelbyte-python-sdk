...
class GetUserOrderHistories(Operation):
    ...
    Get user order history.<br>Other detail info: <ul><li><i>Required
    permission</i>: resource="ADMIN:NAMESPACE:{namespace}:USER:{userId}:ORDER",
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/users/{userId}/orders/{orderNo}/history"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[OrderHistoryInfo]], Union[None, HttpResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserOrderHistories:
        instance = cls()
