# Auto-generated at 2021-09-21T14:10:39.160048+08:00
...
class FulfillUserOrder(Operation):
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/users/{userId}/orders/{orderNo}/fulfill"
    _method: str = "PUT"
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, OrderInfo], Union[None, ErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> FulfillUserOrder:
        instance = cls()
