# Auto-generated at 2021-09-27T17:01:29.880262+08:00
...
class PublicGetUserOrder(Operation):
    ...
    _url: str = "/platform/public/namespaces/{namespace}/users/{userId}/orders/{orderNo}"
    _method: str = "GET"
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetUserOrder:
        instance = cls()
