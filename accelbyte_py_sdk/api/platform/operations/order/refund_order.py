# Auto-generated at 2021-09-21T14:10:39.140566+08:00
...
class RefundOrder(Operation):
    ...
    Responses:
        ...
        409: Conflict - ErrorEntity (ErrorCode: 32171 | ErrorMessage: Order [{orderNo}] is not refundable)
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> RefundOrder:
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = OrderRefundCreate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
