...
class BulkFulfillItemsV3(Operation):
    ...
    body: List[FulfillmentV3Request]  # REQUIRED in [body]
    ...
    def with_body(self, value: List[FulfillmentV3Request]) -> BulkFulfillItemsV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> BulkFulfillItemsV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> BulkFulfillItemsV3:
        self.user_id = value
        return self
    ...
    def parse_response(
    ...
    ) -> Tuple[Union[None, List[FulfillmentV2Result]], Union[None, HttpResponse]]:
        ...
        if code == 200:
            return [FulfillmentV2Result.create_from_dict(i) for i in content], None
    ...
    @classmethod
    def create(
        cls, body: List[FulfillmentV3Request], namespace: str, user_id: str, **kwargs
    ) -> BulkFulfillItemsV3:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = [
                FulfillmentV3Request.create_from_dict(i0, include_empty=include_empty)
