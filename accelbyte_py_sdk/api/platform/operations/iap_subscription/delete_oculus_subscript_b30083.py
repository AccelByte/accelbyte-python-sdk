...
class DeleteOculusSubscriptionTier(Operation):
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/iap/config/oculus/subscription/tier/{sku}"
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> DeleteOculusSubscriptionTier:
        self.namespace = value
        return self

    def with_sku(self, value: str) -> DeleteOculusSubscriptionTier:
        self.sku = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, sku: str, **kwargs) -> DeleteOculusSubscriptionTier:
        instance = cls()
