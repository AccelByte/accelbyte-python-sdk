...
class AddTierIntoMetaQuestSubscriptionGroup(Operation):
    ...
    body: ThirdPartySubscriptionTierCreate  # OPTIONAL in [body]
    ...
    def with_body(
        self, value: ThirdPartySubscriptionTierCreate
    ) -> AddTierIntoMetaQuestSubscriptionGroup:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AddTierIntoMetaQuestSubscriptionGroup:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ThirdPartySubscriptionTierCreate()
    ...
    def parse_response(
        ...
        Union[None, ThirdPartySubscriptionTierInfo],
        ...
        if code == 200:
            return ThirdPartySubscriptionTierInfo.create_from_dict(content), None
        if code == 409:
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ThirdPartySubscriptionTierCreate.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ThirdPartySubscriptionTierCreate()
