...
class CreateOculusSubscriptionGroup(Operation):
    ...
    body: ThirdPartySubscriptionGroupCreate  # OPTIONAL in [body]
    ...
    def with_body(
        self, value: ThirdPartySubscriptionGroupCreate
    ) -> CreateOculusSubscriptionGroup:
        self.body = value
        return self

    def with_namespace(self, value: str) -> CreateOculusSubscriptionGroup:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ThirdPartySubscriptionGroupCreate()
    ...
    def parse_response(
        ...
        Union[None, ThirdPartySubscriptionGroupInfo],
        ...
        if code == 200:
            return ThirdPartySubscriptionGroupInfo.create_from_dict(content), None
        if code == 409:
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ThirdPartySubscriptionGroupCreate.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ThirdPartySubscriptionGroupCreate()
