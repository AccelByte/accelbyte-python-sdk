...
class ListOculusSubscriptionGroups(Operation):
    ...
    def with_namespace(self, value: str) -> ListOculusSubscriptionGroups:
    ...
    def parse_response(
        ...
        Union[None, List[ThirdPartySubscriptionGroupInfo]], Union[None, HttpResponse]
    ]:
        ...
        if code == 200:
            return [
                ThirdPartySubscriptionGroupInfo.create_from_dict(i) for i in content
            ], None
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> ListOculusSubscriptionGroups:
        instance = cls()
