...
class ListOculusSubscriptionGroupTier(Operation):
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/iap/config/oculus/subscription/group/{sku}/tiers"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> ListOculusSubscriptionGroupTier:
        self.namespace = value
        return self

    def with_sku(self, value: str) -> ListOculusSubscriptionGroupTier:
        self.sku = value
        return self
    ...
    def parse_response(
        ...
        Union[None, List[ThirdPartySubscriptionTierInfo]], Union[None, HttpResponse]
    ]:
        ...
        if code == 200:
            return [
                ThirdPartySubscriptionTierInfo.create_from_dict(i) for i in content
            ], None
