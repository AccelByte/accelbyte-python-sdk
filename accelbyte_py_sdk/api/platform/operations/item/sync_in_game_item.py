# Auto-generated at 2021-09-21T14:10:38.903757+08:00
...
class SyncInGameItem(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> SyncInGameItem:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = InGameItemSync.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
