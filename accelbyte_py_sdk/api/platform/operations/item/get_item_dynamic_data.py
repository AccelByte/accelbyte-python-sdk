...
class GetItemDynamicData(Operation):
    ...
    Get item dynamic data for published item.<br>Other detail info:
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ItemDynamicDataInfo], Union[None, ErrorEntity]]:
