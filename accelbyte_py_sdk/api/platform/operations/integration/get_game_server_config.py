# Auto-generated at 2021-10-21T08:52:31.269265+08:00
...
class GetGameServerConfig(Operation):
    ...
    Responses:
        ...
        404: Not Found - ErrorEntity (39241: Game server config for [{namespace}] does not exist)
    """
    ...
    def with_namespace(self, value: str) -> GetGameServerConfig:
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, GameServerConfig], Union[None, ErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetGameServerConfig:
        instance = cls()
