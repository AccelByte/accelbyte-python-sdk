...
class PublicGetUserAppEntitlementByAppId(Operation):
    ...
    _url: str = "/platform/public/namespaces/{namespace}/users/{userId}/entitlements/byAppId"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, AppEntitlementInfo], Union[None, ErrorEntity, HttpResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetUserAppEntitlementByAppId:
        instance = cls()
