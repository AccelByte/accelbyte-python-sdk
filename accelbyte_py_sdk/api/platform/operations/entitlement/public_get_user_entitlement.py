...
class PublicGetUserEntitlement(Operation):
    ...
    Get user entitlement.<p>Other detail info: <ul><li><i>Required permission</i>:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetUserEntitlement:
        instance = cls()
