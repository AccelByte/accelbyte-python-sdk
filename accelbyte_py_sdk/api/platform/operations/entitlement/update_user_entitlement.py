# Auto-generated at 2021-09-21T14:10:38.996999+08:00
...
class UpdateUserEntitlement(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, EntitlementInfo], Union[None, ErrorEntity, ValidationErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateUserEntitlement:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = EntitlementUpdate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
