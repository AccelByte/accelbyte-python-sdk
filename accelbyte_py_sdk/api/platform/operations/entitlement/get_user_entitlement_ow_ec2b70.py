...
class GetUserEntitlementOwnershipByItemId(Operation):
    ...
    def is_valid(self) -> bool:
        ...
        if not hasattr(self, "item_id") or self.item_id is None:
            return False
        # enum checks
        if hasattr(self, "entitlement_clazz") and self.entitlement_clazz is not None and self.entitlement_clazz not in GetUserEntitlementOwnershipByItemId.get_enum_map()["entitlementClazz"]:
            return False
        # pattern checks
        return True
    ...
    def with_entitlement_clazz(self, value: str) -> GetUserEntitlementOwnershipByItemId:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserEntitlementOwnershipByItemId:
        instance = cls()
