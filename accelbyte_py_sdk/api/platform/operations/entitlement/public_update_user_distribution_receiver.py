...
class PublicUpdateUserDistributionReceiver(Operation):
    ...
    not exist.<br>Other detail info: <ul><li><i>Required permission</i>:
    ...
    Responses:
        204: No Content - (update distribution receiver successfully)
    """
    ...
    def with_body(self, value: DistributionReceiverCreate) -> PublicUpdateUserDistributionReceiver:
        self.body = value
        return self

    def with_ext_user_id(self, value: str) -> PublicUpdateUserDistributionReceiver:
        self.ext_user_id = value
        return self

    def with_namespace(self, value: str) -> PublicUpdateUserDistributionReceiver:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> PublicUpdateUserDistributionReceiver:
        self.user_id = value
        return self
    ...
    ) -> PublicUpdateUserDistributionReceiver:
        instance = cls()
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicUpdateUserDistributionReceiver:
        instance = cls()
