# Auto-generated at 2021-09-21T14:10:38.987217+08:00
...
class GetUserEntitlementBySku(Operation):
    ...
    Responses:
        ...
        404: Not Found - ErrorEntity (ErrorCode: 31143 | ErrorMessage: Entitlement with sku [{sku}] does not exist in namespace [{namespace}])
    """

    # region fields

    _url: str = "/platform/admin/namespaces/{namespace}/users/{userId}/entitlements/bySku"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_entitlement_clazz(self, value: str) -> GetUserEntitlementBySku:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserEntitlementBySku:
        instance = cls()
