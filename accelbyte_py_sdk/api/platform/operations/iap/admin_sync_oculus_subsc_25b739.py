...
class AdminSyncOculusSubscriptions(Operation):
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/users/{userId}/iap/oculus/subscription/sync"
    _method: str = "PUT"
    ...
    body: OculusSubscriptionSyncRequest  # OPTIONAL in [body]
    ...
    def with_body(
        self, value: OculusSubscriptionSyncRequest
    ) -> AdminSyncOculusSubscriptions:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminSyncOculusSubscriptions:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminSyncOculusSubscriptions:
        self.user_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = OculusSubscriptionSyncRequest()
    ...
    def parse_response(
        ...
        Union[None, List[ThirdPartySubscriptionTransactionInfo]],
        ...
        if code == 200:
            return [
                ThirdPartySubscriptionTransactionInfo.create_from_dict(i)
                for i in content
            ], None
        if code == 400:
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = OculusSubscriptionSyncRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = OculusSubscriptionSyncRequest()
