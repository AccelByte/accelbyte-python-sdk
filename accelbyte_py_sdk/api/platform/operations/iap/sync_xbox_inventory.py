# Auto-generated at 2021-10-14T22:17:17.404442+08:00
...
class SyncXboxInventory(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[XblReconcileResult]], Union[None, HttpResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> SyncXboxInventory:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = XblReconcileRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
