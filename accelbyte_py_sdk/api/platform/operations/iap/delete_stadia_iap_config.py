...
class DeleteStadiaIAPConfig(Operation):
    ...
    Delete stadia iap config.<br>Other detail info: <ul><li><i>Required
    ...
    def with_namespace(self, value: str) -> DeleteStadiaIAPConfig:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> DeleteStadiaIAPConfig:
        instance = cls()
