...
class PublicReconcilePlayStationStore(Operation):
    ...
    Synchronize with entitlements in PSN Store.<p>Other detail info:
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[PlayStationReconcileResult]], Union[None, ErrorEntity]]:
