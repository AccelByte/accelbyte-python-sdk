# Auto-generated at 2021-10-21T08:52:31.243567+08:00
...
class GetXblIAPConfig(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, XblIAPConfigInfo], Union[None, ErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetXblIAPConfig:
        instance = cls()
