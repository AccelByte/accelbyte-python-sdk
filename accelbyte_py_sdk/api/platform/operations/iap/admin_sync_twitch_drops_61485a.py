...
class AdminSyncTwitchDropsEntitlement(Operation):
    ...
    *  Returns :
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/users/{userId}/iap/twitch/sync"
    _method: str = "PUT"
    ...
    def with_body(self, value: TwitchSyncRequest) -> AdminSyncTwitchDropsEntitlement:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminSyncTwitchDropsEntitlement:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminSyncTwitchDropsEntitlement:
        self.user_id = value
        return self
