...
class SyncOculusSubscriptions(Operation):
    ...
    _url: str = "/platform/public/namespaces/{namespace}/users/{userId}/iap/oculus/subscription/sync"
    _method: str = "PUT"
    ...
    def with_namespace(self, value: str) -> SyncOculusSubscriptions:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> SyncOculusSubscriptions:
        self.user_id = value
        return self
