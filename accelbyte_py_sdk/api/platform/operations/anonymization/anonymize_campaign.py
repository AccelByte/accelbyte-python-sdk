...
class AnonymizeCampaign(Operation):
    ...
    Anonymize campaign. At current it will only anonymize redeem history.<br>Other
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/users/{userId}/anonymization/campaign"
    _method: str = "DELETE"
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AnonymizeCampaign:
        instance = cls()
