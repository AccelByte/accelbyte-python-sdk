...
class AnonymizeEntitlement(Operation):
    ...
    entitlement history.<br>Other detail info: <ul><li><i>Required permission</i>:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AnonymizeEntitlement:
        instance = cls()
