...
class UpdatePaymentTaxConfig(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, PaymentTaxConfigInfo], Union[None, ErrorEntity, HttpResponse, ValidationErrorEntity]]:
