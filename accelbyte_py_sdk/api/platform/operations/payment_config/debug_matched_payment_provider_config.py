# Auto-generated at 2021-10-14T22:17:17.599740+08:00
...
class DebugMatchedPaymentProviderConfig(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, PaymentProviderConfigInfo], Union[None, ErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> DebugMatchedPaymentProviderConfig:
        instance = cls()
