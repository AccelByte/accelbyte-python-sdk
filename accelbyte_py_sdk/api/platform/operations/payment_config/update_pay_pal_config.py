...
class UpdatePayPalConfig(Operation):
    ...
    Update PayPal config.<br>Other detail info: <ul><li><i>Required
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdatePayPalConfig:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = PayPalConfig.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
