...
class GetAggregatePaymentProviders(Operation):
    ...
    Get aggregate payment providers, such as XSOLLA, ADYEN.<br>Other detail info:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetAggregatePaymentProviders:
        instance = cls()
        return instance
