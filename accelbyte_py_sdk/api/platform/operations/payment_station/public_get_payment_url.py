# Auto-generated at 2021-09-21T14:10:39.335714+08:00
...
class PublicGetPaymentUrl(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, PaymentUrl], Union[None, ErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetPaymentUrl:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = PaymentUrlCreate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
