# Auto-generated at 2021-10-14T22:17:17.553853+08:00
...
class PublicGetUnpaidPaymentOrder(Operation):
    ...
    _url: str = "/platform/public/namespaces/{namespace}/payment/orders/{paymentOrderNo}/info"
    _method: str = "GET"
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, PaymentOrderDetails], Union[None, ErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetUnpaidPaymentOrder:
        instance = cls()
