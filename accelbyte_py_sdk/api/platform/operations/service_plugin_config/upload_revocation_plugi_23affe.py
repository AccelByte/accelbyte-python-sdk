...
class UploadRevocationPluginConfigCertV2(Operation):
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/revocation/plugins/revocation/customConfig/cert"
    _method: str = "PUT"
    ...
    def with_file(self, value: Any) -> UploadRevocationPluginConfigCertV2:
        self.file = value
        return self

    def with_namespace(self, value: str) -> UploadRevocationPluginConfigCertV2:
