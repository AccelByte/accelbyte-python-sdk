...
class QueryUserSubscriptions(Operation):
    ...
    def with_charge_status(self, value: Union[str, ChargeStatusEnum]) -> QueryUserSubscriptions:
    ...
    def with_subscribed_by(self, value: Union[str, SubscribedByEnum]) -> QueryUserSubscriptions:
