# Auto-generated at 2021-10-14T22:17:16.543685+08:00
...
class GetDescendantCategories(Operation):
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/categories/{categoryPath}/descendants"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetDescendantCategories:
        instance = cls()
