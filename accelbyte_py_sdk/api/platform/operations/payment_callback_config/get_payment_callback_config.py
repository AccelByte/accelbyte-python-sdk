...
class GetPaymentCallbackConfig(Operation):
    ...
    Get payment callback configuration.<br>Other detail info: <ul><li><i>Required
    permission</i>: resource="ADMIN:NAMESPACE:{namespace}:PAYMENT:CONFIG",
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, PaymentCallbackConfigInfo], Union[None, ErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetPaymentCallbackConfig:
        instance = cls()
