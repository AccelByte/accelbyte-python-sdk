...
class CreatePaymentOrderByDedicated(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, PaymentOrderCreateResult], Union[None, ErrorEntity, HttpResponse, ValidationErrorEntity]]:
