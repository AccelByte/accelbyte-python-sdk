...
class PublicSyncPsnDlcInventory(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicSyncPsnDlcInventory:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = PlayStationDLCSyncRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
