...
class GetDLCItemConfig(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, DLCItemConfigInfo], Union[None, ErrorEntity, HttpResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetDLCItemConfig:
        instance = cls()
