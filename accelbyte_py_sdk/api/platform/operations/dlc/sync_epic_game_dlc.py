...
class SyncEpicGameDLC(Operation):
    ...
    _url: str = "/platform/public/namespaces/{namespace}/users/{userId}/dlc/epicgames/sync"
    _method: str = "PUT"
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> SyncEpicGameDLC:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = EpicGamesDLCSyncRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
