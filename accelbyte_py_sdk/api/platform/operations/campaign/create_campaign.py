# Auto-generated at 2021-10-21T08:52:30.903030+08:00
...
class CreateCampaign(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> CreateCampaign:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = CampaignCreate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
