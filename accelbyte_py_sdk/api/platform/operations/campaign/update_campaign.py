...
class UpdateCampaign(Operation):
    ...
    Update campaign.<br>Other detail info: <ul><li><i>Required permission</i>:
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, CampaignInfo], Union[None, ErrorEntity, ValidationErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateCampaign:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = CampaignUpdate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
