...
class ResetPlatformWalletConfig(Operation):
    ...
    def with_platform(self, value: Union[str, PlatformEnum]) -> ResetPlatformWalletConfig:
        self.platform = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ResetPlatformWalletConfig:
        instance = cls()
