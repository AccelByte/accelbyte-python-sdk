...
class EnableUserWallet(Operation):
    ...
    enable a user wallet.<br>Other detail info: <ul><li><i>Required
    permission</i>: resource="ADMIN:NAMESPACE:{namespace}:USER:{userId}:WALLET",
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> EnableUserWallet:
        instance = cls()
