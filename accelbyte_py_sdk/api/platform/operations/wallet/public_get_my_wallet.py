# Auto-generated at 2021-09-21T14:10:39.115645+08:00
...
class PublicGetMyWallet(Operation):
    ...
    _url: str = "/platform/public/namespaces/{namespace}/users/me/wallets/{currencyCode}"
    _method: str = "GET"
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetMyWallet:
        instance = cls()
