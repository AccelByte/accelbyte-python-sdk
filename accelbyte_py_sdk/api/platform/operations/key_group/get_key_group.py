...
class GetKeyGroup(Operation):
    ...
    Get key group.<br>Other detail info: <ul><li><i>Required permission</i>:
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, KeyGroupInfo], Union[None, ErrorEntity]]:
