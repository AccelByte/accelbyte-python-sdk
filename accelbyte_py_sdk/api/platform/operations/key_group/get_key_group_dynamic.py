# Auto-generated at 2021-10-21T08:52:30.936535+08:00
...
class GetKeyGroupDynamic(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, KeyGroupDynamicInfo], Union[None, ErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetKeyGroupDynamic:
        instance = cls()
