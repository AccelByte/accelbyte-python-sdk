...
class ADTOObjectForUpdateXboxAchievementCompletePercentageAPI(Model):
    ...
    def with_achievements(self, value: List[XboxAchievementRequest]) -> ADTOObjectForUpdateXboxAchievementCompletePercentageAPI:
        self.achievements = value
        return self

    def with_service_config_id(self, value: str) -> ADTOObjectForUpdateXboxAchievementCompletePercentageAPI:
        self.service_config_id = value
        return self

    def with_title_id(self, value: str) -> ADTOObjectForUpdateXboxAchievementCompletePercentageAPI:
        self.title_id = value
        return self

    def with_xbox_user_id(self, value: str) -> ADTOObjectForUpdateXboxAchievementCompletePercentageAPI:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ADTOObjectForUpdateXboxAchievementCompletePercentageAPI:
        instance = cls()
        if not dict_:
            return instance
        if "achievements" in dict_ and dict_["achievements"] is not None:
            instance.achievements = [XboxAchievementRequest.create_from_dict(i0, include_empty=include_empty) for i0 in dict_["achievements"]]
        elif include_empty:
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ADTOObjectForUpdateXboxAchievementCompletePercentageAPI]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ADTOObjectForUpdateXboxAchievementCompletePercentageAPI]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ADTOObjectForUpdateXboxAchievementCompletePercentageAPI, List[ADTOObjectForUpdateXboxAchievementCompletePercentageAPI], Dict[Any, ADTOObjectForUpdateXboxAchievementCompletePercentageAPI]]:
        if many:
