...
class GoogleIAPReceipt(Model):
    ...
    def is_valid(self) -> bool:
        ...
        if not hasattr(self, "order_id") or self.order_id is None:
            return False
        if not hasattr(self, "package_name") or self.package_name is None:
            return False
        if not hasattr(self, "product_id") or self.product_id is None:
            return False
        if not hasattr(self, "purchase_time") or self.purchase_time is None:
            return False
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, GoogleIAPReceipt]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[GoogleIAPReceipt]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[GoogleIAPReceipt, List[GoogleIAPReceipt]]:
        if many:
