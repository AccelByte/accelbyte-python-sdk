...
class EntitlementDecrement(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[EntitlementDecrement, List[EntitlementDecrement], Dict[Any, EntitlementDecrement]]:
        if many:
