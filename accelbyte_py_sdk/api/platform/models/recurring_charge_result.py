...
class RecurringChargeResult(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[RecurringChargeResult, List[RecurringChargeResult], Dict[Any, RecurringChargeResult]]:
        if many:
