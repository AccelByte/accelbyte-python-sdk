...
class PlayStationReconcileRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[PlayStationReconcileRequest, List[PlayStationReconcileRequest], Dict[Any, PlayStationReconcileRequest]]:
        if many:
