...
class ThirdPartySubscriptionTierCreate(Model):
    """Third party subscription tier create (ThirdPartySubscriptionTierCreate)
    ...
    def with_group_sku(self, value: str) -> ThirdPartySubscriptionTierCreate:
        self.group_sku = value
        return self

    def with_sku(self, value: str) -> ThirdPartySubscriptionTierCreate:
        self.sku = value
        return self
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ThirdPartySubscriptionTierCreate]:
        return (
    ...
    ) -> List[ThirdPartySubscriptionTierCreate]:
        return (
    ...
    def create_from_any(
        ...
        ThirdPartySubscriptionTierCreate,
        List[ThirdPartySubscriptionTierCreate],
        Dict[Any, ThirdPartySubscriptionTierCreate],
    ]:
        if many:
