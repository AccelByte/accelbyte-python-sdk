...
class AppUpdate(Model):
    ...
    def with_genres(self, value: List[Union[str, GenresEnum]]) -> AppUpdate:
        self.genres = value
        return self
    ...
    def with_platforms(self, value: List[Union[str, PlatformsEnum]]) -> AppUpdate:
        self.platforms = value
        return self

    def with_players(self, value: List[Union[str, PlayersEnum]]) -> AppUpdate:
        self.players = value
        return self
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, AppUpdate]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[AppUpdate]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[AppUpdate, List[AppUpdate], Dict[Any, AppUpdate]]:
        if many:
