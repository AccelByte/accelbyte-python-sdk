...
class PopulatedItemInfo(Model):
    ...
    def with_entitlement_type(self, value: Union[str, EntitlementTypeEnum]) -> PopulatedItemInfo:
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[PopulatedItemInfo, List[PopulatedItemInfo], Dict[Any, PopulatedItemInfo]]:
        if many:
