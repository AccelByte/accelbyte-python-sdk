...
class FulfillmentScriptInfo(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[FulfillmentScriptInfo, List[FulfillmentScriptInfo], Dict[Any, FulfillmentScriptInfo]]:
        if many:
