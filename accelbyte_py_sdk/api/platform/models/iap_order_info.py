...
class IAPOrderInfo(Model):
    ...
    def is_valid(self) -> bool:
        ...
        if not hasattr(self, "created_at") or self.created_at is None:
            return False
        if not hasattr(self, "iap_order_no") or self.iap_order_no is None:
            return False
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[IAPOrderInfo, List[IAPOrderInfo]]:
        if many:
