...
class PlatformSubscribeRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[PlatformSubscribeRequest, List[PlatformSubscribeRequest], Dict[Any, PlatformSubscribeRequest]]:
        if many:
