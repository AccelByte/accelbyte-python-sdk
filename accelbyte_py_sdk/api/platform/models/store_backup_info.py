...
class StoreBackupInfo(Model):
    ...
    def is_valid(self) -> bool:
        ...
        # required checks
        if not hasattr(self, "auto_backup") or self.auto_backup is None:
            return False
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[StoreBackupInfo, List[StoreBackupInfo]]:
        if many:
