...
class StoreInfo(Model):
    ...
    def is_valid(self) -> bool:
        ...
        if not hasattr(self, "default_language") or self.default_language is None:
            return False
        if not hasattr(self, "default_region") or self.default_region is None:
            return False
        ...
        if not hasattr(self, "store_id") or self.store_id is None:
            return False
        if not hasattr(self, "supported_languages") or self.supported_languages is None:
            return False
        if not hasattr(self, "supported_regions") or self.supported_regions is None:
            return False
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, StoreInfo]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[StoreInfo]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[StoreInfo, List[StoreInfo]]:
        if many:
