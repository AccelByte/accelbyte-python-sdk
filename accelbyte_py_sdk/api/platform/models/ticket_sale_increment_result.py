...
class TicketSaleIncrementResult(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[TicketSaleIncrementResult, List[TicketSaleIncrementResult], Dict[Any, TicketSaleIncrementResult]]:
        if many:
