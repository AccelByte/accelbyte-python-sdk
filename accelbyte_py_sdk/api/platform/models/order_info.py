...
class OrderInfo(Model):
    ...
    def with_creation_options(self, value: ADTOObjectForOrderCreationOptions) -> OrderInfo:
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> OrderInfo:
        ...
        if "creationOptions" in dict_ and dict_["creationOptions"] is not None:
            instance.creation_options = ADTOObjectForOrderCreationOptions.create_from_dict(dict_["creationOptions"], include_empty=include_empty)
        elif include_empty:
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, OrderInfo]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[OrderInfo]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[OrderInfo, List[OrderInfo], Dict[Any, OrderInfo]]:
        if many:
