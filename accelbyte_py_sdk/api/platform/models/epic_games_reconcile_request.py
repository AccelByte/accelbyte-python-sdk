...
class EpicGamesReconcileRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[EpicGamesReconcileRequest, List[EpicGamesReconcileRequest], Dict[Any, EpicGamesReconcileRequest]]:
        if many:
