...
class PlayStationIAPConfigInfo(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[PlayStationIAPConfigInfo, List[PlayStationIAPConfigInfo], Dict[Any, PlayStationIAPConfigInfo]]:
        if many:
