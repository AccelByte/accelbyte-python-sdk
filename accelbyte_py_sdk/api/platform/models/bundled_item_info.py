...
class BundledItemInfo(Model):
    ...
    def with_entitlement_type(self, value: str) -> BundledItemInfo:
    ...
    def with_item_type(self, value: str) -> BundledItemInfo:
    ...
    def with_status(self, value: str) -> BundledItemInfo:
        self.status = value
        return self
    ...
    def with_app_type(self, value: str) -> BundledItemInfo:
        self.app_type = value
        return self
    ...
    def with_season_type(self, value: str) -> BundledItemInfo:
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[BundledItemInfo, List[BundledItemInfo]]:
        if many:
