...
class EpicGamesReconcileResult(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[EpicGamesReconcileResult, List[EpicGamesReconcileResult], Dict[Any, EpicGamesReconcileResult]]:
        if many:
