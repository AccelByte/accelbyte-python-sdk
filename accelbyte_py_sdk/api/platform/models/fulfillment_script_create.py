...
class FulfillmentScriptCreate(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[FulfillmentScriptCreate, List[FulfillmentScriptCreate], Dict[Any, FulfillmentScriptCreate]]:
        if many:
