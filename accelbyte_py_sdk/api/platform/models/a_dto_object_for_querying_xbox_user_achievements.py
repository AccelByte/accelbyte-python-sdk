...
class ADTOObjectForQueryingXboxUserAchievements(Model):
    ...
    def with_achievements(
        self, value: List[AchievementInfo]
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ADTOObjectForQueryingXboxUserAchievements]:
        return (
    ...
    ) -> List[ADTOObjectForQueryingXboxUserAchievements]:
        return (
    ...
    def create_from_any(
        ...
        ADTOObjectForQueryingXboxUserAchievements,
        List[ADTOObjectForQueryingXboxUserAchievements],
        Dict[Any, ADTOObjectForQueryingXboxUserAchievements],
    ]:
        if many:
