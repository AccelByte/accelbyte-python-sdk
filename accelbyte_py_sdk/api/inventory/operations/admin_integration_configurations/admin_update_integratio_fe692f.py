...
class AdminUpdateIntegrationConfiguration(Operation):
    ...
    _url: str = "/inventory/v1/admin/namespaces/{namespace}/integrationConfigurations/{integrationConfigurationId}"
    _method: str = "PUT"
    ...
    body: ApimodelsUpdateIntegrationConfigurationReq  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelsUpdateIntegrationConfigurationReq
    ...
    def with_namespace(self, value: str) -> AdminUpdateIntegrationConfiguration:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelsUpdateIntegrationConfigurationReq()
        if (
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelsUpdateIntegrationConfigurationReq.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelsUpdateIntegrationConfigurationReq()
        if (
