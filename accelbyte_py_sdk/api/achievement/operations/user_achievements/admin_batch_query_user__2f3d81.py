...
class AdminBatchQueryUserAchievements(Operation):
    ...
    _url: str = "/achievement/v1/admin/namespaces/{namespace}/users/{userId}/achievements/batchQuery"
    _method: str = "POST"
    ...
    body: ModelsBatchQueryUserAchievementRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelsBatchQueryUserAchievementRequest
    ) -> AdminBatchQueryUserAchievements:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminBatchQueryUserAchievements:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminBatchQueryUserAchievements:
        self.user_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelsBatchQueryUserAchievementRequest()
    ...
    def parse_response(
        ...
        Union[None, List[ModelsUserAchievementResponse]],
        ...
        if code == 200:
            return [
                ModelsUserAchievementResponse.create_from_dict(i) for i in content
            ], None
        if code == 400:
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsBatchQueryUserAchievementRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelsBatchQueryUserAchievementRequest()
