...
class AdminUpdateAchievement(Operation):
    ...
    def with_body(self, value: ModelsAchievementUpdateRequest) -> AdminUpdateAchievement:
        self.body = value
        return self
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsAchievementResponse], Union[None, HttpResponse, ResponseError]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AdminUpdateAchievement:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsAchievementUpdateRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
