...
class ModelsUserAchievementResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUserAchievementResponse, List[ModelsUserAchievementResponse], Dict[Any, ModelsUserAchievementResponse]]:
        if many:
