...
class ModelsAchievementOrderUpdateRequest(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsAchievementOrderUpdateRequest, List[ModelsAchievementOrderUpdateRequest], Dict[Any, ModelsAchievementOrderUpdateRequest]]:
        if many:
