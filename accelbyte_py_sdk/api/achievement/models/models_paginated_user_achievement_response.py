...
class ModelsPaginatedUserAchievementResponse(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsPaginatedUserAchievementResponse, List[ModelsPaginatedUserAchievementResponse]]:
        if many:
