...
class BulkStatItemCreate(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[BulkStatItemCreate, List[BulkStatItemCreate], Dict[Any, BulkStatItemCreate]]:
        if many:
