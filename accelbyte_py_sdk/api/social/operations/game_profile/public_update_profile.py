...
class PublicUpdateProfile(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, GameProfileInfo], Union[None, ErrorEntity, HttpResponse, ValidationErrorEntity]]:
