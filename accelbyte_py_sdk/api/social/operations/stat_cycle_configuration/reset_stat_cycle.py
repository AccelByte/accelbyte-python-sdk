...
class ResetStatCycle(Operation):
    ...
    def with_cycle_id(self, value: str) -> ResetStatCycle:
        self.cycle_id = value
        return self

    def with_namespace(self, value: str) -> ResetStatCycle:
    ...
    @classmethod
    def create(cls, cycle_id: str, namespace: str, **kwargs) -> ResetStatCycle:
        instance = cls()
