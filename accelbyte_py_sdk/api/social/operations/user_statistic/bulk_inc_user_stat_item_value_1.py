# Auto-generated at 2021-09-27T17:01:27.296620+08:00
...
class BulkIncUserStatItemValue1(Operation):
    ...
    _url: str = "/social/v1/admin/namespaces/{namespace}/users/{userId}/statitems/value/bulk"
    _method: str = "PATCH"
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> BulkIncUserStatItemValue1:
        instance = cls()
