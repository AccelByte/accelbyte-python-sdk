# Auto-generated at 2021-10-14T22:17:14.274959+08:00
...
class BulkResetUserStatItem2(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> BulkResetUserStatItem2:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = [BulkUserStatItemReset.create_from_dict(i0, include_empty=include_empty) for i0 in dict_["body"]]
        elif include_empty:
            instance.body = []
