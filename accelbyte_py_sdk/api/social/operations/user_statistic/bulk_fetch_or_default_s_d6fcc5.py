...
class BulkFetchOrDefaultStatItems1(Operation):
    ...
    _url: str = "/social/v2/admin/namespaces/{namespace}/statitems/value/bulk/getOrDefault"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ADTOObjectForUserStatItemValue]], Union[None, ErrorEntity, HttpResponse, ValidationErrorEntity]]:
        ...
        if code == 200:
            return [ADTOObjectForUserStatItemValue.create_from_dict(i) for i in content], None
        if code == 404:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> BulkFetchOrDefaultStatItems1:
        instance = cls()
