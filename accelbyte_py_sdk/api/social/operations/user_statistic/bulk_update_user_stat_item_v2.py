# Auto-generated at 2021-10-21T08:52:28.495626+08:00
...
class BulkUpdateUserStatItemV2(Operation):
    ...
    *Required permission*: resource="ADMIN:NAMESPACE:{namespace}:STATITEM",
    ...
    def with_body(self, value: List[BulkUserStatItemUpdate]) -> BulkUpdateUserStatItemV2:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> BulkUpdateUserStatItemV2:
        instance = cls()
