...
class CreateStat(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, StatInfo], Union[None, ErrorEntity, HttpResponse]]:
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> CreateStat:
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = StatCreate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
