...
class CountryGroupObject(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[CountryGroupObject, List[CountryGroupObject], Dict[Any, CountryGroupObject]]:
        if many:
