...
class NamespaceStatusUpdate(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[NamespaceStatusUpdate, List[NamespaceStatusUpdate], Dict[Any, NamespaceStatusUpdate]]:
        if many:
