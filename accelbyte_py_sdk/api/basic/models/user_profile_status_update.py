...
class UserProfileStatusUpdate(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[UserProfileStatusUpdate, List[UserProfileStatusUpdate], Dict[Any, UserProfileStatusUpdate]]:
        if many:
