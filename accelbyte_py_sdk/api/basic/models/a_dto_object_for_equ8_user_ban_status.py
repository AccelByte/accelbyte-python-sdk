...
class ADTOObjectForEqu8UserBanStatus(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ADTOObjectForEqu8UserBanStatus, List[ADTOObjectForEqu8UserBanStatus], Dict[Any, ADTOObjectForEqu8UserBanStatus]]:
        if many:
