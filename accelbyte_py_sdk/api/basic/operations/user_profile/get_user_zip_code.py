# Auto-generated at 2021-09-27T17:01:31.842188+08:00
...
class GetUserZipCode(Operation):
    """Get user zip code (getUserZipCode)
    ...
    def with_namespace(self, value: str) -> GetUserZipCode:
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, UserZipCode], Union[None, ErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserZipCode:
        instance = cls()
