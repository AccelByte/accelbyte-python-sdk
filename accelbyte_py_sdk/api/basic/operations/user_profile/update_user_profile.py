# Auto-generated at 2021-10-14T22:17:19.486211+08:00
...
class UpdateUserProfile(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateUserProfile:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = UserProfileAdmin.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
