...
class UpdateCustomAttributesPartially(Operation):
    ...
    Update partially custom attributes tied to the user id.<br>Other detail info:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateCustomAttributesPartially:
        instance = cls()
