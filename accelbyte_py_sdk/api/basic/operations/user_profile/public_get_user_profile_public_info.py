# Auto-generated at 2021-10-21T08:52:33.084616+08:00
...
class PublicGetUserProfilePublicInfo(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, UserProfilePublicInfo], Union[None, ErrorEntity, ValidationErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetUserProfilePublicInfo:
        instance = cls()
