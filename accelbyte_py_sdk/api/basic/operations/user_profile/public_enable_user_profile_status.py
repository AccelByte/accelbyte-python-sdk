# Auto-generated at 2021-09-21T14:10:40.764854+08:00
...
class PublicEnableUserProfileStatus(Operation):
    """Update user profile status (publicEnableUserProfileStatus)
    ...
    def with_body(self, value: UserProfileStatusUpdate) -> PublicEnableUserProfileStatus:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicEnableUserProfileStatus:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> PublicEnableUserProfileStatus:
        self.user_id = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicEnableUserProfileStatus:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = UserProfileStatusUpdate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
