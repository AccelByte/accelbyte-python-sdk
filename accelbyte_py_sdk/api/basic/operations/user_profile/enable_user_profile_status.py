# Auto-generated at 2021-09-27T17:01:31.814632+08:00
...
class EnableUserProfileStatus(Operation):
    """Update user profile status (enableUserProfileStatus)
    ...
    def with_body(self, value: UserProfileStatusUpdate) -> EnableUserProfileStatus:
        self.body = value
        return self

    def with_namespace(self, value: str) -> EnableUserProfileStatus:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> EnableUserProfileStatus:
        self.user_id = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> EnableUserProfileStatus:
        instance = cls()
