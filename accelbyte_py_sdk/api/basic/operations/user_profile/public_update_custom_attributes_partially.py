...
class PublicUpdateCustomAttributesPartially(Operation):
    ...
    Update partially custom attributes tied to user id.<br>Other detail info:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicUpdateCustomAttributesPartially:
        instance = cls()
