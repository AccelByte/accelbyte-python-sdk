# Auto-generated at 2021-09-21T14:10:40.743914+08:00
...
class UpdateUserZipCode(Operation):
    ...
    def with_user_zip_code_update(self, value: UserZipCodeUpdate) -> UpdateUserZipCode:
        self.user_zip_code_update = value
        return self

    def with_namespace(self, value: str) -> UpdateUserZipCode:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateUserZipCode:
        instance = cls()
