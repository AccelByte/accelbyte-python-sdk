# Auto-generated at 2021-09-27T17:01:31.854548+08:00
...
class UpdateCustomAttributesPartially1(Operation):
    """Update partially custom attributes tied to user id (updateCustomAttributesPartially_1)
    ...
    def with_body(self, value: Dict[str, Any]) -> UpdateCustomAttributesPartially1:
        self.body = value
        return self

    def with_namespace(self, value: str) -> UpdateCustomAttributesPartially1:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> UpdateCustomAttributesPartially1:
        self.user_id = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, Dict[str, Any]], Union[None, ErrorEntity, ValidationErrorEntity]]:
    ...
    ) -> UpdateCustomAttributesPartially1:
        instance = cls()
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateCustomAttributesPartially1:
        instance = cls()
