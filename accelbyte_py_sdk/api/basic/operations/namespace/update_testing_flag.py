...
class UpdateTestingFlag(Operation):
    ...
    _url: str = "/basic/v1/admin/namespaces/{namespace}/testingFlag"
    _method: str = "PATCH"
    ...
    body: NamespaceTestingFlagUpdate  # OPTIONAL in [body]
    ...
    def with_body(self, value: NamespaceTestingFlagUpdate) -> UpdateTestingFlag:
        self.body = value
        return self

    def with_namespace(self, value: str) -> UpdateTestingFlag:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = NamespaceTestingFlagUpdate()
    ...
    @classmethod
    def create(
        cls, namespace: str, body: Optional[NamespaceTestingFlagUpdate] = None, **kwargs
    ) -> UpdateTestingFlag:
        instance = cls()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = NamespaceTestingFlagUpdate.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = NamespaceTestingFlagUpdate()
