...
class PublicGetNamespacePublisher(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, NamespacePublisherInfo], Union[None, ErrorEntity, HttpResponse, ValidationErrorEntity]]:
