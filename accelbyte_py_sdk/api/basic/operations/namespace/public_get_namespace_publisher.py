# Auto-generated at 2021-10-14T22:17:19.470143+08:00
...
class PublicGetNamespacePublisher(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, NamespacePublisherInfo], Union[None, ErrorEntity, ValidationErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicGetNamespacePublisher:
        instance = cls()
