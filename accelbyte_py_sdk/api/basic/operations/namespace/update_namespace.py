...
class UpdateNamespace(Operation):
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateNamespace:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = NamespaceUpdate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
