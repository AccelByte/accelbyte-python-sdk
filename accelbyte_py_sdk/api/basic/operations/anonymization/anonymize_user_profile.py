# Auto-generated at 2021-09-21T14:10:40.693990+08:00
...
class AnonymizeUserProfile(Operation):
    ...
    _url: str = "/basic/v1/admin/namespaces/{namespace}/users/{userId}/anonymization/profiles"
    _method: str = "DELETE"
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AnonymizeUserProfile:
        instance = cls()
