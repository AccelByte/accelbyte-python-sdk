...
class UpdateConfig(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, Equ8Config], Union[None, ErrorEntity, HttpResponse]]:
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateConfig:
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ADTOForUpdateEqu8ConfigAPICall.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
