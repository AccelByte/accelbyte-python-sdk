...
class GetUserStatus(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ADTOObjectForEqu8UserStatus], Union[None, ErrorEntity, ValidationErrorEntity]]:
