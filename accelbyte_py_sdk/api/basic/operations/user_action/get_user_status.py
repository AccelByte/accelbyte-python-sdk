...
class GetUserStatus(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ADTOObjectForEqu8UserStatus], Union[None, ErrorEntity, HttpResponse, ValidationErrorEntity]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserStatus:
        instance = cls()
