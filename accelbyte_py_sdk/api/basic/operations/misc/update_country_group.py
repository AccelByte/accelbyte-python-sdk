...
class UpdateCountryGroup(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, CountryGroupObject], Union[None, ErrorEntity, HttpResponse, ValidationErrorEntity]]:
