...
class GetGroupConfigurationAdminV1(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsGetGroupConfigurationResponseV1], Union[None, HttpResponse, ResponseErrorResponse]]:
