...
class CreateMemberRoleAdminV1(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsCreateMemberRoleResponseV1], Union[None, HttpResponse, ResponseErrorResponse]]:
