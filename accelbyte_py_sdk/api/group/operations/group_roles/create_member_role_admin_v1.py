# Auto-generated at 2021-10-21T08:52:32.261479+08:00
...
class CreateMemberRoleAdminV1(Operation):
    ...
    def with_body(self, value: ModelsCreateMemberRoleRequestV1) -> CreateMemberRoleAdminV1:
        self.body = value
        return self
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsCreateMemberRoleResponseV1], Union[None, ResponseErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> CreateMemberRoleAdminV1:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsCreateMemberRoleRequestV1.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
