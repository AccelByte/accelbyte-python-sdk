# Auto-generated at 2021-10-14T22:17:18.572769+08:00
...
class AssignRoleToGroupMemberAdminV1(Operation):
    """Assign role to group member (assignRoleToGroupMemberAdminV1)
    ...
    def with_body(self, value: ModelsAssignRoleToMemberRequestV1) -> AssignRoleToGroupMemberAdminV1:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AssignRoleToGroupMemberAdminV1:
        self.namespace = value
        return self

    def with_member_role_id(self, value: str) -> AssignRoleToGroupMemberAdminV1:
    ...
    def create(
        ...
        namespace: str,
        member_role_id: str,
    ) -> AssignRoleToGroupMemberAdminV1:
        instance = cls()
        instance.body = body
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AssignRoleToGroupMemberAdminV1:
        instance = cls()
