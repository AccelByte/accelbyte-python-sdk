# Auto-generated at 2021-09-27T17:01:30.995833+08:00
...
class GetUserGroupInformationPublicV1(Operation):
    ...
    # noinspection PyMethodMayBeStatic
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsGetUserGroupInformationResponseV1], Union[None, ResponseErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserGroupInformationPublicV1:
        instance = cls()
