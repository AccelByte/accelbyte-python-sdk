...
class InviteGroupPublicV1(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsUserInvitationResponseV1], Union[None, HttpResponse, ResponseErrorResponse]]:
