...
class GetGroupMembersListPublicV1(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ModelsGetGroupMemberListResponseV1], Union[None, HttpResponse, ResponseErrorResponse]]:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetGroupMembersListPublicV1:
        instance = cls()
