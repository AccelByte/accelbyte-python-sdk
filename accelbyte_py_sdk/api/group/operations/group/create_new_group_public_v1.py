# Auto-generated at 2021-10-21T08:52:32.286487+08:00
...
class CreateNewGroupPublicV1(Operation):
    ...
    def with_body(self, value: ModelsPublicCreateNewGroupRequestV1) -> CreateNewGroupPublicV1:
        self.body = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> CreateNewGroupPublicV1:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsPublicCreateNewGroupRequestV1.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
