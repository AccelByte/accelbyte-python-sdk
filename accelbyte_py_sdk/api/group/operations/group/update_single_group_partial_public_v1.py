# Auto-generated at 2021-09-21T14:10:39.989887+08:00
...
class UpdateSingleGroupPartialPublicV1(Operation):
    """update existing group (updateSingleGroupPartialPublicV1)
    ...
    def with_body(self, value: ModelsUpdateGroupRequestV1) -> UpdateSingleGroupPartialPublicV1:
        self.body = value
        return self

    def with_namespace(self, value: str) -> UpdateSingleGroupPartialPublicV1:
        self.namespace = value
        return self

    def with_group_id(self, value: str) -> UpdateSingleGroupPartialPublicV1:
        self.group_id = value
        return self
    ...
    def create(
        ...
        namespace: str,
        group_id: str,
    ) -> UpdateSingleGroupPartialPublicV1:
        instance = cls()
        instance.body = body
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateSingleGroupPartialPublicV1:
        instance = cls()
