...
class ModelsGetUserGroupInformationResponseV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsGetUserGroupInformationResponseV1, List[ModelsGetUserGroupInformationResponseV1], Dict[Any, ModelsGetUserGroupInformationResponseV1]]:
        if many:
