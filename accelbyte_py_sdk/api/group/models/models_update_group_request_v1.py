...
class ModelsUpdateGroupRequestV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateGroupRequestV1, List[ModelsUpdateGroupRequestV1], Dict[Any, ModelsUpdateGroupRequestV1]]:
        if many:
