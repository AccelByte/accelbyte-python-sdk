...
class ModelsUpdateGroupConfigurationResponseV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateGroupConfigurationResponseV1, List[ModelsUpdateGroupConfigurationResponseV1]]:
        if many:
