...
class ModelsUpdateGroupConfigurationResponseV1(Model):
    ...
    def with_configuration_code(self, value: str) -> ModelsUpdateGroupConfigurationResponseV1:
    ...
    def with_global_rules(self, value: List[ModelsRule]) -> ModelsUpdateGroupConfigurationResponseV1:
        self.global_rules = value
        return self

    def with_group_admin_role_id(self, value: str) -> ModelsUpdateGroupConfigurationResponseV1:
        self.group_admin_role_id = value
        return self

    def with_group_max_member(self, value: int) -> ModelsUpdateGroupConfigurationResponseV1:
        self.group_max_member = value
        return self

    def with_group_member_role_id(self, value: str) -> ModelsUpdateGroupConfigurationResponseV1:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ModelsUpdateGroupConfigurationResponseV1:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ModelsUpdateGroupConfigurationResponseV1]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ModelsUpdateGroupConfigurationResponseV1]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateGroupConfigurationResponseV1, List[ModelsUpdateGroupConfigurationResponseV1], Dict[Any, ModelsUpdateGroupConfigurationResponseV1]]:
        if many:
