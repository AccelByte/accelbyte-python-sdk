...
class ModelsUpdateGroupPredefinedRuleRequestV1(Model):
    ...
    def with_rule_detail(self, value: List[ModelsRuleInformation]) -> ModelsUpdateGroupPredefinedRuleRequestV1:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ModelsUpdateGroupPredefinedRuleRequestV1:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ModelsUpdateGroupPredefinedRuleRequestV1]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ModelsUpdateGroupPredefinedRuleRequestV1]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateGroupPredefinedRuleRequestV1, List[ModelsUpdateGroupPredefinedRuleRequestV1], Dict[Any, ModelsUpdateGroupPredefinedRuleRequestV1]]:
        if many:
