...
class ModelsUpdateGroupPredefinedRuleRequestV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateGroupPredefinedRuleRequestV1, List[ModelsUpdateGroupPredefinedRuleRequestV1]]:
        if many:
