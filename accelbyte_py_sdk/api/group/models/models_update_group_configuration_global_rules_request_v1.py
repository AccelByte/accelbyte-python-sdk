...
class ModelsUpdateGroupConfigurationGlobalRulesRequestV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateGroupConfigurationGlobalRulesRequestV1, List[ModelsUpdateGroupConfigurationGlobalRulesRequestV1]]:
        if many:
