...
class ModelsGetGroupConfigurationResponseV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsGetGroupConfigurationResponseV1, List[ModelsGetGroupConfigurationResponseV1]]:
        if many:
