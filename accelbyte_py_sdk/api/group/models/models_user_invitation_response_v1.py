...
class ModelsUserInvitationResponseV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUserInvitationResponseV1, List[ModelsUserInvitationResponseV1], Dict[Any, ModelsUserInvitationResponseV1]]:
        if many:
