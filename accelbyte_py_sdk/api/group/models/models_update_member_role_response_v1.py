...
class ModelsUpdateMemberRoleResponseV1(Model):
    ...
    def with_member_role_id(self, value: str) -> ModelsUpdateMemberRoleResponseV1:
        self.member_role_id = value
        return self

    def with_member_role_name(self, value: str) -> ModelsUpdateMemberRoleResponseV1:
        self.member_role_name = value
        return self

    def with_member_role_permissions(self, value: List[ModelsRolePermission]) -> ModelsUpdateMemberRoleResponseV1:
    ...
    ) -> ModelsUpdateMemberRoleResponseV1:
        instance = cls()
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ModelsUpdateMemberRoleResponseV1:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ModelsUpdateMemberRoleResponseV1]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ModelsUpdateMemberRoleResponseV1]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateMemberRoleResponseV1, List[ModelsUpdateMemberRoleResponseV1], Dict[Any, ModelsUpdateMemberRoleResponseV1]]:
        if many:
