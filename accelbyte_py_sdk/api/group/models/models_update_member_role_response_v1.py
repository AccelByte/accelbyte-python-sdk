...
class ModelsUpdateMemberRoleResponseV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateMemberRoleResponseV1, List[ModelsUpdateMemberRoleResponseV1]]:
        if many:
