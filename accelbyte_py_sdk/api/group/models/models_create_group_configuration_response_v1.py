...
class ModelsCreateGroupConfigurationResponseV1(Model):
    ...
    def with_configuration_code(self, value: str) -> ModelsCreateGroupConfigurationResponseV1:
    ...
    def with_global_rules(self, value: List[ModelsRule]) -> ModelsCreateGroupConfigurationResponseV1:
        self.global_rules = value
        return self

    def with_group_admin_role_id(self, value: str) -> ModelsCreateGroupConfigurationResponseV1:
        self.group_admin_role_id = value
        return self

    def with_group_max_member(self, value: int) -> ModelsCreateGroupConfigurationResponseV1:
        self.group_max_member = value
        return self

    def with_group_member_role_id(self, value: str) -> ModelsCreateGroupConfigurationResponseV1:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ModelsCreateGroupConfigurationResponseV1:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ModelsCreateGroupConfigurationResponseV1]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ModelsCreateGroupConfigurationResponseV1]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsCreateGroupConfigurationResponseV1, List[ModelsCreateGroupConfigurationResponseV1], Dict[Any, ModelsCreateGroupConfigurationResponseV1]]:
        if many:
