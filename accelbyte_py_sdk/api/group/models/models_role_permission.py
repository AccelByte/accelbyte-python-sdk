...
class ModelsRolePermission(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsRolePermission, List[ModelsRolePermission], Dict[Any, ModelsRolePermission]]:
        if many:
