...
class ModelsUpdateGroupCustomAttributesRequestV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateGroupCustomAttributesRequestV1, List[ModelsUpdateGroupCustomAttributesRequestV1]]:
        if many:
