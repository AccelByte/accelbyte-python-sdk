...
class ModelsMemberRequestResponseV1(Model):
    ...
    def is_valid(self) -> bool:
        ...
        if not hasattr(self, "group_id") or self.group_id is None:
            return False
        if not hasattr(self, "request_type") or self.request_type is None:
            return False
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsMemberRequestResponseV1, List[ModelsMemberRequestResponseV1]]:
        if many:
