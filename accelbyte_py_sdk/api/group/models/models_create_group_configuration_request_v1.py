...
class ModelsCreateGroupConfigurationRequestV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsCreateGroupConfigurationRequestV1, List[ModelsCreateGroupConfigurationRequestV1], Dict[Any, ModelsCreateGroupConfigurationRequestV1]]:
        if many:
