...
class ModelsListConfigurationResponseV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsListConfigurationResponseV1, List[ModelsListConfigurationResponseV1]]:
        if many:
