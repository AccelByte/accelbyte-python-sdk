...
class ModelsRuleInformation(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsRuleInformation, List[ModelsRuleInformation], Dict[Any, ModelsRuleInformation]]:
        if many:
