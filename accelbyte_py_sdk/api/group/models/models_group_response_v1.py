...
class ModelsGroupResponseV1(Model):
    ...
    def is_valid(self) -> bool:
        ...
        if not hasattr(self, "group_max_member") or self.group_max_member is None:
            return False
        if not hasattr(self, "group_members") or self.group_members is None:
            return False
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsGroupResponseV1, List[ModelsGroupResponseV1]]:
        if many:
