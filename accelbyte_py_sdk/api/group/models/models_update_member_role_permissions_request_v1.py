...
class ModelsUpdateMemberRolePermissionsRequestV1(Model):
    ...
    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ModelsUpdateMemberRolePermissionsRequestV1, List[ModelsUpdateMemberRolePermissionsRequestV1]]:
        if many:
