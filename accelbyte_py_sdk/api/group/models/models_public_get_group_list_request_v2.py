...
class ModelsPublicGetGroupListRequestV2(Model):
    """Models public get group list request V2 (models.PublicGetGroupListRequestV2)
    ...
    def with_group_i_ds(self, value: List[str]) -> ModelsPublicGetGroupListRequestV2:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelsPublicGetGroupListRequestV2]:
        return (
    ...
    ) -> List[ModelsPublicGetGroupListRequestV2]:
        return (
    ...
    def create_from_any(
        ...
        ModelsPublicGetGroupListRequestV2,
        List[ModelsPublicGetGroupListRequestV2],
        Dict[Any, ModelsPublicGetGroupListRequestV2],
    ]:
        if many:
