...
from ....api.gdpr import public_cancel_user_personal_data_request as public_cancel_user_personal_data_request_internal
...
def public_cancel_user_personal_data_request(
    ...
    if doc:
        click.echo(public_cancel_user_personal_data_request_internal.__doc__)
        return
