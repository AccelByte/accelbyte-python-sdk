...
from ....api.platform import public_get_user_order as public_get_user_order_internal
...
def public_get_user_order(
    ...
    _, error = public_get_user_order_internal(
        user_id=user_id,
        order_no=order_no,
        namespace=namespace,
    )
    ...
    click.echo("publicGetUserOrder success")
