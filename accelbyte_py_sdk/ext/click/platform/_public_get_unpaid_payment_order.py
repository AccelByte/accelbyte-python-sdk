...
from ....api.platform import public_get_unpaid_payment_order as public_get_unpaid_payment_order_internal
...
def public_get_unpaid_payment_order(
    ...
    _, error = public_get_unpaid_payment_order_internal(
        payment_order_no=payment_order_no,
        namespace=namespace,
    )
    if error:
        raise Exception(f"publicGetUnpaidPaymentOrder failed: {str(error)}")
    click.echo("publicGetUnpaidPaymentOrder success")
