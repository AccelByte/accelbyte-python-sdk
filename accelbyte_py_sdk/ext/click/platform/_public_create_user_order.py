...
from ....api.platform import public_create_user_order as public_create_user_order_internal
...
def public_create_user_order(
    ...
    _, error = public_create_user_order_internal(
        user_id=user_id,
        body=body,
        namespace=namespace,
    )
    ...
    click.echo("publicCreateUserOrder success")
