...
from ....api.group import update_member_role_public_v1 as update_member_role_public_v1_internal
...
def update_member_role_public_v1(
    ...
    _, error = update_member_role_public_v1_internal(
        body=body,
    ...
    click.echo("updateMemberRolePublicV1 success")
