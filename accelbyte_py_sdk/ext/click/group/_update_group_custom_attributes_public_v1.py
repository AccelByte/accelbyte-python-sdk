...
from ....api.group import update_group_custom_attributes_public_v1 as update_group_custom_attributes_public_v1_internal
...
def update_group_custom_attributes_public_v1(
    ...
    _, error = update_group_custom_attributes_public_v1_internal(
        body=body,
        group_id=group_id,
        namespace=namespace,
    )
    ...
    click.echo("updateGroupCustomAttributesPublicV1 success")
