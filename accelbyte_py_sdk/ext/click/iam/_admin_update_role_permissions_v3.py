...
from ....api.iam import admin_update_role_permissions_v3 as admin_update_role_permissions_v3_internal
...
def admin_update_role_permissions_v3(
    ...
    result, error = admin_update_role_permissions_v3_internal(
        body=body,
        role_id=role_id,
    )
    if error:
        raise Exception(f"AdminUpdateRolePermissionsV3 failed: {str(error)}")
    click.echo("AdminUpdateRolePermissionsV3 success")
