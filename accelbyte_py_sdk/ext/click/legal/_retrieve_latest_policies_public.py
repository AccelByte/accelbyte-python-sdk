...
from ....api.legal import retrieve_latest_policies_public as retrieve_latest_policies_public_internal
...
def retrieve_latest_policies_public(
    ...
    _, error = retrieve_latest_policies_public_internal(
    ...
    click.echo("retrieveLatestPoliciesPublic success")
