...
from ....api.cloudsave import admin_put_player_record_handler_v1 as admin_put_player_record_handler_v1_internal
...
def admin_put_player_record_handler_v1(
    ...
    click.echo("adminPutPlayerRecordHandlerV1 success")
