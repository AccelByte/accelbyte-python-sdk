...
from ....api.social import bulk_inc_user_stat_item_1 as bulk_inc_user_stat_item_1_internal
...
def bulk_inc_user_stat_item_1(
    ...
    _, error = bulk_inc_user_stat_item_1_internal(
        user_id=user_id,
        body=body,
        namespace=namespace,
    )
    ...
    click.echo("bulkIncUserStatItem_1 success")
