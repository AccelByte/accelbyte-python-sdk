...
from ....api.leaderboard import delete_leaderboard_configuration_admin_v1 as delete_leaderboard_configuration_admin_v1_internal
...
def delete_leaderboard_configuration_admin_v1(
    ...
    _, error = delete_leaderboard_configuration_admin_v1_internal(
        leaderboard_code=leaderboard_code,
        namespace=namespace,
    )
    if error:
        raise Exception(f"deleteLeaderboardConfigurationAdminV1 failed: {str(error)}")
    click.echo("deleteLeaderboardConfigurationAdminV1 success")
