...
from ....api.ugc import create_content_s3 as create_content_s3_internal
...
def create_content_s3(
    ...
    if doc:
        click.echo(create_content_s3_internal.__doc__)
        return
    ...
    _, error = create_content_s3_internal(
        body=body,
    ...
    click.echo("CreateContentS3 success")
