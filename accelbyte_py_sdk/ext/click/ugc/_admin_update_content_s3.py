...
from ....api.ugc import admin_update_content_s3 as admin_update_content_s3_internal
...
def admin_update_content_s3(
    ...
    _, error = admin_update_content_s3_internal(
        body=body,
    ...
    click.echo("AdminUpdateContentS3 success")
