...
class LeaderboardTestCase(IntegrationTestCase):
    ...
    def test_delete_leaderboard_configuration_admin_v1(self):
        ...
        # act
        _, error = delete_leaderboard_configuration_admin_v1(leaderboard_code=self.models_leaderboard_config_req.leaderboard_code)
    ...
    def test_get_leaderboard_configuration_admin_v1(self):
        ...
        # act
        _, error = get_leaderboard_configuration_admin_v1(leaderboard_code=self.models_leaderboard_config_req.leaderboard_code)
