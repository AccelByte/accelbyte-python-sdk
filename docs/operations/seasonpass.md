...
# AccelByte Cloud Seasonpass Service Index (1.17.0)
...
| /seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/exp/history/tags | GET | queryUserExpGrantHistoryTag | [QueryUserExpGrantHistoryTag](../../accelbyte_py_sdk/api/seasonpass/operations/season/query_user_exp_grant_hi_12346c.py) | [query_user_exp_grant_history_tag](../../accelbyte_py_sdk/api/seasonpass/wrappers/_season.py) | [accelbyte_py_sdk_cli seasonpass-query-user-exp-grant-history-tag](../../samples/cli/accelbyte_py_sdk_cli/seasonpass/_query_user_exp_grant_history_tag.py) |
