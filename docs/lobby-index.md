...
| /friends/namespaces/{namespace}/me | GET | getUserFriends | [GetUserFriends](../accelbyte_py_sdk/api/lobby/operations/friends/get_user_friends.py) | [get_user_friends](../accelbyte_py_sdk/api/lobby/wrappers/_friends.py) |
...
| /lobby/v1/public/notification/namespaces/{namespace}/users/me | GET | getAllStoredNotificationsV1 | [GetAllStoredNotificationsV1](../accelbyte_py_sdk/api/lobby/operations/notification/get_all_stored_notifications_v1.py) | [get_all_stored_notifications_v1](../accelbyte_py_sdk/api/lobby/wrappers/_notification.py) |
...
| /notification/namespaces/{namespace}/users/{userId} | GET | getNotifications | [GetNotifications](../accelbyte_py_sdk/api/lobby/operations/notification/get_notifications.py) | [get_notifications](../accelbyte_py_sdk/api/lobby/wrappers/_notification.py) |
...
| Endpoint | Method | ID | Class | Wrapper |
|---|---|---|---|---|
| /lobby/v1/admin/party/namespaces/{namespace}/parties | GET | adminGetPartiesDataV1 | [AdminGetPartiesDataV1](../accelbyte_py_sdk/api/lobby/operations/party/admin_get_parties_data_v1.py) | [admin_get_parties_data_v1](../accelbyte_py_sdk/api/lobby/wrappers/_party.py) |
...
| /lobby/v1/admin/party/namespaces/{namespace}/parties/{partyId}/attributes | PUT | adminUpdatePartyAttributesV1 | [AdminUpdatePartyAttributesV1](../accelbyte_py_sdk/api/lobby/operations/party/admin_update_party_attributes_v1.py) | [admin_update_party_attributes_v1](../accelbyte_py_sdk/api/lobby/wrappers/_party.py) |
...
| model.GetStoredNotificationResp | [ModelGetStoredNotificationResp](../accelbyte_py_sdk/api/lobby/models/model_get_stored_notification_resp.py) |
