...
# Accelbyte Cloud Ds Log Manager Service (2.4.1)
...
list_all_terminated_servers.operation_id = "listAllTerminatedServers"
list_all_terminated_servers.is_deprecated = False
