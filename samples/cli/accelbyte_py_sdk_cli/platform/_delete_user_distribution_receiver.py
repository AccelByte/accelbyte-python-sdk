...
from accelbyte_py_sdk.api.platform import delete_user_distribution_receiver as delete_user_distribution_receiver_internal
...
def delete_user_distribution_receiver(
    ...
    _, error = delete_user_distribution_receiver_internal(
