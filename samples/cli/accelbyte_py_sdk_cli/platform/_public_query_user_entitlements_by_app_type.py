...
from accelbyte_py_sdk.api.platform import (
    public_query_user_entitlements_by_app_type as public_query_user_entitlements_by_app_type_internal,
)
...
public_query_user_entitlements_by_app_type.operation_id = (
