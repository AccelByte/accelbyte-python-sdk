...
from accelbyte_py_sdk.api.platform import public_redeem_code as public_redeem_code_internal
...
def public_redeem_code(
    ...
    if doc:
        click.echo(public_redeem_code_internal.__doc__)
        return
    ...
    _, error = public_redeem_code_internal(
        user_id=user_id,
        body=body,
        namespace=namespace,
    )
    ...
    click.echo("publicRedeemCode success")
