...
from accelbyte_py_sdk.api.platform import query_user_subscriptions as query_user_subscriptions_internal
...
def query_user_subscriptions(
    ...
    result, error = query_user_subscriptions_internal(
        user_id=user_id,
...
query_user_subscriptions.operation_id = "queryUserSubscriptions"
query_user_subscriptions.is_deprecated = False
