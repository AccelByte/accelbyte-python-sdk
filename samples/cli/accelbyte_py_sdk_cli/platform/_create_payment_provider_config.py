...
from accelbyte_py_sdk.api.platform import create_payment_provider_config as create_payment_provider_config_internal
...
def create_payment_provider_config(
    ...
    _, error = create_payment_provider_config_internal(
        body=body,
    )
    if error:
