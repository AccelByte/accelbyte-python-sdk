...
from accelbyte_py_sdk.api.platform import get_user_order as get_user_order_internal
...
def get_user_order(
    ...
    if doc:
        click.echo(get_user_order_internal.__doc__)
        return
    ...
    result, error = get_user_order_internal(
        order_no=order_no,
        user_id=user_id,
        namespace=namespace,
