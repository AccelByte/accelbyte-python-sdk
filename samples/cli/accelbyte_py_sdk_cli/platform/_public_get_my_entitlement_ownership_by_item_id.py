...
from accelbyte_py_sdk.api.platform import (
    public_get_my_entitlement_ownership_by_item_id as public_get_my_entitlement_ownership_by_item_id_internal,
)
...
public_get_my_entitlement_ownership_by_item_id.operation_id = (
