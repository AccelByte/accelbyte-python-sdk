...
from accelbyte_py_sdk.api.platform import exists_any_user_active_entitlement as exists_any_user_active_entitlement_internal
...
def exists_any_user_active_entitlement(
    ...
    _, error = exists_any_user_active_entitlement_internal(
        user_id=user_id,
        app_ids=app_ids,
        item_ids=item_ids,
        skus=skus,
