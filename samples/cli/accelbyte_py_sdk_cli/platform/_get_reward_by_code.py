...
from accelbyte_py_sdk.api.platform import get_reward_by_code as get_reward_by_code_internal
...
get_reward_by_code.operation_id = "getRewardByCode"
get_reward_by_code.is_deprecated = False
