...
from accelbyte_py_sdk.api.platform import (
    get_locale_item_by_sku as get_locale_item_by_sku_internal,
)
...
def get_locale_item_by_sku(
    ...
    if doc:
        click.echo(get_locale_item_by_sku_internal.__doc__)
        return
...
get_locale_item_by_sku.operation_id = "getLocaleItemBySku"
get_locale_item_by_sku.is_deprecated = False
