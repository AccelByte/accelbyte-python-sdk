...
from accelbyte_py_sdk.api.platform import (
    get_user_app_entitlement_ownership_by_app_id as get_user_app_entitlement_ownership_by_app_id_internal,
)
...
get_user_app_entitlement_ownership_by_app_id.operation_id = (
