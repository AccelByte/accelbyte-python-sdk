...
from accelbyte_py_sdk.api.platform import get_google_iap_config as get_google_iap_config_internal
...
get_google_iap_config.operation_id = "getGoogleIAPConfig"
get_google_iap_config.is_deprecated = False
