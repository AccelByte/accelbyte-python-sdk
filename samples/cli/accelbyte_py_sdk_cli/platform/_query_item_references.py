...
from accelbyte_py_sdk.api.platform import (
    query_item_references as query_item_references_internal,
)
from accelbyte_py_sdk.api.platform.models import ErrorEntity
from accelbyte_py_sdk.api.platform.models import ItemDependency
...
def query_item_references(
    ...
    if doc:
        click.echo(query_item_references_internal.__doc__)
        return
    ...
    result, error = query_item_references_internal(
        item_id=item_id,
    ...
    if error:
        raise Exception(f"queryItemReferences failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


query_item_references.operation_id = "queryItemReferences"
query_item_references.is_deprecated = False
