...
from accelbyte_py_sdk.api.platform import update_payment_callback_config as update_payment_callback_config_internal
...
def update_payment_callback_config(
    ...
    _, error = update_payment_callback_config_internal(
        body=body,
        namespace=namespace,
    ...
    click.echo("updatePaymentCallbackConfig success")
