...
def list_item_type_configs(
    ...
    if error:
        raise Exception(f"listItemTypeConfigs failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


list_item_type_configs.operation_id = "listItemTypeConfigs"
list_item_type_configs.is_deprecated = False
