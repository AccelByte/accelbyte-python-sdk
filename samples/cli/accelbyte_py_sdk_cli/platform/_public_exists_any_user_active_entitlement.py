...
from accelbyte_py_sdk.api.platform import (
    public_exists_any_user_active_entitlement as public_exists_any_user_active_entitlement_internal,
)
...
def public_exists_any_user_active_entitlement(
    ...
    if doc:
        click.echo(public_exists_any_user_active_entitlement_internal.__doc__)
        return
    ...
    result, error = public_exists_any_user_active_entitlement_internal(
        user_id=user_id,
        app_ids=app_ids,
        item_ids=item_ids,
        skus=skus,
...
public_exists_any_user_active_entitlement.operation_id = (
