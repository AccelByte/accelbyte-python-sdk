...
from accelbyte_py_sdk.api.platform import public_get_item_by_sku as public_get_item_by_sku_internal
...
public_get_item_by_sku.operation_id = "publicGetItemBySku"
public_get_item_by_sku.is_deprecated = False
