...
from accelbyte_py_sdk.api.platform import public_consume_user_entitlement as public_consume_user_entitlement_internal
...
def public_consume_user_entitlement(
    ...
    click.echo("publicConsumeUserEntitlement success")
