...
from accelbyte_py_sdk.api.platform import (
    public_change_subscription_billing_account as public_change_subscription_billing_account_internal,
)
...
public_change_subscription_billing_account.operation_id = (
