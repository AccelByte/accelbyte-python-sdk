...
from accelbyte_py_sdk.api.platform import public_get_user_app_entitlement_by_app_id as public_get_user_app_entitlement_by_app_id_internal
...
def public_get_user_app_entitlement_by_app_id(
    ...
    _, error = public_get_user_app_entitlement_by_app_id_internal(
        user_id=user_id,
        app_id=app_id,
        namespace=namespace,
    )
