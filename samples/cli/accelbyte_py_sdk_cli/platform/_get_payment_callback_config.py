...
from accelbyte_py_sdk.api.platform import (
    get_payment_callback_config as get_payment_callback_config_internal,
)
...
def get_payment_callback_config(
    ...
    result, error = get_payment_callback_config_internal(
        namespace=namespace,
...
get_payment_callback_config.is_deprecated = True
