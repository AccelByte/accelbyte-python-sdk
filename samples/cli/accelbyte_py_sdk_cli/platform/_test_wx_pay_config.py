...
from accelbyte_py_sdk.api.platform import test_wx_pay_config as test_wx_pay_config_internal
...
test_wx_pay_config.operation_id = "testWxPayConfig"
test_wx_pay_config.is_deprecated = False
