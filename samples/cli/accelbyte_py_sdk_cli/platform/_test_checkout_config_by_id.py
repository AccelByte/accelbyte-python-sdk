...
from accelbyte_py_sdk.api.platform import (
    test_checkout_config_by_id as test_checkout_config_by_id_internal,
)
...
def test_checkout_config_by_id(
    ...
    if doc:
        click.echo(test_checkout_config_by_id_internal.__doc__)
        return
...
test_checkout_config_by_id.operation_id = "testCheckoutConfigById"
test_checkout_config_by_id.is_deprecated = False
