...
from accelbyte_py_sdk.api.platform import get_published_store as get_published_store_internal
...
get_published_store.operation_id = "getPublishedStore"
get_published_store.is_deprecated = False
