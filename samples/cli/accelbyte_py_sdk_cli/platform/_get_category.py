...
from accelbyte_py_sdk.api.platform import get_category as get_category_internal
...
def get_category(
    ...
    if doc:
        click.echo(get_category_internal.__doc__)
        return
    ...
    result, error = get_category_internal(
