...
from accelbyte_py_sdk.api.platform import list_currencies as list_currencies_internal
...
list_currencies.operation_id = "listCurrencies"
list_currencies.is_deprecated = False
