...
from accelbyte_py_sdk.api.platform import public_get_wallet as public_get_wallet_internal
...
public_get_wallet.operation_id = "publicGetWallet"
public_get_wallet.is_deprecated = False
