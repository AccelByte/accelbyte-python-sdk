...
from accelbyte_py_sdk.api.platform import (
    update_apple_iap_config as update_apple_iap_config_internal,
)
...
update_apple_iap_config.operation_id = "updateAppleIAPConfig"
update_apple_iap_config.is_deprecated = False
