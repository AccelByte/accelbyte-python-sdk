...
from accelbyte_py_sdk.api.platform import update_user_distribution_receiver as update_user_distribution_receiver_internal
...
def update_user_distribution_receiver(
    ...
    _, error = update_user_distribution_receiver_internal(
