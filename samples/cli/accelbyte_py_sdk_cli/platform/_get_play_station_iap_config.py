...
from accelbyte_py_sdk.api.platform import get_play_station_iap_config as get_play_station_iap_config_internal
...
def get_play_station_iap_config(
    ...
    _, error = get_play_station_iap_config_internal(
        namespace=namespace,
    )
    if error:
