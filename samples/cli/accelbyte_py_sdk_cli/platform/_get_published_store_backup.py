...
from accelbyte_py_sdk.api.platform import get_published_store_backup as get_published_store_backup_internal
...
def get_published_store_backup(
    ...
    _, error = get_published_store_backup_internal(
        namespace=namespace,
    )
    if error:
