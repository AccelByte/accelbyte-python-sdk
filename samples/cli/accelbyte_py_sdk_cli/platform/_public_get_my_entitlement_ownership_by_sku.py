...
from accelbyte_py_sdk.api.platform import (
    public_get_my_entitlement_ownership_by_sku as public_get_my_entitlement_ownership_by_sku_internal,
)
...
public_get_my_entitlement_ownership_by_sku.operation_id = (
