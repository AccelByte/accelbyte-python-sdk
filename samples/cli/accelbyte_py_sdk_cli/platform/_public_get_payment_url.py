...
from accelbyte_py_sdk.api.platform import (
    public_get_payment_url as public_get_payment_url_internal,
)
...
public_get_payment_url.operation_id = "publicGetPaymentUrl"
public_get_payment_url.is_deprecated = False
