...
from accelbyte_py_sdk.api.platform import test_ali_pay_config_by_id as test_ali_pay_config_by_id_internal
...
test_ali_pay_config_by_id.operation_id = "testAliPayConfigById"
test_ali_pay_config_by_id.is_deprecated = False
