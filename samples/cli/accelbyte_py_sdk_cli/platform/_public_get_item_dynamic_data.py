...
from accelbyte_py_sdk.api.platform import public_get_item_dynamic_data as public_get_item_dynamic_data_internal
...
def public_get_item_dynamic_data(
    ...
    _, error = public_get_item_dynamic_data_internal(
        item_id=item_id,
        namespace=namespace,
