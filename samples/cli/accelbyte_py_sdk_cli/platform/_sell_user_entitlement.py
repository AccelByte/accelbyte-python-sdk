...
def sell_user_entitlement(
    ...
    if doc:
        click.echo(sell_user_entitlement_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"sellUserEntitlement failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


sell_user_entitlement.operation_id = "sellUserEntitlement"
sell_user_entitlement.is_deprecated = False
