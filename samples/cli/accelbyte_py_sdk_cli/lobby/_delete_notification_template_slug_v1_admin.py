...
from accelbyte_py_sdk.api.lobby import (
    delete_notification_template_slug_v1_admin as delete_notification_template_slug_v1_admin_internal,
)
...
delete_notification_template_slug_v1_admin.operation_id = (
