...
from accelbyte_py_sdk.api.lobby import (
    get_user_friends_updated as get_user_friends_updated_internal,
)
...
def get_user_friends_updated(
    ...
    if doc:
        click.echo(get_user_friends_updated_internal.__doc__)
        return
    ...
    result, error = get_user_friends_updated_internal(
        limit=limit,
        offset=offset,
        namespace=namespace,
