...
from accelbyte_py_sdk.api.lobby import admin_delete_profanity_filter as admin_delete_profanity_filter_internal
...
def admin_delete_profanity_filter(
    ...
    _, error = admin_delete_profanity_filter_internal(
        body=body,
        list_=list_,
        namespace=namespace,
