...
from accelbyte_py_sdk.api.lobby import admin_create_profanity_list as admin_create_profanity_list_internal
...
def admin_create_profanity_list(
    ...
    _, error = admin_create_profanity_list_internal(
        body=body,
        namespace=namespace,
    )
    if error:
