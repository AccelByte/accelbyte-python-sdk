...
from accelbyte_py_sdk.api.lobby import (
    personal_chat_history as personal_chat_history_internal,
)
...
personal_chat_history.operation_id = "personalChatHistory"
personal_chat_history.is_deprecated = False
