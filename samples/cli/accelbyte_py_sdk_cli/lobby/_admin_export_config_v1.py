...
from accelbyte_py_sdk.api.lobby import admin_export_config_v1 as admin_export_config_v1_internal
...
def admin_export_config_v1(
    ...
    if doc:
        click.echo(admin_export_config_v1_internal.__doc__)
        return
    ...
    result, error = admin_export_config_v1_internal(
        namespace=namespace,
