...
from accelbyte_py_sdk.api.lobby import (
    admin_delete_third_party_config as admin_delete_third_party_config_internal,
)
...
def admin_delete_third_party_config(
    ...
    if doc:
        click.echo(admin_delete_third_party_config_internal.__doc__)
        return
    ...
    result, error = admin_delete_third_party_config_internal(
        namespace=namespace,
