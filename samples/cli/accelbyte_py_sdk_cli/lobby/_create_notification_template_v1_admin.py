...
from accelbyte_py_sdk.api.lobby import create_notification_template_v1_admin as create_notification_template_v1_admin_internal
...
def create_notification_template_v1_admin(
    ...
    _, error = create_notification_template_v1_admin_internal(
        body=body,
        namespace=namespace,
