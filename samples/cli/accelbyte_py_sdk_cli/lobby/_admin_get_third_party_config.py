...
from accelbyte_py_sdk.api.lobby import admin_get_third_party_config as admin_get_third_party_config_internal
...
def admin_get_third_party_config(
    ...
    _, error = admin_get_third_party_config_internal(
        namespace=namespace,
    )
    if error:
