...
from accelbyte_py_sdk.api.lobby import admin_update_third_party_config as admin_update_third_party_config_internal
...
def admin_update_third_party_config(
    ...
    _, error = admin_update_third_party_config_internal(
        body=body,
        namespace=namespace,
    )
    if error:
