...
from accelbyte_py_sdk.api.lobby import (
    send_users_templated_notification_v1_admin as send_users_templated_notification_v1_admin_internal,
)
...
send_users_templated_notification_v1_admin.operation_id = (
