...
from accelbyte_py_sdk.api.lobby import send_users_templated_notification_v1_admin as send_users_templated_notification_v1_admin_internal
...
def send_users_templated_notification_v1_admin(
    ...
    _, error = send_users_templated_notification_v1_admin_internal(
        body=body,
        namespace=namespace,
    )
    if error:
