...
from accelbyte_py_sdk.api.lobby import (
    send_party_templated_notification_v1_admin as send_party_templated_notification_v1_admin_internal,
)
...
def send_party_templated_notification_v1_admin(
    ...
    result, error = send_party_templated_notification_v1_admin_internal(
        body=body,
        party_id=party_id,
        namespace=namespace,
...
send_party_templated_notification_v1_admin.operation_id = (
    "sendPartyTemplatedNotificationV1Admin"
)
send_party_templated_notification_v1_admin.is_deprecated = True
