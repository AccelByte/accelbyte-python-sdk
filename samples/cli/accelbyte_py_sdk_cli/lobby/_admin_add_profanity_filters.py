...
from accelbyte_py_sdk.api.lobby import admin_add_profanity_filters as admin_add_profanity_filters_internal
...
def admin_add_profanity_filters(
    ...
    _, error = admin_add_profanity_filters_internal(
        body=body,
        list_=list_,
        namespace=namespace,
    )
