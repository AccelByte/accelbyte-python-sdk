...
from accelbyte_py_sdk.api.iam import (
    admin_revoke_user_from_role_v4 as admin_revoke_user_from_role_v4_internal,
)
...
def admin_revoke_user_from_role_v4(
    ...
    result, error = admin_revoke_user_from_role_v4_internal(
        body=body,
        role_id=role_id,
...
admin_revoke_user_from_role_v4.operation_id = "AdminRevokeUserFromRoleV4"
admin_revoke_user_from_role_v4.is_deprecated = False
