...
from accelbyte_py_sdk.api.iam import get_user_justice_platform_account as get_user_justice_platform_account_internal
...
def get_user_justice_platform_account(
    ...
    _, error = get_user_justice_platform_account_internal(
