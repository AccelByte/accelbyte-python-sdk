...
from accelbyte_py_sdk.api.iam import admin_list_user_id_by_user_i_ds_v3 as admin_list_user_id_by_user_i_ds_v3_internal
...
def admin_list_user_id_by_user_i_ds_v3(
    ...
    _, error = admin_list_user_id_by_user_i_ds_v3_internal(
        body=body,
        namespace=namespace,
    ...
    click.echo("AdminListUserIDByUserIDsV3 success")
