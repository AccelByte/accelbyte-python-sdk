...
from accelbyte_py_sdk.api.iam import get_user_by_platform_user_id as get_user_by_platform_user_id_internal
...
def get_user_by_platform_user_id(
    ...
    _, error = get_user_by_platform_user_id_internal(
