...
def admin_ban_user_v3(
    ...
    if doc:
        click.echo(admin_ban_user_v3_internal.__doc__)
        return
    ...
    result, error = admin_ban_user_v3_internal(
        body=body,
        user_id=user_id,
        namespace=namespace,
    ...
    if error:
        raise Exception(f"AdminBanUserV3 failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


admin_ban_user_v3.operation_id = "AdminBanUserV3"
admin_ban_user_v3.is_deprecated = False
