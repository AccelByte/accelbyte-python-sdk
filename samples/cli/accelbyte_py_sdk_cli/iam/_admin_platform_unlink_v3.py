...
from accelbyte_py_sdk.api.iam import admin_platform_unlink_v3 as admin_platform_unlink_v3_internal
...
def admin_platform_unlink_v3(
    ...
    _, error = admin_platform_unlink_v3_internal(
        body=body,
    ...
    click.echo("AdminPlatformUnlinkV3 success")
