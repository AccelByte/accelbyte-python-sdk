...
from accelbyte_py_sdk.api.iam import (
    delete_user_information as delete_user_information_internal,
)
...
def delete_user_information(
    ...
    if doc:
        click.echo(delete_user_information_internal.__doc__)
        return
...
delete_user_information.is_deprecated = True
