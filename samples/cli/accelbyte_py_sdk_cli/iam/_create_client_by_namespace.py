...
from accelbyte_py_sdk.api.iam import (
    create_client_by_namespace as create_client_by_namespace_internal,
)
...
create_client_by_namespace.operation_id = "CreateClientByNamespace"
create_client_by_namespace.is_deprecated = True
