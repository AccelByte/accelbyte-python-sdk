...
from accelbyte_py_sdk.api.iam import admin_add_client_permissions_v3 as admin_add_client_permissions_v3_internal
...
def admin_add_client_permissions_v3(
    ...
    if doc:
        click.echo(admin_add_client_permissions_v3_internal.__doc__)
        return
    ...
    _, error = admin_add_client_permissions_v3_internal(
        body=body,
        client_id=client_id,
        namespace=namespace,
    )
    ...
    click.echo("AdminAddClientPermissionsV3 success")
