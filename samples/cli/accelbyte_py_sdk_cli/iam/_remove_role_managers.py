...
from accelbyte_py_sdk.api.iam import remove_role_managers as remove_role_managers_internal
...
def remove_role_managers(
    ...
    result, error = remove_role_managers_internal(
        body=body,
        role_id=role_id,
...
remove_role_managers.is_deprecated = True
