...
from accelbyte_py_sdk.api.iam import (
    admin_retrieve_user_third_party_platform_token_v3 as admin_retrieve_user_third_party_platform_token_v3_internal,
)
...
def admin_retrieve_user_third_party_platform_token_v3(
    ...
    if error:
        raise Exception(
            f"AdminRetrieveUserThirdPartyPlatformTokenV3 failed: {str(error)}"
        )
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


admin_retrieve_user_third_party_platform_token_v3.operation_id = (
