...
from accelbyte_py_sdk.api.iam import (
    public_list_user_all_platform_accounts_distinct_v3 as public_list_user_all_platform_accounts_distinct_v3_internal,
)
...
def public_list_user_all_platform_accounts_distinct_v3(
    ...
    if error:
        raise Exception(
            f"PublicListUserAllPlatformAccountsDistinctV3 failed: {str(error)}"
        )
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


public_list_user_all_platform_accounts_distinct_v3.operation_id = (
