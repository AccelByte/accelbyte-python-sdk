...
from accelbyte_py_sdk.api.iam import admin_delete_user_information_v3 as admin_delete_user_information_v3_internal
...
def admin_delete_user_information_v3(
    ...
    _, error = admin_delete_user_information_v3_internal(
        user_id=user_id,
        namespace=namespace,
    )
    if error:
