...
from accelbyte_py_sdk.api.iam import admin_remove_role_members_v3 as admin_remove_role_members_v3_internal
...
def admin_remove_role_members_v3(
    ...
    _, error = admin_remove_role_members_v3_internal(
        body=body,
        role_id=role_id,
    )
    if error:
