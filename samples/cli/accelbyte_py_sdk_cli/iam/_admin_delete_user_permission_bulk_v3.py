...
from accelbyte_py_sdk.api.iam import admin_delete_user_permission_bulk_v3 as admin_delete_user_permission_bulk_v3_internal
...
def admin_delete_user_permission_bulk_v3(
    ...
    _, error = admin_delete_user_permission_bulk_v3_internal(
        body=body,
        user_id=user_id,
        namespace=namespace,
    )
