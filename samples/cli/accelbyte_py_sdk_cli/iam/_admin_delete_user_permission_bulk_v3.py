...
from accelbyte_py_sdk.api.iam import (
    admin_delete_user_permission_bulk_v3 as admin_delete_user_permission_bulk_v3_internal,
)
...
def admin_delete_user_permission_bulk_v3(
    ...
    if body is not None:
        try:
            ...
            body = [
                ModelPermissionDeleteRequest.create_from_dict(i0) for i0 in body_json
            ]
