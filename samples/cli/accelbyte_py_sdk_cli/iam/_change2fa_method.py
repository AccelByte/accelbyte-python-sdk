...
from accelbyte_py_sdk.api.iam import change2fa_method as change2fa_method_internal
...
def change2fa_method(
    ...
    if doc:
        click.echo(change2fa_method_internal.__doc__)
        return
    ...
    result, error = change2fa_method_internal(
        factor=factor,
        mfa_token=mfa_token,
