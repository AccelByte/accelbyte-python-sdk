...
from accelbyte_py_sdk.api.iam import admin_add_role_permissions_v4 as admin_add_role_permissions_v4_internal
...
def admin_add_role_permissions_v4(
    ...
    result, error = admin_add_role_permissions_v4_internal(
        body=body,
        role_id=role_id,
...
admin_add_role_permissions_v4.operation_id = "AdminAddRolePermissionsV4"
admin_add_role_permissions_v4.is_deprecated = False
