...
from accelbyte_py_sdk.api.iam import admin_get_user_platform_accounts_v3 as admin_get_user_platform_accounts_v3_internal
...
def admin_get_user_platform_accounts_v3(
    ...
    _, error = admin_get_user_platform_accounts_v3_internal(
        user_id=user_id,
        after=after,
        before=before,
        limit=limit,
