...
from accelbyte_py_sdk.api.iam import (
    admin_decrypt_device_v4 as admin_decrypt_device_v4_internal,
)
...
def admin_decrypt_device_v4(
    ...
    if doc:
        click.echo(admin_decrypt_device_v4_internal.__doc__)
        return
    ...
    result, error = admin_decrypt_device_v4_internal(
        device_id=device_id,
        namespace=namespace,
        x_additional_headers=x_additional_headers,
    )
    if error:
        raise Exception(f"AdminDecryptDeviceV4 failed: {str(error)}")
