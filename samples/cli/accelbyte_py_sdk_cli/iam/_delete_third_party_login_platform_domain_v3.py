...
from accelbyte_py_sdk.api.iam import (
    delete_third_party_login_platform_domain_v3 as delete_third_party_login_platform_domain_v3_internal,
)
...
def delete_third_party_login_platform_domain_v3(
    ...
    if doc:
        click.echo(delete_third_party_login_platform_domain_v3_internal.__doc__)
        return
...
delete_third_party_login_platform_domain_v3.operation_id = (
    "DeleteThirdPartyLoginPlatformDomainV3"
)
delete_third_party_login_platform_domain_v3.is_deprecated = False
