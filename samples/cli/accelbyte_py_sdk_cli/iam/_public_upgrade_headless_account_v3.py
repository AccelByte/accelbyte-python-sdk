...
from accelbyte_py_sdk.api.iam import public_upgrade_headless_account_v3 as public_upgrade_headless_account_v3_internal
...
def public_upgrade_headless_account_v3(
    ...
    _, error = public_upgrade_headless_account_v3_internal(
        body=body,
        namespace=namespace,
