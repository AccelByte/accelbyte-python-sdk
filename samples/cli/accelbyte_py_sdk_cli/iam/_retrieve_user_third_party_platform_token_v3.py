...
from accelbyte_py_sdk.api.iam import (
    retrieve_user_third_party_platform_token_v3 as retrieve_user_third_party_platform_token_v3_internal,
)
...
retrieve_user_third_party_platform_token_v3.operation_id = (
