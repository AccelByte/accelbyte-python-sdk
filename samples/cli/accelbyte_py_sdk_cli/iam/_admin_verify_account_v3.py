...
from accelbyte_py_sdk.api.iam import admin_verify_account_v3 as admin_verify_account_v3_internal
...
def admin_verify_account_v3(
    ...
    if doc:
        click.echo(admin_verify_account_v3_internal.__doc__)
        return
    ...
    _, error = admin_verify_account_v3_internal(
        body=body,
        user_id=user_id,
        namespace=namespace,
    )
    ...
    click.echo("AdminVerifyAccountV3 success")
