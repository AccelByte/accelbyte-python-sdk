...
from accelbyte_py_sdk.api.iam import (
    add_third_party_login_platform_credential_v3 as add_third_party_login_platform_credential_v3_internal,
)
...
add_third_party_login_platform_credential_v3.operation_id = (
