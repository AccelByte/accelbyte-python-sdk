...
from accelbyte_py_sdk.api.ugc import get_group_content as get_group_content_internal
...
def get_group_content(
    ...
    if doc:
        click.echo(get_group_content_internal.__doc__)
        return
    ...
    result, error = get_group_content_internal(
        group_id=group_id,
        user_id=user_id,
        limit=limit,
        offset=offset,
