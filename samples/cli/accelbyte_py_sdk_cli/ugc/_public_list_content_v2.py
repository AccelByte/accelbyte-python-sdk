...
from accelbyte_py_sdk.api.ugc import (
    public_list_content_v2 as public_list_content_v2_internal,
)
...
def public_list_content_v2(
    ...
    if doc:
        click.echo(public_list_content_v2_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"PublicListContentV2 failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


public_list_content_v2.operation_id = "PublicListContentV2"
public_list_content_v2.is_deprecated = False
