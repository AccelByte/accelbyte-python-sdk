...
from accelbyte_py_sdk.api.ugc import admin_get_specific_content as admin_get_specific_content_internal
...
def admin_get_specific_content(
    ...
    _, error = admin_get_specific_content_internal(
        content_id=content_id,
        namespace=namespace,
    )
    if error:
        raise Exception(f"AdminGetSpecificContent failed: {str(error)}")
    click.echo("AdminGetSpecificContent success")
