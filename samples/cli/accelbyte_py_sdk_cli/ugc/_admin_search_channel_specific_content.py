...
from accelbyte_py_sdk.api.ugc import (
    admin_search_channel_specific_content as admin_search_channel_specific_content_internal,
)
...
def admin_search_channel_specific_content(
    ...
    if doc:
        click.echo(admin_search_channel_specific_content_internal.__doc__)
        return
