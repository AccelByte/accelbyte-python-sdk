...
from accelbyte_py_sdk.api.ugc import search_channel_specific_content as search_channel_specific_content_internal
...
def search_channel_specific_content(
    ...
    if doc:
        click.echo(search_channel_specific_content_internal.__doc__)
        return
    login_as_internal(login_as)
    _, error = search_channel_specific_content_internal(
    ...
    click.echo("SearchChannelSpecificContent success")
