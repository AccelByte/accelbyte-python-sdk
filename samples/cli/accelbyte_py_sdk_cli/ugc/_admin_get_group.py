...
from accelbyte_py_sdk.api.ugc import admin_get_group as admin_get_group_internal
...
def admin_get_group(
    ...
    if doc:
        click.echo(admin_get_group_internal.__doc__)
        return
    ...
    result, error = admin_get_group_internal(
        group_id=group_id,
        user_id=user_id,
        namespace=namespace,
