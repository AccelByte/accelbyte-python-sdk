...
from accelbyte_py_sdk.api.ugc import single_admin_update_content_s3 as single_admin_update_content_s3_internal
...
def single_admin_update_content_s3(
    ...
    _, error = single_admin_update_content_s3_internal(
        body=body,
    ...
    click.echo("SingleAdminUpdateContentS3 success")
