...
from accelbyte_py_sdk.api.ugc import (
    single_admin_update_content_s3 as single_admin_update_content_s3_internal,
)
...
def single_admin_update_content_s3(
    ...
    if doc:
        click.echo(single_admin_update_content_s3_internal.__doc__)
        return
    ...
    result, error = single_admin_update_content_s3_internal(
        body=body,
