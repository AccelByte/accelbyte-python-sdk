...
from accelbyte_py_sdk.api.ugc import get_public_followers as get_public_followers_internal
...
def get_public_followers(
    ...
    if doc:
        click.echo(get_public_followers_internal.__doc__)
        return
    ...
    result, error = get_public_followers_internal(
        user_id=user_id,
        limit=limit,
        offset=offset,
        namespace=namespace,
