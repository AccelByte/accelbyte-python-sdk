...
from accelbyte_py_sdk.api.ugc import delete_content as delete_content_internal
...
def delete_content(
    ...
    if doc:
        click.echo(delete_content_internal.__doc__)
        return
    ...
    result, error = delete_content_internal(
