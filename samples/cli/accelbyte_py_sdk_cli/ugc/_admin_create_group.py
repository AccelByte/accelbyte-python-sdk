...
from accelbyte_py_sdk.api.ugc import admin_create_group as admin_create_group_internal
...
def admin_create_group(
    ...
    if doc:
        click.echo(admin_create_group_internal.__doc__)
        return
    ...
    result, error = admin_create_group_internal(
        body=body,
        namespace=namespace,
