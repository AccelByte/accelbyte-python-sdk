...
from accelbyte_py_sdk.api.ugc import (
    admin_get_all_groups as admin_get_all_groups_internal,
)
...
def admin_get_all_groups(
    ...
    if doc:
        click.echo(admin_get_all_groups_internal.__doc__)
        return
...
admin_get_all_groups.operation_id = "AdminGetAllGroups"
admin_get_all_groups.is_deprecated = False
