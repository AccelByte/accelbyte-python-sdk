...
from accelbyte_py_sdk.api.ugc import admin_upload_content_direct as admin_upload_content_direct_internal
...
def admin_upload_content_direct(
    ...
    if doc:
        click.echo(admin_upload_content_direct_internal.__doc__)
        return
    ...
    _, error = admin_upload_content_direct_internal(
        body=body,
    ...
    click.echo("AdminUploadContentDirect success")
