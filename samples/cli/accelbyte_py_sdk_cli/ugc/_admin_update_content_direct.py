...
from accelbyte_py_sdk.api.ugc import admin_update_content_direct as admin_update_content_direct_internal
...
def admin_update_content_direct(
    ...
    if doc:
        click.echo(admin_update_content_direct_internal.__doc__)
        return
    ...
    _, error = admin_update_content_direct_internal(
        body=body,
    ...
    click.echo("AdminUpdateContentDirect success")
