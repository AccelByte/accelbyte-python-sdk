...
from accelbyte_py_sdk.api.ugc import get_followed_content as get_followed_content_internal
...
def get_followed_content(
    ...
    if doc:
        click.echo(get_followed_content_internal.__doc__)
        return
    login_as_internal(login_as)
    _, error = get_followed_content_internal(
        limit=limit,
        offset=offset,
        namespace=namespace,
    )
    ...
    click.echo("GetFollowedContent success")
