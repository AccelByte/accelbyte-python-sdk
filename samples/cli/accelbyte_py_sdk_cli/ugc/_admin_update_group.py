...
from accelbyte_py_sdk.api.ugc import admin_update_group as admin_update_group_internal
...
def admin_update_group(
    ...
    if doc:
        click.echo(admin_update_group_internal.__doc__)
        return
    ...
    result, error = admin_update_group_internal(
        body=body,
        group_id=group_id,
        user_id=user_id,
        namespace=namespace,
