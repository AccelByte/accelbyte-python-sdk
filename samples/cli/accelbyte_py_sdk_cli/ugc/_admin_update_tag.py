...
from accelbyte_py_sdk.api.ugc import admin_update_tag as admin_update_tag_internal
...
def admin_update_tag(
    ...
    if doc:
        click.echo(admin_update_tag_internal.__doc__)
        return
    ...
    result, error = admin_update_tag_internal(
        body=body,
        tag_id=tag_id,
        namespace=namespace,
