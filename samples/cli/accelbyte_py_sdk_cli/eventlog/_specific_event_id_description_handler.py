...
from accelbyte_py_sdk.api.eventlog import specific_event_id_description_handler as specific_event_id_description_handler_internal
...
def specific_event_id_description_handler(
    ...
    result, error = specific_event_id_description_handler_internal(
        event_ids=event_ids,
...
specific_event_id_description_handler.operation_id = "SpecificEventIDDescriptionHandler"
specific_event_id_description_handler.is_deprecated = True
