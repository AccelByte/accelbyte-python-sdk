...
from accelbyte_py_sdk.api.eventlog import (
    get_event_by_event_type_and_event_id_handler as get_event_by_event_type_and_event_id_handler_internal,
)
...
def get_event_by_event_type_and_event_id_handler(
    ...
    result, error = get_event_by_event_type_and_event_id_handler_internal(
        event_id=event_id,
...
get_event_by_event_type_and_event_id_handler.operation_id = (
    "GetEventByEventTypeAndEventIDHandler"
)
get_event_by_event_type_and_event_id_handler.is_deprecated = True
