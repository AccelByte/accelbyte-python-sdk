...
from accelbyte_py_sdk.api.eventlog import (
    get_event_by_event_id_handler as get_event_by_event_id_handler_internal,
)
...
def get_event_by_event_id_handler(
    ...
    result, error = get_event_by_event_id_handler_internal(
        event_id=event_id,
        end_date=end_date,
        page_size=page_size,
...
get_event_by_event_id_handler.operation_id = "GetEventByEventIDHandler"
get_event_by_event_id_handler.is_deprecated = True
