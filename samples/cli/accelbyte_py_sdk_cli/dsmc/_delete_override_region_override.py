...
from accelbyte_py_sdk.api.dsmc import delete_override_region_override as delete_override_region_override_internal
...
def delete_override_region_override(
    ...
    _, error = delete_override_region_override_internal(
