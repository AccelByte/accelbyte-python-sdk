...
from accelbyte_py_sdk.api.dsmc import (
    count_server_detailed as count_server_detailed_internal,
)
...
count_server_detailed.operation_id = "CountServerDetailed"
count_server_detailed.is_deprecated = False
