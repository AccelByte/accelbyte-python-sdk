...
from accelbyte_py_sdk.api.dsmc import update_pod_config as update_pod_config_internal
...
update_pod_config.operation_id = "UpdatePodConfig"
update_pod_config.is_deprecated = False
