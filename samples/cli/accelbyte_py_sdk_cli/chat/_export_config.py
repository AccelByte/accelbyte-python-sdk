...
from accelbyte_py_sdk.api.chat import export_config as export_config_internal
...
def export_config(
    ...
    result, error = export_config_internal(
        namespace=namespace,
...
export_config.operation_id = "ExportConfig"
export_config.is_deprecated = False
