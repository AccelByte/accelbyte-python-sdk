...
from accelbyte_py_sdk.api.gdpr import (
    public_get_user_account_deletion_status as public_get_user_account_deletion_status_internal,
)
...
def public_get_user_account_deletion_status(
    ...
    if doc:
        click.echo(public_get_user_account_deletion_status_internal.__doc__)
        return
    ...
    result, error = public_get_user_account_deletion_status_internal(
        user_id=user_id,
        namespace=namespace,
...
public_get_user_account_deletion_status.operation_id = (
