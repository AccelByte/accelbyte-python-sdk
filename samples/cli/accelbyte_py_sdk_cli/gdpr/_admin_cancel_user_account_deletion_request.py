...
from accelbyte_py_sdk.api.gdpr import (
    admin_cancel_user_account_deletion_request as admin_cancel_user_account_deletion_request_internal,
)
...
admin_cancel_user_account_deletion_request.operation_id = (
