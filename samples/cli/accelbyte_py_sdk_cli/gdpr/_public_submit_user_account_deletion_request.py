...
from accelbyte_py_sdk.api.gdpr import (
    public_submit_user_account_deletion_request as public_submit_user_account_deletion_request_internal,
)
...
public_submit_user_account_deletion_request.operation_id = (
