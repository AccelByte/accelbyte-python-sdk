...
from accelbyte_py_sdk.api.gdpr import (
    admin_get_user_personal_data_requests as admin_get_user_personal_data_requests_internal,
)
...
def admin_get_user_personal_data_requests(
    ...
    result, error = admin_get_user_personal_data_requests_internal(
        user_id=user_id,
        limit=limit,
        offset=offset,
        namespace=namespace,
...
admin_get_user_personal_data_requests.operation_id = "AdminGetUserPersonalDataRequests"
admin_get_user_personal_data_requests.is_deprecated = False
