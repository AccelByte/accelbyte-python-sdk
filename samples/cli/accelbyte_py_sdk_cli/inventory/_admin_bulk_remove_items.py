...
def admin_bulk_remove_items(
    ...
    if doc:
        click.echo(admin_bulk_remove_items_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"AdminBulkRemoveItems failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


admin_bulk_remove_items.operation_id = "AdminBulkRemoveItems"
admin_bulk_remove_items.is_deprecated = False
