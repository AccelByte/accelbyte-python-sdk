...
from accelbyte_py_sdk.api.inventory import admin_create_tag as admin_create_tag_internal
...
def admin_create_tag(
    ...
    if body is not None:
        try:
            ...
            body = ApimodelsCreateTagReq.create_from_dict(body_json)
        except ValueError as e:
            raise Exception(f"Invalid JSON for 'body'. {str(e)}") from e
    result, error = admin_create_tag_internal(
        body=body,
        namespace=namespace,
