...
from accelbyte_py_sdk.api.challenge import (
    admin_get_challenges as admin_get_challenges_internal,
)
...
def admin_get_challenges(
    ...
    if doc:
        click.echo(admin_get_challenges_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"adminGetChallenges failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


admin_get_challenges.operation_id = "adminGetChallenges"
admin_get_challenges.is_deprecated = False
