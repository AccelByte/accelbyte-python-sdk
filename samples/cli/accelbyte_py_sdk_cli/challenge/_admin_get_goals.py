...
from accelbyte_py_sdk.api.challenge import admin_get_goals as admin_get_goals_internal
...
def admin_get_goals(
    ...
    if doc:
        click.echo(admin_get_goals_internal.__doc__)
        return
    ...
    result, error = admin_get_goals_internal(
    ...
    if error:
        raise Exception(f"adminGetGoals failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


admin_get_goals.operation_id = "adminGetGoals"
admin_get_goals.is_deprecated = False
