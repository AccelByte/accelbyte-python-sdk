...
def admin_update_challenge(
    ...
    if doc:
        click.echo(admin_update_challenge_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"adminUpdateChallenge failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


admin_update_challenge.operation_id = "adminUpdateChallenge"
admin_update_challenge.is_deprecated = False
