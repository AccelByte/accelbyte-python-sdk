...
def public_get_scheduled_goals(
    ...
    if doc:
        click.echo(public_get_scheduled_goals_internal.__doc__)
        return
    ...
    result, error = public_get_scheduled_goals_internal(
    ...
    if error:
        raise Exception(f"publicGetScheduledGoals failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


public_get_scheduled_goals.operation_id = "publicGetScheduledGoals"
public_get_scheduled_goals.is_deprecated = False
