...
def join_game_session(
    ...
    if doc:
        click.echo(join_game_session_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"joinGameSession failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


join_game_session.operation_id = "joinGameSession"
join_game_session.is_deprecated = False
