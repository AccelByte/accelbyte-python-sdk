...
def public_party_join(
    ...
    if doc:
        click.echo(public_party_join_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"publicPartyJoin failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


public_party_join.operation_id = "publicPartyJoin"
public_party_join.is_deprecated = False
