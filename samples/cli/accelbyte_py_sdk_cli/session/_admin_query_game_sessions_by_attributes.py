...
def admin_query_game_sessions_by_attributes(
    ...
    if doc:
        click.echo(admin_query_game_sessions_by_attributes_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"adminQueryGameSessionsByAttributes failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


admin_query_game_sessions_by_attributes.operation_id = (
    "adminQueryGameSessionsByAttributes"
)
admin_query_game_sessions_by_attributes.is_deprecated = False
