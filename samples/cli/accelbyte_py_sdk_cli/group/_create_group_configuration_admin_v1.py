...
from accelbyte_py_sdk.api.group import create_group_configuration_admin_v1 as create_group_configuration_admin_v1_internal
...
def create_group_configuration_admin_v1(
    ...
    _, error = create_group_configuration_admin_v1_internal(
        body=body,
        namespace=namespace,
    )
    if error:
