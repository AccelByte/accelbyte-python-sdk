...
from accelbyte_py_sdk.api.group import delete_member_role_public_v1 as delete_member_role_public_v1_internal
...
def delete_member_role_public_v1(
    ...
    _, error = delete_member_role_public_v1_internal(
        body=body,
