...
from accelbyte_py_sdk.api.group import get_group_members_list_public_v1 as get_group_members_list_public_v1_internal
...
def get_group_members_list_public_v1(
    ...
    result, error = get_group_members_list_public_v1_internal(
        group_id=group_id,
        limit=limit,
        offset=offset,
        order=order,
