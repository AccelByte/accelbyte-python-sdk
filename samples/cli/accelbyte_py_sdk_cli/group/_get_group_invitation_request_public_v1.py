...
from accelbyte_py_sdk.api.group import (
    get_group_invitation_request_public_v1 as get_group_invitation_request_public_v1_internal,
)
...
def get_group_invitation_request_public_v1(
    ...
    result, error = get_group_invitation_request_public_v1_internal(
        limit=limit,
        offset=offset,
        namespace=namespace,
...
get_group_invitation_request_public_v1.operation_id = (
    "getGroupInvitationRequestPublicV1"
)
get_group_invitation_request_public_v1.is_deprecated = False
