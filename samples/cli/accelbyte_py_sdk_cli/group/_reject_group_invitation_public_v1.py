...
from accelbyte_py_sdk.api.group import reject_group_invitation_public_v1 as reject_group_invitation_public_v1_internal
...
def reject_group_invitation_public_v1(
    ...
    _, error = reject_group_invitation_public_v1_internal(
        group_id=group_id,
        namespace=namespace,
    )
    if error:
