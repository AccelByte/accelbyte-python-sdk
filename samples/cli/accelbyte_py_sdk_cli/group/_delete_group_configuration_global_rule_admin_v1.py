...
from accelbyte_py_sdk.api.group import (
    delete_group_configuration_global_rule_admin_v1 as delete_group_configuration_global_rule_admin_v1_internal,
)
...
def delete_group_configuration_global_rule_admin_v1(
    ...
    if error:
        raise Exception(
            f"deleteGroupConfigurationGlobalRuleAdminV1 failed: {str(error)}"
        )
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


delete_group_configuration_global_rule_admin_v1.operation_id = (
