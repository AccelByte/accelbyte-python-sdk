...
from accelbyte_py_sdk.api.group import reject_group_join_request_public_v1 as reject_group_join_request_public_v1_internal
...
def reject_group_join_request_public_v1(
    ...
    result, error = reject_group_join_request_public_v1_internal(
        user_id=user_id,
        namespace=namespace,
