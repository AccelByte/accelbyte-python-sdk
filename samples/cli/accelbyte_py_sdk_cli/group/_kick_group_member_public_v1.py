...
from accelbyte_py_sdk.api.group import kick_group_member_public_v1 as kick_group_member_public_v1_internal
...
def kick_group_member_public_v1(
    ...
    _, error = kick_group_member_public_v1_internal(
        user_id=user_id,
        namespace=namespace,
    )
    if error:
