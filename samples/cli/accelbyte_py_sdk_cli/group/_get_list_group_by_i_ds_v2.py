...
def get_list_group_by_i_ds_v2(
    ...
    if doc:
        click.echo(get_list_group_by_i_ds_v2_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"getListGroupByIDsV2 failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


get_list_group_by_i_ds_v2.operation_id = "getListGroupByIDsV2"
get_list_group_by_i_ds_v2.is_deprecated = False
