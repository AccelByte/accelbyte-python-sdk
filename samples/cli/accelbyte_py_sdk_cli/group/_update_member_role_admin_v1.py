...
from accelbyte_py_sdk.api.group import (
    update_member_role_admin_v1 as update_member_role_admin_v1_internal,
)
...
def update_member_role_admin_v1(
    ...
    result, error = update_member_role_admin_v1_internal(
        body=body,
...
update_member_role_admin_v1.operation_id = "updateMemberRoleAdminV1"
update_member_role_admin_v1.is_deprecated = False
