...
from accelbyte_py_sdk.api.social import public_inc_user_stat_item as public_inc_user_stat_item_internal
...
def public_inc_user_stat_item(
    ...
    if doc:
        click.echo(public_inc_user_stat_item_internal.__doc__)
        return
    ...
    _, error = public_inc_user_stat_item_internal(
        stat_code=stat_code,
        user_id=user_id,
        body=body,
        namespace=namespace,
    ...
    click.echo("publicIncUserStatItem success")
