...
from accelbyte_py_sdk.api.social import public_get_user_namespace_slots as public_get_user_namespace_slots_internal
...
def public_get_user_namespace_slots(
    ...
    _, error = public_get_user_namespace_slots_internal(
        user_id=user_id,
        namespace=namespace,
