...
from accelbyte_py_sdk.api.social import bulk_inc_user_stat_item_value_2 as bulk_inc_user_stat_item_value_2_internal
...
def bulk_inc_user_stat_item_value_2(
    ...
    _, error = bulk_inc_user_stat_item_value_2_internal(
        user_id=user_id,
        body=body,
        namespace=namespace,
    )
