...
from accelbyte_py_sdk.api.social import public_delete_user_namespace_slot as public_delete_user_namespace_slot_internal
...
def public_delete_user_namespace_slot(
    ...
    _, error = public_delete_user_namespace_slot_internal(
        slot_id=slot_id,
        user_id=user_id,
        namespace=namespace,
