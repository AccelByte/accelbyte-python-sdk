...
from accelbyte_py_sdk.api.social import bulk_update_user_stat_item_1 as bulk_update_user_stat_item_1_internal
...
def bulk_update_user_stat_item_1(
    ...
    result, error = bulk_update_user_stat_item_1_internal(
        body=body,
        namespace=namespace,
...
bulk_update_user_stat_item_1.operation_id = "bulkUpdateUserStatItem_1"
bulk_update_user_stat_item_1.is_deprecated = False
