...
from accelbyte_py_sdk.api.social import bulk_update_user_stat_item_2 as bulk_update_user_stat_item_2_internal
...
def bulk_update_user_stat_item_2(
    ...
    _, error = bulk_update_user_stat_item_2_internal(
        user_id=user_id,
        body=body,
