...
def development_server_configuration_list(
    ...
    if doc:
        click.echo(development_server_configuration_list_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"DevelopmentServerConfigurationList failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


development_server_configuration_list.operation_id = (
    "DevelopmentServerConfigurationList"
)
development_server_configuration_list.is_deprecated = False
