...
def update_secret_v2(
    ...
    if doc:
        click.echo(update_secret_v2_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"UpdateSecretV2 failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


update_secret_v2.operation_id = "UpdateSecretV2"
update_secret_v2.is_deprecated = False
