...
def save_secret_v2(
    ...
    if doc:
        click.echo(save_secret_v2_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"SaveSecretV2 failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


save_secret_v2.operation_id = "SaveSecretV2"
save_secret_v2.is_deprecated = False
