...
from accelbyte_py_sdk.api.cloudsave import (
    bulk_get_player_public_record_handler_v1 as bulk_get_player_public_record_handler_v1_internal,
)
...
def bulk_get_player_public_record_handler_v1(
    ...
    result, error = bulk_get_player_public_record_handler_v1_internal(
        body=body,
        key=key,
        namespace=namespace,
...
bulk_get_player_public_record_handler_v1.operation_id = (
