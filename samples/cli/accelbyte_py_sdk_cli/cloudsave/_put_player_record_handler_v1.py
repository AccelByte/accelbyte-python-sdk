...
from accelbyte_py_sdk.api.cloudsave import put_player_record_handler_v1 as put_player_record_handler_v1_internal
...
def put_player_record_handler_v1(
    ...
    _, error = put_player_record_handler_v1_internal(
        body=body,
        key=key,
        user_id=user_id,
        namespace=namespace,
