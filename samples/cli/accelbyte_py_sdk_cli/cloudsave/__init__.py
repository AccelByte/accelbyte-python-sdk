...
# justice-cloudsave-service (3.12.9)
...
from ._admin_put_player_records_handler_v1 import admin_put_player_records_handler_v1
...
commands = [
    ...
    admin_put_player_records_handler_v1,
