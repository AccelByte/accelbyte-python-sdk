...
from accelbyte_py_sdk.api.leaderboard import (
    delete_user_ranking_public_v1 as delete_user_ranking_public_v1_internal,
)
...
def delete_user_ranking_public_v1(
    ...
    if doc:
        click.echo(delete_user_ranking_public_v1_internal.__doc__)
        return
    ...
    result, error = delete_user_ranking_public_v1_internal(
