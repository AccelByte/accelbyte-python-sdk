...
from ....api.leaderboard import get_today_leaderboard_ranking_admin_v1 as get_today_leaderboard_ranking_admin_v1_internal
...
def get_today_leaderboard_ranking_admin_v1(
    ...
    _, error = get_today_leaderboard_ranking_admin_v1_internal(
    ...
    click.echo("GetTodayLeaderboardRankingAdminV1 success")
