...
from accelbyte_py_sdk.api.leaderboard import (
    update_leaderboard_configuration_admin_v1 as update_leaderboard_configuration_admin_v1_internal,
)
...
def update_leaderboard_configuration_admin_v1(
    ...
    result, error = update_leaderboard_configuration_admin_v1_internal(
        body=body,
...
update_leaderboard_configuration_admin_v1.operation_id = (
