...
from accelbyte_py_sdk.api.leaderboard import (
    delete_bulk_leaderboard_configuration_admin_v1 as delete_bulk_leaderboard_configuration_admin_v1_internal,
)
...
def delete_bulk_leaderboard_configuration_admin_v1(
    ...
    if error:
        raise Exception(
            f"deleteBulkLeaderboardConfigurationAdminV1 failed: {str(error)}"
        )
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


delete_bulk_leaderboard_configuration_admin_v1.operation_id = (
    "deleteBulkLeaderboardConfigurationAdminV1"
)
delete_bulk_leaderboard_configuration_admin_v1.is_deprecated = False
