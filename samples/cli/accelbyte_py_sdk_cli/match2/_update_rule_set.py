...
def update_rule_set(
    ...
    if doc:
        click.echo(update_rule_set_internal.__doc__)
        return
    ...
    if error:
        raise Exception(f"UpdateRuleSet failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


update_rule_set.operation_id = "UpdateRuleSet"
update_rule_set.is_deprecated = False
