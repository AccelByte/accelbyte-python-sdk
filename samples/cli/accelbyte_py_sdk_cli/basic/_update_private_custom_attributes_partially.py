...
from accelbyte_py_sdk.api.basic import (
    update_private_custom_attributes_partially as update_private_custom_attributes_partially_internal,
)
...
update_private_custom_attributes_partially.operation_id = (
