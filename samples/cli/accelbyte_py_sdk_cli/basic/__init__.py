...
from ._update_country_group import update_country_group
...
from ._update_user_profile import update_user_profile
from ._delete_user_profile import delete_user_profile
...
commands = [
    ...
    update_user_profile,
    delete_user_profile,
    get_custom_attributes_info,
    update_custom_attributes_partially,
    get_private_custom_attributes_info,
    update_private_custom_attributes_partially,
    ...
    public_create_user_profile,
    public_get_custom_attributes_info,
    public_update_custom_attributes_partially,
    public_get_user_profile_public_info,
    public_update_user_profile_status,
]
