...
from accelbyte_py_sdk.api.basic import (
    public_update_user_profile_status as public_update_user_profile_status_internal,
)
...
def public_update_user_profile_status(
    ...
    result, error = public_update_user_profile_status_internal(
        user_id=user_id,
        body=body,
        namespace=namespace,
...
public_update_user_profile_status.operation_id = "publicUpdateUserProfileStatus"
public_update_user_profile_status.is_deprecated = False
