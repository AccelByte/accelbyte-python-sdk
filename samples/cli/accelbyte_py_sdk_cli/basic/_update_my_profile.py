...
from ....api.basic import update_my_profile as update_my_profile_internal
...
def update_my_profile(
    ...
    if doc:
        click.echo(update_my_profile_internal.__doc__)
        return
    ...
    _, error = update_my_profile_internal(
        body=body,
        namespace=namespace,
    )
    if error:
        raise Exception(f"updateMyProfile failed: {str(error)}")
    click.echo("updateMyProfile success")
