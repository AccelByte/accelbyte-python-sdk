...
from accelbyte_py_sdk.api.seasonpass import publish_season as publish_season_internal
...
def publish_season(
    ...
    if doc:
        click.echo(publish_season_internal.__doc__)
        return
    ...
    result, error = publish_season_internal(
        season_id=season_id,
        namespace=namespace,
