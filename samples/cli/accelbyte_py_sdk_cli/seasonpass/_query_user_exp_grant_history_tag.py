...
def query_user_exp_grant_history_tag(
    ...
    if error:
        raise Exception(f"queryUserExpGrantHistoryTag failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


query_user_exp_grant_history_tag.operation_id = "queryUserExpGrantHistoryTag"
query_user_exp_grant_history_tag.is_deprecated = False
