...
from accelbyte_py_sdk.api.seasonpass import query_passes as query_passes_internal
...
def query_passes(
    ...
    if doc:
        click.echo(query_passes_internal.__doc__)
        return
    ...
    result, error = query_passes_internal(
        season_id=season_id,
        namespace=namespace,
