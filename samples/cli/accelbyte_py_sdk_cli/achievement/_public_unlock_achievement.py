...
from accelbyte_py_sdk.api.achievement import public_unlock_achievement as public_unlock_achievement_internal
...
def public_unlock_achievement(
    ...
    _, error = public_unlock_achievement_internal(
    ...
    click.echo("PublicUnlockAchievement success")
