...
from accelbyte_py_sdk.api.achievement import admin_list_user_achievements as admin_list_user_achievements_internal
...
def admin_list_user_achievements(
    ...
    _, error = admin_list_user_achievements_internal(
        user_id=user_id,
        limit=limit,
        offset=offset,
    ...
    click.echo("AdminListUserAchievements success")
