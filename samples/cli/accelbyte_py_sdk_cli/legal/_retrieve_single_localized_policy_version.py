...
from accelbyte_py_sdk.api.legal import (
    retrieve_single_localized_policy_version as retrieve_single_localized_policy_version_internal,
)
...
def retrieve_single_localized_policy_version(
    ...
    result, error = retrieve_single_localized_policy_version_internal(
...
retrieve_single_localized_policy_version.operation_id = (
    "retrieveSingleLocalizedPolicyVersion"
)
retrieve_single_localized_policy_version.is_deprecated = False
