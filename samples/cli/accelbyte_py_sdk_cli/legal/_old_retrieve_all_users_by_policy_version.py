...
from accelbyte_py_sdk.api.legal import (
    old_retrieve_all_users_by_policy_version as old_retrieve_all_users_by_policy_version_internal,
)
...
def old_retrieve_all_users_by_policy_version(
    ...
    if doc:
        click.echo(old_retrieve_all_users_by_policy_version_internal.__doc__)
        return
    ...
    result, error = old_retrieve_all_users_by_policy_version_internal(
    ...
    if error:
        raise Exception(f"oldRetrieveAllUsersByPolicyVersion failed: {str(error)}")
