...
from accelbyte_py_sdk.api.legal import (
    old_update_localized_policy_version as old_update_localized_policy_version_internal,
)
...
def old_update_localized_policy_version(
    ...
    if doc:
        click.echo(old_update_localized_policy_version_internal.__doc__)
        return
    ...
    result, error = old_update_localized_policy_version_internal(
        localized_policy_version_id=localized_policy_version_id,
        body=body,
        x_additional_headers=x_additional_headers,
    )
    if error:
        raise Exception(f"oldUpdateLocalizedPolicyVersion failed: {str(error)}")
