...
social-bulk-get-stat-cycle '{"cycleIds": ["6DaDpv8N7ZQVqGj6", "bPngUNB1vRodwpzS", "oDLjWjkY1aXlFcDt"]}' --login_with_auth "Bearer foo"
...
social-create-stat '{"capCycleOverride": false, "cycleIds": ["RBaAkLnvxkT1X68c", "mDc3fxU8MyKrQpM4", "hkkK6KKXNB3Gv0Iq"], "cycleOverrides": [{"cycleId": "mF51TkhjYnaq6foW", "maximum": 0.34727053930874796, "minimum": 0.7992755215754995}, {"cycleId": "a3bMrXsDr6kILsSS", "maximum": 0.39911652978498113, "minimum": 0.4825982429531729}, {"cycleId": "dmykmoPYgc2L4jk4", "maximum": 0.601197850873372, "minimum": 0.23972943158936733}], "defaultValue": 0.8450331781700982, "description": "LSP0pf4IxjUkl535", "globalAggregationMethod": "LAST", "ignoreAdditionalDataOnValueRejected": true, "incrementOnly": true, "isPublic": false, "maximum": 0.7980589456189408, "minimum": 0.1750964491930096, "name": "sUC9b6i5lZC9xv32", "setAsGlobal": false, "setBy": "CLIENT", "statCode": "8c5csSovoqsZNBdt", "tags": ["e9NDUPVJf6c2Z0QZ", "xfgPubTDIHrvqATh", "uwjRHpKKTlmVr9Xu"], "visibility": "SERVERONLY"}' --login_with_auth "Bearer foo"
...
social-update-stat '{"capCycleOverride": true, "cycleIds": ["ipcCx9Zw5D2L7vIY", "1GXlvPG6bFYReVHQ", "hGGSyEW4ZJJ42d3P"], "cycleOverrides": [{"cycleId": "BddN8S48l9lyNApf", "maximum": 0.1864684982252216, "minimum": 0.37342561101293503}, {"cycleId": "qMrj3oZk03QXcKMD", "maximum": 0.8206979157414905, "minimum": 0.4733386061021079}, {"cycleId": "DxHSZjtqXyJ58f7G", "maximum": 0.04363832473342566, "minimum": 0.8733826502287724}], "defaultValue": 0.9488332054873553, "description": "SaiGVkydwYWQG26y", "globalAggregationMethod": "MIN", "ignoreAdditionalDataOnValueRejected": true, "incrementOnly": false, "isPublic": false, "maximum": 0.7293239407716042, "minimum": 0.45140416990647114, "name": "cvrbYCwZtxFHyPLt", "setAsGlobal": true, "setBy": "SERVER", "tags": ["Ct81P1ktfIovmv9g", "ilbyDPUIj88cekdq", "sR5cJcHm3SZLxoRD"], "visibility": "SHOWALL"}' 'FfRByjlBiuFM3FIo' --login_with_auth "Bearer foo"
...
social-bulk-get-stat-cycle-1 '{"cycleIds": ["lWkD9eOziYRFOn0j", "tohLtl9Zuhytm5UD", "JLHC9LxhvNXTwGBC"]}' --login_with_auth "Bearer foo"
...
social-bulk-get-or-default-by-user-id '{"statCodes": ["vt1j1Rx59hesNWy2", "VFWdsbYuVEGVxYhe", "R3j5mNZ6vwv7K8As"]}' 'NvZ85DDKDAF8KDsB' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'social-bulk-get-stat-cycle' \
    '{"cycleIds": ["Kb9vvxuJlhXbWhbw", "PwToC6knjVwVnzaq", "SfJiQFC2gXoda0kg"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'social-bulk-get-stat-cycle-1' \
    '{"cycleIds": ["qtxjbrztee7QLTGA", "MYvNQOsDa4bkcgep", "ak7Kaol01DK97D2x"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'social-create-stat-1' \
    '{"capCycleOverride": true, "cycleIds": ["rI6MAugK5kypNrp2", "eATj7eGjodd7CcJU", "nFe9FmN86sK5LOq4"], "cycleOverrides": [{"cycleId": "ft5jGcMICPUYnfG6", "maximum": 0.1452152265162484, "minimum": 0.18671963083605625}, {"cycleId": "9U4jReteIMgzISom", "maximum": 0.4607078184093497, "minimum": 0.2909174158727458}, {"cycleId": "odJrhQW41q2OspCZ", "maximum": 0.02906965542380391, "minimum": 0.3115073700009704}], "defaultValue": 0.8939229595185059, "description": "Uta5I0uGcL1koyHj", "globalAggregationMethod": "TOTAL", "ignoreAdditionalDataOnValueRejected": false, "incrementOnly": false, "isPublic": true, "maximum": 0.23240354877606706, "minimum": 0.1857975316295879, "name": "YLETRpABAmO2EGvJ", "setAsGlobal": true, "setBy": "SERVER", "statCode": "S93yOxNInDByhnol", "tags": ["zjPpucddXJ5zifF8", "uO6ti0QP2ssiJ66O", "zOj84O6tgohjtC7b"], "visibility": "SHOWALL"}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'social-bulk-get-or-default-by-user-id' \
    '{"statCodes": ["WfgBAKx27MSBqabU", "LNfHRD3V15QaGGL4", "6LuxJF3sbeqWBdQu"]}' \
    'XOGkkoMUZn1YXj5z' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
