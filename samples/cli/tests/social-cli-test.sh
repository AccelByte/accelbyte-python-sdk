...
social-bulk-get-stat-cycle --body '{"cycleIds": ["DG8aMVGLiBNrDjqo", "yiuATus9hsfpFDcS", "xcwgGLXpUL4pp2nc"]}' --login_with_auth "Bearer foo"
...
social-update-stat 'jQSa3Zdb65UXmy0Z' --body '{"cycleIds": ["p6iIaTIKUkmkk9QM", "0NBMA9ORxpzwLR2A", "K6eXUGPJsw1fiP80"], "defaultValue": 0.5280999080777553, "description": "9Pclxcft2ulIJzPy", "globalAggregationMethod": "MIN", "ignoreAdditionalDataOnValueRejected": true, "isPublic": true, "name": "XuNFviMarv8mnfHK", "tags": ["dlwuUccE536ugBp3", "HBvepnDCjgyJlXe3", "8CCmE2lPnsbD3SGE"]}' --login_with_auth "Bearer foo"
...
social-bulk-get-stat-cycle-1 --body '{"cycleIds": ["MSJlHeb34sZKHcl5", "LLLOexL4fZvWtND2", "tcBFpX8lNtFEJ7tn"]}' --login_with_auth "Bearer foo"
...
social-create-stat-1 --body '{"cycleIds": ["7SUQPLG59e0k5ZtX", "IllKlpO2pqiXJF3W", "GRaoQomSJC4DdrKF"], "defaultValue": 0.9463803715347646, "description": "wK7PpUlcIW32iK7M", "globalAggregationMethod": "MIN", "ignoreAdditionalDataOnValueRejected": true, "incrementOnly": true, "isPublic": false, "maximum": 0.03785487545041544, "minimum": 0.9572081253675198, "name": "KY3uVoJXTIMtpgki", "setAsGlobal": false, "setBy": "SERVER", "statCode": "zP4zvtdxdbZUpd6F", "tags": ["EO65Rb3z7CYLM8Il", "sHqffnrfsGlfPaZK", "JtHJ1pyVwyKQLY6F"]}' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'social-create-stat' \
    --body '{"cycleIds": ["hnoluO6ti0QP2ssi", "tC7bzjPpucddXJ5z", "J66OzOj84O6tgohj"], "defaultValue": 0.13888898729627375, "description": "fF8y959anrNSleyw", "globalAggregationMethod": "MIN", "ignoreAdditionalDataOnValueRejected": false, "incrementOnly": true, "isPublic": false, "maximum": 0.2870733224124047, "minimum": 0.7567692394299385, "name": "pIFvORxTi79DpSjb", "setAsGlobal": true, "setBy": "SERVER", "statCode": "fZ2hxcJ2Fnemn7M2", "tags": ["OW0nXOErQPS4VsRo", "YIK69yg9ADCGiXaL", "3SzUo4hNBDh9ZFP1"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'social-update-stat' \
    'QxCXMd00YBWCaVVm' \
    --body '{"cycleIds": ["GGJwJ00UH197MJ6z", "M45mfIZsWhkS476d", "U7JLMQyMWzYQCAaP"], "defaultValue": 0.5738013960011612, "description": "goxGJoJaSzUtY4ZD", "globalAggregationMethod": "MIN", "ignoreAdditionalDataOnValueRejected": true, "isPublic": false, "name": "b0U4pH16NUsVY21N", "tags": ["aURydf8ZyyZeHAWG", "QeaWytPfds1BYx0E", "VIs7NRen2Y3Ns0QJ"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'social-bulk-get-stat-cycle-1' \
    --body '{"cycleIds": ["bYkBLyO6A0Fqfhna", "fXshuLUk5WdpxjZx", "B3YxKNdOTacCcJfI"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
