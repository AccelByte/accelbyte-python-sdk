...
seasonpass-update-reward '4bTxBmZjdrrIxsB0' 'NRsB1fPqqRRulpqp' --body '{"currency": {"currencyCode": "ymDkQhtrHWwRVnwV", "namespace": "BOqOHi8pWGd1juYh"}, "image": {"as": "iqjRJOqB5F93zFQb", "caption": "JndUDpdONneAczbB", "height": 7, "imageUrl": "GXZnqAQUoY1GjlII", "smallImageUrl": "k0iKoTTS1j02o7Jj", "width": 93}, "itemId": "bTU5JX8ccLjMXJRk", "nullFields": ["0eaKQDOJvrTefglS", "s6g4iY9u02aCNYIW", "ekp18lOC3mNqF7Bl"], "quantity": 23, "type": "ITEM"}' --login_with_auth "Bearer foo"
