...
seasonpass-update-reward 'xsB0NRsB1fPqqRRu' 'lpqpymDkQhtrHWwR' --body '{"currency": {"currencyCode": "VnwVBOqOHi8pWGd1", "namespace": "juYhiqjRJOqB5F93"}, "image": {"as": "zFQbJndUDpdONneA", "caption": "czbBdHb2slt71B1S", "height": 24, "imageUrl": "jlIIk0iKoTTS1j02", "smallImageUrl": "o7JjTXAQN0qdskdQ", "width": 97}, "itemId": "XJRk0eaKQDOJvrTe", "nullFields": ["NYIWekp18lOC3mNq", "fglSs6g4iY9u02aC", "F7Bl0LcghVHfPEsp"], "quantity": 49, "type": "ITEM"}' --login_with_auth "Bearer foo"
