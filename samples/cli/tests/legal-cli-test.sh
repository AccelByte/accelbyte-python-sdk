...
$PYTHON -m $MODULE 'legal-partial-update-policy-1' \
    'DMrentgn3DhqciwI' \
    --body '{"affectedClientIds": ["wVnzaqSfJiQFC2gX", "eShF9RKb9vvxuJlh", "XbWhbwPwToC6knjV"], "affectedCountries": ["oda0kg16yUSpSOAj", "HJWwfCjYwWkLob9g", "KLqs2nEZhpByfHZi"], "basePolicyName": "nxNfgPAwkMBsznlB", "countryGroupName": "UqnLT4AbGptKaWNv", "countryType": "COUNTRY", "description": "YWOaNdsimmkW2miH", "isHidden": true, "isHiddenPublic": false, "tags": ["d0JPxVyQpshaDwNq", "TbbFMXAMfVXe0GZe", "AKy4QxZkaXZ7vmiE"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-create-policy-under-base-policy' \
    '6WmOt6D7ufFVTOhv' \
    --body '{"countries": ["QpfbBke8aEdd36xj", "6wySoltDxsbzxrla", "KEfkoYjY2o6ouRW9"], "countryCode": "UtNquwC3WgumrIz4", "countryGroupName": "NhGztZpr4U4fwQIi", "countryType": "COUNTRY", "description": "XgmRasvjO4lj8m3X", "isDefaultSelection": true, "isMandatory": true, "policyName": "8qwU1cTuHHPB5S3D", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
