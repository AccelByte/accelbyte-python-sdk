...
legal-create-policy-1 --body '{"affectedClientIds": ["LiBNrDjqoxcwgGLX", "9hsfpFDcSDG8aMVG", "IbeZxzfTcyiuATus"], "affectedCountries": ["92k6YmJFfRByjlBi", "pUL4pp2ncYAHdNzD", "meIP6rOvDz9KOsb3"], "basePolicyName": "uFM3FIoVk8T3GpAn", "countryGroupName": "kCmBUqg2SCnqntX9", "countryType": "COUNTRY_GROUP", "description": "0DOqOBSC2DKHRuPM", "isHidden": false, "isHiddenPublic": false, "tags": ["H8Yb33T5UBJCjfcn", "LRfxeCSz9WEi8Kll", "oeH0JT1yduat2vQR"], "typeId": "3biBfsu4jmsRE2w1"}' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'legal-update-policy-1' \
    '4mEh9tRk8knYSV30' \
    --body '{"countries": ["lnroQehMDli6t9un", "QLYXxm09wpGAbpEm", "DY9vLh3u6EDsUmrV"], "countryGroupName": "6kH4OotKwG3UC6XC", "description": "nnZxF8CmQr17W65b", "isDefaultOpted": true, "isMandatory": true, "policyName": "rBBN9tU6TDm5GloF", "readableId": "SKWM1eym5ydC6p25", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
