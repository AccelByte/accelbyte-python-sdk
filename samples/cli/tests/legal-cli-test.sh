...
legal-partial-update-policy-1 't24aOMh5eC3IHeHS' --body '{"affectedClientIds": ["3q31A806DJgas4b6", "z3LNUj7fdgLA84Z8", "KLCa3xreNDUWehwH"], "affectedCountries": ["yabWAgIUXiI07A68", "YYk6QEgJjBbEDoNf", "3n0hEoRCAcf80zfF"], "basePolicyName": "eaqC2J9jyEW6GLbc", "countryGroupName": "0NaKDUL3sa13lk1d", "countryType": "COUNTRY", "description": "BHO86IlBhnetU4Rw", "isHidden": true, "isHiddenPublic": true, "tags": ["UXlTDBzOuYsaZA2y", "aY9eKa699bRVhyaK", "yd4mbqoOfADMMAXF"]}' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'legal-partial-update-policy-1' \
    'DMrentgn3DhqciwI' \
    --body '{"affectedClientIds": ["wVnzaqSfJiQFC2gX", "eShF9RKb9vvxuJlh", "XbWhbwPwToC6knjV"], "affectedCountries": ["HJWwfCjYwWkLob9g", "oda0kg16yUSpSOAj", "KLqs2nEZhpByfHZi"], "basePolicyName": "nxNfgPAwkMBsznlB", "countryGroupName": "UqnLT4AbGptKaWNv", "countryType": "COUNTRY", "description": "YWOaNdsimmkW2miH", "isHidden": true, "isHiddenPublic": false, "tags": ["TbbFMXAMfVXe0GZe", "d0JPxVyQpshaDwNq", "AKy4QxZkaXZ7vmiE"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-update-policy-1' \
    '4mEh9tRk8knYSV30' \
    --body '{"countries": ["QLYXxm09wpGAbpEm", "DY9vLh3u6EDsUmrV", "lnroQehMDli6t9un"], "countryGroupName": "6kH4OotKwG3UC6XC", "description": "nnZxF8CmQr17W65b", "isDefaultOpted": true, "isMandatory": true, "policyName": "rBBN9tU6TDm5GloF", "readableId": "SKWM1eym5ydC6p25", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-update-policy' \
    '9k2hG0WKt4sUmanY' \
    --body '{"countries": ["xM0UHZVNYzGMNIpW", "A9t2ENKKWrFtHIi1", "oSLkUrfuf4U3WeYe"], "countryGroupName": "CMgKAOG5iDcCR5Pb", "description": "CvDLil8wj9cKM3Ar", "isDefaultOpted": false, "isMandatory": false, "policyName": "35hCER4nGmWGgTJf", "readableId": "HlJl4tHGa4XfZcd9", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
