...
$PYTHON -m $MODULE 'legal-partial-update-policy' \
    'gjVBycvU4PbmRDcr' \
    --body '{"affectedClientIds": ["jhTHeh94TSenE5hC", "m2lJFRZ3ZprZ60zM", "g0DjQjBECXvea7H1"], "affectedCountries": ["FkIf5weqZ18MH57l", "2Zsrh90ETtYmGukz", "3MnlrjcHp6B8Vj7r"], "basePolicyName": "XFgDnDkdZ9bpjb1t", "countryGroupName": "dA3QhjCMW64f4XhI", "countryType": "COUNTRY", "description": "PlXn77AtYoFzLAAT", "isHidden": true, "isHiddenPublic": true, "namespace": "8P3cfoivvQxevecW", "tags": ["kt4pK32sJxlZcCTp", "w7Rry0KK5rgAGO0d", "W8rX2MVUGKSZ4GcL"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-partial-update-policy-1' \
    'DMrentgn3DhqciwI' \
    --body '{"affectedClientIds": ["eShF9RKb9vvxuJlh", "XbWhbwPwToC6knjV", "wVnzaqSfJiQFC2gX"], "affectedCountries": ["HJWwfCjYwWkLob9g", "KLqs2nEZhpByfHZi", "oda0kg16yUSpSOAj"], "basePolicyName": "nxNfgPAwkMBsznlB", "countryGroupName": "UqnLT4AbGptKaWNv", "countryType": "COUNTRY", "description": "YWOaNdsimmkW2miH", "isHidden": true, "isHiddenPublic": false, "tags": ["TbbFMXAMfVXe0GZe", "d0JPxVyQpshaDwNq", "AKy4QxZkaXZ7vmiE"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-create-policy-under-base-policy' \
    '6WmOt6D7ufFVTOhv' \
    --body '{"countries": ["6wySoltDxsbzxrla", "QpfbBke8aEdd36xj", "KEfkoYjY2o6ouRW9"], "countryCode": "UtNquwC3WgumrIz4", "countryGroupName": "NhGztZpr4U4fwQIi", "countryType": "COUNTRY", "description": "XgmRasvjO4lj8m3X", "isDefaultSelection": true, "isMandatory": true, "policyName": "8qwU1cTuHHPB5S3D", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-update-policy' \
    '9k2hG0WKt4sUmanY' \
    --body '{"countries": ["A9t2ENKKWrFtHIi1", "oSLkUrfuf4U3WeYe", "xM0UHZVNYzGMNIpW"], "countryGroupName": "CMgKAOG5iDcCR5Pb", "description": "CvDLil8wj9cKM3Ar", "isDefaultOpted": false, "isMandatory": false, "policyName": "35hCER4nGmWGgTJf", "readableId": "HlJl4tHGa4XfZcd9", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
