...
legal-old-retrieve-accepted-agreements 'bPOyNQkT7NvyE3cw' --login_with_auth "Bearer foo"
legal-old-retrieve-all-users-by-policy-version 'yALczNIicXm7agSr' --login_with_auth "Bearer foo"
legal-retrieve-all-legal-policies --login_with_auth "Bearer foo"
legal-old-create-policy --body '{"affectedClientIds": ["umKtPDKJDXn7Z4U6", "jJW2OQNOs1PXhT5F", "vdiRilZ7oFgx4c8O"], "affectedCountries": ["8su8XfqlqNiTvB6S", "dAdIhUDrwoZ5Mecd", "Ki5r6QEa1ysLEzth"], "basePolicyName": "6mXhzkzWkFeZSoEA", "countryGroupName": "cBdW19m4eu6d5tA5", "countryType": "COUNTRY", "description": "duuyZ0GhDogqrhBR", "isHidden": false, "isHiddenPublic": false, "namespace": "5MYzYiKWe5dNRljv", "tags": ["Vpbsx5w8hqUI06Up", "LGMS0lyuI9a2I9u6", "7IPrDQQRgat0Sevk"], "typeId": "OXGSLmCVuHOPlLlk"}' --login_with_auth "Bearer foo"
legal-old-retrieve-single-policy 'vR8sKgnuRkgghGoY' --login_with_auth "Bearer foo"
legal-old-partial-update-policy 'upD391C2qtPYokah' --body '{"affectedClientIds": ["FjkQsfCaTmt1d67F", "XGk2s9Q0mPVo3twu", "0MesTCf9x4rt69ln"], "affectedCountries": ["a7qxNeIxPz6MbwL6", "IY69z1UaLqYSYWyt", "LPziZMdjxcBZufQx"], "basePolicyName": "GiHPllG4cYEzfTD1", "countryGroupName": "ZBm3MqHcUmLZZbSq", "countryType": "COUNTRY", "description": "mu0hpDDWVAla2l5B", "isHidden": true, "isHiddenPublic": false, "namespace": "tIuS5S5XUdjsoqwG", "tags": ["TTr1DmrhZv15T7qu", "yzzWi9gwQYv7t1o7", "IOvBMcaYmvCkGZ5d"]}' --login_with_auth "Bearer foo"
legal-old-retrieve-policy-country 'AgqxpBFmaLoxozr6' 'wfNPX2bOItRMvqtl' --login_with_auth "Bearer foo"
legal-old-retrieve-localized-policy-versions 'B2jJCSQT279ZZPYG' --login_with_auth "Bearer foo"
legal-old-create-localized-policy-version 'u0rdlgdWyOtXi3ch' --body '{"contentType": "oQrpOsDBU5SepjCh", "description": "B3V0v52Dlym6puQ2", "localeCode": "3xoJ8aeCnaLpUKp4"}' --login_with_auth "Bearer foo"
legal-old-retrieve-single-localized-policy-version '4YUDjasWIPUvmEej' --login_with_auth "Bearer foo"
legal-old-update-localized-policy-version 'tGeoyIPa8ZRrvjj7' --body '{"attachmentChecksum": "il35MXbN9oCMNqq9", "attachmentLocation": "8SjTvhZNkSQ70D0H", "attachmentVersionIdentifier": "6BXksUC9b6i5lZC9", "contentType": "xv32e8c5csSovoqs", "description": "ZNBdte9NDUPVJf6c"}' --login_with_auth "Bearer foo"
legal-old-request-presigned-url '2Z0QZxfgPubTDIHr' --body '{"contentMD5": "vqAThuwjRHpKKTlm", "contentType": "Vr9XuoJbRFQSKVPH"}' --login_with_auth "Bearer foo"
legal-old-set-default-localized-policy 'bn4Xxtu7LQRENjEE' --login_with_auth "Bearer foo"
...
legal-retrieve-accepted-agreements 'CKNS0GqVvUfHQvsH' --login_with_auth "Bearer foo"
legal-retrieve-all-users-by-policy-version 'XNUNe4mhgo5QB65l' --login_with_auth "Bearer foo"
...
legal-create-policy --body '{"affectedClientIds": ["IbeZxzfTcyiuATus", "9hsfpFDcSDG8aMVG", "LiBNrDjqoxcwgGLX"], "affectedCountries": ["92k6YmJFfRByjlBi", "pUL4pp2ncYAHdNzD", "meIP6rOvDz9KOsb3"], "basePolicyName": "uFM3FIoVk8T3GpAn", "countryGroupName": "kCmBUqg2SCnqntX9", "countryType": "COUNTRY_GROUP", "description": "0DOqOBSC2DKHRuPM", "isHidden": false, "isHiddenPublic": false, "tags": ["oeH0JT1yduat2vQR", "LRfxeCSz9WEi8Kll", "H8Yb33T5UBJCjfcn"], "typeId": "3biBfsu4jmsRE2w1"}' --login_with_auth "Bearer foo"
legal-retrieve-single-policy 'yEkLgh3tIYt4SqYU' --login_with_auth "Bearer foo"
legal-delete-base-policy 'TLDx9gIiDandpGT2' --login_with_auth "Bearer foo"
legal-partial-update-policy 't24aOMh5eC3IHeHS' --body '{"affectedClientIds": ["KLCa3xreNDUWehwH", "3q31A806DJgas4b6", "z3LNUj7fdgLA84Z8"], "affectedCountries": ["3n0hEoRCAcf80zfF", "YYk6QEgJjBbEDoNf", "yabWAgIUXiI07A68"], "basePolicyName": "eaqC2J9jyEW6GLbc", "countryGroupName": "0NaKDUL3sa13lk1d", "countryType": "COUNTRY", "description": "BHO86IlBhnetU4Rw", "isHidden": true, "isHiddenPublic": true, "tags": ["aY9eKa699bRVhyaK", "yd4mbqoOfADMMAXF", "UXlTDBzOuYsaZA2y"]}' --login_with_auth "Bearer foo"
legal-retrieve-policy-country 'wwrAP2aMlu7WtjCt' 'oYetOO847g8OudOf' --login_with_auth "Bearer foo"
legal-retrieve-all-policies-from-base-policy 'jnCuHZ3c46IjGa23' --login_with_auth "Bearer foo"
legal-create-policy-under-base-policy 'YvYmmDg7VYPXIuvU' --body '{"countries": ["AZvkRCMNFIurjh2i", "YTZBRujIUE1Tq5jy", "mdb4rbkXj0ZwsVC0"], "countryCode": "gL97ZVJSPqJiwv1q", "countryGroupName": "lYB1RSKs6gQxC3Gb", "countryType": "COUNTRY", "description": "0o4zGYY7KQI1AeFg", "isDefaultSelection": true, "isMandatory": true, "policyName": "qZtfNWql4nmwAft4", "shouldNotifyOnUpdate": false}' --login_with_auth "Bearer foo"
legal-delete-localized-policy 'EYOkQ1jMD3cym8xI' --login_with_auth "Bearer foo"
legal-retrieve-localized-policy-versions 'fkOVW2grREOLx0KO' --login_with_auth "Bearer foo"
legal-create-localized-policy-version 'ww3HICQLfl7MUBG7' --body '{"contentType": "qtPu64yAtURKLRkb", "description": "738HGS6rDgMdIIlh", "localeCode": "S1fSiM9331m7Ta1P"}' --login_with_auth "Bearer foo"
legal-retrieve-single-localized-policy-version 'sKc50Kv6ecnEevcA' --login_with_auth "Bearer foo"
legal-update-localized-policy-version 'x2K2zkRenmPZnGBt' --body '{"attachmentChecksum": "4P7WnbdSJtjX7Zsh", "attachmentLocation": "ZyZl5x4bRXBHUTrD", "attachmentVersionIdentifier": "zZSKscfOcYu3dpCR", "contentType": "OYqUiGKXVFCmpo6s", "description": "PwVOEDSJsEK5QpNh"}' --login_with_auth "Bearer foo"
legal-request-presigned-url 'lI2iS5EpGhhvXYck' --body '{"contentMD5": "0upMzUYnb76tFkEO", "contentType": "RV3bu1bNCtX7W40V"}' --login_with_auth "Bearer foo"
legal-set-default-localized-policy '6Do5sYadCCFrHHC3' --login_with_auth "Bearer foo"
legal-delete-policy-version 'DpZxkrQDXuNFviMa' --login_with_auth "Bearer foo"
legal-update-policy-version 'rv8mnfHK8CCmE2lP' --body '{"description": "nsbD3SGEdlwuUccE", "displayVersion": "536ugBp3HBvepnDC", "isCommitted": false}' --login_with_auth "Bearer foo"
legal-publish-policy-version 'Mrok0WvGYYnx4V70' --login_with_auth "Bearer foo"
...
legal-update-policy 'bfUpaXp5JMl5LL4b' --body '{"countries": ["TxBmZjdrrIxsB0NR", "DkQhtrHWwRVnwVBO", "sB1fPqqRRulpqpym"], "countryGroupName": "qOHi8pWGd1juYhiq", "description": "jRJOqB5F93zFQbJn", "isDefaultOpted": false, "isMandatory": false, "policyName": "UDpdONneAczbBdHb", "readableId": "2slt71B1SmZp2JZp", "shouldNotifyOnUpdate": false}' --login_with_auth "Bearer foo"
legal-set-default-policy 'CnPb71ORYcmQbTU5' --login_with_auth "Bearer foo"
legal-retrieve-single-policy-version 'JX8ccLjMXJRk0eaK' --login_with_auth "Bearer foo"
legal-create-policy-version 'QDOJvrTefglSs6g4' --body '{"description": "iY9u02aCNYIWekp1", "displayVersion": "8lOC3mNqF7Bl0Lcg", "isCommitted": false}' --login_with_auth "Bearer foo"
legal-retrieve-all-policy-types '63' --login_with_auth "Bearer foo"
...
legal-old-update-policy-version 'eoip68J1nsv4W2OJ' --body '{"description": "htafxMSJlHeb34sZ", "displayVersion": "KHcl5LLLOexL4fZv", "isCommitted": true}' --login_with_auth "Bearer foo"
legal-old-publish-policy-version 'CiiPDGQhNPEwiJCf' --login_with_auth "Bearer foo"
legal-old-update-policy '2XJVrlzqQls1ozhL' --body '{"countries": ["VA3kE8jKvgatOEBM", "arzBsV6xnZ5Jrzzj", "70TdlNBJYOmpu1VC"], "countryGroupName": "rcaug6CWVG8SWP3g", "description": "lU6muswVJnNnN7kA", "isDefaultOpted": false, "isMandatory": true, "policyName": "7j0riFc5HTHQIoVs", "readableId": "Go7dwV9DBqFKHQkE", "shouldNotifyOnUpdate": true}' --login_with_auth "Bearer foo"
legal-old-set-default-policy 'yTlUrwDTnoujQD4I' --login_with_auth "Bearer foo"
legal-old-retrieve-single-policy-version 'EiH9Z5qXn3aoRtlq' --login_with_auth "Bearer foo"
legal-old-create-policy-version 'OECohViHA5CzgFSy' --body '{"description": "8X1A3PrIfapq5AAe", "displayVersion": "Me4L3mDWORBVXTII", "isCommitted": true}' --login_with_auth "Bearer foo"
legal-old-retrieve-all-policy-types '80' --login_with_auth "Bearer foo"
...
legal-public-change-preference-consent --body '[{"isAccepted": false, "isNeedToSendEventMarketing": true, "localizedPolicyVersionId": "cFX3SUBhyoTsMWPA", "policyId": "xUMkawaGpAyrIwMi", "policyVersionId": "f3BOdkocVTd4BxqG"}, {"isAccepted": false, "isNeedToSendEventMarketing": false, "localizedPolicyVersionId": "BNXzAFdO0Khqf6ki", "policyId": "TdSGv2LFjAKY7Cbg", "policyVersionId": "sWqFWZX7kPBom8F9"}, {"isAccepted": true, "isNeedToSendEventMarketing": true, "localizedPolicyVersionId": "CjtuzFMbAG9YI89h", "policyId": "mguB8FOTjMLo4b9r", "policyVersionId": "IzqYkEpstyVTBcrM"}]' --login_with_auth "Bearer foo"
...
legal-old-public-retrieve-single-localized-policy-version 'gqRqCV7usamANkZl' --login_with_auth "Bearer foo"
legal-public-retrieve-single-localized-policy-version 'OX9Sfo95HgXqKhTP' --login_with_auth "Bearer foo"
...
legal-old-retrieve-latest-policies-by-namespace-and-country-public 'gZvRrvr0n9d9lvcc' --login_with_auth "Bearer foo"
legal-check-readiness --login_with_auth "Bearer foo"
legal-retrieve-latest-policies-by-namespace-and-country-public 'KMLhrTrcBE2ItBS3' 'KtKZWe8aoFzAyBME' --login_with_auth "Bearer foo"
exit()
END
...
$PYTHON -m $MODULE 'legal-old-create-policy' \
    --body '{"affectedClientIds": ["6ePeN8i4GrFES9z7", "huxaEc7M4P7UckSC", "PV87pna08gxefTYK"], "affectedCountries": ["xueHpATHccee9GXh", "KcjmSEwdrkEnnqKz", "FsLfYalUlfwEQKjU"], "basePolicyName": "7eHGebSVu0LQ40ke", "countryGroupName": "pEaC4dfiOMZfEhHr", "countryType": "COUNTRY", "description": "9pysFO3Zvc1BZG99", "isHidden": true, "isHiddenPublic": true, "namespace": "bYXEcENx9xZlAcho", "tags": ["XEQdbzIVy8alncV7", "b44lONDDwMvgI0Hl", "yPR7wZNiVsF6xG2m"], "typeId": "vWgSHdfo07UctPEr"}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-old-partial-update-policy' \
    'gjVBycvU4PbmRDcr' \
    --body '{"affectedClientIds": ["g0DjQjBECXvea7H1", "jhTHeh94TSenE5hC", "m2lJFRZ3ZprZ60zM"], "affectedCountries": ["FkIf5weqZ18MH57l", "2Zsrh90ETtYmGukz", "3MnlrjcHp6B8Vj7r"], "basePolicyName": "XFgDnDkdZ9bpjb1t", "countryGroupName": "dA3QhjCMW64f4XhI", "countryType": "COUNTRY", "description": "PlXn77AtYoFzLAAT", "isHidden": true, "isHiddenPublic": true, "namespace": "8P3cfoivvQxevecW", "tags": ["kt4pK32sJxlZcCTp", "w7Rry0KK5rgAGO0d", "W8rX2MVUGKSZ4GcL"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-retrieve-accepted-agreements-for-multi-users' \
    --body '{"currentPublishedOnly": true, "userIds": ["DZWlGVE9sJ4NpUtK", "yo4nIRysQdbufXjY", "nSoIFeouC2m38kXr"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-create-policy' \
    --body '{"affectedClientIds": ["aSHevO0TQNEI3kfa", "bxJWWSI1ECUo1NPp", "eFhUztXDgB7n4C97"], "affectedCountries": ["K8lbSEEelxnb5QxW", "sBJT6Hh3OMjAjq2m", "uAPP8PATLpUpxeJl"], "basePolicyName": "G2HFnZlA6HKWW4fI", "countryGroupName": "1IQcoBQELcNlZkqT", "countryType": "COUNTRY", "description": "rKgXNwvm4e5GX6H7", "isHidden": false, "isHiddenPublic": false, "tags": ["ixhtAoKiVm6URT95", "XhnUcvWB28Mpusuh", "hDJ5slzgiWZEtyd5"], "typeId": "6LfxnbY97jjYgXch"}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-partial-update-policy' \
    'DMrentgn3DhqciwI' \
    --body '{"affectedClientIds": ["eShF9RKb9vvxuJlh", "wVnzaqSfJiQFC2gX", "XbWhbwPwToC6knjV"], "affectedCountries": ["KLqs2nEZhpByfHZi", "oda0kg16yUSpSOAj", "HJWwfCjYwWkLob9g"], "basePolicyName": "nxNfgPAwkMBsznlB", "countryGroupName": "UqnLT4AbGptKaWNv", "countryType": "COUNTRY", "description": "YWOaNdsimmkW2miH", "isHidden": true, "isHiddenPublic": false, "tags": ["d0JPxVyQpshaDwNq", "TbbFMXAMfVXe0GZe", "AKy4QxZkaXZ7vmiE"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-create-policy-under-base-policy' \
    '6WmOt6D7ufFVTOhv' \
    --body '{"countries": ["KEfkoYjY2o6ouRW9", "6wySoltDxsbzxrla", "QpfbBke8aEdd36xj"], "countryCode": "UtNquwC3WgumrIz4", "countryGroupName": "NhGztZpr4U4fwQIi", "countryType": "COUNTRY", "description": "XgmRasvjO4lj8m3X", "isDefaultSelection": true, "isMandatory": true, "policyName": "8qwU1cTuHHPB5S3D", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-update-policy' \
    '4mEh9tRk8knYSV30' \
    --body '{"countries": ["lnroQehMDli6t9un", "DY9vLh3u6EDsUmrV", "QLYXxm09wpGAbpEm"], "countryGroupName": "6kH4OotKwG3UC6XC", "description": "nnZxF8CmQr17W65b", "isDefaultOpted": true, "isMandatory": true, "policyName": "rBBN9tU6TDm5GloF", "readableId": "SKWM1eym5ydC6p25", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-old-update-policy' \
    '9k2hG0WKt4sUmanY' \
    --body '{"countries": ["oSLkUrfuf4U3WeYe", "xM0UHZVNYzGMNIpW", "A9t2ENKKWrFtHIi1"], "countryGroupName": "CMgKAOG5iDcCR5Pb", "description": "CvDLil8wj9cKM3Ar", "isDefaultOpted": false, "isMandatory": false, "policyName": "35hCER4nGmWGgTJf", "readableId": "HlJl4tHGa4XfZcd9", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
