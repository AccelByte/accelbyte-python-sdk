...
legal-old-create-policy --body '{"affectedClientIds": ["jJW2OQNOs1PXhT5F", "umKtPDKJDXn7Z4U6", "vdiRilZ7oFgx4c8O"], "affectedCountries": ["8su8XfqlqNiTvB6S", "dAdIhUDrwoZ5Mecd", "Ki5r6QEa1ysLEzth"], "basePolicyName": "6mXhzkzWkFeZSoEA", "countryGroupName": "cBdW19m4eu6d5tA5", "countryType": "COUNTRY", "description": "duuyZ0GhDogqrhBR", "isHidden": false, "isHiddenPublic": false, "namespace": "5MYzYiKWe5dNRljv", "tags": ["7IPrDQQRgat0Sevk", "Vpbsx5w8hqUI06Up", "LGMS0lyuI9a2I9u6"], "typeId": "OXGSLmCVuHOPlLlk"}' --login_with_auth "Bearer foo"
legal-old-retrieve-single-policy 'vR8sKgnuRkgghGoY' --login_with_auth "Bearer foo"
legal-old-partial-update-policy 'upD391C2qtPYokah' --body '{"affectedClientIds": ["0MesTCf9x4rt69ln", "XGk2s9Q0mPVo3twu", "FjkQsfCaTmt1d67F"], "affectedCountries": ["a7qxNeIxPz6MbwL6", "IY69z1UaLqYSYWyt", "LPziZMdjxcBZufQx"], "basePolicyName": "GiHPllG4cYEzfTD1", "countryGroupName": "ZBm3MqHcUmLZZbSq", "countryType": "COUNTRY", "description": "mu0hpDDWVAla2l5B", "isHidden": true, "isHiddenPublic": false, "namespace": "tIuS5S5XUdjsoqwG", "tags": ["yzzWi9gwQYv7t1o7", "TTr1DmrhZv15T7qu", "IOvBMcaYmvCkGZ5d"]}' --login_with_auth "Bearer foo"
...
legal-retrieve-accepted-agreements-for-multi-users --body '{"currentPublishedOnly": true, "userIds": ["iGeUlc9d9sogWa24", "I39YBHqaTHeKtW18", "6YE3p4lSck0ZHn5G"]}' --login_with_auth "Bearer foo"
...
legal-partial-update-policy 't24aOMh5eC3IHeHS' --body '{"affectedClientIds": ["KLCa3xreNDUWehwH", "3q31A806DJgas4b6", "z3LNUj7fdgLA84Z8"], "affectedCountries": ["YYk6QEgJjBbEDoNf", "3n0hEoRCAcf80zfF", "yabWAgIUXiI07A68"], "basePolicyName": "eaqC2J9jyEW6GLbc", "countryGroupName": "0NaKDUL3sa13lk1d", "countryType": "COUNTRY", "description": "BHO86IlBhnetU4Rw", "isHidden": true, "isHiddenPublic": true, "tags": ["UXlTDBzOuYsaZA2y", "yd4mbqoOfADMMAXF", "aY9eKa699bRVhyaK"]}' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'legal-retrieve-accepted-agreements-for-multi-users' \
    --body '{"currentPublishedOnly": true, "userIds": ["DZWlGVE9sJ4NpUtK", "nSoIFeouC2m38kXr", "yo4nIRysQdbufXjY"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-create-policy' \
    --body '{"affectedClientIds": ["eFhUztXDgB7n4C97", "aSHevO0TQNEI3kfa", "bxJWWSI1ECUo1NPp"], "affectedCountries": ["uAPP8PATLpUpxeJl", "sBJT6Hh3OMjAjq2m", "K8lbSEEelxnb5QxW"], "basePolicyName": "G2HFnZlA6HKWW4fI", "countryGroupName": "1IQcoBQELcNlZkqT", "countryType": "COUNTRY", "description": "rKgXNwvm4e5GX6H7", "isHidden": false, "isHiddenPublic": false, "tags": ["hDJ5slzgiWZEtyd5", "ixhtAoKiVm6URT95", "XhnUcvWB28Mpusuh"], "typeId": "6LfxnbY97jjYgXch"}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-partial-update-policy' \
    'DMrentgn3DhqciwI' \
    --body '{"affectedClientIds": ["wVnzaqSfJiQFC2gX", "XbWhbwPwToC6knjV", "eShF9RKb9vvxuJlh"], "affectedCountries": ["oda0kg16yUSpSOAj", "HJWwfCjYwWkLob9g", "KLqs2nEZhpByfHZi"], "basePolicyName": "nxNfgPAwkMBsznlB", "countryGroupName": "UqnLT4AbGptKaWNv", "countryType": "COUNTRY", "description": "YWOaNdsimmkW2miH", "isHidden": true, "isHiddenPublic": false, "tags": ["TbbFMXAMfVXe0GZe", "AKy4QxZkaXZ7vmiE", "d0JPxVyQpshaDwNq"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-create-policy-under-base-policy' \
    '6WmOt6D7ufFVTOhv' \
    --body '{"countries": ["6wySoltDxsbzxrla", "KEfkoYjY2o6ouRW9", "QpfbBke8aEdd36xj"], "countryCode": "UtNquwC3WgumrIz4", "countryGroupName": "NhGztZpr4U4fwQIi", "countryType": "COUNTRY", "description": "XgmRasvjO4lj8m3X", "isDefaultSelection": true, "isMandatory": true, "policyName": "8qwU1cTuHHPB5S3D", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-old-update-policy' \
    '9k2hG0WKt4sUmanY' \
    --body '{"countries": ["xM0UHZVNYzGMNIpW", "oSLkUrfuf4U3WeYe", "A9t2ENKKWrFtHIi1"], "countryGroupName": "CMgKAOG5iDcCR5Pb", "description": "CvDLil8wj9cKM3Ar", "isDefaultOpted": false, "isMandatory": false, "policyName": "35hCER4nGmWGgTJf", "readableId": "HlJl4tHGa4XfZcd9", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
