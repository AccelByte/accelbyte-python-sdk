...
legal-create-policy --body '{"affectedClientIds": ["IbeZxzfTcyiuATus", "9hsfpFDcSDG8aMVG", "LiBNrDjqoxcwgGLX"], "affectedCountries": ["meIP6rOvDz9KOsb3", "92k6YmJFfRByjlBi", "pUL4pp2ncYAHdNzD"], "basePolicyName": "uFM3FIoVk8T3GpAn", "countryGroupName": "kCmBUqg2SCnqntX9", "countryType": "COUNTRY_GROUP", "description": "0DOqOBSC2DKHRuPM", "isHidden": false, "isHiddenPublic": false, "tags": ["LRfxeCSz9WEi8Kll", "oeH0JT1yduat2vQR", "H8Yb33T5UBJCjfcn"], "typeId": "3biBfsu4jmsRE2w1"}' --login_with_auth "Bearer foo"
...
legal-partial-update-policy 't24aOMh5eC3IHeHS' --body '{"affectedClientIds": ["z3LNUj7fdgLA84Z8", "3q31A806DJgas4b6", "KLCa3xreNDUWehwH"], "affectedCountries": ["YYk6QEgJjBbEDoNf", "3n0hEoRCAcf80zfF", "yabWAgIUXiI07A68"], "basePolicyName": "eaqC2J9jyEW6GLbc", "countryGroupName": "0NaKDUL3sa13lk1d", "countryType": "COUNTRY", "description": "BHO86IlBhnetU4Rw", "isHidden": true, "isHiddenPublic": true, "tags": ["aY9eKa699bRVhyaK", "UXlTDBzOuYsaZA2y", "yd4mbqoOfADMMAXF"]}' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'legal-old-partial-update-policy' \
    'gjVBycvU4PbmRDcr' \
    --body '{"affectedClientIds": ["g0DjQjBECXvea7H1", "m2lJFRZ3ZprZ60zM", "jhTHeh94TSenE5hC"], "affectedCountries": ["FkIf5weqZ18MH57l", "2Zsrh90ETtYmGukz", "3MnlrjcHp6B8Vj7r"], "basePolicyName": "XFgDnDkdZ9bpjb1t", "countryGroupName": "dA3QhjCMW64f4XhI", "countryType": "COUNTRY", "description": "PlXn77AtYoFzLAAT", "isHidden": true, "isHiddenPublic": true, "namespace": "8P3cfoivvQxevecW", "tags": ["kt4pK32sJxlZcCTp", "W8rX2MVUGKSZ4GcL", "w7Rry0KK5rgAGO0d"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-retrieve-accepted-agreements-for-multi-users' \
    --body '{"currentPublishedOnly": true, "userIds": ["nSoIFeouC2m38kXr", "DZWlGVE9sJ4NpUtK", "yo4nIRysQdbufXjY"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-partial-update-policy' \
    'DMrentgn3DhqciwI' \
    --body '{"affectedClientIds": ["XbWhbwPwToC6knjV", "wVnzaqSfJiQFC2gX", "eShF9RKb9vvxuJlh"], "affectedCountries": ["KLqs2nEZhpByfHZi", "oda0kg16yUSpSOAj", "HJWwfCjYwWkLob9g"], "basePolicyName": "nxNfgPAwkMBsznlB", "countryGroupName": "UqnLT4AbGptKaWNv", "countryType": "COUNTRY", "description": "YWOaNdsimmkW2miH", "isHidden": true, "isHiddenPublic": false, "tags": ["d0JPxVyQpshaDwNq", "TbbFMXAMfVXe0GZe", "AKy4QxZkaXZ7vmiE"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-update-policy' \
    '4mEh9tRk8knYSV30' \
    --body '{"countries": ["QLYXxm09wpGAbpEm", "lnroQehMDli6t9un", "DY9vLh3u6EDsUmrV"], "countryGroupName": "6kH4OotKwG3UC6XC", "description": "nnZxF8CmQr17W65b", "isDefaultOpted": true, "isMandatory": true, "policyName": "rBBN9tU6TDm5GloF", "readableId": "SKWM1eym5ydC6p25", "shouldNotifyOnUpdate": true}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
