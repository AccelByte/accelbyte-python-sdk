...
legal-partial-update-policy 't24aOMh5eC3IHeHS' --body '{"affectedClientIds": ["KLCa3xreNDUWehwH", "z3LNUj7fdgLA84Z8", "3q31A806DJgas4b6"], "affectedCountries": ["YYk6QEgJjBbEDoNf", "3n0hEoRCAcf80zfF", "yabWAgIUXiI07A68"], "basePolicyName": "eaqC2J9jyEW6GLbc", "countryGroupName": "0NaKDUL3sa13lk1d", "countryType": "COUNTRY", "description": "BHO86IlBhnetU4Rw", "isHidden": true, "isHiddenPublic": true, "tags": ["UXlTDBzOuYsaZA2y", "yd4mbqoOfADMMAXF", "aY9eKa699bRVhyaK"]}' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'legal-old-partial-update-policy' \
    'gjVBycvU4PbmRDcr' \
    --body '{"affectedClientIds": ["m2lJFRZ3ZprZ60zM", "jhTHeh94TSenE5hC", "g0DjQjBECXvea7H1"], "affectedCountries": ["FkIf5weqZ18MH57l", "2Zsrh90ETtYmGukz", "3MnlrjcHp6B8Vj7r"], "basePolicyName": "XFgDnDkdZ9bpjb1t", "countryGroupName": "dA3QhjCMW64f4XhI", "countryType": "COUNTRY", "description": "PlXn77AtYoFzLAAT", "isHidden": true, "isHiddenPublic": true, "namespace": "8P3cfoivvQxevecW", "tags": ["w7Rry0KK5rgAGO0d", "kt4pK32sJxlZcCTp", "W8rX2MVUGKSZ4GcL"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-retrieve-accepted-agreements-for-multi-users' \
    --body '{"currentPublishedOnly": true, "userIds": ["yo4nIRysQdbufXjY", "nSoIFeouC2m38kXr", "DZWlGVE9sJ4NpUtK"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-create-policy' \
    --body '{"affectedClientIds": ["eFhUztXDgB7n4C97", "aSHevO0TQNEI3kfa", "bxJWWSI1ECUo1NPp"], "affectedCountries": ["sBJT6Hh3OMjAjq2m", "K8lbSEEelxnb5QxW", "uAPP8PATLpUpxeJl"], "basePolicyName": "G2HFnZlA6HKWW4fI", "countryGroupName": "1IQcoBQELcNlZkqT", "countryType": "COUNTRY", "description": "rKgXNwvm4e5GX6H7", "isHidden": false, "isHiddenPublic": false, "tags": ["XhnUcvWB28Mpusuh", "ixhtAoKiVm6URT95", "hDJ5slzgiWZEtyd5"], "typeId": "6LfxnbY97jjYgXch"}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'legal-partial-update-policy' \
    'DMrentgn3DhqciwI' \
    --body '{"affectedClientIds": ["wVnzaqSfJiQFC2gX", "eShF9RKb9vvxuJlh", "XbWhbwPwToC6knjV"], "affectedCountries": ["HJWwfCjYwWkLob9g", "KLqs2nEZhpByfHZi", "oda0kg16yUSpSOAj"], "basePolicyName": "nxNfgPAwkMBsznlB", "countryGroupName": "UqnLT4AbGptKaWNv", "countryType": "COUNTRY", "description": "YWOaNdsimmkW2miH", "isHidden": true, "isHiddenPublic": false, "tags": ["TbbFMXAMfVXe0GZe", "AKy4QxZkaXZ7vmiE", "d0JPxVyQpshaDwNq"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
