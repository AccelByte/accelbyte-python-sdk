...
platform-disable-item '5TaW4to7QCY2NGGv' 'i9kg3rMIzNmhJTNQ' --body '{"featuresToCheck": ["DLC", "CATALOG", "IAP"]}' --login_with_auth "Bearer foo"
...
platform-public-preview-order-price '{"currencyCode": "IIxTIGI5EssYllIq", "discountCodes": ["GlHm8VTN56tJKwD8", "jJzuQ8GglVgxjOGQ", "O07L9GG1uenDihce"], "discountedPrice": 1, "itemId": "bq5KikDE7hWvT5bz", "price": 5, "quantity": 40}' 'fzIpL2pWB4XsdrxI' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'platform-update-item-purchase-condition' \
    '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 44, "code": "gIUMxGfQHmg4I1PJ", "comparison": "isLessThanOrEqual", "name": "o2dQM3ZXq9atijyF", "predicateType": "SeasonPassPredicate", "value": "8B6hECr4zqhZ9lpl", "values": ["lwasnryjxylwRVcy", "F37X9HTu6c4mMUdJ", "18iHO0dKNHWBFM13"]}, {"anyOf": 29, "code": "8qXSfSkxhrHhjWxk", "comparison": "isNot", "name": "2YoSLUIzzQsIU3IZ", "predicateType": "EntitlementPredicate", "value": "P7Yh6ERWyedt6rkP", "values": ["X634iuF8pqhqsqRF", "HPfyNRUhMXX7FiB3", "xW72ya2ruQcikSHw"]}, {"anyOf": 72, "code": "kqMbz4sxPUl2WbQN", "comparison": "isLessThanOrEqual", "name": "NB2IE43MBCGNyjqn", "predicateType": "StatisticCodePredicate", "value": "2z5O9ugNuq4uGu9k", "values": ["4gy2QBm02aTdgp0W", "m7KeyQB3SUe4ug9J", "3KKHHaSwFS7fAGmA"]}]}, {"operator": "and", "predicates": [{"anyOf": 90, "code": "TwcWL7fNlyGuj0Ek", "comparison": "excludes", "name": "7M8G78KZj2jWyKAz", "predicateType": "SeasonTierPredicate", "value": "YP9kO0rmonOpgtON", "values": ["mMvrDH4IXc6tn8Xa", "C4NCbltixkXwXO0X", "yBI734jCTSnRqHTW"]}, {"anyOf": 10, "code": "fsySRn2FX0Ac7Czu", "comparison": "excludes", "name": "XE90ufrBaS458bBT", "predicateType": "EntitlementPredicate", "value": "FnAIz4y9yy462Mnw", "values": ["chld3LWFhC1kBUvs", "EmQiF1OsXfJG3psj", "UcnOXhewthszMsYO"]}, {"anyOf": 72, "code": "EEU6G6YVa5GGFvLt", "comparison": "isNot", "name": "l66DAEkAvXqNdnEf", "predicateType": "EntitlementPredicate", "value": "4IGPYHaRvV3JGi5l", "values": ["gZzuoTiOgT4AtBZJ", "0G5NBtXVTXK1JdoC", "lQQGLneKl3iXOvSG"]}]}, {"operator": "or", "predicates": [{"anyOf": 17, "code": "MBPDcUuWC1NgHaxQ", "comparison": "is", "name": "8YQRsZpn4zsR2KwS", "predicateType": "StatisticCodePredicate", "value": "l0Un3PT2bVzOt2J0", "values": ["0vyaMbcnlyBvXdpo", "VxSVRWxJw7idbmOx", "YVZKx8oPBJncKdya"]}, {"anyOf": 2, "code": "OWkI0sHphIU3KaP7", "comparison": "isGreaterThan", "name": "dXT4YD9fDzx1WPpv", "predicateType": "StatisticCodePredicate", "value": "BMMNJG6TuQ90jhJC", "values": ["5qUyimmVzOJYebI5", "ChF7cgujItr2ZFjL", "rrsBPvGhWiPLLd5e"]}, {"anyOf": 63, "code": "Qu0coThNxwnnpoM2", "comparison": "isGreaterThanOrEqual", "name": "SoHlpDFImJNovlZq", "predicateType": "SeasonTierPredicate", "value": "O6RDUgilQHCts6SU", "values": ["6WeXWf3dBAVfIM2o", "LFaTIhv5XrQvTAdi", "NxUWIGSkxjKL3EiP"]}]}]}}' \
    'sxP0DyxqSYeCl4gE' \
    'ZgIMDALa4nsITUeF' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-public-create-user-order' \
    '{"currencyCode": "v2JADKAlbiwvSCh7", "discountCodes": ["gGsouhPkDuF7dDQ8", "Ghlo6BJVxNK6m3dL", "3nAeUS40JxsNUjSV"], "discountedPrice": 44, "ext": {"pTtsmzJtuOWKZOaS": {}, "MJHAxVRHDzHpHJ0b": {}, "dnZomYJoJJTExoot": {}}, "itemId": "NzMPSXZiLgCh92m9", "language": "df-Fp", "price": 60, "quantity": 98, "region": "Fq8rcYfG8Z9PgWjy", "returnUrl": "2W7npJxp6vrbIUXH", "sectionId": "WViHiwgQxiaDuZwY"}' \
    'sAt9fGKNjmyiX8Bw' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-public-preview-order-price' \
    '{"currencyCode": "W15hXKp1SF6rFNCe", "discountCodes": ["RrxucZTOtfIlJrMO", "kjryYdmc2XymIObj", "4IbY0HX1WWNf2XD8"], "discountedPrice": 85, "itemId": "esbUpxGfZJIyifvw", "price": 26, "quantity": 36}' \
    'sbXIs1j2kdfY9jVo' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
