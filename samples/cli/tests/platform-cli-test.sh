...
platform-update-item-purchase-condition 'nzS9SiGUjVAw4v3q' '6JRHcn7KaoCEkRdo' --body '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 33, "comparison": "isGreaterThan", "name": "YIZWnXqQ1oHFJ9Q0", "predicateType": "SeasonPassPredicate", "value": "XegSEhrPpK2q8kxR", "values": ["VeHv0L2Acm960EYQ", "4BuEksS2A9VOA8H9", "EuGJVl8xs1WId9Wl"]}, {"anyOf": 1, "comparison": "is", "name": "HgoXCR6XOMXwKdfq", "predicateType": "EntitlementPredicate", "value": "xwEdkyuT3MgzReRq", "values": ["0112ISArROIodcmM", "6v2AEozWWaYvBLE4", "6bpuJip8JyxJ39vr"]}, {"anyOf": 40, "comparison": "isLessThan", "name": "mb01yA7U7dGMjupZ", "predicateType": "EntitlementPredicate", "value": "gwhYzk33J34fiTxK", "values": ["FUsUQ6ZXQcb2o1J5", "63OHpnUCGBVfpctN", "euLAbBgejqc0apxq"]}]}, {"operator": "or", "predicates": [{"anyOf": 49, "comparison": "includes", "name": "9BySn8aUaGlAyvIs", "predicateType": "EntitlementPredicate", "value": "SQdwec1m8BusV9tU", "values": ["h74KVo6Xqjz2xUKL", "aLMqi836ULa7cfZl", "NWSmYyVvyelIJ8Qg"]}, {"anyOf": 61, "comparison": "isLessThan", "name": "ErA82FrR1GSogkew", "predicateType": "SeasonTierPredicate", "value": "kIxXKKIR6kPmswm5", "values": ["LsGP6KLPXkvUv2Xi", "GLmSZns5owBhoUg4", "TCAU1cKApdJDnE73"]}, {"anyOf": 0, "comparison": "isGreaterThanOrEqual", "name": "BzsmaxjTZPlLityt", "predicateType": "SeasonTierPredicate", "value": "yB7FTexsOZ0b2p3b", "values": ["it6boOLGCcg16Dqw", "dQPQ9HkSSV8e1MgT", "63KrcwIcXMhGy83X"]}]}, {"operator": "and", "predicates": [{"anyOf": 91, "comparison": "includes", "name": "F3eTC0vzZUDj9dzG", "predicateType": "EntitlementPredicate", "value": "j7qms9AGQExPhgr9", "values": ["Vpqn47GVghTH2wTo", "Onq9U5lyW89Xwt3w", "gGfC0GjvpgJfuBs1"]}, {"anyOf": 26, "comparison": "isNot", "name": "RTrDCjhnKvsHezWT", "predicateType": "SeasonPassPredicate", "value": "WK0x0ZidAJ1CU1eD", "values": ["1La16Bw3JbUnUDh5", "yGjjv4Mwrv2vancm", "R6Z7rb21A2E9pX0B"]}, {"anyOf": 100, "comparison": "isNot", "name": "dzA8bvXlDhG7Bror", "predicateType": "EntitlementPredicate", "value": "SrSHrkoqv2mM6soM", "values": ["aTvQq2a9YdFNtRVS", "gUxAogcnGkXk17QP", "O0js0hG9xmSnzd7z"]}]}]}}' --login_with_auth "Bearer foo"
...
platform-bulk-credit --body '[{"creditRequest": {"amount": 88, "expireAt": "1995-01-17T00:00:00Z", "origin": "Nintendo", "reason": "onwz27DWfGRVhbZT", "source": "PROMOTION"}, "currencyCode": "MmYyTGO07foRZ6Fu", "userIds": ["llYsONpp6QGW56CN", "jpIWo0qJtqp4Q6Xg", "ICLgMHcP1eE6sjWQ"]}, {"creditRequest": {"amount": 17, "expireAt": "1996-05-30T00:00:00Z", "origin": "Steam", "reason": "GwQkJuy9oLFcHHcr", "source": "ACHIEVEMENT"}, "currencyCode": "twaM2IoyY1wpIdjc", "userIds": ["9wNpmrK5Y5heA2ew", "mya73hX0a8Ri85PA", "AtTj1IMuuhxxlulf"]}, {"creditRequest": {"amount": 100, "expireAt": "1991-04-20T00:00:00Z", "origin": "Epic", "reason": "FcqHxXP3kRhtrBcB", "source": "IAP"}, "currencyCode": "SryWB4yRaDxvxwaL", "userIds": ["M8HkVOW8PnLkgqkq", "YZWPZTgKagTzdcYc", "ko7U3gH239LhRx2L"]}]' --login_with_auth "Bearer foo"
platform-bulk-debit --body '[{"currencyCode": "aa2RdtVb6VgA5yFI", "request": {"allowOverdraft": false, "amount": 38, "balanceOrigin": "System", "reason": "9UyeaFi8OE7BCK4F"}, "userIds": ["eVGrl5NpUG9zblWE", "3slUe94NxhXsVcqT", "iHaUjyTHb0sSlstb"]}, {"currencyCode": "Yi1TMBMzaOrxuKvt", "request": {"allowOverdraft": true, "amount": 45, "balanceOrigin": "Other", "reason": "kiU2jXSwsBBRopVl"}, "userIds": ["e2IoPMSQKcg0OTT9", "5M88TKhFYkA9aRND", "38d4NZGtk6EmWxC7"]}, {"currencyCode": "JA0ll1RimBCiQwuy", "request": {"allowOverdraft": true, "amount": 98, "balanceOrigin": "Xbox", "reason": "ok9sNK1ORg3tChsS"}, "userIds": ["3fFpaS1uq1mH3oYf", "PK2QiAUhIfi17Yrk", "WHNxiaNyqBfgw58H"]}]' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'platform-update-item-purchase-condition' \
    '01oVwoWAbcskuBfc' \
    'vcoAMPzCXwpgD8MO' \
    --body '{"purchaseCondition": {"conditionGroups": [{"operator": "and", "predicates": [{"anyOf": 44, "comparison": "isGreaterThan", "name": "Xcljy6EB8dB8wCiY", "predicateType": "SeasonPassPredicate", "value": "lgtX87XuWOIpQwpt", "values": ["cvroohLb6q3F16PO", "9YdwqEszRnwVX2rv", "Vr6DpLOyrgsLZV9a"]}, {"anyOf": 35, "comparison": "isLessThanOrEqual", "name": "TxBgnOqH9lyv8wx2", "predicateType": "SeasonTierPredicate", "value": "HSXapFLiHZfwcmqp", "values": ["HRQcJzso1tgoqsyj", "2hT9UYbm2BWjzlqI", "uA8sqeXbV9I8yo0u"]}, {"anyOf": 54, "comparison": "excludes", "name": "8csXOpDTl6yIwkTT", "predicateType": "SeasonPassPredicate", "value": "IH1dyZPHtYHKqpl1", "values": ["uh1LdVOaWOjRinmM", "6XXXuoJGXCyzA8a5", "Xk1CdFvYqfoYzBc1"]}]}, {"operator": "or", "predicates": [{"anyOf": 62, "comparison": "isLessThanOrEqual", "name": "WhYLsAlPZs4v14XF", "predicateType": "SeasonTierPredicate", "value": "C3gIRiYFpDlAEyVu", "values": ["nOP02x00SvR2yNPm", "vyXITMn2F86xZRHx", "s1DdUL5bc6QMB9Tt"]}, {"anyOf": 69, "comparison": "isLessThan", "name": "XqeaYlaYm2XGN51w", "predicateType": "SeasonPassPredicate", "value": "p9aCLekZch7a3b0h", "values": ["tkf3M9oI3ymYms9f", "FYqZQAUm9m9ht4Js", "rC6ho0XSsR3HPQNr"]}, {"anyOf": 43, "comparison": "is", "name": "DJjPEF1LpvoOxT54", "predicateType": "SeasonPassPredicate", "value": "o5sDrk8BZ0jnV4jA", "values": ["AxGZ794ngDQya3dv", "yjxR120zHmDzxvCG", "S2mYl0sA87gQx9kL"]}]}, {"operator": "and", "predicates": [{"anyOf": 29, "comparison": "is", "name": "tEpNGaoJWjZSpZNj", "predicateType": "EntitlementPredicate", "value": "Jl9RPULWpWw5UQBl", "values": ["dfnMF2X9wbQz3euR", "4MhLQs8XliOoWqix", "Fdv5aDRSnCrIQ2kC"]}, {"anyOf": 15, "comparison": "isLessThanOrEqual", "name": "yafmo2nIKr9kryla", "predicateType": "EntitlementPredicate", "value": "aH49QFksDAGUgVcY", "values": ["CmsemV8gAHQaitMh", "dzd3mUKKxi2anNFp", "YXwE37QpBIY8LEEt"]}, {"anyOf": 24, "comparison": "excludes", "name": "eY83sh3B07O0XQWC", "predicateType": "SeasonPassPredicate", "value": "XaPi8oY6VkZP57Py", "values": ["d3Y16uyKwJ713r4F", "BLX7knj7y5qEOp7h", "zPCxvetFhAgAkkEh"]}]}]}}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-bulk-credit' \
    --body '[{"creditRequest": {"amount": 21, "expireAt": "1988-10-10T00:00:00Z", "origin": "GooglePlay", "reason": "aANvZ0I2EGVDWs67", "source": "PURCHASE"}, "currencyCode": "CeZXmSBfgrJcwR3q", "userIds": ["Uvez1lbenagh9kCP", "NSZTIlkM5IYJnbFp", "ktAdH94tziEpGVXs"]}, {"creditRequest": {"amount": 35, "expireAt": "1977-12-28T00:00:00Z", "origin": "GooglePlay", "reason": "WLjHPiPqvMMmYJeK", "source": "PROMOTION"}, "currencyCode": "dIk4I9TU6FvvEdqH", "userIds": ["40w6szojkvjtacFS", "zEDtl5oR9m1dm3fG", "K1wINqvFrAsrmYYu"]}, {"creditRequest": {"amount": 98, "expireAt": "1992-09-17T00:00:00Z", "origin": "Playstation", "reason": "UiqcJ2Jldy73ukTx", "source": "GIFT"}, "currencyCode": "3zAXk9qVrzEqsDwI", "userIds": ["XTWGIrWq2VvH0roA", "wRyHKWspPtJlLDOj", "20Sfzrc9YYsgvVLN"]}]' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-bulk-debit' \
    --body '[{"currencyCode": "3usfhiyCf1FOddxt", "request": {"allowOverdraft": true, "amount": 13, "balanceOrigin": "GooglePlay", "reason": "2sFK1jNp3OwcrNR2"}, "userIds": ["vgYPIFEVZLGzEglE", "CbbMa2LqgJOAfFwv", "jH7Xx7m8IqIRyUqa"]}, {"currencyCode": "e95LWKrkj7TPuigp", "request": {"allowOverdraft": false, "amount": 17, "balanceOrigin": "Other", "reason": "JofgD4VypGT4cTfK"}, "userIds": ["2UVIQMA6BOpxtYbm", "NrjPqUk0t9aquw2B", "QwS5kNxCPLeKM4cQ"]}, {"currencyCode": "l8DlY91SXBeHwrkP", "request": {"allowOverdraft": true, "amount": 32, "balanceOrigin": "Epic", "reason": "7RKEcLehyAowu72o"}, "userIds": ["CUdMES0mVVI1Filc", "KCk0zbREElwdZORo", "O4pajEhkRLMvZnYZ"]}]' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
