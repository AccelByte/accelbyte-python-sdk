...
platform-update-item-purchase-condition '0KO5bEJaPnAFjsod' 'yJQVVBrShGbIIuqK' --body '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 100, "comparison": "isGreaterThan", "name": "03HgoXCR6XOMXwKd", "predicateType": "EntitlementPredicate", "value": "PCxwEdkyuT3MgzRe", "values": ["E46bpuJip8JyxJ39", "Rq0112ISArROIodc", "mM6v2AEozWWaYvBL"]}, {"anyOf": 43, "comparison": "isGreaterThanOrEqual", "name": "rtuWWrqTZbSqBSKp", "predicateType": "SeasonPassPredicate", "value": "AmgwhYzk33J34fiT", "values": ["J5euLAbBgejqc0ap", "xK63OHpnUCGBVfpc", "tNFUsUQ6ZXQcb2o1"]}, {"anyOf": 47, "comparison": "isGreaterThanOrEqual", "name": "VByeI3ycMcYYBixK", "predicateType": "SeasonTierPredicate", "value": "vIslt7N1qcxKs4nl", "values": ["f1MfqUZXkjHvcUOT", "ShBKsQjXvfQgQDt6", "lxNf09pefgFIiJss"]}]}, {"operator": "and", "predicates": [{"anyOf": 11, "comparison": "includes", "name": "Zl4VuY6rsZyo6CBR", "predicateType": "SeasonTierPredicate", "value": "gkewIzTOqKkcjRh3", "values": ["IlTk3Bpclrk4hIRn", "l2gAJOTCbx7J3gNL", "0znIKzAEAHQpBOgH"]}, {"anyOf": 63, "comparison": "isLessThan", "name": "P5l94s7CbIJ7eHnV", "predicateType": "SeasonTierPredicate", "value": "OboMkyB7FTexsOZ0", "values": ["b2p3b63KrcwIcXMh", "Gy83Xit6boOLGCcg", "16DqwdQPQ9HkSSV8"]}, {"anyOf": 8, "comparison": "isLessThan", "name": "MgTTLS2FgarY903I", "predicateType": "SeasonTierPredicate", "value": "ZUDj9dzGgGVxo9OH", "values": ["cOpR45VDlvSc0Mr7", "ImwCwGqOf0bNs97K", "gfHumyfuBNisecYb"]}]}, {"operator": "or", "predicates": [{"anyOf": 99, "comparison": "isLessThanOrEqual", "name": "9Xwt3wmRTrDCjhnK", "predicateType": "SeasonPassPredicate", "value": "bbrmgjhWK0x0ZidA", "values": ["bUnUDh5yGjjv4Mwr", "v2vancmR6Z7rb21A", "J1CU1eD1La16Bw3J"]}, {"anyOf": 76, "comparison": "isNot", "name": "8Y4JFVUdzA8bvXlD", "predicateType": "EntitlementPredicate", "value": "dM5T3fDSrSHrkoqv", "values": ["mSnzd7zgUxAogcnG", "2mM6soMaTvQq2a9Y", "dFNtRVSO0js0hG9x"]}, {"anyOf": 21, "comparison": "includes", "name": "k17QPkJHRhmLKQuQ", "predicateType": "SeasonPassPredicate", "value": "FSKiXl8G2uf6E8Ea", "values": ["KXu1bqI2M5PmXfKn", "JCpKedhuzI7G9NCK", "jXLSAS8MKMaxQ1Qy"]}]}]}}' --login_with_auth "Bearer foo"
...
platform-bulk-credit --body '[{"creditRequest": {"amount": 31, "expireAt": "1991-05-06T00:00:00Z", "metadata": {"qIl7U12hO5vpk9DO": {}, "SgbsdGVPLD9A5Nmu": {}, "ZDUV3yHurgOfba1X": {}}, "origin": "GooglePlay", "reason": "T9JA0ll1RimBCiQw", "source": "OTHER"}, "currencyCode": "P5Vok9sNK1ORg3tC", "userIds": ["oYfPK2QiAUhIfi17", "hsS3fFpaS1uq1mH3", "YrkWHNxiaNyqBfgw"]}, {"creditRequest": {"amount": 7, "expireAt": "1988-11-03T00:00:00Z", "metadata": {"x0XYL0fJOPYpnPqG": {}, "lPnhBDOWqDU8N3Dj": {}, "VUt0n0jfyDbtIXIC": {}}, "origin": "Twitch", "reason": "6tmIR28xVxbtpSKO", "source": "CONSUME_ENTITLEMENT"}, "currencyCode": "mzQx1RsYhcRlv16W", "userIds": ["qyNgN7GoeMsezFZs", "zuQcsjFehD6uTDYn", "we8YK3lZFslECI9Q"]}, {"creditRequest": {"amount": 95, "expireAt": "1988-08-15T00:00:00Z", "metadata": {"wIGGsusS0zZRODEK": {}, "PdudZsLaf8aZrXW8": {}, "4dt0TSTmy7XF26K2": {}}, "origin": "Xbox", "reason": "xttUz8nWKJjv06Pu", "source": "CONSUME_ENTITLEMENT"}, "currencyCode": "DyGYIVFDbTvRYfpJ", "userIds": ["sgBd7MYLLoPZrkjR", "4wM9WZfOOxAzmsbh", "i5QJuc2SNBaOlXfg"]}]' --login_with_auth "Bearer foo"
platform-bulk-debit --body '[{"currencyCode": "m5Ki0orhXrISEaPZ", "request": {"allowOverdraft": false, "amount": 78, "balanceOrigin": "System", "balanceSource": "EXPIRATION", "metadata": {"3nplXaUQV5QEvKEl": {}, "LfbB7gwwAR1xFrny": {}, "irw3iJt5iA3JS2xe": {}}, "reason": "aJ08JrSHPqdhKHn6"}, "userIds": ["EcV1FRyeeqehMNeR", "7UfYSrdN0JVz4U43", "ZjZMdr1C2TIQzRJY"]}, {"currencyCode": "YKeMbL0G4v5D6ylZ", "request": {"allowOverdraft": false, "amount": 30, "balanceOrigin": "Other", "balanceSource": "PAYMENT", "metadata": {"O918X7rLoexHBMBM": {}, "MAYokSWFwajRGUyk": {}, "lfLVY6g3PO4hKAeF": {}}, "reason": "4GUV5m96qcCJsVOW"}, "userIds": ["tu5RPsqd66ImBEuh", "naxZVf6MD9r1y5Ih", "r531Kajxq7lzuVRV"]}, {"currencyCode": "EvhKIbrq1xsGpdob", "request": {"allowOverdraft": true, "amount": 29, "balanceOrigin": "Twitch", "balanceSource": "DLC_REVOCATION", "metadata": {"hcO55hVjfWyK02w5": {}, "QytAmkanukAzAMaR": {}, "vIUhUwguGgbLLN3O": {}}, "reason": "7CEYjxqElP5lA2FJ"}, "userIds": ["4eeuMgEctVEux2MS", "uwsEHlwdeJyhsHS6", "0iGLRTXGsC5mxxse"]}]' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'platform-bulk-debit' \
    --body '[{"currencyCode": "dMKko1WdXcuqjnyB", "request": {"allowOverdraft": false, "amount": 28, "balanceOrigin": "System", "balanceSource": "ORDER_REVOCATION", "metadata": {"7fT7f00EZw65iq4f": {}, "nnFA4ieAeG0JcWHL": {}, "xYckKH0j3mmJ2Y5F": {}}, "reason": "sP84rgl0AQlBikeT"}, "userIds": ["qfnhjjtIQ7ipAfw6", "pjQGHI3Wkg4HIrEm", "eA9eq8hIKrzAUsKq"]}, {"currencyCode": "xTfJiEwGhGbMCnu8", "request": {"allowOverdraft": false, "amount": 61, "balanceOrigin": "Playstation", "balanceSource": "EXPIRATION", "metadata": {"jWqzvHab6b9t7DWT": {}, "aUGBJRTcrm3mIBuP": {}, "ZxqlGGOe2VYsej3c": {}}, "reason": "SW6YWXMTlqVrGyQY"}, "userIds": ["sYNW28u3UZ3q6QdM", "u2FcuLwU5IJt4pAa", "Dnbzj7Xg2lcvB7TO"]}, {"currencyCode": "AL9IC4460Wck2oK2", "request": {"allowOverdraft": false, "amount": 20, "balanceOrigin": "Twitch", "balanceSource": "DLC_REVOCATION", "metadata": {"wkxgJXK2OjNzQ95l": {}, "ceIy0lnTniV8j7Xm": {}, "R8FUW42wLu5tQBUE": {}}, "reason": "3k2mUvrQPFxSaRrD"}, "userIds": ["poEAwuriKcfEberK", "sF1CKYcMJnrn1I3y", "smttvFw6Ev28mtO5"]}]' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
