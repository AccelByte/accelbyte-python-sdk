...
platform-update-item-purchase-condition '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 9, "code": "Gz3b5WAEvdRF9bqM", "comparison": "is", "name": "uhh3bvadRthdbVAp", "predicateType": "EntitlementPredicate", "value": "dVw0zCqoMZvpIOO9", "values": ["CKpMv2Yky9DYkD2s", "7DmQ5ZOzx6iCJTu6", "0IifzMhkk5Pxsjqb"]}, {"anyOf": 71, "code": "X4FCK5ucTFsAFzaO", "comparison": "isLessThanOrEqual", "name": "htWm8RQvRUbUDSie", "predicateType": "EntitlementPredicate", "value": "qdTelFAadM9y66Dr", "values": ["f4SSGGt3MiBKohow", "3kKoaP1K4CDuH1mM", "IfOCDyVAHrHncR5d"]}, {"anyOf": 90, "code": "XqQ1oHFJ9Q0vqsL9", "comparison": "includes", "name": "omqWsGA76yxi0QzZ", "predicateType": "EntitlementPredicate", "value": "2A9VOA8H9VeHv0L2", "values": ["xs1WId9WlalqshF9", "Acm960EYQEuGJVl8", "Rh2o7GCQGPCxwEdk"]}]}, {"operator": "or", "predicates": [{"anyOf": 74, "code": "uT3MgzReRq0112IS", "comparison": "isLessThanOrEqual", "name": "acO5MnjnxD1OXkxS", "predicateType": "EntitlementPredicate", "value": "WWaYvBLE46bpuJip", "values": ["8JyxJ39vrtuWWrqT", "k33J34fiTxK63OHp", "ZbSqBSKp8AmgwhYz"]}, {"anyOf": 28, "code": "pE130YWSgxpKWtdt", "comparison": "excludes", "name": "ZXQcb2o1J5euLAbB", "predicateType": "EntitlementPredicate", "value": "ZV3ig8Jg5VByeI3y", "values": ["wec1m8BusV9tUh74", "KVo6Xqjz2xUKLNWS", "cMcYYBixKJXCISQd"]}, {"anyOf": 25, "code": "efgFIiJssShBKsQj", "comparison": "is", "name": "vfQgQDt6ce8NDMEr", "predicateType": "StatisticCodePredicate", "value": "rsZyo6CBRRnoOikI", "values": ["xXKKIR6kPmswm5TC", "AU1cKApdJDnE73GL", "mSZns5owBhoUg4Ls"]}]}, {"operator": "or", "predicates": [{"anyOf": 85, "code": "AHQpBOgHEP5l94s7", "comparison": "isNot", "name": "smaxjTZPlLitytGk", "predicateType": "EntitlementPredicate", "value": "7FTexsOZ0b2p3b63", "values": ["KrcwIcXMhGy83Xit", "6boOLGCcg16DqwdQ", "PQ9HkSSV8e1MgTTL"]}, {"anyOf": 91, "code": "82GF3eTC0vzZUDj9", "comparison": "excludes", "name": "RBEj7qms9AGQExPh", "predicateType": "EntitlementPredicate", "value": "fuBNisecYbcOpR45", "values": ["qS7Dcmtfh50eObbr", "qOf0bNs97KvKyj3M", "VDlvSc0Mr7ImwCwG"]}, {"anyOf": 24, "code": "zWTqgYPixtHk6lWq", "comparison": "isLessThan", "name": "eD1La16Bw3JbUnUD", "predicateType": "EntitlementPredicate", "value": "jRYldcTpdeCD9XPR", "values": ["i4bAQL7VE2wL8Y4J", "FVUdzA8bvXlDhG7B", "rorbKIKuOXJPm5zt"]}]}]}}' 'rr09CDA8Ij5bGKSu' 'opWQbaCvdPSq8Z27' --login_with_auth "Bearer foo"
...
platform-admin-create-user-order '{"currencyCode": "qZ5rryiMMt6fQtLh", "currencyNamespace": "zylaquioT3QBt29A", "discountCodes": ["ZlXMef7AvS3TfKx6", "F1Qwzz606UGXPhoN", "iRASsuFM4ahGw7Xc"], "discountedPrice": 57, "entitlementPlatform": "Playstation", "ext": {"BBkrXu9czsYr3cFe": {}, "Vw70xdNTuOdLKK0M": {}, "2B2hbqJin37P69t1": {}}, "itemId": "KqeGz7qbPnXEuOzz", "language": "koBmMR9C4qPqJrAd", "options": {"skipPriceValidation": false}, "platform": "GooglePlay", "price": 20, "quantity": 69, "region": "z1mFkyxoUzfMFoXC", "returnUrl": "OguSq2A4R3wDdSkN", "sandbox": false, "sectionId": "h5yNbYXmlAOi1SC3"}' 'I1SjkH42LtyZKrTJ' --login_with_auth "Bearer foo"
...
platform-public-preview-order-price '{"currencyCode": "IIxTIGI5EssYllIq", "discountCodes": ["jJzuQ8GglVgxjOGQ", "O07L9GG1uenDihce", "GlHm8VTN56tJKwD8"], "discountedPrice": 1, "itemId": "bq5KikDE7hWvT5bz", "price": 5, "quantity": 40}' 'fzIpL2pWB4XsdrxI' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'platform-update-catalog-config' \
    '{"enableInventoryCheck": true, "itemDeletionCheckConfig": ["ENTITLEMENT", "IAP", "REWARD"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-disable-item' \
    'jqaJnmx4p5ShR3fI' \
    '6ZeDWbxHSLn6kQxq' \
    --body '{"featuresToCheck": ["ENTITLEMENT", "IAP", "REWARD"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-update-item-purchase-condition' \
    '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 44, "code": "gIUMxGfQHmg4I1PJ", "comparison": "isLessThanOrEqual", "name": "o2dQM3ZXq9atijyF", "predicateType": "SeasonPassPredicate", "value": "8B6hECr4zqhZ9lpl", "values": ["F37X9HTu6c4mMUdJ", "18iHO0dKNHWBFM13", "lwasnryjxylwRVcy"]}, {"anyOf": 29, "code": "8qXSfSkxhrHhjWxk", "comparison": "isNot", "name": "2YoSLUIzzQsIU3IZ", "predicateType": "EntitlementPredicate", "value": "P7Yh6ERWyedt6rkP", "values": ["HPfyNRUhMXX7FiB3", "xW72ya2ruQcikSHw", "X634iuF8pqhqsqRF"]}, {"anyOf": 72, "code": "kqMbz4sxPUl2WbQN", "comparison": "isLessThanOrEqual", "name": "NB2IE43MBCGNyjqn", "predicateType": "StatisticCodePredicate", "value": "2z5O9ugNuq4uGu9k", "values": ["3KKHHaSwFS7fAGmA", "m7KeyQB3SUe4ug9J", "4gy2QBm02aTdgp0W"]}]}, {"operator": "and", "predicates": [{"anyOf": 90, "code": "TwcWL7fNlyGuj0Ek", "comparison": "excludes", "name": "7M8G78KZj2jWyKAz", "predicateType": "SeasonTierPredicate", "value": "YP9kO0rmonOpgtON", "values": ["yBI734jCTSnRqHTW", "mMvrDH4IXc6tn8Xa", "C4NCbltixkXwXO0X"]}, {"anyOf": 10, "code": "fsySRn2FX0Ac7Czu", "comparison": "excludes", "name": "XE90ufrBaS458bBT", "predicateType": "EntitlementPredicate", "value": "FnAIz4y9yy462Mnw", "values": ["UcnOXhewthszMsYO", "EmQiF1OsXfJG3psj", "chld3LWFhC1kBUvs"]}, {"anyOf": 72, "code": "EEU6G6YVa5GGFvLt", "comparison": "isNot", "name": "l66DAEkAvXqNdnEf", "predicateType": "EntitlementPredicate", "value": "4IGPYHaRvV3JGi5l", "values": ["0G5NBtXVTXK1JdoC", "lQQGLneKl3iXOvSG", "gZzuoTiOgT4AtBZJ"]}]}, {"operator": "or", "predicates": [{"anyOf": 17, "code": "MBPDcUuWC1NgHaxQ", "comparison": "is", "name": "8YQRsZpn4zsR2KwS", "predicateType": "StatisticCodePredicate", "value": "l0Un3PT2bVzOt2J0", "values": ["VxSVRWxJw7idbmOx", "YVZKx8oPBJncKdya", "0vyaMbcnlyBvXdpo"]}, {"anyOf": 2, "code": "OWkI0sHphIU3KaP7", "comparison": "isGreaterThan", "name": "dXT4YD9fDzx1WPpv", "predicateType": "StatisticCodePredicate", "value": "BMMNJG6TuQ90jhJC", "values": ["ChF7cgujItr2ZFjL", "5qUyimmVzOJYebI5", "rrsBPvGhWiPLLd5e"]}, {"anyOf": 63, "code": "Qu0coThNxwnnpoM2", "comparison": "isGreaterThanOrEqual", "name": "SoHlpDFImJNovlZq", "predicateType": "SeasonTierPredicate", "value": "O6RDUgilQHCts6SU", "values": ["LFaTIhv5XrQvTAdi", "NxUWIGSkxjKL3EiP", "6WeXWf3dBAVfIM2o"]}]}]}}' \
    'sxP0DyxqSYeCl4gE' \
    'ZgIMDALa4nsITUeF' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-admin-create-user-order' \
    '{"currencyCode": "7hRJWz66woOwujZi", "currencyNamespace": "qrVmhfRRK7pehYZg", "discountCodes": ["LjFarF9k0U2fuxYp", "TLF2CAqFwYdrzmGz", "kvzgJn2pWVs6zZRX"], "discountedPrice": 56, "entitlementPlatform": "Steam", "ext": {"AexxsuLkWktcAyka": {}, "y7LItVjr1YSzeXfU": {}, "iXANoRioh11etL7r": {}}, "itemId": "vPzXTBq3cXU8GYxE", "language": "0OhdSVFcSQWMXN21", "options": {"skipPriceValidation": false}, "platform": "Epic", "price": 39, "quantity": 91, "region": "lGGfo4IJnwUyJDPc", "returnUrl": "4Bi2BT8WWMNZ7MQ0", "sandbox": true, "sectionId": "gV63aIt0NDFEcKEQ"}' \
    'axvtIGC9xYvHbX0p' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-bulk-credit' \
    '[{"creditRequest": {"amount": 49, "expireAt": "1984-11-17T00:00:00Z", "metadata": {"2mKAvkSzld2vfGrb": {}, "c2jP3wtM1fSokFng": {}, "c559mMToWdIIC6lF": {}}, "origin": "Oculus", "reason": "oAXWUBY9BL1BmvNw", "source": "REDEEM_CODE"}, "currencyCode": "IYCmOOskIKiuKPVq", "userIds": ["ffgy1mpc59V2qKD8", "lNq4hOjr98OLoHsz", "NdfcbarmjmzkYQML"]}, {"creditRequest": {"amount": 85, "expireAt": "1975-10-15T00:00:00Z", "metadata": {"17CLEa8QbsGBZrZx": {}, "DKJWeWYfQ5eExWeq": {}, "j0EGyRTt1yUKDmgU": {}}, "origin": "Epic", "reason": "sI3cSyJGEsS9JnHf", "source": "ACHIEVEMENT"}, "currencyCode": "7UTJHBJE3tOlW5QY", "userIds": ["RcQcxJjxgx0It94B", "uLjZOmtY6jje5osr", "YAf28mqvM4LzAMy1"]}, {"creditRequest": {"amount": 56, "expireAt": "1996-07-23T00:00:00Z", "metadata": {"TDWnlXZ0fFMUOsM2": {}, "D6XBEfj5FBqjqhaV": {}, "BjVf2bpiMDOiSWOp": {}}, "origin": "Nintendo", "reason": "ULctkrQt7UdVDHgE", "source": "OTHER"}, "currencyCode": "dNQhgapqGnYl698V", "userIds": ["nbrD6I10HAKBM66I", "RGqR2jdN2MQUBknT", "g4h5oxaA4ecsKGNr"]}]' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-public-create-user-order' \
    '{"currencyCode": "v2JADKAlbiwvSCh7", "discountCodes": ["3nAeUS40JxsNUjSV", "Ghlo6BJVxNK6m3dL", "gGsouhPkDuF7dDQ8"], "discountedPrice": 44, "ext": {"pTtsmzJtuOWKZOaS": {}, "MJHAxVRHDzHpHJ0b": {}, "dnZomYJoJJTExoot": {}}, "itemId": "NzMPSXZiLgCh92m9", "language": "df-Fp", "price": 60, "quantity": 98, "region": "Fq8rcYfG8Z9PgWjy", "returnUrl": "2W7npJxp6vrbIUXH", "sectionId": "WViHiwgQxiaDuZwY"}' \
    'sAt9fGKNjmyiX8Bw' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-public-preview-order-price' \
    '{"currencyCode": "W15hXKp1SF6rFNCe", "discountCodes": ["4IbY0HX1WWNf2XD8", "RrxucZTOtfIlJrMO", "kjryYdmc2XymIObj"], "discountedPrice": 85, "itemId": "esbUpxGfZJIyifvw", "price": 26, "quantity": 36}' \
    'sbXIs1j2kdfY9jVo' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
