...
platform-update-item-purchase-condition 'UI9esSsXegSEhrPp' 'K2q8kxR4BuEksS2A' --body '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 83, "comparison": "isLessThanOrEqual", "name": "A8H9VeHv0L2Acm96", "predicateType": "SeasonPassPredicate", "value": "EYQEuGJVl8xs1WId", "values": ["zReRq0112ISArROI", "9WlalqshF9Rh2o7G", "CQGPCxwEdkyuT3Mg"]}, {"anyOf": 30, "comparison": "isGreaterThan", "name": "dcmM6v2AEozWWaYv", "predicateType": "SeasonPassPredicate", "value": "ekLfjmy8zosRCRgV", "values": ["MjupZkZQY8CNyT4k", "wbrQKmb01yA7U7dG", "3DIbfT22G5NpE130"]}, {"anyOf": 11, "comparison": "isGreaterThanOrEqual", "name": "SgxpKWtdtdtVW9an", "predicateType": "SeasonPassPredicate", "value": "1J5euLAbBgejqc0a", "values": ["pxqZ209BySn8aUaG", "lAyvIslt7N1qcxKs", "4nlf1MfqUZXkjHvc"]}]}, {"operator": "or", "predicates": [{"anyOf": 82, "comparison": "isLessThanOrEqual", "name": "lxNf09pefgFIiJss", "predicateType": "SeasonTierPredicate", "value": "8QgaLMqi836ULa7c", "values": ["fZl4VuY6rsZyo6CB", "RRnoOikIxXKKIR6k", "Pmswm5TCAU1cKApd"]}, {"anyOf": 72, "comparison": "isNot", "name": "IlTk3Bpclrk4hIRn", "predicateType": "EntitlementPredicate", "value": "znIKzAEAHQpBOgHE", "values": ["WOboMkyB7FTexsOZ", "P5l94s7CbIJ7eHnV", "0b2p3b63KrcwIcXM"]}, {"anyOf": 15, "comparison": "isGreaterThanOrEqual", "name": "Gy83Xit6boOLGCcg", "predicateType": "EntitlementPredicate", "value": "6DqwdQPQ9HkSSV8e", "values": ["1MgTTLS2FgarY903", "AGQExPhgr9gGfC0G", "INGIyEfRBEj7qms9"]}]}, {"operator": "and", "predicates": [{"anyOf": 3, "comparison": "isLessThan", "name": "cOpR45VDlvSc0Mr7", "predicateType": "SeasonTierPredicate", "value": "ghTH2wToOnq9U5ly", "values": ["Hk6lWq6tEeUmU96F", "W89Xwt3wmRTrDCjh", "nKvsHezWTqgYPixt"]}, {"anyOf": 76, "comparison": "isNot", "name": "JbUnUDh5yGjjv4Mw", "predicateType": "SeasonPassPredicate", "value": "CD9XPRi4bAQL7VE2", "values": ["JPm5ztrr09CDA8Ij", "wL8Y4JFVUdzA8bvX", "lDhG7BrorbKIKuOX"]}, {"anyOf": 2, "comparison": "excludes", "name": "KSuopWQbaCvdPSq8", "predicateType": "SeasonTierPredicate", "value": "27GpvHCDx55JZ5z6", "values": ["pDDubntPCFxfeoW2", "gujpFzlPspQD9IRI", "NdSWzOXjO1NQUqWH"]}]}]}}' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'platform-update-item-purchase-condition' \
    'wifDA7LpND5zXLhr' \
    'mEeBwTzs9QmLReEZ' \
    --body '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 36, "comparison": "is", "name": "6n6anryoVkl4tChu", "predicateType": "SeasonPassPredicate", "value": "kTTCLlRCEQSp3XwO", "values": ["SYIIOqTjadq7tSbu", "LamxL9Ltl0k2ZOJH", "SNJT3B5f3ynPDyKk"]}, {"anyOf": 56, "comparison": "isGreaterThan", "name": "nYPNYKWhYLsAlPZs", "predicateType": "SeasonTierPredicate", "value": "v14XFGIVeBHRe7JB", "values": ["UY6EuVZznqQVYO57", "FFTD6KSEeAEd96gz", "lzH9CrXX7cBfnjlf"]}, {"anyOf": 79, "comparison": "isNot", "name": "Ri3CuA2GelFQyuDW", "predicateType": "SeasonPassPredicate", "value": "N51wxYTCHYaW7BAF", "values": ["Znpxmzs0AQYJnB9w", "4rkop7LL7Yqjh4lg", "GGsrJv0EyLkZej5v"]}]}, {"operator": "and", "predicates": [{"anyOf": 25, "comparison": "isGreaterThanOrEqual", "name": "h0KRDJjPEF1LpvoO", "predicateType": "SeasonPassPredicate", "value": "HiFEo5sDrk8BZ0jn", "values": ["a3dvyjxR120zHmDz", "xvCGS2mYl0sA87gQ", "V4jAAxGZ794ngDQy"]}, {"anyOf": 47, "comparison": "is", "name": "9f2ojEQrZ645LOpa", "predicateType": "SeasonTierPredicate", "value": "pZNjdKHqDX1jGg2X", "values": ["mHSK4Sz7fbw7cgHH", "6VHZOulL5KfkSA0a", "vIEPvqjKVvPP5x3g"]}, {"anyOf": 11, "comparison": "is", "name": "nOzyuw55KAICc0N5", "predicateType": "SeasonPassPredicate", "value": "lalbZWuO0OVwGUgR", "values": ["0zAUzpliq50demc4", "3PEWI0N4k2W2caqa", "RVdR05rSilF29Lpg"]}]}, {"operator": "or", "predicates": [{"anyOf": 79, "comparison": "includes", "name": "3d2v2ibO04gNmB9r", "predicateType": "SeasonPassPredicate", "value": "MA5lA6x0lY16PWsr", "values": ["RsKMCPmtnE1aHAuV", "ZKYNaKhi81nO4RNj", "sxYq77iFOu0ybeoE"]}, {"anyOf": 43, "comparison": "isGreaterThanOrEqual", "name": "C342Uggyr64isEfx", "predicateType": "EntitlementPredicate", "value": "Gqd31L6KqJTL11T4", "values": ["DEJfdxsQXLRJRONK", "h0R0RXJ6anzAeqD1", "vlBRDjj3FKvRIguq"]}, {"anyOf": 69, "comparison": "isGreaterThanOrEqual", "name": "lhQ1rqjRECHyhLYG", "predicateType": "EntitlementPredicate", "value": "kzIBx4VA9ZxbKQDq", "values": ["G7UJEMeseC0hnoI1", "QCljoyZp9rrR7RJb", "dph0xgVXvWuSKhoO"]}]}]}}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-bulk-credit' \
    --body '[{"creditRequest": {"amount": 11, "expireAt": "1983-09-29T00:00:00Z", "origin": "Steam", "reason": "XQQVmxHmCVmuzoO2", "source": "OTHER"}, "currencyCode": "HKWspPtJlLDOjXTW", "userIds": ["fzrc9YYsgvVLN3us", "fhiyCf1FOddxtE52", "GIrWq2VvH0roA20S"]}, {"creditRequest": {"amount": 39, "expireAt": "1996-09-12T00:00:00Z", "origin": "Xbox", "reason": "OAzTmCVFEHDMT1eD", "source": "PURCHASE"}, "currencyCode": "bcvyxtTxuptcOYST", "userIds": ["j2AWA5f61ztkSpGm", "xv9QtivQqeRyPorh", "f8BXosNylCwcf2iV"]}, {"creditRequest": {"amount": 94, "expireAt": "1973-06-21T00:00:00Z", "origin": "GooglePlay", "reason": "Fn3W0qApZ98a9g9A", "source": "GIFT"}, "currencyCode": "qUk0t9aquw2B2UVI", "userIds": ["QMA6BOpxtYbmQwS5", "Y91SXBeHwrkPCaAy", "kNxCPLeKM4cQl8Dl"]}]' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-bulk-debit' \
    --body '[{"currencyCode": "cmEvk3rVTLjZT9qa", "request": {"allowOverdraft": true, "amount": 80, "balanceOrigin": "Xbox", "reason": "ES0mVVI1FilcO4pa"}, "userIds": ["zbREElwdZORocHSH", "ulJHhAnY7QeDSRro", "jEhkRLMvZnYZKCk0"]}, {"currencyCode": "VkXb4xPPUmUifQvf", "request": {"allowOverdraft": false, "amount": 2, "balanceOrigin": "Nintendo", "reason": "YfuaQ7gPgiz2EBME"}, "userIds": ["zy0T6Q89155mM6Rs", "5ikH5iUT9GB4bGcY", "YxtVcgA1q0sR85Dc"]}, {"currencyCode": "nV5fUvb2OK8scK4M", "request": {"allowOverdraft": true, "amount": 45, "balanceOrigin": "Twitch", "reason": "s1H5juf5Cq950Xti"}, "userIds": ["UYgwdNmcpdldDn2Y", "2l1kZWnqjJaGGTFa", "MxQDIHnPin3vZc9b"]}]' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
