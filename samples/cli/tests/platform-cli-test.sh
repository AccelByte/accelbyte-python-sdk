...
platform-bulk-credit --body '[{"creditRequest": {"amount": 24, "expireAt": "1994-08-16T00:00:00Z", "metadata": {"MCGnxZwak7KHnzGA": {}, "SmVzePIroz41oQCu": {}, "XeTRyJQrNLTcqLVT": {}}, "origin": "Xbox", "reason": "CyiB4tDCWx3cEX8w", "source": "REFUND"}, "currencyCode": "of79zVTWIfgdNphq", "userIds": ["PLhDSJx9jzxaRKph", "4kiIFgS4fLqlrKGi", "e9fS1m77MAg4KoZQ"]}, {"creditRequest": {"amount": 93, "expireAt": "1980-04-09T00:00:00Z", "metadata": {"XxjkyNfj3XgTRTjI": {}, "9oNBzgQ4CRwg0sKV": {}, "eSpMny0GrvKI5EVB": {}}, "origin": "GooglePlay", "reason": "ZFzLNsjdCFtKY0Ks", "source": "IAP_CHARGEBACK_REVERSED"}, "currencyCode": "TTfqLCv9DYBOProN", "userIds": ["4UWbQaKFrTv4JWEl", "TLcOef8MgIwkrKFE", "mOCxqPrq9I3XJWBx"]}, {"creditRequest": {"amount": 42, "expireAt": "1983-07-06T00:00:00Z", "metadata": {"dxB5kvtM8ah9bPsk": {}, "sceGUEX8ERZcKSYL": {}, "o6y7yJMowQ6LpHCv": {}}, "origin": "Steam", "reason": "vWp3h0xPsVY8qNwB", "source": "SELL_BACK"}, "currencyCode": "pUUv7qefNMFsZAIq", "userIds": ["GJUgU8bD5mGFFmKT", "8ubfdXi7BycDPcke", "ak1zi0JSa5cRn31D"]}]' --login_with_auth "Bearer foo"
platform-bulk-debit --body '[{"currencyCode": "TUxG0mpmFxxDNXGl", "request": {"allowOverdraft": false, "amount": 44, "balanceOrigin": "Epic", "balanceSource": "OTHER", "metadata": {"y4Csye3iJLtjsu6Z": {}, "JRCoDq3geuHFFaZz": {}, "PIjETqcKN1gaQ4Bn": {}}, "reason": "0cPPtKaJlw31pdDr"}, "userIds": ["O3lGZ7eGOPj2XoFu", "XQ47WSGyDCKF0LLh", "g8BUQUmPHnPumcaz"]}, {"currencyCode": "KAna0ji757aNDFeK", "request": {"allowOverdraft": false, "amount": 25, "balanceOrigin": "Oculus", "balanceSource": "PAYMENT", "metadata": {"1es7A4PFduN4gx0U": {}, "C6eWKCFGS97Si6Xy": {}, "LVPrkUxyZ1OH5Nn4": {}}, "reason": "nMT8QOyTuUSD9Imt"}, "userIds": ["07foRZ6FujpIWo0q", "aPAocOQcpBWSNrCj", "SNEAdojkCMmYyTGO"]}, {"currencyCode": "Jtqp4Q6XgICLgMHc", "request": {"allowOverdraft": true, "amount": 10, "balanceOrigin": "IOS", "balanceSource": "ORDER_REVOCATION", "metadata": {"9tqvfHmFvUZiUW5Y": {}, "0CYw5OXSGwQkJuy9": {}, "oLFcHHcraLXR2n9J": {}}, "reason": "Qvq7NKWIHYsii3fC"}, "userIds": ["h7sieJjZPAkiWuml", "lU31uXPwYxedGHCI", "kmt4bfJOhNaIT0pv"]}]' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'platform-update-item-purchase-condition' \
    '178A4NUDAdwt7cj6' \
    'v5DLEk9RkumkrnY4' \
    --body '{"purchaseCondition": {"conditionGroups": [{"operator": "and", "predicates": [{"anyOf": 21, "comparison": "isGreaterThanOrEqual", "name": "sFD2le3UGhQnnmMg", "predicateType": "EntitlementPredicate", "value": "iVQ6covYDuI4l1d9", "values": ["nqiWP9WWQMGmm0bi", "YaLVuL1mLP65pId3", "6F25c13PNqPn7XRl"]}, {"anyOf": 98, "comparison": "includes", "name": "jE8A3EsOz8LDnxgL", "predicateType": "SeasonPassPredicate", "value": "t7Qhdw4vmSxnJcya", "values": ["dDu6rxIv2ZMtZX5K", "ijSCsFa6ipRu1AaF", "jz0yLelzMzWiPzug"]}, {"anyOf": 21, "comparison": "isGreaterThan", "name": "53tX2oxmEDDgGBgP", "predicateType": "SeasonPassPredicate", "value": "HmOLBLlsw2pDJDLe", "values": ["Wv5cGRm3WTx0oyOr", "xXCStzvOyY1tNKAV", "JwzbVEEQ0D6RcLpR"]}]}, {"operator": "or", "predicates": [{"anyOf": 90, "comparison": "excludes", "name": "u5wP9CTLKxi1BjFM", "predicateType": "SeasonTierPredicate", "value": "ZdT1fZJTutZpZZn6", "values": ["ANjqBdfMMU89e6CI", "RTnJUdR3MUQnEeAN", "egDbFDXW3N42ccGU"]}, {"anyOf": 57, "comparison": "isGreaterThanOrEqual", "name": "n2Q3kMtF5tiwPCAx", "predicateType": "SeasonTierPredicate", "value": "vuCoP1hIpdIWajZT", "values": ["yB7k7Q9zNJHkXmHB", "9cu1ZdRIZ1hHCpAp", "GunPxVvWyQvciFGx"]}, {"anyOf": 73, "comparison": "is", "name": "NOaveGzkTPehZVmZ", "predicateType": "EntitlementPredicate", "value": "8RDVgsQzaeOv7xB8", "values": ["GlNYJeVVZQH5C76G", "aeCobrGOAvaYctXd", "3jNOlJBjBMsJisMu"]}]}, {"operator": "or", "predicates": [{"anyOf": 22, "comparison": "is", "name": "QcGm0x3DmUahjPVD", "predicateType": "SeasonTierPredicate", "value": "XtIeslnM3lJQMDxu", "values": ["7Auj8cqdtNaFO3AB", "y1AeDryAFewcN6U8", "vRJ3ebbfa3ep8cKN"]}, {"anyOf": 23, "comparison": "excludes", "name": "ukM2BVMu418S3o2D", "predicateType": "SeasonTierPredicate", "value": "qhPmlYgFAu9gD8vs", "values": ["CanZaGzamJ8JZ6lV", "iDfzK1gMLvJ1KqSZ", "9zpsDX7CWEoHK3yL"]}, {"anyOf": 56, "comparison": "isGreaterThanOrEqual", "name": "wuAW3jLkVq9bAefB", "predicateType": "SeasonTierPredicate", "value": "aufemZ4xlGtWc5Uc", "values": ["amt1NNvdmy7qa1St", "GIGpI8YhyHkINdPY", "MbwcUsu3gJ0yHA6K"]}]}]}}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-bulk-credit' \
    --body '[{"creditRequest": {"amount": 28, "expireAt": "1994-12-23T00:00:00Z", "metadata": {"if17nsndhy0Gtga4": {}, "xRRNit3ApyAvkVtA": {}, "8b9zvOaiSMHjVciA": {}}, "origin": "Oculus", "reason": "PgLrITdqgHGJd9Al", "source": "PROMOTION"}, "currencyCode": "ZMehNOncXNM18ZiB", "userIds": ["Sz425Kp2PGW8gpXu", "Qj6RS5aO256ceteB", "Laa5iN5b6ODd1kj4"]}, {"creditRequest": {"amount": 35, "expireAt": "1977-08-11T00:00:00Z", "metadata": {"0FWbYOy7zpSeyGBL": {}, "auvijI1vUPcP4XMN": {}, "ICniSwlnSYTuNVaj": {}}, "origin": "Other", "reason": "4T9TmQupOzuaRV8V", "source": "IAP_CHARGEBACK_REVERSED"}, "currencyCode": "Re1LpwuZIoLrVS0A", "userIds": ["QgwjgNbqY9SXZMP7", "crY9Vdxzm1SnMFP7", "ijRI315PPtar2LEa"]}, {"creditRequest": {"amount": 81, "expireAt": "1999-02-03T00:00:00Z", "metadata": {"iEdDgNGO3Dfmm8Q8": {}, "A03ovBcVCnifE0YS": {}, "9KhgP8rRhISjcIvS": {}}, "origin": "GooglePlay", "reason": "I6tzdbpIKoQhtOlK", "source": "IAP_CHARGEBACK_REVERSED"}, "currencyCode": "2RlQ3Wpg0XNZCsES", "userIds": ["Z2IdgUYmmt7HXJCU", "CHRPA5OQX8twQrDu", "49JFXjPc1tJBaHYT"]}]' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
