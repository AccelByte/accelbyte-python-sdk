...
iam-admin-retrieve-user-third-party-platform-token-v3 'uSjfZe9i' '1osghF1h' --login_with_auth "Bearer foo"
iam-revoke-user-v3 'zi1Nl47s' --login_with_auth "Bearer foo"
iam-authorize-v3 'yJ5ibzSH' 'code' --login_with_auth "Basic YWRtaW46YWRtaW4="
